...
aliases:
  ...
  - /openriak-ts/latest/using/configuring/
linkTitle: "Configure"
weight: 250
---

[riakconf]: {{<baseurl>}}openriak-ts/3.0.0/configuring/riakconf/
[mdc]: {{<baseurl>}}openriak-ts/3.0.0/configuring/mdc/
[global expiry]: {{<baseurl>}}openriak-ts/3.0.0/configuring/global-object-expiration/
[kv config]: {{<baseurl>}}riak/kv/2.2.0/configuring/reference
[WITH]: {{<baseurl>}}openriak-ts/3.0.0/using/creating-activating/#using-the-with-clause
