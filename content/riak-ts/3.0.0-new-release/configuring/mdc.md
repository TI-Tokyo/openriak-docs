...
version_history:
  in: "1.3.0+"
  locations:
    - [">=3.0.0", "configuring/mdc"]
    - ["<=1.4.0",  "using/mdc"]
aliases:
  - /riakts/3.0.0/configuring/mdc
  - /openriak-ts/latest/using/mdc
linkTitle: "Multi-Datacenter Replication"
weight: 306
---

[activating]: {{<baseurl>}}openriak-ts/3.0.0/using/creating-activating
...
[install]: {{<baseurl>}}openriak-ts/3.0.0/setup/installing
...
{{% note title="Tip" %}}
[`SHOW CREATE TABLE`]({{<baseurl>}}openriak-ts/3.0.0/using/querying/show-create-table/) makes this much easier.
{{% /note %}}
