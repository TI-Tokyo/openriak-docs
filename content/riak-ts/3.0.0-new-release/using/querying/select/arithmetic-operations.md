...
aliases:
  - /openriak-ts/latest/using/arithmetic-operations
  - /openriak-ts/3.0.0/using/arithmetic-operations
  - /riakts/3.0.0/using/arithmetic-operations
linkTitle: "Arithmetic Operations"
weight: 300
---

[querying select]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/#select-query
