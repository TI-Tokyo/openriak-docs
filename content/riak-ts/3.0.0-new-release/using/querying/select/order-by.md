...
[query guidelines]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/guidelines/
[configuring]: {{<baseurl>}}openriak-ts/3.0.0/configuring/riakconf/#maximum-returned-data-size
