...
aliases:
  - /riakts/3.0.0/using/aggregate-functions/
  - /openriak-ts/latest/using/aggregate-functions/
  - /openriak-ts/3.0.0/using/aggregate-functions/
  - /riakts/3.0.0/using/querying/select/aggregate-functions/
