...
version_history:
  in: "3.0.0+"
aliases:
  - /riakts/3.0.0/using/querying/reference

linkTitle: "SQL Reference"
weight: 90
---

[select]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/select/
[describe]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/describe/
[delete]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/delete/
[explain]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/explain/
[show tables]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/show-tables/
[create table]: {{<baseurl>}}openriak-ts/3.0.0/using/creating-activating/
[group by]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/select/group-by/
[order by]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/select/order-by/
[limit]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/select/limit/
[offset]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/select/
[arithmetic]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/select/arithmetic-operations/
[aggregate]: {{<baseurl>}}openriak-ts/3.0.0/using/querying/select/aggregate-functions/
