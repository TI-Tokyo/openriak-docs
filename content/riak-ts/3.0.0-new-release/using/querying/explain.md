...
toc: true
aliases:
  - /riakts/3.0.0/using/querying/explain

linkTitle: "EXPLAIN"
weight: 400
---

[creating-activating]: {{<baseurl>}}openriak-ts/3.0.0/using/creating-activating
[develop]: {{<baseurl>}}openriak-ts/3.0.0/developing
[planning]: {{<baseurl>}}openriak-ts/3.0.0/using/planning
[riak shell]: {{<baseurl>}}openriak-ts/3.0.0/using/riakshell
