...
aliases:
  - /riakts/3.0.0/installing/debian-ubuntu/
  - /riakts/3.0.0/setup/installing/debian-ubuntu/
  - /openriak-ts/3.0.0/installing/debian-ubuntu/
  - /openriak-ts/latest/installing/debian-ubuntu/
linkTitle: "Debian and Ubuntu"
weight: 201
---

[download]: {{<baseurl>}}openriak-ts/3.0.0/downloads/
[openfileslimit]: {{<baseurl>}}riak/kv/2.2.0/using/performance/open-files-limit
[planning]: {{<baseurl>}}openriak-ts/3.0.0/using/planning
[security basics pam]: {{<baseurl>}}openriak-ts/3.0.0/using/security/sources-management/#pam-based-authentication
...
```bash
sudo dpkg -i riak-ts_3.0.0-1_amd64.deb
```
