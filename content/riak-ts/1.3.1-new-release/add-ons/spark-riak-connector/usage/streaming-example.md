...
version_history:
  in: "1.3.0+"
linkTitle: "Spark Streaming Example"
weight: 108
---
...
We also assume Riak TS is installed and there is a Riak TS node running at `127.0.0.1:8087`. You can find instruction to do so [here]({{<baseurl>}}openriak-ts/1.2.0/installing/mac-osx/).
