...
[erlang]: {{<baseurl>}}openriak-ts/1.5.2/developing/erlang
[go]: {{<baseurl>}}openriak-ts/1.5.2/developing/golang
[http]: {{<baseurl>}}openriak-ts/1.5.2/developing/http
[java]: {{<baseurl>}}openriak-ts/1.5.2/developing/java
[ruby]: {{<baseurl>}}openriak-ts/1.5.2/developing/ruby
[python]: {{<baseurl>}}openriak-ts/1.5.2/developing/python
[csharp]: {{<baseurl>}}openriak-ts/1.5.2/developing/csharp
[nodejs]: {{<baseurl>}}openriak-ts/1.5.2/developing/nodejs
[erlang]: {{<baseurl>}}openriak-ts/1.5.2/developing/erlang
[php]: {{<baseurl>}}openriak-ts/1.5.2/developing/php
