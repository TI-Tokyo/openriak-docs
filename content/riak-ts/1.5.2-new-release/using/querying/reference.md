...
[select]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/select/
[describe]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/describe/
[delete]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/delete/
[explain]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/explain/
[show tables]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/show-tables/
[create table]: {{<baseurl>}}openriak-ts/1.5.2/using/creating-activating/
[group by]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/select/group-by/
[order by]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/select/order-by/
[limit]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/select/limit/
[offset]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/select/
[arithmetic]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/select/arithmetic-operations/
[aggregate]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/select/aggregate-functions/
