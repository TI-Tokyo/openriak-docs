...
[GROUP BY]: group-by/
[guidelines]: {{<baseurl>}}openriak-ts/1.5.2/using/querying/guidelines
[iso8601]: ../../timerepresentations/
[iso8601 accuracy]: {{<baseurl>}}openriak-ts/1.5.2/using/timerepresentations/#reduced-accuracy
[ISO 8601]: https://en.wikipedia.org/wiki/ISO_8601
[learn timestamps accuracy]: {{<baseurl>}}openriak-ts/1.5.2/learn-about/timestamps/#reduced-accuracy
