...
toc: true
aliases:
  - /riakts/1.5.2/using/querying/explain

linkTitle: "EXPLAIN"
weight: 400
---

[creating-activating]: {{<baseurl>}}openriak-ts/1.5.2/using/creating-activating
[develop]: {{<baseurl>}}openriak-ts/1.5.2/developing
[planning]: {{<baseurl>}}openriak-ts/1.5.2/using/planning
[riak shell]: {{<baseurl>}}openriak-ts/1.5.2/using/riakshell
