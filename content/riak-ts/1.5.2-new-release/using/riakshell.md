...
[creating]: {{<baseurl>}}openriak-ts/1.5.2/using/creating-activating
[writing]: {{<baseurl>}}openriak-ts/1.5.2/using/writingdata
...
As of TS 1.5.2 (the first release to support comments), there is a
...
Logging : on
Date Log : off
Logfile : "/users/myusername/riakts/riak-ts-1.5.2/bin/../log/riak_shell/riak_shell"
