...
aliases:
  ...
  - /openriak-ts/1.5.2/installing/debian-ubuntu/
  - /openriak-ts/latest/installing/debian-ubuntu/
linkTitle: "Debian and Ubuntu"
weight: 201
---

[download]: {{<baseurl>}}openriak-ts/1.5.2/downloads/
[openfileslimit]: {{<baseurl>}}riak/kv/2.2.0/using/performance/open-files-limit
[planning]: {{<baseurl>}}openriak-ts/1.5.2/using/planning
[security basics pam]: {{<baseurl>}}openriak-ts/1.5.2/using/security/sources-management/#pam-based-authentication
