...
description: "Upgrading from Riak TS 1.4.0 to 1.5.2"
menu:
  riak_ts-1.5.2:
    name: "Upgrade"
    identifier: "upgrade"
...
This page walks you through the process of upgrading to Riak TS 1.5.2 from Riak TS 1.4.0. Find your operating system below:
