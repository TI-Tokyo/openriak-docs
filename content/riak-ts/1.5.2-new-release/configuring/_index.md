...
[riakconf]: {{<baseurl>}}openriak-ts/1.5.2/configuring/riakconf/
[mdc]: {{<baseurl>}}openriak-ts/1.5.2/configuring/mdc/
[global expiry]: {{<baseurl>}}openriak-ts/1.5.2/configuring/global-object-expiration/
[kv config]: {{<baseurl>}}riak/kv/2.2.0/configuring/reference
[WITH]: {{<baseurl>}}openriak-ts/1.5.2/using/creating-activating/#using-the-with-clause
