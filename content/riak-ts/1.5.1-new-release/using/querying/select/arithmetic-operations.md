...
aliases:
    - /openriak-ts/1.5.1/using/arithmetic-operations
    - /riakts/1.5.1/using/arithmetic-operations
    - /riakts/1.5.1/using/querying/select/arithmetic-operations
linkTitle: "Arithmetic Operations"
weight: 300
---

[querying select]: {{<baseurl>}}openriak-ts/1.5.1/using/querying/#select-query
