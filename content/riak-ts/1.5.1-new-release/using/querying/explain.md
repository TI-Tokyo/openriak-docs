...
[creating-activating]: {{<baseurl>}}openriak-ts/1.5.1/using/creating-activating
[develop]: {{<baseurl>}}openriak-ts/1.5.1/developing
[planning]: {{<baseurl>}}openriak-ts/1.5.1/using/planning
[riak shell]: {{<baseurl>}}openriak-ts/1.5.1/using/riakshell
