...
[SELECT]: {{<baseurl>}}openriak-ts/1.5.1/using/querying/SELECT#iso_8601
...
It is possible to use ISO 8601-compliant date/time strings rather than integer timestamps in SELECT statements. Please see [SELECT]({{<baseurl>}}openriak-ts/1.5.1/using/querying/select/#iso-8601) for an example or [Time Representations]({{<baseurl>}}openriak-ts/1.5.1/using/timerepresentations/) for more information.
{{% /note %}}
