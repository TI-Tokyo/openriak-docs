...
aliases:
    ...
    - /openriak-ts/1.5.1/installing/debian-ubuntu/
linkTitle: "Debian and Ubuntu"
weight: 201
---

[download]: {{<baseurl>}}openriak-ts/1.5.1/downloads/
[openfileslimit]: {{<baseurl>}}riak/kv/2.2.0/using/performance/open-files-limit
[planning]: {{<baseurl>}}openriak-ts/1.5.1/using/planning
[security basics pam]: {{<baseurl>}}openriak-ts/1.5.1/using/security/sources-management/#pam-based-authentication
...
```bash
sudo dpkg -i riak-ts_1.5.1-1_amd64.deb
```
