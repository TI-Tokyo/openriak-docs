...
[erlang]: {{<baseurl>}}openriak-ts/1.5.1/developing/erlang
[go]: {{<baseurl>}}openriak-ts/1.5.1/developing/golang
[http]: {{<baseurl>}}openriak-ts/1.5.1/developing/http
[java]: {{<baseurl>}}openriak-ts/1.5.1/developing/java
[ruby]: {{<baseurl>}}openriak-ts/1.5.1/developing/ruby
[python]: {{<baseurl>}}openriak-ts/1.5.1/developing/python
[csharp]: {{<baseurl>}}openriak-ts/1.5.1/developing/csharp
[nodejs]: {{<baseurl>}}openriak-ts/1.5.1/developing/nodejs
[erlang]: {{<baseurl>}}openriak-ts/1.5.1/developing/erlang
[php]: {{<baseurl>}}openriak-ts/1.5.1/developing/php
