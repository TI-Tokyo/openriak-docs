...
[install]: {{<baseurl>}}openriak-ts/1.4.0/setup/installing
[upgrade]: {{<baseurl>}}openriak-ts/1.4.0/setup/upgrading
[downgrade]: {{<baseurl>}}openriak-ts/1.4.0/setup/downgrading
