...
aliases:
    ...
    - /openriak-ts/1.4.0/installing/debian-ubuntu/
linkTitle: "Debian and Ubuntu"
weight: 201
---

[download]: {{<baseurl>}}openriak-ts/1.4.0/downloads/
[openfileslimit]: {{<baseurl>}}riak/kv/2.1.4/using/performance/open-files-limit
[planning]: {{<baseurl>}}openriak-ts/1.4.0/using/planning
[security basics pam]: {{<baseurl>}}openriak-ts/1.4.0/using/security/sources-management/#pam-based-authentication
