...
[rolling restart]: {{<baseurl>}}riak/kv/2.1.4/using/repair-recovery/rolling-restart/
[config ref security]: {{<baseurl>}}riak/kv/2.1.4/configuring/reference/#security
