...
[erlang]: {{<baseurl>}}openriak-ts/1.5.0/developing/erlang
[go]: {{<baseurl>}}openriak-ts/1.5.0/developing/golang
[http]: {{<baseurl>}}openriak-ts/1.5.0/developing/http
[java]: {{<baseurl>}}openriak-ts/1.5.0/developing/java
[ruby]: {{<baseurl>}}openriak-ts/1.5.0/developing/ruby
[python]: {{<baseurl>}}openriak-ts/1.5.0/developing/python
[csharp]: {{<baseurl>}}openriak-ts/1.5.0/developing/csharp
[nodejs]: {{<baseurl>}}openriak-ts/1.5.0/developing/nodejs
[erlang]: {{<baseurl>}}openriak-ts/1.5.0/developing/erlang
[php]: {{<baseurl>}}openriak-ts/1.5.0/developing/php
