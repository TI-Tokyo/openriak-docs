...
[creating-activating]: {{<baseurl>}}openriak-ts/1.5.0/using/creating-activating
[develop]: {{<baseurl>}}openriak-ts/1.5.0/developing
[planning]: {{<baseurl>}}openriak-ts/1.5.0/using/planning
[riak shell]: {{<baseurl>}}openriak-ts/1.5.0/using/riakshell
