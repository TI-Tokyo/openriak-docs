...
[activating]: {{<baseurl>}}openriak-ts/1.5.0/using/creating-activating
...
[install]: {{<baseurl>}}openriak-ts/1.5.0/setup/installing
...
{{% note title="Tip" %}}
[`SHOW CREATE TABLE`]({{<baseurl>}}openriak-ts/1.5.0/using/querying/show-create-table/) makes this much easier.
{{% /note %}}
