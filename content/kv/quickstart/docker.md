...
[overview]: #overview
[5minstart]: #a-dev-node-in-under-5-mins
[assumptions]: #assumptions
[settings]: #settings
[makeown]: #make-your-own-docker-image
[start]: #start-the-openriak-kv-instance
[send]: #send-openriak-a-command
[stop]: #stop-the-container
[restart]: #re-start-the-container
[clean]: #clean-up-removing-the-container-entirely
...
## Settings
    ...
    7. We will only have 8 partitions.
    8. We will listen on `127.0.0.1` on the default ports (`8098` for web and `8087` for Protocol Buffers).
