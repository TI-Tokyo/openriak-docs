...
3. [Multiple clusters on one host](#multiple-clusters-on-one-host)
...
### Note: It is strongly recommended to use fully qualified domain names (FQDNs) rather than IP address for cluster node names.
