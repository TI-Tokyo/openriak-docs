...
aliases:
  ...
  - /riak/kv/3.2.5/theory/concepts/Replication
  - /riak/3.2.5/theory/concepts/replication
  - /riak/kv/3.2.5/theory/concepts/replication
keywords: "nval n_val"
---

[cluster ops v3 mdc]: {{< baseurl >}}kv/3.2.5/using/cluster-operations/v3-multi-datacenter
...
[concept vnodes]: {{< baseurl >}}kv/3.2.5/learn/concepts/vnodes
[glossary node]: {{< baseurl >}}kv/3.2.5/learn/glossary/#node
...
bucket's [bucket type]({{< baseurl >}}kv/3.2.5/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{< baseurl >}}kv/3.2.5/configuring/v3-multi-datacenter) capabilities.
...
type]({{< baseurl >}}kv/3.2.5/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{< baseurl >}}kv/3.2.5/developing/usage/secondary-indexes/) and
[MapReduce]({{< baseurl >}}kv/3.2.5/developing/usage/mapreduce/) queries. Lowering an object or bucket's
