...
aliases:
  ...
  - /riak/kv/3.2.5/theory/concepts/crdts
---

[crdts pdf]: http://hal.upmc.fr/docs/00/55/55/88/PDF/techreport.pdf
[data types converg]: {{< baseurl >}}kv/3.2.5/learn/concepts/crdts/#convergence
[crdts reading list]: http://christophermeiklejohn.com/crdt/2014/07/22/readings-in-crdts.html
[data types impl]: {{< baseurl >}}kv/3.2.5/learn/concepts/crdts/#implementation
[concept causal context dvv]: {{< baseurl >}}kv/3.2.5/learn/concepts/causal-context/#dotted-version-vectors
...
[dev data types context]: {{< baseurl >}}kv/3.2.5/developing/data-types/#data-types-and-context
