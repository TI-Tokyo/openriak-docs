...
aliases:
  ...
  - /riak/kv/3.2.5/theory/concepts/vnodes
---

[concept causal context]: {{< baseurl >}}kv/3.2.5/learn/concepts/causal-context
[concept clusters ring]: {{< baseurl >}}kv/3.2.5/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{< baseurl >}}kv/3.2.5/setup/planning/backend/bitcask) as a backend, navigate
