...
aliases:
  ...
  - /riak/kv/3.2.5/dev/data-modeling/
---

[dev data model articles etc]: {{< baseurl >}}kv/3.2.5/developing/data-modeling/#articles-blog-posts-and-other-content
[dev data model log data]: {{< baseurl >}}kv/3.2.5/developing/data-modeling/#log-data
[dev data model sensor data]: {{< baseurl >}}kv/3.2.5/developing/data-modeling/#sensor-data
[dev data model serve advertisements]: {{< baseurl >}}kv/3.2.5/developing/data-modeling/#serving-advertisements
[dev data model sess storage]: {{< baseurl >}}kv/3.2.5/developing/data-modeling/#session-storage
[dev data model user acct]: {{< baseurl >}}kv/3.2.5/developing/data-modeling/#user-accounts
[dev data model user events]: {{< baseurl >}}kv/3.2.5/developing/data-modeling/#user-events-and-timelines
[dev data model user settings]: {{< baseurl >}}kv/3.2.5/developing/data-modeling/#user-settings-and-preferences
...
[replication properties]: {{< baseurl >}}kv/3.2.5/developing/app-guide/replication-properties
