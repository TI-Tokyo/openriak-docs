...
[upgrade]: {{< baseurl >}}kv/3.2.5/setup/upgrading/cluster/
[rolling restarts]: {{< baseurl >}}kv/3.2.5/using/repair-recovery/rolling-restart/
[add node]: {{< baseurl >}}kv/3.2.5/using/cluster-operations/adding-removing-nodes
