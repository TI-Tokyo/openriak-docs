...
This document is a systematic comparison of [Version 2]({{< baseurl >}}kv/3.2.5/using/reference/v2-multi-datacenter) and [Version 3]({{< baseurl >}}kv/3.2.5/using/reference/v3-multi-datacenter) of Riak's Multi-Datacenter
...
* Version 3 is able to take advantage of [Active Anti-Entropy]({{< baseurl >}}kv/3.2.5/learn/concepts/active-anti-entropy/) \(AAE)
