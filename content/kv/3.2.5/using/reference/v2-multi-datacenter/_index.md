...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{< baseurl >}}kv/3.2.5/using/reference/v3-multi-datacenter/) instead.
{{% /note %}}
