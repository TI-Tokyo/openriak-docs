...
[use admin riak admin#cluster]: {{< baseurl >}}kv/3.2.5/using/admin/riak-admin/#cluster
...
[use admin riak admin#cluster-plan]: {{< baseurl >}}kv/3.2.5/using/admin/riak-admin/#cluster-plan
[use admin riak admin#cluster-commit]: {{< baseurl >}}kv/3.2.5/using/admin/riak-admin/#cluster-commit
