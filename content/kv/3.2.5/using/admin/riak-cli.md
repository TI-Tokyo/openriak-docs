...
[configuration file]: {{< baseurl >}}kv/3.2.5/configuring/reference/
[escript]: http://www.erlang.org/doc/man/escript.html
[`riak admin`]: {{< baseurl >}}kv/3.2.5/using/admin/riak-admin/#top
[configuration]: {{< baseurl >}}kv/3.2.5/configuring/reference/
