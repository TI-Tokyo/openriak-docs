...
[config v3 nat]: {{< baseurl >}}kv/3.2.5/configuring/v3-multi-datacenter/nat
[config v3 quickstart]: {{< baseurl >}}kv/3.2.5/configuring/v3-multi-datacenter/quick-start
[config v3 ssl]: {{< baseurl >}}kv/3.2.5/configuring/v3-multi-datacenter/ssl
[ref v3 stats]: {{< baseurl >}}kv/3.2.5/using/reference/multi-datacenter/statistics
