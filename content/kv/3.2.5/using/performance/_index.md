...
clusters on the Amazon Web Services EC2 environment, see [AWS Performance Tuning]({{< baseurl >}}kv/3.2.5/using/performance/amazon-web-services).
...
open files limit is necessary. See [Open Files Limit]({{< baseurl >}}kv/3.2.5/using/performance/open-files-limit/) for more
details.

## Other Tuning Docs

* [AWS Performance Tuning]({{< baseurl >}}kv/3.2.5/using/performance/amazon-web-services)
* [Erlang VM Tuning]({{< baseurl >}}kv/3.2.5/using/performance/erlang)
* [Latency Reduction]({{< baseurl >}}kv/3.2.5/using/performance/latency-reduction)
* [Open Files Limit]({{< baseurl >}}kv/3.2.5/using/performance/open-files-limit/)
