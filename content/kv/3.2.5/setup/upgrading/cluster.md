...
[production checklist]: {{< baseurl >}}kv/3.2.5/setup/upgrading/checklist
...
[cluster ops mdc]: {{< baseurl >}}kv/3.2.5/using/cluster-operations/v3-multi-datacenter
[config v3 mdc]: {{< baseurl >}}kv/3.2.5/configuring/v3-multi-datacenter
[jmx monitor]: {{< baseurl >}}kv/3.2.5/using/reference/jmx
[snmp]: {{< baseurl >}}kv/3.2.5/using/reference/snmp
...
If you run [Riak Control]({{< baseurl >}}kv/3.2.5/using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
