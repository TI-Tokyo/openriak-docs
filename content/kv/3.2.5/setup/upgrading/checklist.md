...
aliases:
  ...
  - /riak/kv/3.2.5/ops/upgrading/production-checklist/
---

[perf open files]: {{< baseurl >}}kv/3.2.5/using/performance/open-files-limit
[perf index]: {{< baseurl >}}kv/3.2.5/using/performance
[ntp]: http://www.ntp.org/
[security basics]: {{< baseurl >}}kv/3.2.5/using/security/basics
[cluster ops load balance]: {{< baseurl >}}kv/3.2.5/configuring/load-balancing-proxy
[config reference]: {{< baseurl >}}kv/3.2.5/configuring/reference
[config backend]: {{< baseurl >}}kv/3.2.5/configuring/backend
...
[use admin riak control]: {{< baseurl >}}kv/3.2.5/using/admin/riak-control
[cluster ops inspect node]: {{< baseurl >}}kv/3.2.5/using/cluster-operations/inspecting-node
[troubleshoot http]: {{< baseurl >}}kv/3.2.5/using/troubleshooting/http-204
