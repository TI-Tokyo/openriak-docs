...
* `riak_kv_wm_buckets` - [Bucket Operations]({{< baseurl >}}kv/3.2.5/developing/api/http/#bucket-operations)
* `riak_kv_wm_index` - [HTTP Secondary Indexes]({{< baseurl >}}kv/3.2.5/developing/api/http/secondary-indexes)
* `riak_kv_wm_link_walker` - [HTTP Link Walking]({{< baseurl >}}kv/3.2.5/developing/api/http/link-walking)
* `riak_kv_wm_mapred` - [HTTP MapReduce]({{< baseurl >}}kv/3.2.5/developing/api/http/mapreduce)
* `riak_kv_wm_object`- [Object/Key Operations]({{< baseurl >}}kv/3.2.5/developing/api/http/#object-key-operations)
* `riak_kv_wm_ping` - [HTTP Ping]({{< baseurl >}}kv/3.2.5/developing/api/http/ping)
* `riak_kv_wm_props` - [HTTP Set Bucket Properties]({{< baseurl >}}kv/3.2.5/developing/api/http/set-bucket-props)
* `riak_kv_wm_stats` - [HTTP Status]({{< baseurl >}}kv/3.2.5/developing/api/http/status)
