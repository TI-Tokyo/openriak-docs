...
is a special case of [MapReduce]({{< baseurl >}}kv/3.2.5/developing/usage/mapreduce), and can be expressed more verbosely as such.
[Read more about Links]({{< baseurl >}}kv/3.2.5/learn/glossary/#links).
...
response from [fetching the object]({{< baseurl >}}kv/3.2.5/developing/api/http/fetch-object), without the status
code.
