...
The regular POST/PUT ([HTTP Store Object]({{< baseurl >}}kv/3.2.5/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{< baseurl >}}kv/3.2.5/developing/api/http/fetch-object)) responses apply here.
