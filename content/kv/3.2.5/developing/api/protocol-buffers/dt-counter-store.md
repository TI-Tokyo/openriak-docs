...
An operation to update a [counter]({{< baseurl >}}kv/3.2.5/developing/data-types).
...
stored on their own in a key or [within a map]({{< baseurl >}}kv/3.2.5/developing/api/protocol-buffers/dt-map-store).
