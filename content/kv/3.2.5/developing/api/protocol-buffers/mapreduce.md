...
The JSON encoding is the same as [REST API]({{< baseurl >}}kv/3.2.5/developing/usage/mapreduce/#rest) and
the external term format is the same as the [local Erlang API]({{< baseurl >}}kv/3.2.5/developing/app-guide/advanced-mapreduce/#erlang)
