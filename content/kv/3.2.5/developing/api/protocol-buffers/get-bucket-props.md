...
The bucket's name (`bucket`) must be specified. The [bucket type]({{< baseurl >}}kv/3.2.5/using/cluster-operations/bucket-types) parameter (`type`) is optional. If it is not specified,
...
[configuration file]({{< baseurl >}}kv/3.2.5/configuring/reference/#default-bucket-properties) documentation.
