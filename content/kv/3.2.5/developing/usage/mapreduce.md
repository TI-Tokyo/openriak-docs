...
[usage types]: {{< baseurl >}}kv/3.2.5/developing/usage/bucket-types
[api http]: {{< baseurl >}}kv/3.2.5/developing/api/http
[api pb]: {{< baseurl >}}kv/3.2.5/developing/api/protocol-buffers
[glossary vnode]: {{< baseurl >}}kv/3.2.5/learn/glossary/#vnode
[guide mapreduce]: {{< baseurl >}}kv/3.2.5/developing/app-guide/advanced-mapreduce
