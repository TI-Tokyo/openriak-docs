...
For reasons explained in the [Introduction to conflict resolution]({{< baseurl >}}kv/3.2.5/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that
