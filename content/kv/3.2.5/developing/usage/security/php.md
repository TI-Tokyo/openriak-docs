...
If you are using [trust-]({{< baseurl >}}kv/3.2.5/using/security/managing-sources/#trust-based-authentication) or [PAM]({{< baseurl >}}kv/3.2.5/using/security/managing-sources/#pam-based-authentication)-based authentication, you can use the
security setup described [below](#php-client-basics). [Certificate]({{< baseurl >}}kv/3.2.5/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
...
regardless of which [security source]({{< baseurl >}}kv/3.2.5/using/security/managing-sources/) you choose. All clients should also provide a username, regardless of
