...
[use ref strong consistency#trade-offs]: {{< baseurl >}}kv/3.2.5/using/reference/strong-consistency/#trade-offs
[glossary vnode]: {{< baseurl >}}kv/3.2.5/learn/glossary/#vnode
[config strong consistency#enable]: {{< baseurl >}}kv/3.2.5/configuring/strong-consistency/#enabling-strong-consistency
...
[config strong consistency#fault]: {{< baseurl >}}kv/3.2.5/configuring/strong-consistency/#fault-tolerance
[concept causal context]: {{< baseurl >}}kv/3.2.5/learn/concepts/causal-context
[concept causal context#vector]: {{< baseurl >}}kv/3.2.5/learn/concepts/causal-context/#vector-clocks
[concept version vector]: {{< baseurl >}}kv/3.2.5/learn/concepts/causal-context/#dotted-version-vectors
...
[use ref strong consistency#vs]: {{< baseurl >}}kv/3.2.5/using/reference/strong-consistency/#strong-vs.-eventual-consistency
...
[config strong consistency#details]: {{< baseurl >}}kv/3.2.5/configuring/strong-consistency/#implementation-details
