...
[bucket type]: {{< baseurl >}}kv/3.2.5/developing/usage/bucket-types
[Riak data types]: {{< baseurl >}}kv/3.2.5/developing/data-types
[strong consistency]: {{< baseurl >}}kv/3.2.5/developing/app-guide/strong-consistency
...
The [Multi]({{< baseurl >}}kv/3.2.5/setup/planning/backend/multi) backend does not
