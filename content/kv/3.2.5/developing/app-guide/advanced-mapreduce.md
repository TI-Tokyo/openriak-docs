...
aliases:
  ...
  - /riak/kv/3.2.5/dev/advanced/mapreduce/
---
...
[use ref custom code]: {{< baseurl >}}kv/3.2.5/using/reference/custom-code
...
[installing custom code]({{< baseurl >}}kv/3.2.5/using/reference/custom-code).
{{% /note %}}
