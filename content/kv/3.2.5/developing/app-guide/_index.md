...
aliases:
  ...
  - /riak/kv/3.2.5/dev/using/application-guide/
---

[usage conflict resolution]: {{< baseurl >}}kv/3.2.5/developing/usage/conflict-resolution
[dev data model#log]: {{< baseurl >}}kv/3.2.5/developing/data-modeling/#log-data
[dev data model#sensor]: {{< baseurl >}}kv/3.2.5/developing/data-modeling/#sensor-data
[concept eventual consistency]: {{< baseurl >}}kv/3.2.5/learn/concepts/eventual-consistency
[dev data model#user]: {{< baseurl >}}kv/3.2.5/developing/data-modeling/#user-data
[dev kv model]: {{< baseurl >}}kv/3.2.5/developing/key-value-modeling
[dev data types]: {{< baseurl >}}kv/3.2.5/developing/data-types
[dev data types#counters]: {{< baseurl >}}kv/3.2.5/developing/data-types/#counters
[dev data types#sets]: {{< baseurl >}}kv/3.2.5/developing/data-types/#sets
[dev data types#maps]: {{< baseurl >}}kv/3.2.5/developing/data-types/#maps
[usage create objects]: {{< baseurl >}}kv/3.2.5/developing/usage/creating-objects
[usage search]: {{< baseurl >}}kv/3.2.5/deprecated/riak-search/
[use ref search]: {{< baseurl >}}kv/3.2.5/deprecated/riak-search/
[usage 2i]: {{< baseurl >}}kv/3.2.5/developing/usage/secondary-indexes
[dev client libraries]: {{< baseurl >}}kv/3.2.5/developing/client-libraries
[concept crdts]: {{< baseurl >}}kv/3.2.5/learn/concepts/crdts
[dev data model]: {{< baseurl >}}kv/3.2.5/developing/data-modeling
[usage mapreduce]: {{< baseurl >}}kv/3.2.5/developing/usage/mapreduce
[apps mapreduce]: {{< baseurl >}}kv/3.2.5/developing/app-guide/advanced-mapreduce
[use ref 2i]: {{< baseurl >}}kv/3.2.5/using/reference/secondary-indexes
...
[obj model java]: {{< baseurl >}}kv/3.2.5/developing/getting-started/java/object-modeling
[obj model ruby]: {{< baseurl >}}kv/3.2.5/developing/getting-started/ruby/object-modeling
[obj model python]: {{< baseurl >}}kv/3.2.5/developing/getting-started/python/object-modeling
[obj model csharp]: {{< baseurl >}}kv/3.2.5/developing/getting-started/csharp/object-modeling
[obj model nodejs]: {{< baseurl >}}kv/3.2.5/developing/getting-started/nodejs/object-modeling
[obj model erlang]: {{< baseurl >}}kv/3.2.5/developing/getting-started/erlang/object-modeling
[obj model golang]: {{< baseurl >}}kv/3.2.5/developing/getting-started/golang/object-modeling
[concept strong consistency]: {{< baseurl >}}kv/3.2.5/using/reference/strong-consistency
[use ref strong consistency]: {{< baseurl >}}kv/3.2.5/using/reference/strong-consistency
[cluster ops strong consistency]: {{< baseurl >}}kv/3.2.5/using/cluster-operations/strong-consistency
[config strong consistency]: {{< baseurl >}}kv/3.2.5/configuring/strong-consistency
[apps strong consistency]: {{< baseurl >}}kv/3.2.5/developing/app-guide/strong-consistency
[usage update objects]: {{< baseurl >}}kv/3.2.5/developing/usage/updating-objects
[apps replication properties]: {{< baseurl >}}kv/3.2.5/developing/app-guide/replication-properties
[install index]: {{< baseurl >}}kv/3.2.5/setup/installing
[getting started]: {{< baseurl >}}kv/3.2.5/developing/getting-started
[usage index]: {{< baseurl >}}kv/3.2.5/developing/usage
[glossary]: {{< baseurl >}}kv/3.2.5/learn/glossary
