...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{< baseurl >}}kv/3.2.5/configuring/v3-multi-datacenter/quick-start/) instead.
{{% /note %}}
...
`riak repl`'s [status output]({{< baseurl >}}kv/3.2.5/using/cluster-operations/v2-multi-datacenter/#status).
...
[config v2 mdc]: {{< baseurl >}}kv/3.2.5/configuring/v2-multi-datacenter
[cluster ops v2 mdc]: {{< baseurl >}}kv/3.2.5/using/cluster-operations/v2-multi-datacenter
