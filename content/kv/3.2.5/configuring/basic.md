...
aliases:
  ...
  - /riak/kv/3.2.5/ops/building/configuration/
keywords: "ring size ringsize ring_size"
---

[config reference]: {{< baseurl >}}kv/3.2.5/configuring/reference
[use running cluster]: {{< baseurl >}}kv/3.2.5/using/running-a-cluster
[use admin riak admin#member-status]: {{< baseurl >}}kv/3.2.5/using/admin/riak-admin/#member-status
[perf erlang]: {{< baseurl >}}kv/3.2.5/using/performance/erlang
[plan start]: {{< baseurl >}}kv/3.2.5/setup/planning/start
[plan best practices]: {{< baseurl >}}kv/3.2.5/setup/planning/best-practices
[cluster ops backup]: {{< baseurl >}}kv/3.2.5/using/cluster-operations/backing-up
[cluster ops add remove node]: {{< baseurl >}}kv/3.2.5/using/cluster-operations/adding-removing-nodes
[plan backend]: {{< baseurl >}}kv/3.2.5/setup/planning/backend
...
[perf benchmark]: {{< baseurl >}}kv/3.2.5/using/performance/benchmarking
[perf open files]: {{< baseurl >}}kv/3.2.5/using/performance/open-files-limit
[perf index]: {{< baseurl >}}kv/3.2.5/using/performance
[perf aws]: {{< baseurl >}}kv/3.2.5/using/performance/amazon-web-services
[Cluster Capacity Planning]: {{< baseurl >}}kv/3.2.5/setup/planning/cluster-capacity/#ring-size-number-of-partitions
...
directly impacted, although the mechanism described in [HTTP Reset Bucket Properties]({{< baseurl >}}kv/3.2.5/developing/api/http/reset-bucket-props) can be used to force them to pick up the new
defaults.
