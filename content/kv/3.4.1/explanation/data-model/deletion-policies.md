...
- [Bucket types as namespaces and policy](/kv/3.4.1/explanation/data-model/bucket-types/) — Explain bucket types as namespaces and policy, its trade-offs, and its effect on application design.
