...
[dev key value]: {{< baseurl >}}kv/3.4.1/how-to/plan/map-data-to-objects/
[glossary read rep]: {{< baseurl >}}kv/3.4.1/explanation/foundations/glossary/#read-repair
[perf latency reduc]: {{< baseurl >}}kv/3.4.1/how-to/tune/reduce-latency/
...
[usage protocol buffers]: {{< baseurl >}}kv/3.4.1/reference/protocol-buffers/
[usage updating objects]: {{< baseurl >}}kv/3.4.1/how-to/develop/update-object/
...
In the case of outcome 2, the choice between **a**, **b** and **c** is determined by settings. If you set the `allow_mult` parameter to `true` for a [bucket type]({{< baseurl >}}kv/3.4.1/how-to/develop/use-bucket-types/), all non-CRDT writes to that bucket type will create siblings in the case of concurrent writes (and occasionally under other
