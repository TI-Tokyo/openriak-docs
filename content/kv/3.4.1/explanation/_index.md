...
- [Consistency concepts]({{< baseurl >}}kv/3.4.1/explanation/consistency/) — Introduce how OpenRiak balances availability, convergence, and stronger consistency guarantees.
...
- [Security concepts]({{< baseurl >}}kv/3.4.1/explanation/security/) — Introduce the OpenRiak security model, trust boundaries, identities, and authorization decisions.
- [Storage architecture]({{< baseurl >}}kv/3.4.1/explanation/storage/) — Introduce storage engine design, workload fit, capacity implications, and backend trade-offs.
