...
[concept replication aae]: {{< baseurl >}}kv/3.4.1/explanation/replication/#active-anti-entropy
...
[repair recover failure recovery]: {{< baseurl >}}kv/3.4.1/how-to/troubleshoot/recover-cluster-failure/
[repair recover repairs]: {{< baseurl >}}kv/3.4.1/explanation/operations/repair-granularity/
...
* [Bucket Types]({{< baseurl >}}kv/3.4.1/how-to/develop/use-bucket-types/)
