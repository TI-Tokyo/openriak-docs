...
Riak tabulates a variety of stats related to OpenRiak's optional [strong consistency](../../reference/strong-consistency) feature. The table below lists those stats.
...
[start]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
[stop]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
[restart]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
[inspect]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
[test]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
[nodestatus]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
[clusterstatus]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
[member]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
[clusterstatus]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
[ringstatus]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
[debug]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
