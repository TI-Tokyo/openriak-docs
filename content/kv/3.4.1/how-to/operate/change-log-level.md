...
by accessing the Erlang console directly using the [`riak attach`]({{< baseurl >}}kv/3.4.1/reference/commands/riak/#attach) command. Once you run this command and drop into the console, enter the following:
