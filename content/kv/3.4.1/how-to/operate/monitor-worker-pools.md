...
Replication queues use the [disk-backed queue framework](/kv/3.4.1/explanation/replication/queues/) common across multiple Riak services.
...
- The sink worker pool does not auto-expand.
  - Sufficient sink workers need to be configured to keep-up with real-time replication, though [this number can be adjusted at runtime](/kv/3.4.1/reference/replication-api/runtime-controls/).
