...
[rolling upgrade]: {{< baseurl >}}kv/3.4.1/how-to/operate/upgrade-cluster/
...
[aae status]: {{< baseurl >}}kv/3.4.1/reference/commands/riak-admin/#aae-status
...
|:---|:---:|:---:|:---|
| Active Anti-Entropy file format changes | ✔ |  | Can be opted out using a [capability]({{< baseurl >}}kv/3.4.1/how-to/operate/downgrade-cluster/)
