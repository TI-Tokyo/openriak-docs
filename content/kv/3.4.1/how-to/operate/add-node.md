...
If [locations are to be used]({{< baseurl >}}kv/3.4.1/reference/operations/cluster-claim-algorithms/) within the cluster, then location changes must also be staged:
