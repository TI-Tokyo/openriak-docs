...
In Riak versions 2.9.1 and later, [TicTac AAE]({{< baseurl >}}kv/3.4.1/how-to/operate/monitor-active-anti-entropy/) is included with releases as an option to be used in addition to or instead of traditional AAE in Riak.
