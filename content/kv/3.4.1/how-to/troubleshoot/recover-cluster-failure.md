...
returns to service (also called [hinted handoff]({{< baseurl >}}kv/3.4.1/explanation/foundations/glossary/#hinted-handoff)).
...
See [Changing Cluster Information]({{< baseurl >}}kv/3.4.1/how-to/operate/change-cluster-information/#clusters-from-backups) for instructions on cluster recovery.
