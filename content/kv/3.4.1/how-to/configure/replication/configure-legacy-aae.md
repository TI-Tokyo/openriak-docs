---
title: 'Configure legacy active anti-entropy'
description: 'Show operators how to configure legacy active anti-entropy and validate data movement.'
weight: 3
diataxis: 'how-to'
product: 'OpenRiak KV'
...
Show operators how to configure legacy active anti-entropy and validate data movement.
...
Configurable parameters for OpenRiak's legacy active anti-entropy subsystem.
