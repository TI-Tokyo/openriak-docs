...
[use running cluster]: {{< baseurl >}}kv/3.4.1/how-to/operate/
[use admin riak admin#member-status]: {{< baseurl >}}kv/3.4.1/reference/commands/riak-admin/#member-status
[perf erlang]: {{< baseurl >}}kv/3.4.1/how-to/tune/tune-erlang-vm/
[plan start]: {{< baseurl >}}kv/3.4.1/how-to/plan/
[plan best practices]: {{< baseurl >}}kv/3.4.1/how-to/plan/production-readiness-checklist/
...
[plan backend]: {{< baseurl >}}kv/3.4.1/explanation/storage/choosing-backend/
...
[perf benchmark]: {{< baseurl >}}kv/3.4.1/how-to/tune/benchmark-cluster/
[perf open files]: {{< baseurl >}}kv/3.4.1/how-to/tune/set-open-files-limit/
[perf index]: {{< baseurl >}}kv/3.4.1/how-to/tune/
[perf aws]: {{< baseurl >}}kv/3.4.1/how-to/tune/tune-aws-deployment/
[Cluster Capacity Planning]: {{< baseurl >}}kv/3.4.1/explanation/storage/capacity-planning/
...
directly impacted, although the mechanism described in [HTTP Reset Bucket Properties]({{< baseurl >}}kv/3.4.1/reference/http-api/reset-bucket-properties/) can be used to force them to pick up the new
defaults.
