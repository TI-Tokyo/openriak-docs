...
[use running cluster]: /kv/3.4.1/how-to/operate/
[use admin riak admin#member-status]: /kv/3.4.1/reference/commands/riak-admin/#member-status
[perf erlang]: /kv/3.4.1/how-to/tune/tune-erlang-vm/
[plan start]: /kv/3.4.1/how-to/plan/
[plan best practices]: /kv/3.4.1/how-to/plan/production-readiness-checklist/
...
[plan backend]: /kv/3.4.1/explanation/storage/choosing-backend/
...
[perf benchmark]: /kv/3.4.1/how-to/tune/benchmark-cluster/
[perf open files]: /kv/3.4.1/how-to/tune/set-open-files-limit/
[perf index]: /kv/3.4.1/how-to/tune/
[perf aws]: /kv/3.4.1/how-to/tune/tune-aws-deployment/
[Cluster Capacity Planning]: /kv/3.4.1/explanation/storage/capacity-planning/
...
directly impacted, although the mechanism described in [HTTP Reset Bucket Properties](/kv/3.4.1/reference/http-api/reset-bucket-properties/) can be used to force them to pick up the new
defaults.
