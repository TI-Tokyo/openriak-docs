...
Where different backends support different cluster-wide features (e.g. support of the [Riak Query API](/kv/3.4.1/tutorials/query-api/)), then the feature will only be usable when all nodes have updated.
