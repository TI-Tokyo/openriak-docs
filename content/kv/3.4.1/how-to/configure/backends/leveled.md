...
- `leveled.compaction_runs_perday`; refer to the [operations guide](/kv/3.4.1/how-to/configure/backends/leveled-compaction-window/) for more on leveled compaction.
