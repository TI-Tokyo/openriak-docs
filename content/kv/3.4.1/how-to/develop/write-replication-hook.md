---
title: 'Write a replication hook'
description: 'Show developers how to write a replication hook with a minimal verified example.'
weight: 18
diataxis: 'how-to'
product: 'OpenRiak KV'
...
Show developers how to write a replication hook with a minimal verified example.
...
This document is a guide to developing extensions for OpenRiak's
