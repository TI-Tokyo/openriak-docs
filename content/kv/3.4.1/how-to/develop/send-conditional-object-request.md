---
title: 'Send a conditional object request'
description: 'Show developers how to use object validators to avoid unintended fetches or writes.'
weight: 20
diataxis: 'how-to'
product: 'OpenRiak KV'
...
Show developers how to use object validators to avoid unintended fetches or writes.
