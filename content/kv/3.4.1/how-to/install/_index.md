...
[install aws]: {{< baseurl >}}kv/3.4.1/how-to/install/amazon-linux/
[install alpine]: {{< baseurl >}}kv/3.4.1/how-to/install/alpine-linux/
[install debian & ubuntu]: {{< baseurl >}}kv/3.4.1/how-to/install/debian-ubuntu/
[install raspbian]: {{< baseurl >}}kv/3.4.1/how-to/install/debian-ubuntu/#raspbian-bullseye
[install rhel & centos]: {{< baseurl >}}kv/3.4.1/how-to/install/rhel-rocky/
[install oracle linux]: {{< baseurl >}}kv/3.4.1/how-to/install/rhel-rocky/
[install source index]: {{< baseurl >}}kv/3.4.1/how-to/install/source/
[upgrade index]: {{< baseurl >}}kv/3.4.1/how-to/operate/upgrade-cluster/
