...
- [Install and verify OpenRiak](/kv/3.4.1/how-to/install/) — Introduce installation procedures and their common verification outcome.
- [Operate a cluster](/kv/3.4.1/how-to/operate/) — Introduce routine cluster administration and lifecycle procedures.
- [Plan a production cluster](/kv/3.4.1/how-to/plan/) — Introduce planning procedures that turn workload and infrastructure requirements into deployment decisions.
- [Use the Redis add-on](/kv/3.4.1/how-to/redis-add-on/) — Introduce practical procedures for deploying and using the Redis add-on for OpenRiak.
- [Secure OpenRiak](/kv/3.4.1/how-to/secure/) — Introduce focused procedures for enabling and administering OpenRiak security.
...
- [Tune performance](/kv/3.4.1/how-to/tune/) — Introduce measurement-led procedures for improving OpenRiak performance safely.
