...
- [`riak_kv.get`](/kv/3.4.1/reference/http-api/fetch-object/)
- [`riak_kv.put`](/kv/3.4.1/reference/http-api/store-object/)
- [`riak_kv.delete`](/kv/3.4.1/reference/http-api/delete-object/)
- [`riak_kv.list_keys`](/kv/3.4.1/reference/specialized-apis/list-api/)
- [`riak_kv.list_buckets`](/kv/3.4.1/reference/specialized-apis/list-api/)
- [`riak_kv.mapreduce`](/kv/3.4.1/reference/http-api/mapreduce/)
- `riak_kv.index`;
  - used to control both the [legacy query api](/kv/3.4.1/reference/specialized-apis/legacy-query-api/) and the [Query API](/kv/3.4.1/tutorials/query-api/).
