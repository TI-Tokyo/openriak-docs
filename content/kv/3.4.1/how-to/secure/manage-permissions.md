...
- [`riak_kv.get`]({{< baseurl >}}kv/3.4.1/reference/http-api/fetch-object/)
- [`riak_kv.put`]({{< baseurl >}}kv/3.4.1/reference/http-api/store-object/)
- [`riak_kv.delete`]({{< baseurl >}}kv/3.4.1/reference/http-api/delete-object/)
- [`riak_kv.list_keys`]({{< baseurl >}}kv/3.4.1/reference/specialized-apis/list-api/)
- [`riak_kv.list_buckets`]({{< baseurl >}}kv/3.4.1/reference/specialized-apis/list-api/)
- [`riak_kv.mapreduce`]({{< baseurl >}}kv/3.4.1/reference/http-api/mapreduce/)
- `riak_kv.index`;
  - used to control both the [legacy query api]({{< baseurl >}}kv/3.4.1/reference/specialized-apis/legacy-query-api/) and the [Query API]({{< baseurl >}}kv/3.4.1/tutorials/query-api/).
