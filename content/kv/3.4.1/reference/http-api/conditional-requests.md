---
title: 'Conditional object request reference'
description: 'Define conditional request headers, validator behavior, status codes, and latch-object semantics.'
weight: 17
diataxis: 'reference'
product: 'OpenRiak KV'
...
Define conditional request headers, validator behavior, status codes, and latch-object semantics.
