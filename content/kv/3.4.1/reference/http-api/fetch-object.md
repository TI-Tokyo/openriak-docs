...
object ([default is defined by the bucket](/kv/3.4.1/reference/http-api/set-bucket-properties/))
* `pr` - how many primary replicas need to be online when doing the read
([default is defined by the bucket](/kv/3.4.1/reference/http-api/set-bucket-properties/))
...
purposes of R ([default is defined by the bucket](/kv/3.4.1/reference/http-api/set-bucket-properties/))
...
datetime format
* `Link` - user- and system-defined links to other resources. [Read more about Links.](/kv/3.4.1/explanation/foundations/glossary/)
