...
is OpenRiak's [bucket types]({{< baseurl >}}kv/3.4.1/reference/data/buckets-and-bucket-types/) feature. This feature
...
made both to memory and to disk. Logical clocks, namely [dotted version vectors]({{< baseurl >}}kv/3.4.1/explanation/data-model/causal-context/#dotted-version-vectors), are used in place of [vector clocks]({{< baseurl >}}kv/3.4.1/explanation/data-model/causal-context/#vector-clocks) or timestamps to resolve value conflicts. Values stored as cluster metadata are opaque Erlang
