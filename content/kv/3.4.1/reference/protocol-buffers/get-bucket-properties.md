...
The bucket's name (`bucket`) must be specified. The [bucket type](/kv/3.4.1/how-to/operate/manage-bucket-types/) parameter (`type`) is optional. If it is not specified,
...
[configuration file](/kv/3.4.1/reference/configuration/#default-bucket-properties) documentation.
