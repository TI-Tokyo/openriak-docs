...
An operation to update a [counter](/kv/3.4.1/reference/data/distributed-data-types/).
...
stored on their own in a key or [within a map](/kv/3.4.1/reference/protocol-buffers/update-map/).
