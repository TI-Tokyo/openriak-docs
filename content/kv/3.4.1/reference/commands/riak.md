...
[configuration file]: {{< baseurl >}}kv/3.4.1/reference/configuration/
[escript]: http://www.erlang.org/doc/man/escript.html
[`riak admin`]: {{< baseurl >}}kv/3.4.1/reference/commands/riak-admin/#top
[configuration]: {{< baseurl >}}kv/3.4.1/reference/configuration/
