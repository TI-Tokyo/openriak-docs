---
title: 'riak admin command reference'
description: 'List every supported riak admin command with syntax, options, output, and safety notes.'
weight: 2
diataxis: 'reference'
product: 'OpenRiak KV'
...
legacy_3_2_5_sources:
  - 'C:\Users\pjacl\Downloads\riak-docs-fork\kv\3.2.5\using\admin\riak-admin.md'
...
List every supported riak admin command with syntax, options, output, and safety notes.
...
[use admin commands#join]: {{< baseurl >}}kv/3.4.1/reference/commands/#join
[use admin commands#leave]: {{< baseurl >}}kv/3.4.1/reference/commands/#leave
[cluster ops backup]: {{< baseurl >}}kv/3.4.1/how-to/operate/back-up-node/
[config reference#node-metadata]: {{< baseurl >}}kv/3.4.1/reference/configuration/#node-metadata
[cluster ops change info]: {{< baseurl >}}kv/3.4.1/how-to/operate/change-cluster-information/
...
[config reference#ring]: {{< baseurl >}}kv/3.4.1/reference/configuration/#ring
[cluster ops inspect node]: {{< baseurl >}}kv/3.4.1/how-to/operate/inspect-node-and-cluster/
[use ref monitoring]: {{< baseurl >}}kv/3.4.1/reference/operations/statistics-and-monitoring/
[downgrade]: {{< baseurl >}}kv/3.4.1/how-to/operate/downgrade-cluster/
[security index]: {{< baseurl >}}kv/3.4.1/how-to/secure/
...
[repair recover index]: {{< baseurl >}}kv/3.4.1/explanation/operations/node-failure-and-recovery/
[cluster ops strong consistency]: {{< baseurl >}}kv/3.4.1/explanation/consistency/strong-consistency/
[cluster ops handoff]: {{< baseurl >}}kv/3.4.1/how-to/operate/manage-handoffs/
[use admin riak admin#stats]: {{< baseurl >}}kv/3.4.1/reference/commands/riak-admin/
...
**Note:**
In OpenRiak KV 3.0.1+ the `riak-admin` command has been changed to `riak admin` (with no hyphen). For execution purposes, please use `riak admin`. Please be aware that the output from `riak admin` may quote `riak-admin` in command execution examples as it has inherited OpenRiak KV 2.x functionality.
...
in [Backing up OpenRiak KV][cluster ops backup].
...
using the backup and restore methods described in [Backing up OpenRiak KV][cluster ops backup].
...
Output system information from an OpenRiak cluster. This command will collect
 ...
 * OpenRiak KV status
 * OpenRiak KV ringready
 * OpenRiak KV transfers
...
This command provides insight into operation of OpenRiak's Active
...
number of partitions in your OpenRiak cluster):
...
consensus subsystem undergirding OpenRiak's [strong consistency][cluster ops strong consistency] feature.
...
Enables you to change the value of one of OpenRiak's configuration
...
Provides a brief description of one of OpenRiak's [configurable parameters][config reference].
