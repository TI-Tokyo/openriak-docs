...
description: 'Define command syntax, options, output fields, exit behavior, and required privileges.'
weight: 1
diataxis: 'reference'
product: 'OpenRiak KV'
...
legacy_3_2_5_sources:
  - 'C:\Users\pjacl\Downloads\riak-docs-fork\kv\3.2.5\using\admin.md'
  - 'C:\Users\pjacl\Downloads\riak-docs-fork\kv\3.2.5\using\admin\commands.md'
...
Define command syntax, options, output fields, exit behavior, and required privileges.
...
Covers the `riak` interface, which enables control of the processes associated with an OpenRiak node.
...
[use admin riak admin#cluster]: {{< baseurl >}}kv/3.4.1/reference/commands/riak-admin/#cluster
...
[use admin riak admin#cluster-plan]: {{< baseurl >}}kv/3.4.1/reference/commands/riak-admin/
[use admin riak admin#cluster-commit]: {{< baseurl >}}kv/3.4.1/reference/commands/riak-admin/
...
`1004782375664995756265033323.0.1144576013453623296`. You can convert
