...
description: 'Define the names, fields, states, limits, and version applicability for object deletion and tombstones.'
weight: 7
diataxis: 'reference'
product: 'OpenRiak KV'
...
Define the names, fields, states, limits, and version applicability for object deletion and tombstones.
...
When designing applications and operating a live OpenRiak cluster, it is important to know how to interpret OpenRiak's responses to requests. With respect to deletion and tombstones, please note the following:
