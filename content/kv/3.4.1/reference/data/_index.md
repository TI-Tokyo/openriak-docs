...
- [Buckets and bucket types](/kv/3.4.1/reference/data/buckets-and-bucket-types/) — Define the fields, limits, supported operations, representations, and compatibility rules for buckets and bucket types.
- [Content types](/kv/3.4.1/reference/data/content-types/) — Define the fields, limits, supported operations, representations, and compatibility rules for content types.
- [Distributed data types](/kv/3.4.1/reference/data/distributed-data-types/) — Define the fields, limits, supported operations, representations, and compatibility rules for distributed data types.
- [Keys and objects](/kv/3.4.1/reference/data/keys-and-objects/) — Define the fields, limits, supported operations, representations, and compatibility rules for keys and objects.
- [Object metadata](/kv/3.4.1/reference/data/object-metadata/) — Define the fields, limits, supported operations, representations, and compatibility rules for object metadata.
- [Secondary indexes](/kv/3.4.1/reference/data/secondary-indexes/) — Define the fields, limits, supported operations, representations, and compatibility rules for secondary indexes.
- [Version vectors](/kv/3.4.1/reference/data/version-vectors/) — Define the fields, limits, supported operations, representations, and compatibility rules for version vectors.
