...
The replication API consists of [the AAE fold API](/kv/3.4.1/reference/aae-fold-api/) and the [fetch API required to access replication queues](/kv/3.4.1/reference/specialized-apis/fetch-api/).

## In this section

- [Replication runtime control reference](/kv/3.4.1/reference/replication-api/runtime-controls/) — List supported source, sink, queue, reconciliation, range, and resynchronization controls.
