...
Define a realistic, disposable scenario for **Learn multi-cluster replication**. List the exact OpenRiak KV 3.4.1 environment, client tools, permissions, sample data, and prior knowledge required, including a safe way to reset the exercise.
