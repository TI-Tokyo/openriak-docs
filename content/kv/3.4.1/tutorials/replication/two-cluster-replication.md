...
**Deprecation Warning**
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{< baseurl >}}kv/3.4.1/tutorials/replication/two-cluster-replication/) instead.
...
[assumptions]: {{< baseurl >}}kv/3.4.1/tutorials/replication/two-cluster-replication/
[design]: {{< baseurl >}}kv/3.4.1/tutorials/replication/two-cluster-replication/
[installingg]: {{< baseurl >}}kv/3.4.1/tutorials/replication/two-cluster-replication/
