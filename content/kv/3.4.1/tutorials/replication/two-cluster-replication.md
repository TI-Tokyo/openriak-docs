...
**Deprecation Warning**
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3](/kv/3.4.1/tutorials/replication/two-cluster-replication/) instead.
...
[assumptions]: /kv/3.4.1/tutorials/replication/two-cluster-replication/
[design]: /kv/3.4.1/tutorials/replication/two-cluster-replication/
[installingg]: /kv/3.4.1/tutorials/replication/two-cluster-replication/
