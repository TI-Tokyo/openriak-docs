...
- [Build a search index with the Query API](/kv/3.4.1/tutorials/query-api/build-search-index/)

## In this section

- [Build a search index with the Query API](/kv/3.4.1/tutorials/query-api/build-search-index/) — Guide a developer through designing, loading, querying, and evaluating a small Query API search index.
