...
- [Secure a first client connection](/kv/3.4.1/tutorials/security/secure-client-connection/) — Guide a newcomer through enabling security and making one authenticated TLS client request.
