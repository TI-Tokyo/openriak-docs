...
Define a realistic, disposable scenario for **Learn OpenRiak security**. List the exact OpenRiak KV 3.4.1 environment, client tools, permissions, sample data, and prior knowledge required, including a safe way to reset the exercise.
...
- [Secure a first client connection]({{< baseurl >}}kv/3.4.1/tutorials/security/secure-client-connection/) — Guide a newcomer through enabling security and making one authenticated TLS client request.
