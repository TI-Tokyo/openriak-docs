...
[CRUD Operations]({{< baseurl >}}kv/3.4.1/tutorials/first-application/java/)
...
Riak, see [Updating Objects]({{< baseurl >}}kv/3.4.1/how-to/develop/update-object/)
and [Conflict Resolution]({{< baseurl >}}kv/3.4.1/how-to/develop/resolve-conflicts/)
documentation.
