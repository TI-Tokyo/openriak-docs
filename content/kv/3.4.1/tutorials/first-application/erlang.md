...
[CRUD Operations]({{< baseurl >}}kv/3.4.1/tutorials/first-application/erlang/)
...
A more comprehensive discussion can be found in [Key/Value Modeling]({{< baseurl >}}kv/3.4.1/how-to/plan/map-data-to-objects/).
