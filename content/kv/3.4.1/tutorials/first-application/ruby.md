...
If you haven't set up an OpenRiak node and started it, please visit [Running A Cluster]({{< baseurl >}}kv/3.4.1/how-to/operate/) first. To try this flavor
...
[CRUD Operations]({{< baseurl >}}kv/3.4.1/tutorials/first-application/ruby/)
