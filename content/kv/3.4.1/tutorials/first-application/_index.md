...
[dev data model#log]: {{< baseurl >}}kv/3.4.1/how-to/plan/map-data-to-objects/
[dev data model#sensor]: {{< baseurl >}}kv/3.4.1/how-to/plan/map-data-to-objects/
[concept eventual consistency]: {{< baseurl >}}kv/3.4.1/explanation/consistency/eventual-consistency/
[dev data model#user]: {{< baseurl >}}kv/3.4.1/how-to/plan/map-data-to-objects/
[dev kv model]: {{< baseurl >}}kv/3.4.1/how-to/plan/map-data-to-objects/
[dev data types]: {{< baseurl >}}kv/3.4.1/reference/data/distributed-data-types/
[dev data types#counters]: {{< baseurl >}}kv/3.4.1/reference/data/distributed-data-types/
[dev data types#sets]: {{< baseurl >}}kv/3.4.1/reference/data/distributed-data-types/
[dev data types#maps]: {{< baseurl >}}kv/3.4.1/reference/data/distributed-data-types/
[usage create objects]: {{< baseurl >}}kv/3.4.1/how-to/develop/create-object/
[usage search]: {{< baseurl >}}kv/3.4.1/reference/specialized-apis/legacy-query-api/
[use ref search]: {{< baseurl >}}kv/3.4.1/reference/specialized-apis/legacy-query-api/
...
[dev data model]: {{< baseurl >}}kv/3.4.1/how-to/plan/map-data-to-objects/
[usage mapreduce]: {{< baseurl >}}kv/3.4.1/how-to/develop/run-mapreduce/
[apps mapreduce]: {{< baseurl >}}kv/3.4.1/how-to/develop/run-mapreduce/
[use ref 2i]: {{< baseurl >}}kv/3.4.1/reference/data/secondary-indexes/
...
[obj model java]: {{< baseurl >}}kv/3.4.1/tutorials/first-application/java/
[obj model ruby]: {{< baseurl >}}kv/3.4.1/tutorials/first-application/ruby/
[obj model python]: {{< baseurl >}}kv/3.4.1/tutorials/first-application/python/
[obj model csharp]: {{< baseurl >}}kv/3.4.1/tutorials/first-application/csharp/
[obj model nodejs]: {{< baseurl >}}kv/3.4.1/tutorials/first-application/nodejs/
[obj model erlang]: {{< baseurl >}}kv/3.4.1/tutorials/first-application/erlang/
[obj model golang]: {{< baseurl >}}kv/3.4.1/tutorials/first-application/golang/
...
[apps strong consistency]: {{< baseurl >}}kv/3.4.1/reference/specialized-apis/strong-consistency-api/
...
[usage index]: {{< baseurl >}}kv/3.4.1/how-to/develop/
[glossary]: {{< baseurl >}}kv/3.4.1/explanation/foundations/glossary/
...
- [Build a first OpenRiak application with C#]({{< baseurl >}}kv/3.4.1/tutorials/first-application/csharp/)
- [Build a first OpenRiak application with Erlang]({{< baseurl >}}kv/3.4.1/tutorials/first-application/erlang/)
- [Build a first OpenRiak application with Go]({{< baseurl >}}kv/3.4.1/tutorials/first-application/golang/)

## In this section

- [Build a first OpenRiak application with C#]({{< baseurl >}}kv/3.4.1/tutorials/first-application/csharp/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with C#.
- [Build a first OpenRiak application with Erlang]({{< baseurl >}}kv/3.4.1/tutorials/first-application/erlang/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Erlang.
- [Build a first OpenRiak application with Go]({{< baseurl >}}kv/3.4.1/tutorials/first-application/golang/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Go.
- [Build a first OpenRiak application with Java]({{< baseurl >}}kv/3.4.1/tutorials/first-application/java/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Java.
- [Build a first OpenRiak application with Node.js]({{< baseurl >}}kv/3.4.1/tutorials/first-application/nodejs/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Node.js.
- [Build a first OpenRiak application with PHP]({{< baseurl >}}kv/3.4.1/tutorials/first-application/php/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with PHP.
- [Build a first OpenRiak application with Python]({{< baseurl >}}kv/3.4.1/tutorials/first-application/python/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Python.
- [Build a first OpenRiak application with Ruby]({{< baseurl >}}kv/3.4.1/tutorials/first-application/ruby/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Ruby.
- [Build a first OpenRiak application with Rust]({{< baseurl >}}kv/3.4.1/tutorials/first-application/rust/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Rust.
