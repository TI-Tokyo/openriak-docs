...
[dev data model#log]: /kv/3.4.1/how-to/plan/map-data-to-objects/
[dev data model#sensor]: /kv/3.4.1/how-to/plan/map-data-to-objects/
[concept eventual consistency]: /kv/3.4.1/explanation/consistency/eventual-consistency/
[dev data model#user]: /kv/3.4.1/how-to/plan/map-data-to-objects/
[dev kv model]: /kv/3.4.1/how-to/plan/map-data-to-objects/
[dev data types]: /kv/3.4.1/reference/data/distributed-data-types/
[dev data types#counters]: /kv/3.4.1/reference/data/distributed-data-types/
[dev data types#sets]: /kv/3.4.1/reference/data/distributed-data-types/
[dev data types#maps]: /kv/3.4.1/reference/data/distributed-data-types/
[usage create objects]: /kv/3.4.1/how-to/develop/create-object/
[usage search]: /kv/3.4.1/reference/specialized-apis/legacy-query-api/
[use ref search]: /kv/3.4.1/reference/specialized-apis/legacy-query-api/
...
[dev data model]: /kv/3.4.1/how-to/plan/map-data-to-objects/
[usage mapreduce]: /kv/3.4.1/how-to/develop/run-mapreduce/
[apps mapreduce]: /kv/3.4.1/how-to/develop/run-mapreduce/
[use ref 2i]: /kv/3.4.1/reference/data/secondary-indexes/
...
[obj model java]: /kv/3.4.1/tutorials/first-application/java/
[obj model ruby]: /kv/3.4.1/tutorials/first-application/ruby/
[obj model python]: /kv/3.4.1/tutorials/first-application/python/
[obj model csharp]: /kv/3.4.1/tutorials/first-application/csharp/
[obj model nodejs]: /kv/3.4.1/tutorials/first-application/nodejs/
[obj model erlang]: /kv/3.4.1/tutorials/first-application/erlang/
[obj model golang]: /kv/3.4.1/tutorials/first-application/golang/
...
[cluster ops strong consistency]: /kv/3.4.1/explanation/consistency/strong-consistency/
[config strong consistency]: /kv/3.4.1/how-to/configure/strong-consistency/
[apps strong consistency]: /kv/3.4.1/reference/specialized-apis/strong-consistency-api/
...
[install index]: /kv/3.4.1/how-to/install/
[getting started]: /kv/3.4.1/tutorials/first-application/
[usage index]: /kv/3.4.1/how-to/develop/
[glossary]: /kv/3.4.1/explanation/foundations/glossary/
...
- [Build a first OpenRiak application with C#](/kv/3.4.1/tutorials/first-application/csharp/)
- [Build a first OpenRiak application with Erlang](/kv/3.4.1/tutorials/first-application/erlang/)
- [Build a first OpenRiak application with Go](/kv/3.4.1/tutorials/first-application/golang/)

## In this section

- [Build a first OpenRiak application with C#](/kv/3.4.1/tutorials/first-application/csharp/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with C#.
- [Build a first OpenRiak application with Erlang](/kv/3.4.1/tutorials/first-application/erlang/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Erlang.
- [Build a first OpenRiak application with Go](/kv/3.4.1/tutorials/first-application/golang/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Go.
- [Build a first OpenRiak application with Java](/kv/3.4.1/tutorials/first-application/java/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Java.
- [Build a first OpenRiak application with Node.js](/kv/3.4.1/tutorials/first-application/nodejs/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Node.js.
- [Build a first OpenRiak application with PHP](/kv/3.4.1/tutorials/first-application/php/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with PHP.
- [Build a first OpenRiak application with Python](/kv/3.4.1/tutorials/first-application/python/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Python.
- [Build a first OpenRiak application with Ruby](/kv/3.4.1/tutorials/first-application/ruby/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Ruby.
- [Build a first OpenRiak application with Rust](/kv/3.4.1/tutorials/first-application/rust/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Rust.
