...
- [Build a first OpenRiak cluster in the cloud](/kv/3.4.1/tutorials/first-cluster/cloud/) — Guide a newcomer through deploying and testing a disposable cluster on a supported cloud platform.
