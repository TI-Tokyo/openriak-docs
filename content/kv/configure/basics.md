...
[Overview]: #overview
[VM Tuning]: #erlang-vm-tunings
[Ring Size]: #ring-size
[Backend]: #backend
[Default props]: #default-bucket-properties
...
<insert link to erlang vm changes here>
...
>![NOTE]
>The steps involved in changing the ring size depend on whether the Nodes in the cluster have already been joined together or if it is changed prior to joining.
...
>![NOTE]
> OpenRiak will not allow two nodes with different ring sizes to be joined into a cluster.
