...
[below](/kv/3.4.0/explanation/replication/references-and-triggers/#symbolic-consistency-names). Each
...
check out the [section below](/kv/3.4.0/explanation/replication/references-and-triggers/#client-level-replication-settings)
...
documentation on [Bitcask](/kv/3.4.0/explanation/storage/bitcask/), [LevelDB](/kv/3.4.0/explanation/storage/leveldb/), and [multiple backends](/kv/3.4.0/explanation/storage/multi-backend/).
...
refer to the section on [development usage with OpenRiak KV](/kv/3.4.0/how-to/develop/)
...
Replication references may also be generated by [AAE folds](/kv/3.4.0/reference/aae-fold-api/) when seeding clusters with data, or repairing large deltas.
...
Riak can be configured to operate in one of [three possible delete modes](/kv/3.4.0/how-to/plan/choose-deletion-policy/).  Using a delete mode other than `keep`is tested with replication, but there will be an increased probability of false-negative reconciliation events that may consume resources on the cluster.
