...
[concept cap neg]: {{< baseurl >}}kv/3.4.0/explanation/foundations/capability-negotiation/
...
[use index]: {{< baseurl >}}kv/3.4.0/how-to/operate/
...
- [The ring and how data is distributed in Riak]({{< baseurl >}}kv/3.4.0/explanation/foundations/clusters-rings-and-partitions/)
- [Eventual consistency]({{< baseurl >}}kv/3.4.0/explanation/consistency/eventual-consistency/)
- [Background processes]({{< baseurl >}}kv/3.4.0/explanation/operations/)
- [Backend design]({{< baseurl >}}kv/3.4.0/explanation/storage/)
