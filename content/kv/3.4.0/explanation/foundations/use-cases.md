...
[dev data model articles etc]: /kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model log data]: /kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model sensor data]: /kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model serve advertisements]: /kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model sess storage]: /kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model user acct]: /kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model user events]: /kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model user settings]: /kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data types]: /kv/3.4.0/reference/data/distributed-data-types/
[plan backend bitcask]: /kv/3.4.0/explanation/storage/bitcask/
[replication properties]: /kv/3.4.0/explanation/replication/references-and-triggers/
