...
[dev data model articles etc]: {{< baseurl >}}kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model log data]: {{< baseurl >}}kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model sensor data]: {{< baseurl >}}kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model serve advertisements]: {{< baseurl >}}kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model sess storage]: {{< baseurl >}}kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model user acct]: {{< baseurl >}}kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model user events]: {{< baseurl >}}kv/3.4.0/how-to/plan/map-data-to-objects/
[dev data model user settings]: {{< baseurl >}}kv/3.4.0/how-to/plan/map-data-to-objects/
...
[replication properties]: {{< baseurl >}}kv/3.4.0/explanation/replication/references-and-triggers/
