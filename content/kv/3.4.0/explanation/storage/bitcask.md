...
description: 'Explain how bitcask stores data, its constraints, and the workloads for which it is appropriate.'
weight: 2
...
Explain how bitcask stores data, its constraints, and the workloads for which it is appropriate.
...
[learn clusters]: {{< baseurl >}}kv/3.4.0/explanation/foundations/clusters-rings-and-partitions/
...
[usage delete objects]: {{< baseurl >}}kv/3.4.0/how-to/develop/delete-object/
...
OpenRiak KV stores each [vnode][glossary vnode] of the
...
* [[Why does it seem that Bitcask merging is only triggered when a
    OpenRiak node is restarted?|Developing on Riak
...
After performing one PUT (write) into the OpenRiak cluster running Bitcask:
...
[strengths]: {{< baseurl >}}kv/3.4.0/explanation/storage/bitcask/
[weaknesses]: #weaknesses
[installenable]: {{< baseurl >}}kv/3.4.0/explanation/storage/bitcask/
