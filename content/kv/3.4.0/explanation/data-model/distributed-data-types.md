...
[data types converg]: {{< baseurl >}}kv/3.4.0/explanation/data-model/distributed-data-types/#convergence
[crdts reading list]: http://christophermeiklejohn.com/crdt/2014/07/22/readings-in-crdts.html
[data types impl]: {{< baseurl >}}kv/3.4.0/explanation/data-model/distributed-data-types/#implementation
[concept causal context dvv]: {{< baseurl >}}kv/3.4.0/explanation/data-model/causal-context/#dotted-version-vectors
...
[dev data types context]: {{< baseurl >}}kv/3.4.0/reference/data/distributed-data-types/#data-types-and-context
