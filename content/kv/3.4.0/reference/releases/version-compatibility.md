...
Define exactly what **Version compatibility** covers in OpenRiak KV 3.4.0 and what belongs in neighbouring reference pages. State the component, interface, file, command, or data type being documented and the supported context in which it is available.
...
- [Release and compatibility reference]({{< baseurl >}}kv/3.4.0/reference/releases/) — Provide factual version, platform, package, compatibility, and change information.
