...
The list API supports the listing of keys and buckets.  The List API is deprecated in Riak 3.4, the [AAE Fold API]({{< baseurl >}}kv/3.4.0/reference/aae-fold-api/) should be used instead, with the fold functions [`list_buckets`]({{< baseurl >}}kv/3.4.0/reference/aae-fold-api/list-buckets/), [`find_keys`]({{< baseurl >}}kv/3.4.0/reference/aae-fold-api/find-keys/) and [`find_tombs`]({{< baseurl >}}kv/3.4.0/reference/aae-fold-api/find-tombstones/).
