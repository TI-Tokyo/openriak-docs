...
[use ref strong consistency#trade-offs]: /kv/3.4.0/reference/specialized-apis/strong-consistency-api/#trade-offs
[glossary vnode]: /kv/3.4.0/explanation/foundations/glossary/#vnode
[config strong consistency#enable]: /kv/3.4.0/how-to/configure/strong-consistency/#enabling-strong-consistency
...
[config strong consistency#fault]: /kv/3.4.0/how-to/configure/strong-consistency/#fault-tolerance
[concept causal context]: /kv/3.4.0/explanation/data-model/causal-context/
[concept causal context#vector]: /kv/3.4.0/explanation/data-model/causal-context/#vector-clocks
[concept version vector]: /kv/3.4.0/explanation/data-model/causal-context/#dotted-version-vectors
...
[use ref strong consistency#vs]: /kv/3.4.0/reference/specialized-apis/strong-consistency-api/
[dev client libraries]: /kv/3.4.0/reference/client-libraries/
[getting started]: /kv/3.4.0/tutorials/first-application/
[config strong consistency#details]: /kv/3.4.0/how-to/configure/strong-consistency/#implementation-details
...
[operations](/kv/3.4.0/how-to/configure/strong-consistency/#fault-tolerance)
documentation.

A second trade-off regards performance. OpenRiak's implementation of strong
consistency involves a complex [consensus subsystem](/kv/3.4.0/reference/specialized-apis/strong-consistency-api/) that typically requires more communication between Riak nodes than eventually consistent operations,
which can entail a performance hit of varying proportions, depending on
a variety of factors.

Ways to address this issue can be found in [strong consistency and performance](/kv/3.4.0/how-to/configure/strong-consistency/#performance).
