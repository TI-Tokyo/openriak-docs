...
[use ref strong consistency#trade-offs]: {{< baseurl >}}kv/3.4.0/reference/specialized-apis/strong-consistency-api/#trade-offs
[glossary vnode]: {{< baseurl >}}kv/3.4.0/explanation/foundations/glossary/#vnode
[config strong consistency#enable]: {{< baseurl >}}kv/3.4.0/how-to/configure/strong-consistency/#enabling-strong-consistency
...
[config strong consistency#fault]: {{< baseurl >}}kv/3.4.0/how-to/configure/strong-consistency/#fault-tolerance
[concept causal context]: {{< baseurl >}}kv/3.4.0/explanation/data-model/causal-context/
[concept causal context#vector]: {{< baseurl >}}kv/3.4.0/explanation/data-model/causal-context/#vector-clocks
[concept version vector]: {{< baseurl >}}kv/3.4.0/explanation/data-model/causal-context/#dotted-version-vectors
...
[use ref strong consistency#vs]: {{< baseurl >}}kv/3.4.0/reference/specialized-apis/strong-consistency-api/
...
[config strong consistency#details]: {{< baseurl >}}kv/3.4.0/how-to/configure/strong-consistency/#implementation-details
...
[operations]({{< baseurl >}}kv/3.4.0/how-to/configure/strong-consistency/#fault-tolerance)
documentation.

A second trade-off regards performance. OpenRiak's implementation of strong
consistency involves a complex [consensus subsystem]({{< baseurl >}}kv/3.4.0/reference/specialized-apis/strong-consistency-api/) that typically requires more communication between Riak nodes than eventually consistent operations,
which can entail a performance hit of varying proportions, depending on
a variety of factors.

Ways to address this issue can be found in [strong consistency and performance]({{< baseurl >}}kv/3.4.0/how-to/configure/strong-consistency/#performance).
