...
[bucket type]: /kv/3.4.0/how-to/develop/use-bucket-types/
[Riak data types]: /kv/3.4.0/reference/data/distributed-data-types/
[strong consistency]: /kv/3.4.0/reference/specialized-apis/strong-consistency-api/
...
The [Multi](/kv/3.4.0/explanation/storage/multi-backend/) backend does not
