...
are made available through the HTTP API via the [`/stats`](/kv/3.4.0/reference/http-api/status/) endpoint, or through the [`riak admin`](/kv/3.4.0/reference/commands/riak-admin/) interface, in particular the `stat` and `status` commands.
...
Riak statistics provided in the [Inspecting a Node](/kv/3.4.0/how-to/operate/inspect-node-and-cluster/) and [HTTP Status](/kv/3.4.0/reference/http-api/status/) documentation.
...
documentation on [system tuning](/kv/3.4.0/how-to/tune/#storage-and-file-system-tuning).
...
If graphing all of the [available Riak metrics](/kv/3.4.0/how-to/operate/inspect-node-and-cluster/) is
...
The [`riak admin`](/kv/3.4.0/reference/commands/riak-admin/) tool provides two
...
[Inspecting a Node](/kv/3.4.0/how-to/operate/inspect-node-and-cluster/#riak admin-status) document.
...
in the [Inspecting a Node](/kv/3.4.0/reference/commands/riak-admin/#stat) document.
...
[Riak Control](/kv/3.4.0/reference/commands/riak-control/) is Basho's REST-driven user-interface for managing Riak
...
the Riak HTTP [`/stats`](/kv/3.4.0/reference/http-api/status/) endpoint is also available.
...
A [Riak New Relic Agent][riak_new_relic] for collecting statistics from the Riak HTTP [`/stats`](/kv/3.4.0/reference/http-api/status/) endpoint is also available.
...
[`/stats`](/kv/3.4.0/reference/http-api/status/) endpoint.
...
* [Inspecting a Node](/kv/3.4.0/how-to/operate/inspect-node-and-cluster/)
* [Riaknostic](http://riaknostic.basho.com)
* [Riak Control](/kv/3.4.0/reference/commands/riak-control/)
