...
This document is a systematic comparison of [Version 2]({{< baseurl >}}kv/3.4.0/explanation/replication/v2-and-v3-replication/) and [Version 3]({{< baseurl >}}kv/3.4.0/explanation/replication/v2-and-v3-replication/) of OpenRiak's Multi-Datacenter
...
* Version 3 is able to take advantage of [Active Anti-Entropy]({{< baseurl >}}kv/3.4.0/explanation/replication/active-anti-entropy/) \(AAE)
