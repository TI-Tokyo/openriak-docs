...
Assigns a set of [bucket properties]({{< baseurl >}}kv/3.4.0/reference/protocol-buffers/set-bucket-properties/) to a
...
`props` field contains an [`RpbBucketProps`]({{< baseurl >}}kv/3.4.0/reference/protocol-buffers/get-bucket-properties/).
