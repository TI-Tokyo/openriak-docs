...
The JSON encoding is the same as [REST API](/kv/3.4.0/how-to/develop/run-mapreduce/) and
the external term format is the same as the [local Erlang API](/kv/3.4.0/how-to/develop/run-mapreduce/)
