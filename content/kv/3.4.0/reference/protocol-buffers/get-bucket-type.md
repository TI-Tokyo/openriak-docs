...
Gets the bucket properties associated with a [bucket type](/kv/3.4.0/how-to/operate/manage-bucket-types/).
...
[`RpbBucketProps`](/kv/3.4.0/reference/protocol-buffers/get-bucket-properties/) message.
