...
[Read more about Secondary Indexing]({{< baseurl >}}kv/3.4.0/reference/http-api/secondary-indexes/)
* `Link` - user and system-defined links to other resources. [Read more about Links.]({{< baseurl >}}kv/3.4.0/reference/http-api/link-walking/)
...
If `returnbody=true`, any of the response headers expected from [HTTP Fetch Object]({{< baseurl >}}kv/3.4.0/reference/http-api/fetch-object/) may be present. Like when fetching the object, `300 Multiple Choices`
