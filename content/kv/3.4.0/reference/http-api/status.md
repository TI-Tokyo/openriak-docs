...
The output of `/stats` contains the output of `riak admin status` detailed in the [Inspecting a Node]({{< baseurl >}}kv/3.4.0/how-to/operate/inspect-node-and-cluster/) doc, plus the below stats generated by the Riak Core application.
