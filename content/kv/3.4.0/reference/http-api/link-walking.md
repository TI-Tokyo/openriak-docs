...
is a special case of [MapReduce](/kv/3.4.0/how-to/develop/run-mapreduce/), and can be expressed more verbosely as such.
[Read more about Links](/kv/3.4.0/explanation/foundations/glossary/).
...
response from [fetching the object](/kv/3.4.0/reference/http-api/fetch-object/), without the status
code.
