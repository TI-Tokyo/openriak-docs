---
title: 'Walk links with the HTTP API'
...
is a special case of [MapReduce]({{< baseurl >}}kv/3.4.0/how-to/develop/run-mapreduce/), and can be expressed more verbosely as such.
[Read more about Links]({{< baseurl >}}kv/3.4.0/explanation/foundations/glossary/).
...
response from [fetching the object]({{< baseurl >}}kv/3.4.0/reference/http-api/fetch-object/), without the status
code.
