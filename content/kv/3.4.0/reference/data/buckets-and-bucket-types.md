...
description: 'Define the fields, limits, supported operations, representations, and compatibility rules for buckets and bucket types.'
weight: 2
diataxis: 'reference'
product: 'OpenRiak KV'
...
Define the fields, limits, supported operations, representations, and compatibility rules for buckets and bucket types.
...
older configuration system based on [bucket properties]({{< baseurl >}}kv/3.4.0/how-to/develop/use-bucket-types/).
...
[HTTP]({{< baseurl >}}kv/3.4.0/reference/http-api/set-bucket-properties/) or [Protocol Buffers]({{< baseurl >}}kv/3.4.0/reference/protocol-buffers/set-bucket-properties/). With this approach, you can take any given bucket and
...
* Nearly all bucket properties can be updated using bucket types, except the
  ...
  [Riak data types]({{< baseurl >}}kv/3.4.0/reference/data/distributed-data-types/), and [strong consistency]({{< baseurl >}}kv/3.4.0/reference/specialized-apis/strong-consistency-api/) respectively
...
way that they are configured when using [bucket properties]({{< baseurl >}}kv/3.4.0/how-to/develop/use-bucket-types/). You cannot simply take a
...
>
> If you are connecting to Riak using one of Basho's official [client libraries]({{< baseurl >}}kv/3.4.0/reference/client-libraries/), you can find more information about getting started with your client in our [Developing with OpenRiak KV: Getting Started]({{< baseurl >}}kv/3.4.0/tutorials/first-application/) section.
...
Prior to Riak 2.0, Riak created [siblings]({{< baseurl >}}kv/3.4.0/explanation/data-model/causal-context/#siblings) in the case of conflicting updates only when explicitly instructed to do so, i.e. when `allow_mult` is to `true`. The default `allow_mult` setting was `false`.
...
do so. New applications, however, are encouraged to retain and [resolve siblings]({{< baseurl >}}kv/3.4.0/how-to/develop/resolve-conflicts/) with the appropriate application-side business logic.
...
`user_account_bucket` with a [pre-commit hook]({{< baseurl >}}kv/3.4.0/how-to/develop/write-commit-hook/#pre-commit-hooks) called `syntax_check` and two [post-commit
hooks]({{< baseurl >}}kv/3.4.0/how-to/develop/write-commit-hook/) called `welcome_email` and `update_registry`. This would involve four steps:
...
because buckets act as a [separate namespace]({{< baseurl >}}kv/3.4.0/reference/data/buckets-and-bucket-types/#buckets-as-namespaces) in Riak, in addition to [buckets]({{< baseurl >}}kv/3.4.0/explanation/data-model/keys-objects-and-buckets/) and [keys]({{< baseurl >}}kv/3.4.0/explanation/data-model/keys-objects-and-buckets/).
...
[buckets]: {{< baseurl >}}kv/3.4.0/reference/data/buckets-and-bucket-types/
[howmany]: {{< baseurl >}}kv/3.4.0/reference/data/buckets-and-bucket-types/
[buckettypes]: #bucket-types
[howwork]: {{< baseurl >}}kv/3.4.0/reference/data/buckets-and-bucket-types/
[when]: #when-to-use-bucket-types
[createactivate]: {{< baseurl >}}kv/3.4.0/reference/data/buckets-and-bucket-types/
[namespace]: {{< baseurl >}}kv/3.4.0/reference/data/buckets-and-bucket-types/
[allowmulti]: {{< baseurl >}}kv/3.4.0/reference/data/buckets-and-bucket-types/
