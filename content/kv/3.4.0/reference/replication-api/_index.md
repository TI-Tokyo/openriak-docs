...
The replication API consists of [the AAE fold API]({{< baseurl >}}kv/3.4.0/reference/aae-fold-api/) and the [fetch API required to access replication queues]({{< baseurl >}}kv/3.4.0/reference/specialized-apis/fetch-api/).

## In this section

- [Replication runtime control reference]({{< baseurl >}}kv/3.4.0/reference/replication-api/runtime-controls/) — List supported source, sink, queue, reconciliation, range, and resynchronization controls.
