...
In assessing the bandwidth needs of Riak deployments, the flow of requests using [the Object API]({{< baseurl >}}kv/3.4.0/reference/http-api/) should be considered:
