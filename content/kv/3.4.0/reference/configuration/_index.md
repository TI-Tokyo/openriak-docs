...
as <a href="/kv/3.4.0/explanation/foundations/glossary/#active-anti-entropy-aae">active anti-entropy</a> data, and cluster metadata
</td>
<td>
<code>./data</code>
</td>
...
associated <a href="/kv/3.4.0/explanation/foundations/glossary/#vnode">vnode</a> before assuming that the vnode
...
href="/kv/3.4.0/explanation/foundations/glossary/#vnode">vnodes</a> attempt to trigger <a
href="/kv/3.4.0/explanation/foundations/glossary/#hinted-handoff">handoff</a> between
...
- [Active anti-entropy configuration properties](/kv/3.4.0/reference/configuration/active-anti-entropy/) — List active anti-entropy configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Bitcask configuration properties](/kv/3.4.0/reference/configuration/bitcask/) — List bitcask configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Bucket property reference](/kv/3.4.0/reference/configuration/bucket-properties/) — Define supported bucket properties, defaults, interactions, and version-specific constraints.
- [DTrace configuration properties](/kv/3.4.0/reference/configuration/dtrace/) — List dtrace configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [LevelDB configuration properties](/kv/3.4.0/reference/configuration/leveldb/) — List leveldb configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Leveled configuration properties](/kv/3.4.0/reference/configuration/leveled/) — List leveled configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Logging configuration properties](/kv/3.4.0/reference/configuration/logging/) — List logging configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Memory backend configuration properties](/kv/3.4.0/reference/configuration/memory/) — List memory backend configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Multi-backend configuration properties](/kv/3.4.0/reference/configuration/multi/) — List multi-backend configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Networking configuration properties](/kv/3.4.0/reference/configuration/networking/) — List networking configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Node configuration properties](/kv/3.4.0/reference/configuration/node/) — List node configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Prefix Multi configuration properties](/kv/3.4.0/reference/configuration/prefix-multi/) — List prefix multi configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Repair configuration properties](/kv/3.4.0/reference/configuration/repair/) — Define repair pairing, deferment, concurrency, and workload-control settings introduced or changed in 3.4.0.
- [Replication configuration properties](/kv/3.4.0/reference/configuration/replication/) — List replication configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Security configuration properties](/kv/3.4.0/reference/configuration/security/) — List security configuration properties with defaults, accepted values, units, dependencies, and version notes.
