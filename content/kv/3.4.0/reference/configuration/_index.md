...
description: 'Define the scope, defaults, units, validation rules, and version applicability of OpenRiak settings.'
weight: 1
diataxis: 'reference'
product: 'OpenRiak KV'
...
migration_sources:
  - '\\wsl.localhost\Ubuntu\home\peter\GitHub\TI-Tokyo\openriak-docs\content\kv\configure\reference\index.md'
migration_review:
  - 'Legacy version text or MDX syntax remains and requires editorial review.'
legacy_3_2_5_sources:
  - 'C:\Users\pjacl\Downloads\riak-docs-fork\kv\3.2.5\configuring\reference.md'
...
Define the scope, defaults, units, validation rules, and version applicability of OpenRiak settings.
...
Every OpenRiak node has a name and a cookie used to facilitate inter-node
...
<td>
Cookie for distributed node communication within an OpenRiak cluster.
...
<td>
Number of partitions in the cluster (only valid when first creating
...
<td>
Specifies the storage engine used for OpenRiak's key-value data and
secondary indexes (if supported).<br /><br />The available options are
<code>bitcask</code> (the default), <code>leveldb</code>,
<code>memory</code>, <code>leveled</code> and <code>multi</code>.
</td>
<td>
<code>bitcask</code>
</td>
...
as <a href="{{< baseurl >}}kv/3.4.0/explanation/foundations/glossary/#active-anti-entropy-aae">active anti-entropy</a> data, and cluster metadata
</td>
<td>
<code>./data</code>
</td>
...
<td>
The directory in which OpenRiak's configuration files are stored.
</td>
<td>
<code>./etc</code>
</td>
...
<td>
The directory in which OpenRiak's dependencies are housed.
</td>
<td>
<code>./lib</code>
</td>
...
<td>
The directory in which OpenRiak's log files are stored, e.g.
<code>console.log</code>, <code>erlang.log</code>, and
<code>crash.log</code> files.
</td>
<td>
<code>./log</code>
</td>
...
To give an example, you can select the directory used by OpenRiak's [active anti-entropy](#active-anti-entropy) system using the
...
this setting can cause performance problems on multi-core systems.
</td>
<td>
<code>off</code>
</td>
...
<td>
A process will become busy when it exceeds this amount of time
...
<td>
The threshold at which a warning will be triggered about the number
...
<td>
The threshold at which to warn a warning will be triggered about the
...
<br /><br />
<strong>Note</strong>: See <a href="../../developing/usage/conflict-resolution">Conflict Resolution</a> for a discussion of siblings.
</td>
<td>
<code>false</code>
</td>
...
<code>notfound_ok</code> is set to <code>false</code>.
</td>
<td>
<code>false</code>
</td>
...
<code>module:function</code> format.
</td>
<td>
</td>
</tr>
...
allowed, using the <code>module:function</code> format.
</td>
<td>
</td>
</tr>
...
href="http://www.erlang.org/doc/man/erl_driver.html">here</a>.
</td>
<td>
</td>
</tr>
...
forms of network monitoring. In an OpenRiak cluster, one of the functions of
...
href="http://www.erlang.org/doc/man/kernel_app.html">here</a>.
</td>
<td>
</td>
</tr>
...
<td>
Set the scheduler forced wakeup interval. All run queues will be
...
More information <a
href="http://www.erlang.org/doc/man/erl.html#+sfwi">here</a>.
</td>
<td>
</td>
</tr>
...
<td>
Enables or disables the Erlang scheduler's compaction of load. When
...
<td>
For nodes with many <code>busy_dist_port</code> events, Basho
...
href="http://erlang.org/doc/man/erl.html#emu_flags">here</a>.
</td>
<td>
<code>on</code>
</td>
...
<td>
Sets the mapping of warning messages for <code>error_logger</code>.
...
which is the default), or info reports (<code>i</code>).
</td>
<td>
<code>w</code>
</td>
...
href="http://erlang.org/doc/man/erl.html#smp">here</a>.
</td>
<td>
<code>enable</code>
</td>
...
Configurable parameters for OpenRiak's now-deprecated JavaScript
...
Configurable parameters for [OpenRiak KV Security][security index].
...
OpenRiak's Protocol Buffers or HTTP API.
...
<td>
When <code>log.console</code> is set to <code>file</code> or
...
<td>
The schedule on which to rotate the crash log. More information <a
...
Configurable parameters for OpenRiak's active anti-entropy subsystem.
...
can block <a href="../../using/cluster-operations/handoff">handoff</a>
...
<td>
To encrypt <code>riak_core</code> intra-cluster data handoff
...
<td>
Whether serialized <a href="../../developing/data-types">Data Types</a> will use compression and at what
...
Owing to lack of usage, SNMP support has been removed from OpenRiak KV 2.9.0 and higher.

#### JMX

Owing to lack of usage, JMX support has also been removed from OpenRiak KV 2.9.0 and higher.

#### Strong Consistency

> **Please Note:**
>
> OpenRiak KV's strong consistency is an experimental feature and may be removed from the product in the future. Strong consistency is not commercially supported or production-ready. Strong consistency is incompatible with Multi-Datacenter Replication, Bitcask Expiration, LevelDB Secondary Indexes, Riak Data Types and Commit Hooks. It suffers from known issues and we do not recommend its usage in any production environment.

OpenRiak's strong consistency feature has a variety of tunable parameters
...
architecture of OpenRiak's implementation of strong consistency. We highly
...
<code>lease_duration</code> setting.
</td>
<td>
...
associated <a href="{{< baseurl >}}kv/3.4.0/explanation/foundations/glossary/#vnode">vnode</a> before assuming that the vnode
...
<td>
Determines how long the consensus subsystem delays syncing to disk
...
write. We do not recommend that you change this setting.
</td>
<td>
<code>50</code>
</td>
...
<td>
Determines how often the consensus subsystem writes data to disk
that was requested to be written asynchronously (in milliseconds). We do
not recommend that you change this setting.
</td>
<td>
<code>5000</code>
</td>
...
<a href="https://github.com/basho/riak_ensemble/blob/wip/riak-2.0-user-docs/riak_consistent_user_docs.md#leader-leases">leader leases</a>.
</td>
<td>
<code>true</code>
</td>
...
<td>
Determines the timeout used internally for reading consistent data,
in milliseconds. This setting must be greater than the highest request
timeout used by your application.
</td>
<td>
...
<td>
Determines the timeout, in milliseconds, used internally for writing
...
<td>
The number of concurrent workers used by the leader to service
...
<tr>
<td>
<code>tree_validation</code>
</td>
<td>
Determines whether Riak considers peer Merkle trees to be trusted
...
a simple majority of nodes to be online and reachable.
</td>
<td>
<code>true</code>
</td>
...
<tr>
<td>
<code>synchronous_tree_updates</code>
</td>
<td>
...
defaults to <code>false</code> in the name of improved performance.
</td>
<td>
<code>false</code>
</td>
...
<tr>
<td>
<code>max_concurrent_requests</code>
</td>
<td>
...
<td>
Whether <a href="http://dtrace.org/blogs/">DTrace</a> is enabled.
...
package) and in R14B04 via a custom repository and branch.
</td>
<td>
<code>off</code>
</td>
...
<tr>
<td>
<code>vnode_management_timer</code>
</td>
<td>
Sets the frequency with which <a
href="{{< baseurl >}}kv/3.4.0/explanation/foundations/glossary/#vnode">vnodes</a> attempt to trigger <a
href="{{< baseurl >}}kv/3.4.0/explanation/foundations/glossary/#hinted-handoff">handoff</a> between
...
<tr>
<td>
<code>retry_put_coordinator_failure</code>
</td>
<td>
...
<tr>
<td>
<code>background_manager</code>
</td>
<td>
OpenRiak's background manager is a subsystem that coordinates access to
...
caused by multiple background tasks.
</td>
<td>
<code>on</code>
</td>
...
%% to release 3.2.5 it was set to a default of 10.
</td>
<td>
<code>5</code>
</td>
...
related to OpenRiak's `riak_repl` subsystem.
...
<td>
<code>/var/db/riak/riak_repl/</code>
</td>
</tr>

<tr>
<td>
<code>max_fssource_cluster</code>
</td>
<td>
...
<tr>
<td>
<code>max_fssource_node</code>
</td>
<td>
This setting limits the number of fullsync workers that will be
...
<tr>
<td>
<code>max_fssink_node</code>
</td>
<td>
This setting limits the number of fullsync workers allowed to run on
...
either via the configuration file or command line.
</td>
<td>
<code>1</code>
</td>
...
<tr>
<td>
<code>rtq_max_bytes</code>
</td>
<td>
The maximum size, in bytes, to which the realtime replication queue
can grow before new objects are dropped. Dropped objects will need to be
replicated with a fullsync.
</td>
<td>
<code>104857600</code>
</td>
...
<tr>
<td>
<code>rt_heartbeat_interval</code>
</td>
<td>
...
the realtime heartbeat. This feature is available only in OpenRiak KV
Enterprise Edition 1.3.2 - 2.2.3 and then from OpenRiak KV 2.2.6 onwards.
</td>
<td>
<code>15</code>
</td>
...
<tr>
<td>
<code>rt_heartbeat_timeout</code>
</td>
<td>
If a heartbeat response is not received within the time period
specified by this setting (in seconds), the source connection exits and
will be re-established. This feature is available only in OpenRiak KV
Enterprise Edition 1.3.2 - 2.2.3 and then from OpenRiak KV 2.2.6 onwards.
</td>
<td>
<code>15</code>
...
<tr>
<td>
<code>realtime_connection_rebalance_max_delay_secs</code>
</td>
<td>
Should a server on the source cluster be restarted, this is
the amount of time (in seconds), before the realtime connections are
rebalanced by a change in the number of source nodes.
</td>
<td>
<code>300</code>
</td>
...
<tr>
<td>
<code>fullsync_use_background_manager</code>
</td>
<td>
...
only in OpenRiak KV Enterprise Edition 2.0 and later as well as OpenRiak KV 2.2.6 onwards.
</td>
<td>
<code>true</code>
</td>
...
<td>
If you are <a href="../../using/reference/custom-code">installing
...
<tr>
<td>
<code>cluster_mgr</code>
</td>
<td>
<code>riak_core</code>
</td>
<td>
The cluster manager listens for connections from remote clusters on
...
<tr>
<td>
<code>target_n_val</code>
</td>
<td>
<code>riak_core</code>
</td>
<td>
The highest <code>n_val</code> that you generally intend to use.
...
- [Active anti-entropy configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/active-anti-entropy/) — List active anti-entropy configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Bitcask configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/bitcask/) — List bitcask configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Bucket property reference]({{< baseurl >}}kv/3.4.0/reference/configuration/bucket-properties/) — Define supported bucket properties, defaults, interactions, and version-specific constraints.
- [DTrace configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/dtrace/) — List dtrace configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [LevelDB configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/leveldb/) — List leveldb configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Leveled configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/leveled/) — List leveled configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Logging configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/logging/) — List logging configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Memory backend configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/memory/) — List memory backend configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Multi-backend configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/multi/) — List multi-backend configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Networking configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/networking/) — List networking configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Node configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/node/) — List node configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Prefix Multi configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/prefix-multi/) — List prefix multi configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Repair configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/repair/) — Define repair pairing, deferment, concurrency, and workload-control settings introduced or changed in 3.4.0.
- [Replication configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/replication/) — List replication configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Security configuration properties]({{< baseurl >}}kv/3.4.0/reference/configuration/security/) — List security configuration properties with defaults, accepted values, units, dependencies, and version notes.
