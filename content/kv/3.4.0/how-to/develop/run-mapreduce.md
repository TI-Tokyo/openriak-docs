...
[use ref custom code]: {{< baseurl >}}kv/3.4.0/reference/operations/custom-code/
...
[installing custom code]({{< baseurl >}}kv/3.4.0/reference/operations/custom-code/).
...
[usage types]: {{< baseurl >}}kv/3.4.0/how-to/develop/use-bucket-types/
[api http]: {{< baseurl >}}kv/3.4.0/reference/http-api/
[api pb]: {{< baseurl >}}kv/3.4.0/reference/protocol-buffers/
[glossary vnode]: {{< baseurl >}}kv/3.4.0/explanation/foundations/glossary/#vnode
[guide mapreduce]: {{< baseurl >}}kv/3.4.0/how-to/develop/run-mapreduce/
