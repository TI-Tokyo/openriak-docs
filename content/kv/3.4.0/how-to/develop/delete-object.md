...
you first fetch the [causal context]({{< baseurl >}}kv/3.4.0/explanation/data-model/causal-context/) of the object prior to updating.
This can be done by setting the `deletedvclock` parameter to `true` as
part of the [fetch operation]({{< baseurl >}}kv/3.4.0/reference/protocol-buffers/fetch-object/). This can also be done
