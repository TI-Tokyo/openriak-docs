...
[use ref handoff]: /kv/3.4.0/reference/operations/handoff/
[config mapreduce]: /kv/3.4.0/how-to/configure/mapreduce/
...
- [Node selection, including storage](/kv/3.4.0/how-to/plan/size-cluster/);
- [Network requirements](/kv/3.4.0/reference/configuration/networking/);
- [The use of a proxy, WAF or load-balancing gateway](/kv/3.4.0/how-to/configure/load-balancing-proxy/).
