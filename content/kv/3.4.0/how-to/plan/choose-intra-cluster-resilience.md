...
- [Configuring data distribution guarantees](/kv/3.4.0/how-to/plan/choose-intra-cluster-resilience/);
- [Enabling proactive reconciliation](/kv/3.4.0/explanation/replication/active-anti-entropy/).

Further guidance on the infrastructure requirements for a cluster, and the planning of cluster changes, can be found within the [guide to building and scaling a cluster](/kv/3.4.0/how-to/plan/).
