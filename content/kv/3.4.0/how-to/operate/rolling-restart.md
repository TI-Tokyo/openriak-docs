...
Because Riak functions as a multi-node system, cluster-level [Riak version upgrades](/kv/3.4.0/how-to/operate/upgrade-cluster/) and restarts can be performed on a node-by-node, "rolling" basis.
