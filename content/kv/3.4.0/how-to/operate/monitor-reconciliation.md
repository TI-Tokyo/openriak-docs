...
For information on monitoring inter-cluster reconciliation and repair [refer to the NextGen Repl guide]({{< baseurl >}}kv/3.4.0/how-to/operate/monitor-reconciliation/).
