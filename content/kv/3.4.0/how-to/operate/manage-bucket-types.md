...
In Riak versions 2.0 and later, Basho suggests that you [use bucket types]({{< baseurl >}}kv/3.4.0/how-to/develop/use-bucket-types/) to namespace and configure all buckets you use. Bucket types have a lower overhead within the cluster than the
