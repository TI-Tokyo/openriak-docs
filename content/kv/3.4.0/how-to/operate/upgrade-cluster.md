...
[cluster ops load balance]: {{< baseurl >}}kv/3.4.0/how-to/configure/load-balancing-proxy/
[config reference]: {{< baseurl >}}kv/3.4.0/reference/configuration/
[config backend]: {{< baseurl >}}kv/3.4.0/how-to/configure/backends/
...
[use admin riak control]: {{< baseurl >}}kv/3.4.0/reference/commands/riak-control/
[cluster ops inspect node]: {{< baseurl >}}kv/3.4.0/how-to/operate/inspect-node-and-cluster/
[troubleshoot http]: {{< baseurl >}}kv/3.4.0/how-to/troubleshoot/http-204/
...
[production checklist]: {{< baseurl >}}kv/3.4.0/how-to/operate/upgrade-cluster/
[use admin riak control]: {{< baseurl >}}kv/3.4.0/reference/commands/riak-control/
[use admin commands]: {{< baseurl >}}kv/3.4.0/reference/commands/
[use admin riak admin]: {{< baseurl >}}kv/3.4.0/reference/commands/riak/ admin
...
[cluster ops mdc]: {{< baseurl >}}kv/3.4.0/reference/replication-api/runtime-controls/
[config v3 mdc]: {{< baseurl >}}kv/3.4.0/how-to/configure/replication/configure-v3-multi-datacenter/
[jmx monitor]: {{< baseurl >}}kv/3.4.0/reference/operations/jmx/
[snmp]: {{< baseurl >}}kv/3.4.0/reference/operations/snmp/
...
If you run [Riak Control]({{< baseurl >}}kv/3.4.0/reference/commands/riak-control/), you should disable it during the rolling upgrade process.
