...
[use admin riak cli#chkconfig]: {{< baseurl >}}kv/3.4.0/reference/commands/riak/#chkconfig
...
[retrieve conf val]: {{< baseurl >}}kv/3.4.0/how-to/configure/manage-configuration/
[check config]: {{< baseurl >}}kv/3.4.0/how-to/configure/manage-configuration/
