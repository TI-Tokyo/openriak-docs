...
[config reference#strong-cons]: {{< baseurl >}}kv/3.4.0/reference/configuration/#strong-consistency
...
[use admin riak admin#ensemble]: {{< baseurl >}}kv/3.4.0/reference/commands/riak-admin/#ensemble-status
[use admin riak admin]: {{< baseurl >}}kv/3.4.0/reference/commands/riak-admin/
...
[cluster ops obj del]: {{< baseurl >}}kv/3.4.0/reference/operations/object-deletion/
