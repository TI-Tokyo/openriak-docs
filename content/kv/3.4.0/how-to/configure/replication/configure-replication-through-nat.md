...
[config v2 ssl]: {{< baseurl >}}kv/3.4.0/how-to/configure/replication/secure-replication/

**Deprecation Warning**
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{< baseurl >}}kv/3.4.0/how-to/configure/replication/configure-replication-through-nat/) instead.
