...
**Deprecation Warning**
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{< baseurl >}}kv/3.4.0/how-to/configure/replication/secure-replication/) instead.
...
[config reference#advanced.config]: {{< baseurl >}}kv/3.4.0/reference/configuration/
...
The real-time connections may be secured, by [enabling security on the source cluster]({{< baseurl >}}kv/3.4.0/how-to/secure/).  The securing of communications for replication is supported only with the PB transport in Riak 3.4.
