...
**Deprecation Warning**
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{< baseurl >}}kv/3.4.0/how-to/configure/replication/configure-fullsync/) instead.
...
- For security the [settings for real-time replication]({{< baseurl >}}kv/3.4.0/how-to/configure/replication/configure-real-time-replication/) are used e.g. `repl_cacert_filename` etc.
...
The root to be compared is the root of [the merkle tree]({{< baseurl >}}kv/3.4.0/explanation/replication/active-anti-entropy/) representing the state of the whole tree in 1,024 4-byte hashes.  The roots are merged across all partitions, to provide a representation of cluster state in a single 4KB integer.
...
[overview]: #overview
[enable fullsync]: {{< baseurl >}}kv/3.4.0/how-to/configure/replication/configure-fullsync/
[queues]: #queues
[read write values]: {{< baseurl >}}kv/3.4.0/how-to/configure/replication/configure-fullsync/
