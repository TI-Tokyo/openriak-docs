---
title: 'Configure API listeners'
description: 'Show operators how to configure api listeners and verify the result.'
weight: 2
diataxis: 'how-to'
product: 'OpenRiak KV'
...
Show operators how to configure api listeners and verify the result.
