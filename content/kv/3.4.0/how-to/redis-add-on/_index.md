...
* [Riak Redis Add-on](/kv/3.4.0/how-to/redis-add-on/)
...
- [Extend the Redis add-on](/kv/3.4.0/how-to/redis-add-on/develop/) — Show developers how to add and test a supported Redis add-on feature.
- [Set up the Redis add-on](/kv/3.4.0/how-to/redis-add-on/set-up/) — Show operators how to deploy the Redis add-on in a supported topology and verify connectivity.
- [Use the Redis add-on](/kv/3.4.0/how-to/redis-add-on/use/) — Show developers how to perform supported Redis operations against OpenRiak.
