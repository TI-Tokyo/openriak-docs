...
[CRUD Operations](/kv/3.4.0/tutorials/first-application/php/)
...
More complex use cases can be composed from these initial create, read, update, and delete (CRUD) operations. [In the next chapter](/kv/3.4.0/tutorials/first-application/php/) we will look at how to store and query more complicated and interconnected data, such as documents.
