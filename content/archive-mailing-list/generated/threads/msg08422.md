---
title: "Riak performance issue with many connected objects (11 million +) (and 2 replies)"
date: "2012-08-31T08:54:36-07:00"
author: "Lei Gu"
...
<nav class="mailing-list-toc" aria-label="Thread contents"><h2>In this thread</h2><ol><li><a href="#msg08422"><span>Riak performance issue with many connected objects (11 million +)</span><small>Lei Gu · Aug 31, 2012</small></a><ol><li><a href="#msg08424"><span>Re: Riak performance issue with many connected objects (11 million +)</span><small>Jared Morrow · Aug 31, 2012</small></a></li><li><a href="#msg08426"><span>Re: Riak performance issue with many connected objects (11 million +)</span><small>Lei Gu · Aug 31, 2012</small></a></li></ol></li></ol></nav><section class="mailing-list-thread" data-thread-root="msg08422"><article id="msg08422" class="mailing-list-message mailing-list-message--root"><header class="mailing-list-message__header"><span class="mailing-list-message__author">Lei Gu</span><time datetime="2012-08-31T08:54:36-07:00">August 31, 2012 at 8:54 AM</time></header><div class="mailing-list-message__body">I started performance testing Riak by loading 11 million connected objects in
...
</div><ol class="mailing-list-replies"><li class="mailing-list-reply"><details id="msg08424" class="mailing-list-message"><summary><header class="mailing-list-message__header"><span class="mailing-list-message__author">Jared Morrow</span><time datetime="2012-08-31T10:41:02-07:00">August 31, 2012 at 10:41 AM</time><span class="mailing-list-message__subject">Re: Riak performance issue with many connected objects (11 million +)</span></header></summary><div class="mailing-list-message__content"><div class="mailing-list-message__body">*My first reply bounced due to it being too big, so I&#x27;ll try again with
...
<blockquote>I started performance testing Riak by loading 11 million connected objects
...
riak-users@lists.basho.com
<a href="http://lists.basho.com/mailman/listinfo/riak-users_lists.basho.com">http://lists.basho.com/mailman/listinfo/riak-users_lists.basho.com</a>
</div></div></details></li><li class="mailing-list-reply"><details id="msg08426" class="mailing-list-message"><summary><header class="mailing-list-message__header"><span class="mailing-list-message__author">Lei Gu</span><time datetime="2012-08-31T10:49:18-07:00">August 31, 2012 at 10:49 AM</time><span class="mailing-list-message__subject">Re: Riak performance issue with many connected objects (11 million +)</span></header></summary><div class="mailing-list-message__content"><div class="mailing-list-message__body">Hi Jared,
...
To: Lei Gu &lt;l...@e-dialog.com&lt;mailto:l...@e-dialog.com&gt;&gt;
...
a n_val of 3, you will be storing 3 copies of every piece of data on that one
...
operates.  We recommend a minimum of five physical nodes for a n_val of 3.  If
you lower your n_val you can possibly lower your physical node count and still
...
&lt;l...@e-dialog.com&lt;mailto:l...@e-dialog.com&gt;&gt; wrote:
I started performance testing Riak by loading 11 million connected objects in
Riak. Loading has not been an issue, although it did take a long time.
Now when I tried to access an object, Riak never returns and was using 100% of
CPU and 74% of memory.
...
ring_num_partitions : 64
ring_ownership :
&lt;&lt;&quot;[{&#x27;riak@127.0.0.1&lt;mailto:riak@127.0.0.1&gt;&lt;mailto:&#x27;riak@127.0.0.1&lt;mailto:riak@127.0.0.1&gt;&gt;&#x27;,64}]&quot;&gt;&gt;
ring_creation_size : 64
storage_backend : riak_kv_eleveldb_backend
pbc_connects_total : 10
pbc_connects : 1
