---
title: "Riak Merge On Restarts Only (and 4 replies)"
date: "2013-01-18T14:15:16-08:00"
author: "Ian Ha"
...
<nav class="mailing-list-toc" aria-label="Thread contents"><h2>In this thread</h2><ol><li><a href="#msg09844"><span>Riak Merge On Restarts Only</span><small>Ian Ha · Jan 18, 2013</small></a><ol><li><a href="#msg09849"><span>Re: Riak Merge On Restarts Only</span><small>Brian Sparrow · Jan 19, 2013</small></a><ol><li><a href="#msg09870"><span>Re: Riak Merge On Restarts Only</span><small>Ian Ha · Jan 22, 2013</small></a><ol><li><a href="#msg09871"><span>Re: Riak Merge On Restarts Only</span><small>Brian Sparrow · Jan 22, 2013</small></a><ol><li><a href="#msg09872"><span>Re: Riak Merge On Restarts Only</span><small>Hector Castro · Jan 22, 2013</small></a></li></ol></li></ol></li></ol></li></ol></li></ol></nav><section class="mailing-list-thread" data-thread-root="msg09844"><article id="msg09844" class="mailing-list-message mailing-list-message--root"><header class="mailing-list-message__header"><span class="mailing-list-message__author">Ian Ha</span><time datetime="2013-01-18T14:15:16-08:00">January 18, 2013 at 2:15 PM</time></header><div class="mailing-list-message__body">Hi,
...
</div><ol class="mailing-list-replies"><li class="mailing-list-reply"><details id="msg09849" class="mailing-list-message"><summary><header class="mailing-list-message__header"><span class="mailing-list-message__author">Brian Sparrow</span><time datetime="2013-01-19T11:02:04-08:00">January 19, 2013 at 11:02 AM</time><span class="mailing-list-message__subject">Re: Riak Merge On Restarts Only</span></header></summary><div class="mailing-list-message__content"><div class="mailing-list-message__body">Hi Ian,
...
riak-users@lists.basho.com
<a href="http://lists.basho.com/mailman/listinfo/riak-users_lists.basho.com">http://lists.basho.com/mailman/listinfo/riak-users_lists.basho.com</a>
</div><ol class="mailing-list-replies"><li class="mailing-list-reply"><details id="msg09870" class="mailing-list-message"><summary><header class="mailing-list-message__header"><span class="mailing-list-message__author">Ian Ha</span><time datetime="2013-01-22T07:50:30-08:00">January 22, 2013 at 7:50 AM</time><span class="mailing-list-message__subject">Re: Riak Merge On Restarts Only</span></header></summary><div class="mailing-list-message__content"><div class="mailing-list-message__body">Thanks Brian. This is very helpful and informative!
...
Customer Service Engineer
Basho Technologies
</blockquote></div><ol class="mailing-list-replies"><li class="mailing-list-reply"><details id="msg09871" class="mailing-list-message"><summary><header class="mailing-list-message__header"><span class="mailing-list-message__author">Brian Sparrow</span><time datetime="2013-01-22T08:04:49-08:00">January 22, 2013 at 8:04 AM</time><span class="mailing-list-message__subject">Re: Riak Merge On Restarts Only</span></header></summary><div class="mailing-list-message__content"><div class="mailing-list-message__body">What is reported by riak-admin vnode_status?
...
<blockquote>Thanks Brian. This is very helpful and informative!
...
On Sat, Jan 19, 2013 at 2:01 PM, Brian Sparrow &lt;bspar...@basho.com
</blockquote></div><ol class="mailing-list-replies"><li class="mailing-list-reply"><details id="msg09872" class="mailing-list-message"><summary><header class="mailing-list-message__header"><span class="mailing-list-message__author">Hector Castro</span><time datetime="2013-01-22T13:29:09-08:00">January 22, 2013 at 1:29 PM</time><span class="mailing-list-message__subject">Re: Riak Merge On Restarts Only</span></header></summary><div class="mailing-list-message__content"><div class="mailing-list-message__body">As I read through this thread, I came across the following FAQ entry
[0] in the Riak docs that echos a lot of what Brian mentioned.

[0]
<a href="http://docs.basho.com/riak/1.2.1/cookbooks/faqs/developing-faq/#why-does-it-seem-that-bitcask-merging-is-only-trig">http://docs.basho.com/riak/1.2.1/cookbooks/faqs/developing-faq/#why-does-it-seem-that-bitcask-merging-is-only-trig</a>

--
Hector

On Tue, Jan 22, 2013 at 1:14 PM, Brian Sparrow &lt;bspar...@basho.com&gt; wrote:
<blockquote>Anytime.
...
Yes Ian based on the output of vnode_status the 2.1GB file is still opened
and the 340MB file was created by the last merge. For your system it seems a
smaller max_file_size would work well. 1GB max_file_size(and then reduce
...
On Tue, Jan 22, 2013 at 11:42 AM, Brian Sparrow &lt;bspar...@basho.com&gt; wrote:

If the file is not reported in vnode_status then the file has not yet been
...
On Tue, Jan 22, 2013 at 11:03 AM, Brian Sparrow &lt;bspar...@basho.com&gt; wrote:
...
bitcask will merge anytime the merge_triggers and thresholds set in the
app.config are satisfied on a closed bitcask file. A bitcask data file is
closed when it reaches the max_file_size threshold set in app.config(default
...
normal operation because the files are not reaching the 2GB max_file_size.

Q: I&#x27;m assuming our config values are correct as the restart considers the
thresholds met to go ahead with a merge.

A: I do not see anything wrong with your configuration with the exception of
no max_file_size being set. If you want to merge more often, reduce the
max_file size to 1GB or lower(the lower the file size, the more merging). A
