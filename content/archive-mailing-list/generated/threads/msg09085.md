---
title: "Issue with clustering Riak nodes on CentOS servers. (and 4 replies)"
date: "2012-10-30T11:40:11-07:00"
...
<nav class="mailing-list-toc" aria-label="Thread contents"><h2>In this thread</h2><ol><li><a href="#msg09085"><span>Issue with clustering Riak nodes on CentOS servers.</span><small>SWEENEY, JAMES · Oct 30, 2012</small></a><ol><li><a href="#msg09086"><span>Re: Issue with clustering Riak nodes on CentOS servers.</span><small>Callixte Cauchois · Oct 30, 2012</small></a></li><li><a href="#msg09091"><span>Re: Issue with clustering Riak nodes on CentOS servers.</span><small>Tin Le · Oct 30, 2012</small></a></li><li><a href="#msg09093"><span>Re: Issue with clustering Riak nodes on CentOS servers.</span><small>Bryan Hughes · Oct 30, 2012</small></a><ol><li><a href="#msg09094"><span>Re: Issue with clustering Riak nodes on CentOS servers.</span><small>Bryan Hughes · Oct 30, 2012</small></a></li></ol></li></ol></li></ol></nav><section class="mailing-list-thread" data-thread-root="msg09085"><article id="msg09085" class="mailing-list-message mailing-list-message--root"><header class="mailing-list-message__header"><span class="mailing-list-message__author">SWEENEY, JAMES</span><time datetime="2012-10-30T11:40:11-07:00">October 30, 2012 at 11:40 AM</time></header><div class="mailing-list-message__body">Hello,  I am attempting to create a 4 node riak installation on 4 separate
CentOS servers.   Installation of Riak went well.  We have run simple tests
like riak ping, sudo curl \-v <a href="http://127.0.0.1:8098/riak/test">http://127.0.0.1:8098/riak/test</a>, ect,  and
...
</div><ol class="mailing-list-replies"><li class="mailing-list-reply"><details id="msg09086" class="mailing-list-message"><summary><header class="mailing-list-message__header"><span class="mailing-list-message__author">Callixte Cauchois</span><time datetime="2012-10-30T11:43:41-07:00">October 30, 2012 at 11:43 AM</time><span class="mailing-list-message__subject">Re: Issue with clustering Riak nodes on CentOS servers.</span></header></summary><div class="mailing-list-message__content"><div class="mailing-list-message__body">Hi there,
...
</div></div></details></li><li class="mailing-list-reply"><details id="msg09091" class="mailing-list-message"><summary><header class="mailing-list-message__header"><span class="mailing-list-message__author">Tin Le</span><time datetime="2012-10-30T14:20:48-07:00">October 30, 2012 at 2:20 PM</time><span class="mailing-list-message__subject">Re: Issue with clustering Riak nodes on CentOS servers.</span></header></summary><div class="mailing-list-message__content"><div class="mailing-list-message__body"><blockquote>Hello,  I am attempting to create a 4 node riak installation on 4
separate CentOS servers.   Installation of Riak went well.  We have run
simple tests like riak ping, sudo curl \-v
<a href="http://127.0.0.1:8098/riak/test">http://127.0.0.1:8098/riak/test</a>, ect,  and everything seems fine with the
</blockquote>    ^^^^^^^^^^^^^^^^^^^

Did you change your http address from 127.0.0.1 to 10.1.78.9?   On that
machine, 10.1.78.9, does curl -v <a href="http://10.1.78.9:8098/riak/test">http://10.1.78.9:8098/riak/test</a> work?

<blockquote>riak servers,  they all start up with no errors.  We used the default
...
riak-users@lists.basho.com
<a href="http://lists.basho.com/mailman/listinfo/riak-users_lists.basho.com">http://lists.basho.com/mailman/listinfo/riak-users_lists.basho.com</a>
</div></div></details></li><li class="mailing-list-reply"><details id="msg09093" class="mailing-list-message"><summary><header class="mailing-list-message__header"><span class="mailing-list-message__author">Bryan Hughes</span><time datetime="2012-10-30T15:36:21-07:00">October 30, 2012 at 3:36 PM</time><span class="mailing-list-message__subject">Re: Issue with clustering Riak nodes on CentOS servers.</span></header></summary><div class="mailing-list-message__content"><div class="mailing-list-message__body">Hi James,
...
<blockquote>sudo service iptables status
</blockquote>
...
<a href="http://docs.basho.com/riak/1.2.0/cookbooks/Network-Security-and-Firewall-Configurations/">http://docs.basho.com/riak/1.2.0/cookbooks/Network-Security-and-Firewall-Configurations/</a>
...
<blockquote>sudo vi /etc/sysconfig/iptables (and add the following to
</blockquote>RH-Firewall-1-INPUT just above the icmp-host-prohibited)
...
<blockquote>sudo service iptables restart
</blockquote>
...
riak-users@lists.basho.com
<a href="http://lists.basho.com/mailman/listinfo/riak-users_lists.basho.com">http://lists.basho.com/mailman/listinfo/riak-users_lists.basho.com</a>
</div><ol class="mailing-list-replies"><li class="mailing-list-reply"><details id="msg09094" class="mailing-list-message"><summary><header class="mailing-list-message__header"><span class="mailing-list-message__author">Bryan Hughes</span><time datetime="2012-10-30T21:20:29-07:00">October 30, 2012 at 9:20 PM</time><span class="mailing-list-message__subject">Re: Issue with clustering Riak nodes on CentOS servers.</span></header></summary><div class="mailing-list-message__content"><div class="mailing-list-message__body">Hi James,
...
<a href="http://aloiroberto.wordpress.com/2010/11/24/how-to-manage-multiple-erlang-installations/">http://aloiroberto.wordpress.com/2010/11/24/how-to-manage-multiple-erlang-installations/</a>
...
NOTE: If yum can not install git, do the following:
     wget
<a href="http://packages.sw.be/rpmforge-release/rpmforge-release-0.3.6-1.el5.rf.i386.rpm">http://packages.sw.be/rpmforge-release/rpmforge-release-0.3.6-1.el5.rf.i386.rpm</a>

     rpm -Uvh <a href="http://repo.webtatic.com/yum/centos/5/latest.rpm">http://repo.webtatic.com/yum/centos/5/latest.rpm</a>
     yum install --enablerepo=webtatic git-all

 6. mkdir erlang
 7. cd erlang
 8. mkdir R15B01
 9. wget <a href="http://erlang.org/download/otp_src_R15B01.tar.gz">http://erlang.org/download/otp_src_R15B01.tar.gz</a>
...
24. cd /home/riak
25. wget
<a href="http://downloads.basho.com.s3-website-us-east-1.amazonaws.com/riak/CURRENT/riak-1.2.0.tar.gz">http://downloads.basho.com.s3-website-us-east-1.amazonaws.com/riak/CURRENT/riak-1.2.0.tar.gz</a>
...
&lt;mailto:riak@10.1.78.9&gt;

    Attempting to restart script through sudo -H -u riak

    Noderiak@10.1.78.9  &lt;mailto:riak@10.1.78.9&gt;  is not reachable!
