...
command: erlang:riak_client:aae_fold/1:object_stats
versions: 3.4.0, 3.4.1

# Summary

Measure object counts and sizes over a bucket range.

# Description

Returns aggregated object count, total size and size-distribution data.
...
## erlang-riak-client-aae-fold-object-stats:seed-five-objects
