...
- [Queued Query API results]({{< product-version-root >}}reference/query-api/queued-results/) — Define disk-backed queue_raw_keys and queue_raw_terms results, batching behavior, retrieval, and lifecycle.
