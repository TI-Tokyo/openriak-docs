...
description: 'Define repair pairing, deferment, concurrency, and workload-control settings in OpenRiak KV 3.4.1.'
weight: 15
diataxis: 'reference'
product: 'OpenRiak KV'
...
Define repair pairing, deferment, concurrency, and workload-control settings in OpenRiak KV {{< current-version >}}.
