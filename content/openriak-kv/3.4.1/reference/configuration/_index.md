...
<br /><br />
<strong>Note</strong>: See <a href="{{< product-version-root >}}how-to/develop/resolve-conflicts/">Conflict Resolution</a> for a discussion of siblings.
</td>
<td>
<code>false</code>
</td>
...
can block <a href="{{< product-version-root >}}how-to/operate/manage-handoffs/">handoff</a>
...
<td>
Whether serialized <a href="{{< product-version-root >}}reference/data/distributed-data-types/">Data Types</a> will use compression and at what
...
<td>
If you are <a href="{{< product-version-root >}}reference/operations/custom-code/">installing
custom code</a> for Riak, e.g. for the purpose of running <a
href="{{< product-version-root >}}how-to/develop/run-mapreduce/">MapReduce</a> jobs or <a
href="{{< product-version-root >}}how-to/develop/write-commit-hook/">commit hooks</a>, this setting specifies
...
information can be found in <a href="{{< product-version-root >}}reference/operations/object-deletion/">Object
Deletion</a>.
</td>
<td>
...
- [Active anti-entropy configuration properties]({{< product-version-root >}}reference/configuration/active-anti-entropy/) — List active anti-entropy configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Bitcask configuration properties]({{< product-version-root >}}reference/configuration/bitcask/) — List bitcask configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Bucket property reference]({{< product-version-root >}}reference/configuration/bucket-properties/) — Define supported bucket properties, defaults, interactions, and version-specific constraints.
- [DTrace configuration properties]({{< product-version-root >}}reference/configuration/dtrace/) — List dtrace configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [LevelDB configuration properties]({{< product-version-root >}}reference/configuration/leveldb/) — List leveldb configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Leveled configuration properties]({{< product-version-root >}}reference/configuration/leveled/) — List leveled configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Logging configuration properties]({{< product-version-root >}}reference/configuration/logging/) — List logging configuration properties with defaults, accepted values, units, dependencies, and version notes.
- [Memory backend configuration properties]({{< product-version-root >}}reference/configuration/memory/) — List memory backend configuration properties with defaults, accepted values, units, dependencies, and version notes.
