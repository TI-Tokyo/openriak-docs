...
- [The OpenRiak security model]({{< product-version-root >}}explanation/security/security-model/) — Explain the openriak security model and the security decisions administrators must make.
