...
The replication API consists of [the AAE fold API]({{< product-version-root >}}reference/aae-fold-api/) and the [fetch API required to access replication queues]({{< product-version-root >}}reference/specialized-apis/fetch-api/).

## In this section

- [Replication runtime control reference]({{< product-version-root >}}reference/replication-api/runtime-controls/) — List supported source, sink, queue, reconciliation, range, and resynchronization controls.
