...
Prior to the introduction of the [Riak Query API]({{< product-version-root >}}tutorials/query-api/), there existed a simple REST-based API for querying index entries in Riak.  This API is deprecated, use of the Query API is preferred to support new queries.
