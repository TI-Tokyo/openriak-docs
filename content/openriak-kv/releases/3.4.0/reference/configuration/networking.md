---
title: 'Networking configuration properties'
description: 'List networking configuration properties with defaults, accepted values, units, dependencies, and version notes.'
weight: 10
diataxis: 'reference'
product: 'OpenRiak KV'
...
List networking configuration properties with defaults, accepted values, units, dependencies, and version notes.
...
In assessing the bandwidth needs of Riak deployments, the flow of requests using [the Object API]({{< product-version-root >}}reference/http-api/) should be considered:
