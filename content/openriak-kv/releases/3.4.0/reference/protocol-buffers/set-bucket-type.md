...
Assigns a set of [bucket properties]({{< product-version-root >}}reference/protocol-buffers/set-bucket-properties/) to a
...
`props` field contains an [`RpbBucketProps`]({{< product-version-root >}}reference/protocol-buffers/get-bucket-properties/).
