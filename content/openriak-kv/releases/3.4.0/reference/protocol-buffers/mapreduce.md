---
title: 'Run MapReduce with Protocol Buffers'
...
The JSON encoding is the same as [REST API]({{< product-version-root >}}how-to/develop/run-mapreduce/) and
the external term format is the same as the [local Erlang API]({{< product-version-root >}}how-to/develop/run-mapreduce/)
