...
`context` | The opaque binary "context" that informs Riak which version of a data type the client has seen, analogous to [vector clocks]({{< product-version-root >}}explanation/foundations/glossary/#vector-clock)
