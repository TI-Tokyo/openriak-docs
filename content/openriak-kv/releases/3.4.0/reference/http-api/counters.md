...
The regular POST/PUT ([HTTP Store Object]({{< product-version-root >}}reference/http-api/store-object/)) and GET ([HTTP Fetch Object]({{< product-version-root >}}reference/http-api/fetch-object/)) responses apply here.
