...
object ([default is defined by the bucket]({{< product-version-root >}}reference/http-api/set-bucket-properties/))
* `pr` - how many primary replicas need to be online when doing the read
([default is defined by the bucket]({{< product-version-root >}}reference/http-api/set-bucket-properties/))
...
purposes of R ([default is defined by the bucket]({{< product-version-root >}}reference/http-api/set-bucket-properties/))
