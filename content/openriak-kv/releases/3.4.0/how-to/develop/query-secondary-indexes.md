...
recommend [Riak Search]({{< product-version-root >}}reference/specialized-apis/legacy-query-api/) rather than secondary indexes for
...
be used to find multiple objects in Riak. If you're storing [user data]({{< product-version-root >}}how-to/plan/map-data-to-objects/), for example, you could tag each object
...
[Riak Search]({{< product-version-root >}}reference/specialized-apis/legacy-query-api/) serves analogous purposes but is quite
...
* Query results can be used as input to a [MapReduce]({{< product-version-root >}}how-to/develop/run-mapreduce/)
  query
...
[strongly consistent buckets]({{< product-version-root >}}reference/specialized-apis/strong-consistency-api/) and attach
...
mechanism that does not require a schema (as does [Riak Search]({{< product-version-root >}}reference/specialized-apis/legacy-query-api/)) and a basic query interface, i.e. an interface that
...
* When you need more than the exact match and range searches that 2i
  supports. If that's the case, we recommend checking out [Riak Search]({{< product-version-root >}}reference/specialized-apis/legacy-query-api/).
...
>
> If you are connecting to Riak using one of Basho's official [client libraries]({{< product-version-root >}}reference/client-libraries/), you can find more information about getting started with
your client in the [Developing with OpenRiak KV: Getting Started]({{< product-version-root >}}tutorials/first-application/) section.
