---
title: 'Store content with media types'
description: 'Show developers how to store content with media types with a minimal verified example.'
weight: 11
diataxis: 'how-to'
product: 'OpenRiak KV'
...
Show developers how to store content with media types with a minimal verified example.
...
OpenRiak KV is a fundamentally content-agnostic database. You can use it to
