...
- [`riak_kv.get`]({{< product-version-root >}}reference/http-api/fetch-object/)
- [`riak_kv.put`]({{< product-version-root >}}reference/http-api/store-object/)
- [`riak_kv.delete`]({{< product-version-root >}}reference/http-api/delete-object/)
- [`riak_kv.list_keys`]({{< product-version-root >}}reference/specialized-apis/list-api/)
- [`riak_kv.list_buckets`]({{< product-version-root >}}reference/specialized-apis/list-api/)
- [`riak_kv.mapreduce`]({{< product-version-root >}}reference/http-api/mapreduce/)
- `riak_kv.index`;
  - used to control both the [legacy query api]({{< product-version-root >}}reference/specialized-apis/legacy-query-api/) and the [Query API]({{< product-version-root >}}tutorials/query-api/).
