...
See [Changing Cluster Information]({{< product-version-root >}}how-to/operate/change-cluster-information/#clusters-from-backups) for instructions on cluster recovery.
