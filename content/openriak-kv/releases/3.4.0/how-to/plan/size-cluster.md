...
- [Node selection, including storage]({{< product-version-root >}}how-to/plan/size-cluster/);
- [Network requirements]({{< product-version-root >}}reference/configuration/networking/);
- [The use of a proxy, WAF or load-balancing gateway]({{< product-version-root >}}how-to/configure/load-balancing-proxy/).
