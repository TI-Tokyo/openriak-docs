...
* [Riak Redis Add-on]({{< product-version-root >}}how-to/redis-add-on/)

### OpenRiak Redis Add-on

[addon redis develop]: {{< product-version-root >}}how-to/redis-add-on/develop/
[addon redis features]: {{< product-version-root >}}how-to/redis-add-on/
[addon redis setup]: {{< product-version-root >}}how-to/redis-add-on/set-up/
[addon redis use]: {{< product-version-root >}}how-to/redis-add-on/
...
- [Extend the Redis add-on]({{< product-version-root >}}how-to/redis-add-on/develop/) — Show developers how to add and test a supported Redis add-on feature.
- [Set up the Redis add-on]({{< product-version-root >}}how-to/redis-add-on/set-up/) — Show operators how to deploy the Redis add-on in a supported topology and verify connectivity.
- [Use the Redis add-on]({{< product-version-root >}}how-to/redis-add-on/use/) — Show developers how to perform supported Redis operations against OpenRiak.
