...
[tictacaae client]: {{< product-version-root >}}how-to/operate/#the-riak-client
...
**Note:**
How to get the value for `Client` is detailed in [The Riak Client]({{< product-version-root >}}how-to/operate/#the-riak-client).
