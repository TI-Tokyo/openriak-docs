...
[config tictacaae]: {{< product-version-root >}}how-to/configure/replication/enable-tictac-aae/
[tictacaae system]: {{< product-version-root >}}how-to/operate/
[tictacaae folds-overview]: ../tictac-aae-fold
[tictacaae client]: ../tictac-aae-fold#the-riak-client
[tictacaae find-keys]: {{< product-version-root >}}how-to/operate/
[tictacaae find-tombs]: {{< product-version-root >}}how-to/operate/
[tictacaae list-buckets]: {{< product-version-root >}}how-to/operate/
[tictacaae object-stats]: {{< product-version-root >}}how-to/operate/
[tictacaae count-tombs]: {{< product-version-root >}}how-to/operate/
[tictacaae count-keys]: {{< product-version-root >}}how-to/operate/
[tictacaae reap-tombs]: {{< product-version-root >}}how-to/operate/
[tictacaae erase-keys]: {{< product-version-root >}}how-to/operate/
[tictacaae repair-keys-range]: {{< product-version-root >}}how-to/operate/
[filters]: ../tictac-aae-fold/filters
[filter-by bucket]: {{< product-version-root >}}reference/aae-fold-api/filters/#filter-by-bucket-name
...
[filter-by sibling-count]: {{< product-version-root >}}how-to/operate//#the-sibling-count-filter
[filter-by object-size]: {{< product-version-root >}}how-to/operate//#the-object-size-filter
...
- Supports [more than ten different fold types]({{< product-version-root >}}reference/aae-fold-api/);
- [Are throttled to minimise the impact on other cluster operations, and have query options that may improve efficiency]({{< product-version-root >}}reference/aae-fold-api/).

The AAE Fold API has four potential interfaces:

- [AAE Folds via the Command Line]({{< product-version-root >}}how-to/operate/aae-fold/run-from-command-line/);
- [AAE Folds via remote_console]({{< product-version-root >}}how-to/operate/use-remote-console/);
- [AAE Folds via HTTP]({{< product-version-root >}}reference/aae-fold-api/);
- [AAE Folds via protocol buffers]({{< product-version-root >}}reference/aae-fold-api/).
...
- [Count keys with AAE fold]({{< product-version-root >}}how-to/operate/aae-fold/count-keys/) — Show operators how to count keys with aae fold and interpret the outcome.
- [Count tombstones with AAE fold]({{< product-version-root >}}how-to/operate/aae-fold/count-tombstones/) — Show operators how to count tombstones with aae fold and interpret the outcome.
- [Erase keys with AAE fold]({{< product-version-root >}}how-to/operate/aae-fold/erase-keys/) — Show operators how to erase keys with aae fold and interpret the outcome.
- [Find keys with AAE fold]({{< product-version-root >}}how-to/operate/aae-fold/find-keys/) — Show operators how to find keys with aae fold and interpret the outcome.
- [Find tombstones with AAE fold]({{< product-version-root >}}how-to/operate/aae-fold/find-tombstones/) — Show operators how to find tombstones with aae fold and interpret the outcome.
- [List buckets with AAE fold]({{< product-version-root >}}how-to/operate/aae-fold/list-buckets/) — Show operators how to list buckets with aae fold and interpret the outcome.
- [Collect object statistics with AAE fold]({{< product-version-root >}}how-to/operate/aae-fold/object-statistics/) — Show operators how to collect object statistics with aae fold and interpret the outcome.
- [Reap tombstones with AAE fold]({{< product-version-root >}}how-to/operate/aae-fold/reap-tombstones/) — Show operators how to reap tombstones with aae fold and interpret the outcome.
- [Repair a key range with AAE fold]({{< product-version-root >}}how-to/operate/aae-fold/repair-key-range/) — Show operators how to repair a key range with aae fold and interpret the outcome.
- [Run an AAE fold from the command line]({{< product-version-root >}}how-to/operate/aae-fold/run-from-command-line/) — Show operators how to start a long-running AAE fold and write its completed results to disk.
