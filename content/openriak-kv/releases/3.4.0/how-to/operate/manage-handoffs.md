...
[`riak admin`]({{< product-version-root >}}reference/commands/riak-admin/) interface enables you to
...
`Hinted` | Total number of [hinted handoffs]({{< product-version-root >}}reference/operations/handoff/#types-of-handoff)
...
This command displays the values for handoff-specific [configurable parameters]({{< product-version-root >}}reference/configuration/#intra-cluster-handoff) on each node in
