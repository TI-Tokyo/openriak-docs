---
title: 'Configure MapReduce'
description: 'Show operators how to configure mapreduce and verify the result.'
weight: 8
diataxis: 'how-to'
product: 'OpenRiak KV'
...
Show operators how to configure mapreduce and verify the result.
...
[config reference#appconfig]: {{< product-version-root >}}reference/configuration/
