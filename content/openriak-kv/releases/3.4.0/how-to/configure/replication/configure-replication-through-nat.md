---
title: 'Configure replication through NAT'
description: 'Show operators how to configure replication through nat and validate data movement.'
weight: 7
diataxis: 'how-to'
product: 'OpenRiak KV'
...
Show operators how to configure replication through nat and validate data movement.
...
**Deprecation Warning**
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{< product-version-root >}}how-to/configure/replication/configure-replication-through-nat/) instead.
