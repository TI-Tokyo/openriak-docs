---
title: 'Configure next-generation replication'
description: 'Show operators how to configure next-generation replication and validate data movement.'
weight: 4
diataxis: 'how-to'
product: 'OpenRiak KV'
...
Show operators how to configure next-generation replication and validate data movement.
...
[configure nextgenrepl sink]: {{< product-version-root >}}how-to/configure/replication/configure-next-generation-replication/
[tictacaae folds]: {{< product-version-root >}}how-to/configure/
