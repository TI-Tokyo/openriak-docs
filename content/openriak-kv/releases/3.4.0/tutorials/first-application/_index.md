...
[dev data types#counters]: {{< product-version-root >}}reference/data/distributed-data-types/
[dev data types#sets]: {{< product-version-root >}}reference/data/distributed-data-types/
[dev data types#maps]: {{< product-version-root >}}reference/data/distributed-data-types/
[usage create objects]: {{< product-version-root >}}how-to/develop/create-object/
[usage search]: {{< product-version-root >}}reference/specialized-apis/legacy-query-api/
...
[obj model csharp]: {{< product-version-root >}}tutorials/first-application/csharp/
[obj model nodejs]: {{< product-version-root >}}tutorials/first-application/nodejs/
[obj model erlang]: {{< product-version-root >}}tutorials/first-application/erlang/
...
* **Objects that exceed 1-2MB in size** - If you will be
  ...
  out [Riak CS](/docs/openriak-cs/2.1.3/) instead, as Riak
...
- [Build a first OpenRiak application with C#]({{< product-version-root >}}tutorials/first-application/csharp/)
- [Build a first OpenRiak application with Erlang]({{< product-version-root >}}tutorials/first-application/erlang/)
- [Build a first OpenRiak application with Go]({{< product-version-root >}}tutorials/first-application/golang/)

## In this section

- [Build a first OpenRiak application with C#]({{< product-version-root >}}tutorials/first-application/csharp/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with C#.
- [Build a first OpenRiak application with Erlang]({{< product-version-root >}}tutorials/first-application/erlang/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Erlang.
- [Build a first OpenRiak application with Go]({{< product-version-root >}}tutorials/first-application/golang/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Go.
- [Build a first OpenRiak application with Java]({{< product-version-root >}}tutorials/first-application/java/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Java.
- [Build a first OpenRiak application with Node.js]({{< product-version-root >}}tutorials/first-application/nodejs/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Node.js.
- [Build a first OpenRiak application with PHP]({{< product-version-root >}}tutorials/first-application/php/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with PHP.
- [Build a first OpenRiak application with Python]({{< product-version-root >}}tutorials/first-application/python/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Python.
- [Build a first OpenRiak application with Ruby]({{< product-version-root >}}tutorials/first-application/ruby/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Ruby.
- [Build a first OpenRiak application with Rust]({{< product-version-root >}}tutorials/first-application/rust/) — Guide a developer through modeling, storing, retrieving, querying, and updating a small dataset with Rust.
