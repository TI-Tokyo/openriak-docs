...
[learn why riak]: {{< product-version-root >}}explanation/foundations/why-openriak/
[learn use cases]: ./use-cases/
[learn new nosql]: ./new-to-nosql/
[glossary]: ./glossary/
[concepts]: {{< product-version-root >}}explanation/foundations/
...
[concept cap neg]: {{< product-version-root >}}explanation/foundations/capability-negotiation/
...
[use index]: {{< product-version-root >}}how-to/operate/
...
- [The ring and how data is distributed in Riak]({{< product-version-root >}}explanation/foundations/clusters-rings-and-partitions/)
- [Eventual consistency]({{< product-version-root >}}explanation/consistency/eventual-consistency/)
- [Background processes]({{< product-version-root >}}explanation/operations/)
- [Backend design]({{< product-version-root >}}explanation/storage/)
