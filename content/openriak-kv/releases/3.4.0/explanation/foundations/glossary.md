---
title: 'OpenRiak terminology'
description: 'Explain openriak terminology and why it matters when designing or operating OpenRiak systems.'
weight: 6
...
Explain openriak terminology and why it matters when designing or operating OpenRiak systems.
...
[concept keys objects]: {{< product-version-root >}}explanation/data-model/keys-objects-and-buckets/
...
[concept replication aae]: {{< product-version-root >}}explanation/replication/#active-anti-entropy
...
[glossary read rep]: {{< product-version-root >}}explanation/foundations/glossary/#read-repair
[glossary vnode]: {{< product-version-root >}}explanation/foundations/glossary/#vnode
[Lager]: https://github.com/basho/lager
[learn dynamo]: {{< product-version-root >}}explanation/foundations/dynamo-model/
[plan cluster capacity]: {{< product-version-root >}}explanation/storage/capacity-planning/
[repair recover failure recovery]: {{< product-version-root >}}how-to/troubleshoot/recover-cluster-failure/
[repair recover repairs]: {{< product-version-root >}}explanation/operations/repair-granularity/
...
* [Bucket Types]({{< product-version-root >}}how-to/develop/use-bucket-types/)

#### Cluster

A OpenRiak cluster is a 160-bit integer space which is divided into
...
are resolved in OpenRiak's eventually consistent system. There are five Riak
...
ships as OpenRiak's default logger.

#### MapReduce

OpenRiak's MapReduce gives developers the capability to perform more
...
Partitions are the spaces into which an OpenRiak cluster is divided. Each
...
* [Understanding OpenRiak's Configurable Behaviors]
...
the foundation for OpenRiak's scalable architecture.
...
OpenRiak KV is the key/value datastore for Riak.

* [OpenRiak KV]

#### Riak Pipe

Riak Pipe is the processing layer that powers OpenRiak's MapReduce. It's
best described as "UNIX pipes for Riak."

* [Riak Pipe]
* [Riak Pipe - the New MapReduce Power]
* [Riak Pipe - OpenRiak's Distributed Processing Framework]
...
Since any node in an OpenRiak cluster is able to handle a request, and not
