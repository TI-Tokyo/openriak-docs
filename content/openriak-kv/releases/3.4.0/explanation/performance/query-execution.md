---
title: 'Query execution performance'
description: 'Explain how query distribution, scanning, filtering, buffering, and collation affect latency and capacity.'
weight: 6
...
Explain how query distribution, scanning, filtering, buffering, and collation affect latency and capacity.
...
Understanding the [detailed guidance about query performance]({{< product-version-root >}}explanation/performance/query-execution/) is important, but in summary:
