---
title: 'How LevelDB stores data'
description: 'Explain how leveldb stores data, its constraints, and the workloads for which it is appropriate.'
weight: 5
...
legacy_3_2_5_sources:
  - 'C:\Users\pjacl\Downloads\riak-docs-fork\kv\3.2.5\setup\planning\backend\leveldb.md'
source_material:
  - 'legacy-3.2.5'
  - 'live-3.2.5'
  - 'proposed-kv'
...
Explain how leveldb stores data, its constraints, and the workloads for which it is appropriate.
...
[config reference#aae]: {{< product-version-root >}}reference/configuration/#active-anti-entropy
...
* Delete operations now receive priority handling in compaction
  ...
  in previous versions of OpenRiak's LevelDB backend.
...
but slow performance. Because OpenRiak's integrity is based on multiple
