...
[repair recover fail]: {{< product-version-root >}}explanation/operations/node-failure-and-recovery/
[repair recover errors]: {{< product-version-root >}}explanation/operations/node-failure-and-recovery/
[repair recover repairs]: {{< product-version-root >}}explanation/operations/node-failure-and-recovery/
[repair recover restart]: {{< product-version-root >}}how-to/operate/rolling-restart/
