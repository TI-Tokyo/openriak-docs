...
[v2 mdc arch]: {{< product-version-root >}}explanation/foundations/clusters-rings-and-partitions/
[v2 mdc fullsync]: {{< product-version-root >}}explanation/replication/v2-and-v3-replication/

**Deprecation Warning**
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{< product-version-root >}}explanation/replication/v2-and-v3-replication/) instead.
...
[v3 mdc arch]: {{< product-version-root >}}explanation/foundations/clusters-rings-and-partitions/
[v3 mdc aae]: {{< product-version-root >}}reference/commands/aae/
[v3 mdc cascade]: {{< product-version-root >}}explanation/replication/cascading-writes/
[v3 mdc fullsync]: {{< product-version-root >}}explanation/replication/v2-and-v3-replication/
