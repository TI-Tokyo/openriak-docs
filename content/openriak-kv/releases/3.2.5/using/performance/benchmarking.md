...
aliases:
  ...
  - /riak/kv/3.2.5/ops/building/benchmarking
---
...
* Erlang must be installed. See [Installing Erlang]({{< product-version-root >}}setup/installing/source/erlang) for instructions
