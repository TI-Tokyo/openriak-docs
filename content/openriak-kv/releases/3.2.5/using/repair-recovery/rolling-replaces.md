...
[upgrade]: {{< product-version-root >}}setup/upgrading/cluster/
[rolling restarts]: {{< product-version-root >}}using/repair-recovery/rolling-restart/
[add node]: {{< product-version-root >}}using/cluster-operations/adding-removing-nodes
