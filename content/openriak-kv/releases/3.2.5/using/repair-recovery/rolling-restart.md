...
aliases:
  ...
  - /riak/kv/3.2.5/ops/running/recovery/rolling-restart
---

Because Riak functions as a multi-node system, cluster-level [Riak version upgrades]({{< product-version-root >}}setup/upgrading/cluster) and restarts can be performed on a node-by-node, "rolling" basis.
