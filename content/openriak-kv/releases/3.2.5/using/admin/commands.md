...
aliases:
  ...
  - /riak/kv/3.2.5/ops/running/cluster-admin
---

[use admin riak admin#cluster]: {{< product-version-root >}}using/admin/riak-admin/#cluster
...
[use admin riak admin#cluster-plan]: {{< product-version-root >}}using/admin/riak-admin/#cluster-plan
[use admin riak admin#cluster-commit]: {{< product-version-root >}}using/admin/riak-admin/#cluster-commit
