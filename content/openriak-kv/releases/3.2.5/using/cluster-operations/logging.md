...
by accessing the Erlang console directly using the [`riak attach`]({{< product-version-root >}}using/admin/riak-cli/#attach) command. Once you run this command and drop into the console, enter the following:
