...
aliases:
  ...
  - /riak/kv/3.2.5/ops/mdc/v3/operations
---

[config v3 mdc]: {{< product-version-root >}}configuring/v3-multi-datacenter
[config v3 nat]: {{< product-version-root >}}configuring/v3-multi-datacenter/nat
[config v3 quickstart]: {{< product-version-root >}}configuring/v3-multi-datacenter/quick-start
[config v3 ssl]: {{< product-version-root >}}configuring/v3-multi-datacenter/ssl
[ref v3 stats]: {{< product-version-root >}}using/reference/multi-datacenter/statistics
