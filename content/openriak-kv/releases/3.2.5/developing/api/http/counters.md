...
aliases:
  ...
  - /riak/kv/3.2.5/dev/references/http/counters
---
...
The regular POST/PUT ([HTTP Store Object]({{< product-version-root >}}developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{< product-version-root >}}developing/api/http/fetch-object)) responses apply here.
