...
aliases:
  ...
  - /riak/kv/3.2.5/dev/references/http/store-object
---
...
[Read more about Secondary Indexing]({{< product-version-root >}}developing/api/http/secondary-indexes)
* `Link` - user and system-defined links to other resources. [Read more about Links.]({{< product-version-root >}}developing/api/http/link-walking)
...
If `returnbody=true`, any of the response headers expected from [HTTP Fetch Object]({{< product-version-root >}}developing/api/http/fetch-object) may be present. Like when fetching the object, `300 Multiple Choices`
