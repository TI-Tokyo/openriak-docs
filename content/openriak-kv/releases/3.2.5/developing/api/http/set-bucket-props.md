...
aliases:
  ...
  - /riak/kv/3.2.5/dev/references/http/set-bucket-props
---
...
clock) when writing
* `precommit` - [precommit hooks]({{< product-version-root >}}developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks]({{< product-version-root >}}developing/usage/commit-hooks)
