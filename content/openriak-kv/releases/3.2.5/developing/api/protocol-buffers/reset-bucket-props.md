...
aliases:
  ...
  - /riak/kv/3.2.5/dev/references/protocol-buffers/reset-bucket-props
---
...
[bucket type]({{< product-version-root >}}developing/usage/bucket-types) using the `type` value. If you do not
