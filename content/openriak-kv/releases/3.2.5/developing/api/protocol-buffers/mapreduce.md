...
aliases:
  ...
  - /riak/kv/3.2.5/dev/references/protocol-buffers/mapreduce
---
...
The JSON encoding is the same as [REST API]({{< product-version-root >}}developing/usage/mapreduce/#rest) and
the external term format is the same as the [local Erlang API]({{< product-version-root >}}developing/app-guide/advanced-mapreduce/#erlang)
