...
aliases:
  ...
  - /riak/kv/3.2.5/dev/using/mapreduce
---

[usage 2i]: {{< product-version-root >}}developing/usage/secondary-indexes
[usage search]: {{< product-version-root >}}deprecated/riak-search/
[usage types]: {{< product-version-root >}}developing/usage/bucket-types
[api http]: {{< product-version-root >}}developing/api/http
[api pb]: {{< product-version-root >}}developing/api/protocol-buffers
[glossary vnode]: {{< product-version-root >}}learn/glossary/#vnode
[guide mapreduce]: {{< product-version-root >}}developing/app-guide/advanced-mapreduce
