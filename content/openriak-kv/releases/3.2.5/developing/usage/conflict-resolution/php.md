...
aliases:
  ...
  - /riak/kv/3.2.5/dev/using/conflict-resolution/php
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{< product-version-root >}}developing/usage) section.
