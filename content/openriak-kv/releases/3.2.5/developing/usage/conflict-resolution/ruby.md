...
aliases:
  ...
  - /riak/kv/3.2.5/dev/using/conflict-resolution/ruby
---
...
the official Ruby client library, in the [Developing with Riak KV: Usage]({{< product-version-root >}}developing/usage) section.
