...
aliases:
  ...
  - /riak/kv/3.2.5/dev/using/conflict-resolution/java
---
...
[bucket type]({{< product-version-root >}}developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official Java client library, in the [Developing with Riak KV: Usage]({{< product-version-root >}}developing/usage) section.
