...
#### [Using Search]({{< product-version-root >}}deprecated/riak-search/)

Tutorial on using search.

[Learn More >>]({{< product-version-root >}}deprecated/riak-search/)
...
#### [Creating Search Schemas]({{< product-version-root >}}deprecated/riak-search/)

Step-by-step guide on creating and using custom search schemas.

[Learn More >>]({{< product-version-root >}}deprecated/riak-search/)

#### [Searching with Data Types]({{< product-version-root >}}deprecated/riak-search/)

Guide on using search with Data Types.

[Learn More >>]({{< product-version-root >}}deprecated/riak-search/)

#### [Implementing a Document Store]({{< product-version-root >}}deprecated/riak-search/)

Tutorial on using Riak KV as a document store.

[Learn More >>]({{< product-version-root >}}deprecated/riak-search/)

#### [Custom Extractors]({{< product-version-root >}}deprecated/riak-search/)
