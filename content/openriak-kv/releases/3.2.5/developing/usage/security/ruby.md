...
aliases:
  ...
  - /riak/kv/3.2.5/dev/advanced/client-security/ruby
---

This tutorial shows you how to set up a Riak Ruby client to authenticate
itself when connecting to Riak.

If you are using [trust-]({{< product-version-root >}}using/security/managing-sources/) or [PAM]({{< product-version-root >}}using/security/managing-sources/#pam-based-authentication)-based authentication, you
can use the security setup described in the [Ruby Client Basics](#ruby-client-basics) section.
[Password]({{< product-version-root >}}using/security/managing-sources/#password-based-authentication)-based authentication is covered
in a [later section](#password-based-authentication), while [certificate]({{< product-version-root >}}using/security/managing-sources/#certificate-based-authentication)-based authentication
...
regardless of which [security source]({{< product-version-root >}}using/security/managing-sources/) you choose. All clients should also provide a username. The example below sets up a client object (we'll simply call it `client`) that connects
...
this in [Trust-based Authentication]({{< product-version-root >}}using/security/managing-sources/#trust-based-authentication).
...
[PAM]({{< product-version-root >}}using/security/managing-sources/#pam-based-authentication), you will
...
documentation on [User Management]({{< product-version-root >}}using/security/basics#user-management).
