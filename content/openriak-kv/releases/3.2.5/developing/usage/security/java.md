...
aliases:
  ...
  - /riak/kv/3.2.5/dev/advanced/client-security/java
---
...
security setup described [below](#java-client-basics). [Certificate]({{< product-version-root >}}using/security/managing-sources/#certificate-based-authentication)-based authentication is not
