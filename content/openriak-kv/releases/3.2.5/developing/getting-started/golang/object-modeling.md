...
aliases:
  ...
  - /riak/kv/3.2.5/dev/taste-of-riak/object-modeling-golang
---
...
We'll be using the bucket `Users` to store our data. We won't be [using bucket types]({{< product-version-root >}}developing/usage/bucket-types) here, so we don't need to specify one.
