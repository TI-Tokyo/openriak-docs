...
If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{< product-version-root >}}using/running-a-cluster) first and ensure you have
...
[CRUD Operations]({{< product-version-root >}}developing/getting-started/golang/crud-operations)
