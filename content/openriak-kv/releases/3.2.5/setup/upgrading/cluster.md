...
[production checklist]: {{< product-version-root >}}setup/upgrading/checklist
...
[cluster ops mdc]: {{< product-version-root >}}using/cluster-operations/v3-multi-datacenter
[config v3 mdc]: {{< product-version-root >}}configuring/v3-multi-datacenter
[jmx monitor]: {{< product-version-root >}}using/reference/jmx
[snmp]: {{< product-version-root >}}using/reference/snmp
...
If you run [Riak Control]({{< product-version-root >}}using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
