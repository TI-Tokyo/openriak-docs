...
aliases:
  ...
  - /riak/kv/3.2.5/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{< product-version-root >}}setup/upgrading/cluster
[config ref]: {{< product-version-root >}}configuring/reference
[concept aae]: {{< product-version-root >}}learn/concepts/active-anti-entropy/
[aae status]: {{< product-version-root >}}using/admin/riak-admin/#aae-status
