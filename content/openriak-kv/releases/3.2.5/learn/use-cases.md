...
[dev data model articles etc]: {{< product-version-root >}}developing/data-modeling/#articles-blog-posts-and-other-content
[dev data model log data]: {{< product-version-root >}}developing/data-modeling/#log-data
[dev data model sensor data]: {{< product-version-root >}}developing/data-modeling/#sensor-data
[dev data model serve advertisements]: {{< product-version-root >}}developing/data-modeling/#serving-advertisements
[dev data model sess storage]: {{< product-version-root >}}developing/data-modeling/#session-storage
[dev data model user acct]: {{< product-version-root >}}developing/data-modeling/#user-accounts
[dev data model user events]: {{< product-version-root >}}developing/data-modeling/#user-events-and-timelines
[dev data model user settings]: {{< product-version-root >}}developing/data-modeling/#user-settings-and-preferences
...
[replication properties]: {{< product-version-root >}}developing/app-guide/replication-properties
