...
[cluster ops v3 mdc]: {{< product-version-root >}}using/cluster-operations/v3-multi-datacenter
...
[concept vnodes]: {{< product-version-root >}}learn/concepts/vnodes
[glossary node]: {{< product-version-root >}}learn/glossary/#node
...
bucket's [bucket type]({{< product-version-root >}}developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{< product-version-root >}}configuring/v3-multi-datacenter) capabilities.
...
type]({{< product-version-root >}}developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{< product-version-root >}}developing/usage/secondary-indexes/) and
[MapReduce]({{< product-version-root >}}developing/usage/mapreduce/) queries. Lowering an object or bucket's
