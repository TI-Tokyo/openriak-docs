...
aliases:
  ...
  - /riak/kv/3.2.5/theory/concepts/aae
---
...
[config aae]: {{< product-version-root >}}configuring/reference/#active-anti-entropy
...
[search indexes]({{< product-version-root >}}deprecated/riak-search/)
