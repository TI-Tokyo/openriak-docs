...
aliases:
  ...
  - /riak/kv/3.2.5/ops/mdc/v2/nat
---

[config v2 ssl]: {{< product-version-root >}}configuring/v2-multi-datacenter/ssl

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{< product-version-root >}}configuring/v3-multi-datacenter/nat/) instead.
{{% /note %}}
