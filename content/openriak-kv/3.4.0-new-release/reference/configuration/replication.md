---
title: 'Replication configuration properties'
description: 'List replication configuration properties with defaults, accepted values, units, dependencies, and version notes.'
weight: 13
diataxis: 'reference'
product: 'OpenRiak KV'
...
List replication configuration properties with defaults, accepted values, units, dependencies, and version notes.
...
[configure nextgenrepl queuing]: {{< product-version-root >}}reference/configuration/
[configure nextgenrepl queue filters]: {{< product-version-root >}}reference/configuration/#queue-filters
...
- Available from Riak 3.0.18`repl_reap`
