---
title: 'Set bucket properties with the HTTP API'
...
legacy_3_2_5_sources:
  - 'C:\Users\pjacl\Downloads\riak-docs-fork\kv\3.2.5\developing\api\http\set-bucket-props.md'
...
clock) when writing
* `precommit` - [precommit hooks]({{< product-version-root >}}how-to/develop/write-commit-hook/)
* `postcommit` - [postcommit hooks]({{< product-version-root >}}how-to/develop/write-commit-hook/)
