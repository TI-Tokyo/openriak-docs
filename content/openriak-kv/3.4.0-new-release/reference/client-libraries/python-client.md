---
title: Python client
description: The Python client example uses the HTTP API through the language's HTTP library. It does not depend
...
restructured_from:
- reference/client-libraries/python.md
related:
...
The Python client example uses the HTTP API through the language's HTTP library. It does not depend on a Riak-specific Protocol Buffers client.

## Transport and runtime

The accompanying example targets **Python 3** and uses [this HTTP client interface](https://docs.python.org/3/library/urllib.request.html). Object addressing, headers, and response statuses follow the shared HTTP reference.
