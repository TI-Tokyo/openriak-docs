...
description: The Node.js client example uses the HTTP API through the language's HTTP library. It does not depend
...
restructured_from:
- reference/client-libraries/nodejs.md
related:
- tutorials/first-application/build-a-small-application-with-node-js
...
The accompanying example targets **Node.js 22 or newer** and uses [this HTTP client interface](https://nodejs.org/api/globals.html#fetch). Object addressing, headers, and response statuses follow the shared HTTP reference.
