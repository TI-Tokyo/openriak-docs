---
title: Ruby client
description: The Ruby client example uses the HTTP API through the language's HTTP library. It does not depend on
...
restructured_from:
- reference/client-libraries/ruby.md
related:
- tutorials/first-application/build-a-small-application-with-ruby
...
The Ruby client example uses the HTTP API through the language's HTTP library. It does not depend on a Riak-specific Protocol Buffers client.

## Transport and runtime

The accompanying example targets **Ruby 3.3 or newer** and uses [this HTTP client interface](https://docs.ruby-lang.org/en/master/Net/HTTP.html). Object addressing, headers, and response statuses follow the shared HTTP reference.
