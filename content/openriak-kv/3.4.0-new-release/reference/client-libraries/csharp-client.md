---
title: C# client
description: The C# client example uses the HTTP API through the language's HTTP library. It does not depend on
...
restructured_from:
- reference/client-libraries/csharp.md
related:
...
The C# client example uses the HTTP API through the language's HTTP library. It does not depend on a Riak-specific Protocol Buffers client.

## Transport and runtime

The accompanying example targets **.NET SDK 8** and uses [this HTTP client interface](https://learn.microsoft.com/en-us/dotnet/fundamentals/networking/http/httpclient). Object addressing, headers, and response statuses follow the shared HTTP reference.
