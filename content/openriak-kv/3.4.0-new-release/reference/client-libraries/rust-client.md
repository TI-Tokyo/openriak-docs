---
title: Rust client
description: The Rust client example uses the HTTP API through the language's HTTP library. It does not depend on
...
restructured_from:
- reference/client-libraries/rust.md
related:
- tutorials/first-application/build-a-small-application-with-rust
...
The Rust client example uses the HTTP API through the language's HTTP library. It does not depend on a Riak-specific Protocol Buffers client.

## Transport and runtime

The accompanying example targets **Rust with Cargo; reqwest 0.12.24** and uses [this HTTP client interface](https://docs.rs/reqwest/0.12.24/reqwest/blocking/index.html). Object addressing, headers, and response statuses follow the shared HTTP reference.
