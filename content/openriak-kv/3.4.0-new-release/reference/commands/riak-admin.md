...
[use admin commands#join]: {{< product-version-root >}}reference/commands/#join
[use admin commands#leave]: {{< product-version-root >}}reference/commands/#leave
[cluster ops backup]: {{< product-version-root >}}how-to/operate/back-up-node/
[config reference#node-metadata]: {{< product-version-root >}}reference/configuration/#node-metadata
[cluster ops change info]: {{< product-version-root >}}how-to/operate/change-cluster-information/
...
[config reference#ring]: {{< product-version-root >}}reference/configuration/#ring
[cluster ops inspect node]: {{< product-version-root >}}how-to/operate/inspect-node-and-cluster/
[use ref monitoring]: {{< product-version-root >}}reference/operations/statistics-and-monitoring/
