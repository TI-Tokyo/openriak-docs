---
title: 'AAE command reference'
description: 'List 3.4.0 command-line operations for AAE status, tree rebuilding, fold execution, and result retrieval.'
weight: 5
diataxis: 'reference'
product: 'OpenRiak KV'
...
List {{< current-version >}} command-line operations for AAE status, tree rebuilding, fold execution, and result retrieval.
