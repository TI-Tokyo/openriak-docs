...
enabled on each OpenRiak node. For more information, see our [security documentation]({{< product-version-root >}}how-to/secure/enable-security/#enabling-ssl). Once SSL is enabled, you can proceed to setting up [authentication](#authentication) for Riak Control.
