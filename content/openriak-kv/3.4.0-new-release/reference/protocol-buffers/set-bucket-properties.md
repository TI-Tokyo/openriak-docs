...
[PBC Get Bucket Properties]({{< product-version-root >}}reference/protocol-buffers/get-bucket-properties/) documentation.

You can also specify a [bucket type]({{< product-version-root >}}how-to/develop/use-bucket-types/) using the
