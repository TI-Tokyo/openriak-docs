...
older configuration system based on [bucket properties]({{< product-version-root >}}how-to/develop/use-bucket-types/).
...
[HTTP]({{< product-version-root >}}reference/http-api/set-bucket-properties/) or [Protocol Buffers]({{< product-version-root >}}reference/protocol-buffers/set-bucket-properties/). With this approach, you can take any given bucket and
...
* Nearly all bucket properties can be updated using bucket types, except the
  ...
  [Riak data types]({{< product-version-root >}}reference/data/distributed-data-types/), and [strong consistency]({{< product-version-root >}}reference/specialized-apis/strong-consistency-api/) respectively
...
way that they are configured when using [bucket properties]({{< product-version-root >}}how-to/develop/use-bucket-types/). You cannot simply take a
...
>
> If you are connecting to Riak using one of Basho's official [client libraries]({{< product-version-root >}}reference/client-libraries/), you can find more information about getting started with your client in our [Developing with OpenRiak KV: Getting Started]({{< product-version-root >}}tutorials/first-application/) section.
...
do so. New applications, however, are encouraged to retain and [resolve siblings]({{< product-version-root >}}how-to/develop/resolve-conflicts/) with the appropriate application-side business logic.
...
`user_account_bucket` with a [pre-commit hook]({{< product-version-root >}}how-to/develop/write-commit-hook/#pre-commit-hooks) called `syntax_check` and two [post-commit
hooks]({{< product-version-root >}}how-to/develop/write-commit-hook/) called `welcome_email` and `update_registry`. This would involve four steps:
...
[buckets]: {{< product-version-root >}}reference/data/buckets-and-bucket-types/
[howmany]: {{< product-version-root >}}reference/data/buckets-and-bucket-types/
[buckettypes]: #bucket-types
[howwork]: {{< product-version-root >}}reference/data/buckets-and-bucket-types/
[when]: #when-to-use-bucket-types
[createactivate]: {{< product-version-root >}}reference/data/buckets-and-bucket-types/
[namespace]: {{< product-version-root >}}reference/data/buckets-and-bucket-types/
[allowmulti]: {{< product-version-root >}}reference/data/buckets-and-bucket-types/
