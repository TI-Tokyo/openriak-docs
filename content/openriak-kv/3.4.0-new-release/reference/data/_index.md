...
- [Buckets and bucket types]({{< product-version-root >}}reference/data/buckets-and-bucket-types/) — Define the fields, limits, supported operations, representations, and compatibility rules for buckets and bucket types.
- [Content types]({{< product-version-root >}}reference/data/content-types/) — Define the fields, limits, supported operations, representations, and compatibility rules for content types.
- [Distributed data types]({{< product-version-root >}}reference/data/distributed-data-types/) — Define the fields, limits, supported operations, representations, and compatibility rules for distributed data types.
- [Keys and objects]({{< product-version-root >}}reference/data/keys-and-objects/) — Define the fields, limits, supported operations, representations, and compatibility rules for keys and objects.
- [Object metadata]({{< product-version-root >}}reference/data/object-metadata/) — Define the fields, limits, supported operations, representations, and compatibility rules for object metadata.
- [Secondary indexes]({{< product-version-root >}}reference/data/secondary-indexes/) — Define the fields, limits, supported operations, representations, and compatibility rules for secondary indexes.
- [Version vectors]({{< product-version-root >}}reference/data/version-vectors/) — Define the fields, limits, supported operations, representations, and compatibility rules for version vectors.
