...
- [Counters]({{< product-version-root >}}reference/http-api/counters/)
- [Flags]({{< product-version-root >}}reference/data/distributed-data-types/#flags)
- [GSets]({{< product-version-root >}}reference/data/distributed-data-types/)
- [Maps]({{< product-version-root >}}how-to/develop/use-maps/)
- [Registers]({{< product-version-root >}}how-to/develop/use-maps/#registers)
- [Sets]({{< product-version-root >}}reference/data/distributed-data-types/)

OpenRiak KV also has 1 context-free data type, that has similar usage but does not require contexts.

- [HyperLogLogs]({{< product-version-root >}}reference/data/distributed-data-types/) (abbreviated `hll` in many places)

Counters, sets, gsets, maps, and hyperloglogs can be used as bucket-level data types or types that you interact with directly. Flags and registers must be [embedded in maps]({{< product-version-root >}}how-to/develop/use-maps/).
...
In the example below we'll fetch the context [from a user data map created for Ahmed]({{< product-version-root >}}how-to/develop/use-maps/#create-a-map):
...
- [Maps]({{< product-version-root >}}how-to/develop/use-maps/)
- [GSets]({{< product-version-root >}}reference/data/distributed-data-types/)
- [Hyperloglogs]({{< product-version-root >}}reference/data/distributed-data-types/)
...
Support for these data types is unchanged since Riak 2.2.3, so refer to the [legacy documentation]({{<baseurl>}}openriak-kv/2.2.3/learn/concepts/crdts/index.html) for further information.
...
- There is no in-built support for querying data within data-types, the Data Type API is incompatible with the [Query API]({{< product-version-root >}}tutorials/query-api/).
