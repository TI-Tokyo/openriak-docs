...
description: Install a published OpenRiak KV package on Amazon Linux. Use a fresh node for a new deployment; use
...
restructured_from:
- how-to/install/amazon-linux.md
related:
...
{{< service-command action="stop" os="amazon-linux" >}}
...
{{< service-command action="start" os="amazon-linux" >}}
