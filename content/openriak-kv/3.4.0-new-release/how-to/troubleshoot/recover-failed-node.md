...
- [Proactive replacement]({{< product-version-root >}}how-to/operate/rolling-replacement/)
- [Reactive replacement]({{< product-version-root >}}how-to/operate/replace-node/)
- [Rolling replacement]({{< product-version-root >}}how-to/operate/rolling-replacement/)
- [Rolling restart]({{< product-version-root >}}how-to/operate/rolling-restart/)
- [Leveled backend repair]({{< product-version-root >}}how-to/operate/repair-leveled-store/)
- [Repairing a single vnode]({{< product-version-root >}}how-to/operate/repair-vnode/)
- [Repairing a key range]({{< product-version-root >}}how-to/operate/aae-fold/repair-key-range/)
