...
[upgrade checklist]: {{< product-version-root >}}how-to/operate/upgrade-cluster/
[upgrade version]: {{< product-version-root >}}how-to/operate/upgrade-cluster/
...
[cluster ops load balance]: {{< product-version-root >}}how-to/configure/load-balancing-proxy/
...
[use admin riak control]: {{< product-version-root >}}reference/commands/riak-control/
[cluster ops inspect node]: {{< product-version-root >}}how-to/operate/inspect-node-and-cluster/
[troubleshoot http]: {{< product-version-root >}}how-to/troubleshoot/http-204/
...
[production checklist]: {{< product-version-root >}}how-to/operate/upgrade-cluster/
[use admin riak control]: {{< product-version-root >}}reference/commands/riak-control/
[use admin commands]: {{< product-version-root >}}reference/commands/
[use admin riak admin]: {{< product-version-root >}}reference/commands/riak/ admin
...
[cluster ops mdc]: {{< product-version-root >}}reference/replication-api/runtime-controls/
[config v3 mdc]: {{< product-version-root >}}how-to/configure/replication/configure-v3-multi-datacenter/
[jmx monitor]: {{< product-version-root >}}reference/operations/jmx/
[snmp]: {{< product-version-root >}}reference/operations/snmp/
...
If you run [Riak Control]({{< product-version-root >}}reference/commands/riak-control/), you should disable it during the rolling upgrade process.
...
Riak upgrades are all designed to support in-place rolling upgrades across the cluster - a [rolling restart]({{< product-version-root >}}how-to/operate/rolling-restart/) with a package deployment between the stop and start.
