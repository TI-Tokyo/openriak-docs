...
In Riak versions 2.0 and later, Basho suggests that you [use bucket types]({{< product-version-root >}}how-to/develop/use-bucket-types/) to namespace and configure all buckets you use. Bucket types have a lower overhead within the cluster than the
