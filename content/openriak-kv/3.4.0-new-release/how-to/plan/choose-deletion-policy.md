...
[Clearing of old tombstones is a a semi-automated process]({{< product-version-root >}}foundations/operations/garbage-collection/), and so has some ongoing operational overheads.
