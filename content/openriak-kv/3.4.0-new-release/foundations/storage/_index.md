...
- [How Prefix Multi routing works]({{< product-version-root >}}foundations/storage/prefix-multi/) — Explain how prefix multi routing works, its constraints, and the workloads for which it is appropriate.
