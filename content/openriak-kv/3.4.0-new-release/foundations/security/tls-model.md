...
Explain the question that **TLS identities and certificate trust** answers for architects, developers, or operators using OpenRiak KV {{< current-version >}}. Establish the problem and vocabulary before describing the mechanism, and keep task instructions in linked how-to guides.
...
- [Authentication sources and trust]({{< product-version-root >}}foundations/security/authentication-sources/) — Explain authentication sources and trust and the security decisions administrators must make.
