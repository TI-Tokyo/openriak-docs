...
[repair recover fail]: {{< product-version-root >}}foundations/operations/node-failure-and-recovery/
[repair recover errors]: {{< product-version-root >}}foundations/operations/node-failure-and-recovery/
[repair recover repairs]: {{< product-version-root >}}foundations/operations/node-failure-and-recovery/
