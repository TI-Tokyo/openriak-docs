...
[glossary readrep]: {{< product-version-root >}}foundations/foundations/glossary/#read-repair
[tiered storage]: {{< product-version-root >}}foundations/storage/leveldb/#tiered-storage
...
[partitions]({{< product-version-root >}}foundations/foundations/clusters-rings-and-partitions/#the-ring). Repairs of OpenRiak KV data are typically
...
repair data will depend mainly on your use case and on whether [active anti-entropy]({{< product-version-root >}}foundations/replication/active-anti-entropy/) is enabled.

You will need to run a repair if the following are both true:

* Active anti-entropy is [disabled]({{< product-version-root >}}foundations/replication/active-anti-entropy/)
* You have both non-expiring data and keys that are not accessed
  ...
  [read repair]({{< product-version-root >}}foundations/replication/active-anti-entropy/#read-repair-vs-active-anti-entropy))

You will most likely not need to run a repair operation if _any_ of the
following is true:

* Active anti-entropy is [enabled]({{< product-version-root >}}foundations/replication/active-anti-entropy/)
