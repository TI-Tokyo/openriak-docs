...
[concept clusters ring]: {{< product-version-root >}}foundations/foundations/clusters-rings-and-partitions/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{< product-version-root >}}foundations/storage/bitcask/) as a backend, navigate
