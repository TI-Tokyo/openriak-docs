...
[learn why riak]: {{< product-version-root >}}foundations/foundations/why-openriak/
[learn use cases]: ./use-cases/
[learn new nosql]: ./new-to-nosql/
[glossary]: ./glossary/
[concepts]: {{< product-version-root >}}foundations/foundations/
...
[concept cap neg]: {{< product-version-root >}}foundations/foundations/capability-negotiation/
...
- [The ring and how data is distributed in Riak]({{< product-version-root >}}foundations/foundations/clusters-rings-and-partitions/)
- [Eventual consistency]({{< product-version-root >}}foundations/consistency/eventual-consistency/)
- [Background processes]({{< product-version-root >}}foundations/operations/)
- [Backend design]({{< product-version-root >}}foundations/storage/)
