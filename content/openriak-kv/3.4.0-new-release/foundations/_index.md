...
source_material:
  ...
  - 'live-3.2.5'
  - 'proposed-kv'
tags: ['diataxis', 'kv', 'explanation', 'foundations']
...
Explain the question that **Explanation** answers for architects, developers, or operators using OpenRiak KV {{< current-version >}}. Establish the problem and vocabulary before describing the mechanism, and keep task instructions in linked how-to guides.
...
- [Consistency concepts]({{< product-version-root >}}foundations/consistency/) — Introduce how OpenRiak balances availability, convergence, and stronger consistency guarantees.
...
- [Replication concepts]({{< product-version-root >}}foundations/replication/) — Introduce repair, convergence, and multi-cluster data movement in OpenRiak.
