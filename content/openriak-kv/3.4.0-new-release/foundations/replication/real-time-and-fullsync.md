---
title: 'Real-time and Fullsync replication'
description: 'Explain real-time and fullsync replication, its data flow, failure behavior, and operational trade-offs.'
weight: 8
...
Explain real-time and fullsync replication, its data flow, failure behavior, and operational trade-offs.
...
Enterprise versions 1.4.0 - 2.2.3 and now available to all versions post 2.2.3) can now take advantage of OpenRiak's [active anti-entropy][glossary aae] \(AAE) subsystem, which was first introduced as a
