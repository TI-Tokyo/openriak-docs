---
title: 'Learn OpenRiak security'
description: 'Introduce a guided environment for learning OpenRiak authentication, TLS, and authorization.'
weight: 1
diataxis: 'tutorial'
product: 'OpenRiak KV'
...
Introduce a guided environment for learning OpenRiak authentication, TLS, and authorization.
...
Define a realistic, disposable scenario for **Learn OpenRiak security**. List the exact OpenRiak KV {{< current-version >}} environment, client tools, permissions, sample data, and prior knowledge required, including a safe way to reset the exercise.
...
- [Secure a first client connection]({{< product-version-root >}}tutorials/security/secure-client-connection/) — Guide a newcomer through enabling security and making one authenticated TLS client request.
