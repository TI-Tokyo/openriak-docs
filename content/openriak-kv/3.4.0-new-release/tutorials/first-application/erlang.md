...
[CRUD Operations]({{< product-version-root >}}tutorials/first-application/erlang/)
...
A more comprehensive discussion can be found in [Key/Value Modeling]({{< product-version-root >}}how-to/plan/map-data-to-objects/).
