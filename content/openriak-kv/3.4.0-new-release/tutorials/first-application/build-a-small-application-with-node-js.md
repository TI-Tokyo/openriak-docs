---
title: Build a small application with Node.js
...
restructured_from:
- tutorials/first-application/nodejs.md
related:
...
- reference/client-libraries/node-js-client
...
Use the Leveled cluster from the Docker tutorial and **Node.js 22 or newer**. This exercise uses a local unauthenticated HTTP listener. Use the authentication guide before connecting this client to a secured deployment.

Save the example as `app.mjs` in a new working directory.
...
{{< learning-example file="app.mjs" language="javascript" >}}
...
The underlying [HTTP library API](https://nodejs.org/api/globals.html#fetch) documents connection, TLS, and timeout options.
