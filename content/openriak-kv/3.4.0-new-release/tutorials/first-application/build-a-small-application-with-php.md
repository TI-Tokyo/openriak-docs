---
title: Build a small application with PHP
...
restructured_from:
- tutorials/first-application/php.md
related:
...
- reference/client-libraries/php-client
...
Use the Leveled cluster from the Docker tutorial and **PHP 8.3 with URL stream wrappers enabled**. This exercise uses a local unauthenticated HTTP listener. Use the authentication guide before connecting this client to a secured deployment.

Save the example as `app.php` in a new working directory.
...
{{< learning-example file="app.php" language="php" >}}
...
The underlying [HTTP library API](https://www.php.net/manual/en/context.http.php) documents connection, TLS, and timeout options.
