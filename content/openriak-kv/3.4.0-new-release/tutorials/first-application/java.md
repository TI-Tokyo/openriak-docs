...
[CRUD Operations]({{< product-version-root >}}tutorials/first-application/java/)
...
Riak, see [Updating Objects]({{< product-version-root >}}how-to/develop/update-object/)
and [Conflict Resolution]({{< product-version-root >}}how-to/develop/resolve-conflicts/)
documentation.
