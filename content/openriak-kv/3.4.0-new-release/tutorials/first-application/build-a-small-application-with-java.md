---
title: Build a small application with Java
...
restructured_from:
- tutorials/first-application/java.md
related:
...
- reference/client-libraries/java-client
...
Use the Leveled cluster from the Docker tutorial and **JDK 17 or newer**. This exercise uses a local unauthenticated HTTP listener. Use the authentication guide before connecting this client to a secured deployment.

Save the example as `App.java` in a new working directory.
...
{{< learning-example file="App.java" language="java" >}}
...
The underlying [HTTP library API](https://docs.oracle.com/en/java/javase/17/docs/api/java.net.http/java/net/http/HttpClient.html) documents connection, TLS, and timeout options.
