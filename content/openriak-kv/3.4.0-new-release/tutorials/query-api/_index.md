...
- [Build a search index with the Query API]({{< product-version-root >}}tutorials/query-api/build-search-index/)

## In this section

- [Build a search index with the Query API]({{< product-version-root >}}tutorials/query-api/build-search-index/) — Guide a developer through designing, loading, querying, and evaluating a small Query API search index.
