---
title: 'Build a first OpenRiak cluster with Docker'
description: 'Guide a newcomer from an empty Docker environment to a working cluster and a verified read and write.'
weight: 3
diataxis: 'tutorial'
product: 'OpenRiak KV'
...
Guide a newcomer from an empty Docker environment to a working cluster and a verified read and write.
...
- [Build a first OpenRiak cluster in the cloud]({{< product-version-root >}}tutorials/first-cluster/cloud/)
- [Build a first OpenRiak cluster on Ubuntu]({{< product-version-root >}}tutorials/first-cluster/ubuntu/)
- [Build a first OpenRiak cluster with Vagrant]({{< product-version-root >}}tutorials/first-cluster/vagrant/)
