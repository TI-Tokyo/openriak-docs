...
[concept clusters ring]: {{< product-version-root >}}explanation/foundations/clusters-rings-and-partitions/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{< product-version-root >}}explanation/storage/bitcask/) as a backend, navigate
