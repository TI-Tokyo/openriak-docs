---
title: 'Next-generation replication'
description: 'Explain next-generation replication, its data flow, failure behavior, and operational trade-offs.'
weight: 6
...
Explain next-generation replication, its data flow, failure behavior, and operational trade-offs.

## Overview

### Next-Gen Replication

[concept TicTac aae]: {{< product-version-root >}}explanation/replication/tictac-aae/
