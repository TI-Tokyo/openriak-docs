...
documentation on [Bitcask][plan backend bitcask], [LevelDB][plan backend leveldb], and [multiple backends]({{< product-version-root >}}explanation/storage/multi-backend/).
...
[concept clusters]: {{< product-version-root >}}explanation/foundations/clusters-rings-and-partitions/
[concept vnodes]: {{< product-version-root >}}explanation/foundations/virtual-nodes/
[glossary node]: {{< product-version-root >}}explanation/foundations/glossary/#node
[glossary ring]: {{< product-version-root >}}explanation/foundations/glossary/#ring
[usage replication]: {{< product-version-root >}}explanation/replication/
...
- [Queues and workers]({{< product-version-root >}}explanation/replication/queues/);
- [Replication references]({{< product-version-root >}}explanation/replication/references-and-triggers/);
- [Replication triggers]({{< product-version-root >}}explanation/replication/references-and-triggers/).
...
- [Replication sink nodes]({{< product-version-root >}}explanation/replication/sink-nodes/) — Explain replication sink nodes, its data flow, failure behavior, and operational trade-offs.
