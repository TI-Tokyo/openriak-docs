...
Explain the question that **Bucket types as namespaces and policy** answers for architects, developers, or operators using OpenRiak KV 3.4.1. Establish the problem and vocabulary before describing the mechanism, and keep task instructions in linked how-to guides.
...
- [Secondary index design]({{< product-version-root >}}explanation/data-model/secondary-indexes/) — Explain secondary index design, its trade-offs, and its effect on application design.
