...
description: 'List OpenRiak statistics, including 3.4.1 virtual machine measurements, endpoints, units, limits, and interpretation guidance.'
weight: 10
diataxis: 'reference'
product: 'OpenRiak KV'
...
are made available through the HTTP API via the [`/stats`]({{< product-version-root >}}reference/http-api/status/) endpoint, or through the [`riak admin`]({{< product-version-root >}}reference/commands/riak-admin/) interface, in particular the `stat` and `status` commands.
...
Riak statistics provided in the [Inspecting a Node]({{< product-version-root >}}how-to/operate/inspect-node-and-cluster/) and [HTTP Status]({{< product-version-root >}}reference/http-api/status/) documentation.
...
documentation on [system tuning]({{< product-version-root >}}how-to/tune/#storage-and-file-system-tuning).
...
If graphing all of the [available Riak metrics]({{< product-version-root >}}how-to/operate/inspect-node-and-cluster/) is
...
The [`riak admin`]({{< product-version-root >}}reference/commands/riak-admin/) tool provides two
...
[Inspecting a Node]({{< product-version-root >}}how-to/operate/inspect-node-and-cluster/#riak admin-status) document.
...
in the [Inspecting a Node]({{< product-version-root >}}reference/commands/riak-admin/#stat) document.
...
[Riak Control]({{< product-version-root >}}reference/commands/riak-control/) is Basho's REST-driven user-interface for managing Riak
...
the Riak HTTP [`/stats`]({{< product-version-root >}}reference/http-api/status/) endpoint is also available.
...
A [Riak New Relic Agent][riak_new_relic] for collecting statistics from the Riak HTTP [`/stats`]({{< product-version-root >}}reference/http-api/status/) endpoint is also available.
...
[`/stats`]({{< product-version-root >}}reference/http-api/status/) endpoint.
...
* [Inspecting a Node]({{< product-version-root >}}how-to/operate/inspect-node-and-cluster/)
* [Riaknostic](http://riaknostic.basho.com)
* [Riak Control]({{< product-version-root >}}reference/commands/riak-control/)
...
[data_types_counters]: {{< product-version-root >}}how-to/develop/use-counters/
[data_types_sets]: {{< product-version-root >}}how-to/develop/use-sets/
[data_types_maps]: {{< product-version-root >}}how-to/develop/use-maps/
