---
title: 'AAE fold filters'
description: 'Document parameters, filters, response fields, limits, and risks for the aae fold filters.'
weight: 5
diataxis: 'reference'
product: 'OpenRiak KV'
...
Document parameters, filters, response fields, limits, and risks for the aae fold filters.
...
[tictacaae client]: {{< product-version-root >}}reference/#the-riak-client
[tictacaae find-keys]: {{< product-version-root >}}reference/
...
[filter-by sibling-count]: {{< product-version-root >}}reference//#the-sibling-count-filter
[filter-by object-size]: {{< product-version-root >}}reference//#the-object-size-filter
...
**Note:**
How to get the value for `Client` is detailed in [The Riak Client]({{< product-version-root >}}reference/#the-riak-client).
