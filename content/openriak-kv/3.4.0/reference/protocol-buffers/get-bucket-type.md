...
Gets the bucket properties associated with a [bucket type]({{< product-version-root >}}how-to/operate/manage-bucket-types/).
...
[`RpbBucketProps`]({{< product-version-root >}}reference/protocol-buffers/get-bucket-properties/) message.
