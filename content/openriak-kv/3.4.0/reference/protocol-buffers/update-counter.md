...
An operation to update a [counter]({{< product-version-root >}}reference/data/distributed-data-types/).
...
stored on their own in a key or [within a map]({{< product-version-root >}}reference/protocol-buffers/update-map/).
