---
title: 'Delete an object with Protocol Buffers'
...
Delete an object in the specified [bucket type]({{< product-version-root >}}how-to/operate/manage-bucket-types/)/bucket/key location.
