...
[pre/post-commit hooks]({{< product-version-root >}}how-to/develop/write-commit-hook/), and MapReduce operations. This
doc contains installation steps with simple examples for each use case.

Your developers can compile [custom erlang code]({{< product-version-root >}}how-to/develop/write-commit-hook/), which
...
in the [Commands documentation]({{< product-version-root >}}reference/commands/riak-admin/#wait-for-service).
