...
Protocol | Port
:--------|:----
<a href="{{< product-version-root >}}reference/http-api/">HTTP</a> | TCP port 8098
<a href="{{< product-version-root >}}reference/protocol-buffers/">Protocol Buffers</a> | TCP port 8087
...
- [Apply security best practices]({{< product-version-root >}}how-to/secure/best-practices/) — Show operators how to apply security hardening practices to an OpenRiak deployment.
- [Configure TLS certificates and ciphers]({{< product-version-root >}}how-to/secure/configure-tls/) — Show security engineers how to configure tls certificates and ciphers and test the resulting controls.
- [Enable OpenRiak security]({{< product-version-root >}}how-to/secure/enable-security/) — Show security engineers how to enable openriak security and test the resulting controls.
- [Manage groups]({{< product-version-root >}}how-to/secure/manage-groups/) — Show security engineers how to manage groups and test the resulting controls.
- [Grant and revoke permissions]({{< product-version-root >}}how-to/secure/manage-permissions/) — Show security engineers how to grant and revoke permissions and test the resulting controls.
- [Manage authentication sources]({{< product-version-root >}}how-to/secure/manage-sources/) — Show security engineers how to manage authentication sources and test the resulting controls.
- [Manage users]({{< product-version-root >}}how-to/secure/manage-users/) — Show security engineers how to manage users and test the resulting controls.
- [Harden OpenRiak network access]({{< product-version-root >}}how-to/secure/secure-networking/) — Show security engineers how to harden openriak network access and test the resulting controls.
