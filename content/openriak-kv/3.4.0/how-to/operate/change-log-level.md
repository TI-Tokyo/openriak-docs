...
by accessing the Erlang console directly using the [`riak attach`]({{< product-version-root >}}reference/commands/riak/#attach) command. Once you run this command and drop into the console, enter the following:
