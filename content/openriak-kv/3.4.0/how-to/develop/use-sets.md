---
title: 'Use distributed sets'
description: 'Show developers how to use distributed sets with a minimal verified example.'
weight: 16
diataxis: 'how-to'
product: 'OpenRiak KV'
...
Show developers how to use distributed sets with a minimal verified example.
...
Sets are a bucket-level Riak data type that can be used by themselves, associated with a bucket/key pair, or used [within a map]({{< product-version-root >}}how-to/develop/use-maps/#sets-within-maps).
...
```javascript
// As with counters, with the OpenRiak node.js Client you interact with sets on the
