---
title: 'Use distributed counters'
description: 'Show developers how to use distributed counters with a minimal verified example.'
weight: 12
diataxis: 'how-to'
product: 'OpenRiak KV'
...
Show developers how to use distributed counters with a minimal verified example.
...
Counters are a bucket-level Riak data type that can be used by themselves, associated with a bucket/key pair, or used [within a map]({{< product-version-root >}}how-to/develop/use-maps/#counters-within-maps). A counter's value can only be a positive integer, negative integer, or zero.
