---
title: 'Configure current multi-datacenter replication'
description: 'Show operators how to configure current multi-datacenter replication and validate data movement.'
weight: 10
diataxis: 'how-to'
product: 'OpenRiak KV'
...
Show operators how to configure current multi-datacenter replication and validate data movement.
...
[config v3 ssl#verify-peer]: {{< product-version-root >}}how-to/configure/replication/secure-replication/#verifying-peer-certificates
...
If you are using OpenRiak KV version 2.0, configuration is managed
...
OpenRiak KV version 2.2.0 changed the values of the default bucket properties hash.  This will cause an issue replicating between OpenRiak KV clusters with versions 2.2.0 or greater and OpenRiak KV clusters with versions less than 2.2.0.

To replicate between OpenRiak KV versions 2.2.0 or greater and OpenRiak KV clusters less than version 2.2.0, add the necessary override in the advanced.config file:
...
If all of the Replication clusters are running OpenRiak KV 2.2.0 or greater, this override is no longer necessary and should be removed.
