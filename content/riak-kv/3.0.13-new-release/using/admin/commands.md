...
aliases:
  ...
  - /openriak-kv/3.0.13/ops/running/cluster-admin
...
[use admin riak admin#cluster-plan]: {{<baseurl>}}openriak-kv/3.0.13/using/admin/riak-admin/#cluster-plan
[use admin riak admin#cluster-commit]: {{<baseurl>}}openriak-kv/3.0.13/using/admin/riak-admin/#cluster-commit
