...
aliases:
  ...
  - /openriak-kv/3.0.13/dev/advanced/write-once
linkTitle: "Write Once"
weight: 102
---

[glossary vnode]: {{<baseurl>}}openriak-kv/3.0.13/learn/glossary/#vnode
[bucket type]: {{<baseurl>}}openriak-kv/3.0.13/developing/usage/bucket-types
[Riak data types]: {{<baseurl>}}openriak-kv/3.0.13/developing/data-types
[strong consistency]: {{<baseurl>}}openriak-kv/3.0.13/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}openriak-kv/3.0.13/setup/planning/backend/multi) backend does not
