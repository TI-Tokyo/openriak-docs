...
toc: true
aliases:
  - /riak/3.0.13/dev/taste-of-riak/python
  - /openriak-kv/3.0.13/dev/taste-of-riak/python
linkTitle: "Python"
weight: 102
---
...
[CRUD Operations]({{<baseurl>}}openriak-kv/3.0.13/developing/getting-started/python/crud-operations)
