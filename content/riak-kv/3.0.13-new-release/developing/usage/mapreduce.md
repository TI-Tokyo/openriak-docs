...
toc: true
aliases:
  - /riak/3.0.13/dev/using/mapreduce
  - /openriak-kv/3.0.13/dev/using/mapreduce
linkTitle: "Using MapReduce"
weight: 106
---

[usage 2i]: {{<baseurl>}}openriak-kv/3.0.13/developing/usage/secondary-indexes
[usage types]: {{<baseurl>}}openriak-kv/3.0.13/developing/usage/bucket-types
[api http]: {{<baseurl>}}openriak-kv/3.0.13/developing/api/http
[api pb]: {{<baseurl>}}openriak-kv/3.0.13/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}openriak-kv/3.0.13/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}openriak-kv/3.0.13/developing/app-guide/advanced-mapreduce
