...
toc: true
aliases:
  - /riak/3.0.13/dev/using/conflict-resolution/csharp
  - /openriak-kv/3.0.13/dev/using/conflict-resolution/csharp
linkTitle: "C Sharp"
weight: 103
---

For reasons explained in the [Introduction to conflict resolution]({{<baseurl>}}openriak-kv/3.0.13/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that requires applications to resolve siblings according to use-case-specific
