...
toc: true
aliases:
  - /riak/3.0.13/ops/building/planning/cluster
  - /openriak-kv/3.0.13/ops/building/planning/cluster
...
[use admin riak admin#cluster]: {{<baseurl>}}openriak-kv/3.0.13/using/admin/riak-admin/#cluster
