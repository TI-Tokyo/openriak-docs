...
version_history:
  in: "2.0.0-2.99.999"
aliases:
  - /riak/3.0.13/ops/upgrading/rolling-upgrades/
...
If you run [Riak Control]({{<baseurl>}}openriak-kv/3.0.13/using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
