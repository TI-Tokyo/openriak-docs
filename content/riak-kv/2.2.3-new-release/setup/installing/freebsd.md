...
toc: true
aliases:
  - /riak/2.2.3/ops/building/installing/Installing-on-FreeBSD
  - /openriak-kv/2.2.3/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.2.3/installing/freebsd/
  - /openriak-kv/2.2.3/installing/freebsd/
linkTitle: "FreeBSD"
weight: 303
---
...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.2/2.2.3/freebsd/10/riak-2.2.3.txz
```
