...
aliases:
  ...
  - /openriak-kv/2.2.3/ops/building/installing/Installing-on-Mac-OS-X
  - /riak/2.2.3/installing/mac-osx/
  - /openriak-kv/2.2.3/installing/mac-osx/
linkTitle: "Mac OS X"
weight: 303
---
...
```bash
curl -O https://files.tiot.jp/riak/kv/2.2/2.2.3/osx/10.8/riak-2.2.3-OSX-x86_64.tar.gz
