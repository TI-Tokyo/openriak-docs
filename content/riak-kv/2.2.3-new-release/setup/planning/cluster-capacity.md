...
toc: true
aliases:
  - /riak/2.2.3/ops/building/planning/cluster
  - /openriak-kv/2.2.3/ops/building/planning/cluster
...
[use admin riak-admin#cluster]: {{<baseurl>}}openriak-kv/2.2.3/using/admin/riak-admin/#cluster
