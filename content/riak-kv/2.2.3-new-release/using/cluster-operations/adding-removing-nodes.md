...
toc: true
aliases:
  - /riak/2.2.3/ops/running/nodes/adding-removing
  - /openriak-kv/2.2.3/ops/running/nodes/adding-removing
...
simply the script [`riak`]({{<baseurl>}}openriak-kv/2.2.3/using/admin/riak-cli/):
