...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}openriak-kv/2.2.3/using/reference/v3-multi-datacenter/) instead.
{{% /note %}}
