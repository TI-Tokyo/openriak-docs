...
toc: true
aliases:
  - /riak/2.2.3/ops/building/benchmarking
  - /openriak-kv/2.2.3/ops/building/benchmarking
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}openriak-kv/2.2.3/setup/installing/source/erlang) for instructions
