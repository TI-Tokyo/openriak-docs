...
aliases:
  - /riak/2.2.3/ops/mdc/v2/nat
  - /openriak-kv/2.2.3/ops/mdc/v2/nat
linkTitle: "With NAT"
weight: 101
---
...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}openriak-kv/2.2.3/configuring/v3-multi-datacenter/nat/) instead.
{{% /note %}}
