...
Riak, see [Updating Objects]({{<baseurl>}}openriak-kv/2.2.3/developing/usage/updating-objects/)
and [Conflict Resolution]({{<baseurl>}}openriak-kv/2.2.3/developing/usage/conflict-resolution/)
documentation.
