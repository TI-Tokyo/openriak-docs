...
aliases:
  - /riak/2.2.3/dev/using/search
  - /openriak-kv/2.2.3/dev/using/search
linkTitle: "Searching"
weight: 105
---
...
will depend on your [configuration]({{<baseurl>}}openriak-kv/2.2.3/configuring/reference#client-interfaces).
...
>
> If you are connecting to Riak using one of Basho's official [client libraries]({{<baseurl>}}openriak-kv/2.2.3/developing/client-libraries), you can find more information about getting started with your client in the [Developing with Riak KV: Getting Started]({{<baseurl>}}openriak-kv/2.2.3/developing/getting-started) section.
...
[Security]({{<baseurl>}}openriak-kv/2.2.3/using/security/) is a new feature as of
...
indexing process. You can even create your own [custom extractors]({{<baseurl>}}openriak-kv/2.2.3/developing/usage/custom-extractors).
...
* [Riak Data Types]({{<baseurl>}}openriak-kv/2.2.3/developing/data-types/)
  * counter (`application/riak_counter`)
  * map (`application/riak_map`)
  * set (`application/riak_set`)
* noop (unknown content type)

More on Riak Data Types can be found in [Riak Data Types and Search]({{<baseurl>}}openriak-kv/2.2.3/developing/usage/searching-data-types).
...
one of the default types. A full tutorial can be found in [Custom Search Extractors]({{<baseurl>}}openriak-kv/2.2.3/developing/usage/custom-extractors).
...
[MapReduce]({{<baseurl>}}openriak-kv/2.2.3/developing/usage/mapreduce/) jobs. This is a useful cross-section for
