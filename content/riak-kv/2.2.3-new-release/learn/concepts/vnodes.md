...
toc: true
aliases:
  - /riak/2.2.3/theory/concepts/vnodes
  - /openriak-kv/2.2.3/theory/concepts/vnodes
linkTitle: "Vnodes"
weight: 109
---

[concept causal context]: {{<baseurl>}}openriak-kv/2.2.3/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}openriak-kv/2.2.3/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}openriak-kv/2.2.3/setup/planning/backend/bitcask) as a backend, navigate
