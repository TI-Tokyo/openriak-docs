...
aliases:
  ...
  - /openriak-kv/2.2.3/intro-v20
  - /riak/2.2.3/intro-v20
  - /openriak-kv/2.2.3/introduction
...
Please see the KV 2.2.2 release notes [here]({{<baseurl>}}openriak-kv/2.2.2/release-notes/), and the KV 2.2.1 release notes [here]({{<baseurl>}}openriak-kv/2.2.1/release-notes/).
