...
toc: true
aliases:
  - /riak/3.0.6/ops/building/benchmarking
  - /openriak-kv/3.0.6/ops/building/benchmarking
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}openriak-kv/3.0.6/setup/installing/source/erlang) for instructions
