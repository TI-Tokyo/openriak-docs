...
toc: true
aliases:
  - /riak/3.0.6/theory/concepts/Replication
  - /openriak-kv/3.0.6/theory/concepts/Replication
  - /riak/3.0.6/theory/concepts/replication
  - /openriak-kv/3.0.6/theory/concepts/replication
...
[glossary node]: {{<baseurl>}}openriak-kv/3.0.6/learn/glossary/#node
...
bucket's [bucket type]({{<baseurl>}}openriak-kv/3.0.6/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}openriak-kv/3.0.6/configuring/planning/v3-multi-datacenter) capabilities.
...
type]({{<baseurl>}}openriak-kv/3.0.6/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}openriak-kv/3.0.6/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}openriak-kv/3.0.6/developing/usage/mapreduce/) queries. Lowering an object or bucket's
