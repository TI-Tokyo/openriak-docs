...
[upgrade]: {{<baseurl>}}openriak-kv/3.2.5/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}openriak-kv/3.2.5/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}openriak-kv/3.2.5/using/cluster-operations/adding-removing-nodes
