...
toc: true
aliases:
  - /riak/3.2.5/ops/running/nodes/adding-removing
  - /openriak-kv/3.2.5/ops/running/nodes/adding-removing
...
simply the script [`riak`]({{<baseurl>}}openriak-kv/3.2.5/using/admin/riak-cli/):
