...
toc: true
aliases:
  - /riak/3.2.5/ops/building/benchmarking
  - /openriak-kv/3.2.5/ops/building/benchmarking
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}openriak-kv/3.2.5/setup/installing/source/erlang) for instructions
