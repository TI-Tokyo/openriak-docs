...
toc: true
aliases:
  - /riak/3.2.5/ops/advanced/install-custom-code/
  - /openriak-kv/3.2.5/ops/advanced/install-custom-code/
linkTitle: "Installing Custom Code"
weight: 111
---

Riak supports the use of Erlang named functions in compiled modules for
[pre/post-commit hooks]({{<baseurl>}}openriak-kv/3.2.5/developing/usage/commit-hooks), and MapReduce operations. This
doc contains installation steps with simple examples for each use case.

Your developers can compile [custom erlang code]({{<baseurl>}}openriak-kv/3.2.5/developing/usage/commit-hooks), which
...
in the [Commands documentation]({{<baseurl>}}openriak-kv/3.2.5/using/admin/riak-admin/#wait-for-service).
