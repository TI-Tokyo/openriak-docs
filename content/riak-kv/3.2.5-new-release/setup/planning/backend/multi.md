...
toc: true
aliases:
  - /riak/3.2.5/ops/advanced/backends/multi/
  - /openriak-kv/3.2.5/ops/advanced/backends/multi/
...
[use admin riak admin cli]: {{<baseurl>}}openriak-kv/3.2.5/using/admin/riak admin
