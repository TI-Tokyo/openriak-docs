...
aliases:
  ...
  - /openriak-kv/3.2.5/ops/upgrading/rolling-upgrades/
linkTitle: "Upgrading a Cluster"
weight: 102
---

[production checklist]: {{<baseurl>}}openriak-kv/3.2.5/setup/upgrading/checklist
...
[jmx monitor]: {{<baseurl>}}openriak-kv/3.2.5/using/reference/jmx
[snmp]: {{<baseurl>}}openriak-kv/3.2.5/using/reference/snmp
...
If you run [Riak Control]({{<baseurl>}}openriak-kv/3.2.5/using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
