...
toc: true
aliases:
  - /riak/3.2.5/ops/upgrading/rolling-downgrades/
  - /openriak-kv/3.2.5/ops/upgrading/rolling-downgrades/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/3.2.5/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/3.2.5/using/admin/riak-admin/#aae-status
