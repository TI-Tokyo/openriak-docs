...
aliases:
  ...
  - /openriak-kv/3.2.5/dev/advanced/write-once
...
[Riak data types]: {{<baseurl>}}openriak-kv/3.2.5/developing/data-types
[strong consistency]: {{<baseurl>}}openriak-kv/3.2.5/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}openriak-kv/3.2.5/setup/planning/backend/multi) backend does not
