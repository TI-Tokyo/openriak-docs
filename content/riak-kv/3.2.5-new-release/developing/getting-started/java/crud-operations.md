...
Riak, see [Updating Objects]({{<baseurl>}}openriak-kv/3.2.5/developing/usage/updating-objects/)
and [Conflict Resolution]({{<baseurl>}}openriak-kv/3.2.5/developing/usage/conflict-resolution/)
documentation.
