...
aliases:
  ...
  - /openriak-kv/3.2.5/dev/references/http/fetch-object
...
object ([default is defined by the bucket]({{<baseurl>}}openriak-kv/3.2.5/developing/api/http/set-bucket-props))
* `pr` - how many primary replicas need to be online when doing the read
([default is defined by the bucket]({{<baseurl>}}openriak-kv/3.2.5/developing/api/http/set-bucket-props))
...
purposes of R ([default is defined by the bucket]({{<baseurl>}}openriak-kv/3.2.5/developing/api/http/set-bucket-props))
...
datetime format
* `Link` - user- and system-defined links to other resources. [Read more about Links.]({{<baseurl>}}openriak-kv/3.2.5/learn/glossary/#links)
