...
[upgrade]: {{<baseurl>}}openriak-kv/2.2.2/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}openriak-kv/2.2.2/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}openriak-kv/2.2.2/using/cluster-operations/adding-removing-nodes
