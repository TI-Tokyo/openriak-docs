...
toc: true
aliases:
  - /riak/2.2.2/dev/using/mapreduce
  - /openriak-kv/2.2.2/dev/using/mapreduce
...
[usage types]: {{<baseurl>}}openriak-kv/2.2.2/developing/usage/bucket-types
[api http]: {{<baseurl>}}openriak-kv/2.2.2/developing/api/http
[api pb]: {{<baseurl>}}openriak-kv/2.2.2/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}openriak-kv/2.2.2/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}openriak-kv/2.2.2/developing/app-guide/advanced-mapreduce
