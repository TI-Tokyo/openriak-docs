...
toc: true
aliases:
  - /riak/2.2.2/dev/references/protocol-buffers/get-client-id
  - /openriak-kv/2.2.2/dev/references/protocol-buffers/get-client-id
...
connected and can be changed using [Set Client ID]({{<baseurl>}}openriak-kv/2.2.2/developing/api/protocol-buffers/set-client-id).
