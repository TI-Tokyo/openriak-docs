...
toc: true
aliases:
  - /riak/2.2.2/dev/taste-of-riak/ruby
  - /openriak-kv/2.2.2/dev/taste-of-riak/ruby
linkTitle: "Ruby"
weight: 101
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}openriak-kv/2.2.2/using/running-a-cluster) first. To try this flavor
...
[CRUD Operations]({{<baseurl>}}openriak-kv/2.2.2/developing/getting-started/ruby/crud-operations)
