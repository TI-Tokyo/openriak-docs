...
toc: true
aliases:
  - /riak/2.2.2/ops/building/installing/Installing-on-FreeBSD
  - /openriak-kv/2.2.2/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.2.2/installing/freebsd/
  - /openriak-kv/2.2.2/installing/freebsd/
linkTitle: "FreeBSD"
weight: 303
---
...
`pkg_add` remote option. For this example, we're installing `riak-2.2.2-FreeBSD-amd64.tbz`.

```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.2/2.2.2/freebsd/10/riak-2.2.2.txz
```
...
```
Package dependency openssl-1.0.0_7 for /tmp/riak-2.2.2-FreeBSD-amd64.tbz not found!
```
