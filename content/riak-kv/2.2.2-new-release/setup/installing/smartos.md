...
toc: true
aliases:
  - /riak/2.2.2/ops/building/installing/Installing-on-SmartOS
  - /openriak-kv/2.2.2/ops/building/installing/Installing-on-SmartOS
  - /riak/2.2.2/installing/smartos/
  - /openriak-kv/2.2.2/installing/smartos/
linkTitle: "SmartOS"
weight: 305
---
...
{{% note title="SmartOS End of Life (EOL) for Riak KV 2.2.2" %}}
SmartOS is no longer supported in Riak KV 2.2.2+. If you are interested in using Riak KV on SmartOS, you can still [build from source](../source).
{{% /note %}}
