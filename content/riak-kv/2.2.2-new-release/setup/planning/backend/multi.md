...
toc: true
aliases:
  - /riak/2.2.2/ops/advanced/backends/multi/
  - /openriak-kv/2.2.2/ops/advanced/backends/multi/
...
[use admin riak-admin cli]: {{<baseurl>}}openriak-kv/2.2.2/using/admin/riak-admin
