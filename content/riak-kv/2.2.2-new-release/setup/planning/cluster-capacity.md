...
toc: true
aliases:
  - /riak/2.2.2/ops/building/planning/cluster
  - /openriak-kv/2.2.2/ops/building/planning/cluster
...
[use admin riak-admin#cluster]: {{<baseurl>}}openriak-kv/2.2.2/using/admin/riak-admin/#cluster
