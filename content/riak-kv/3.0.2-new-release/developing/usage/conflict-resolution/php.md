...
aliases:
  ...
  - /openriak-kv/3.0.2/dev/using/conflict-resolution/php
linkTitle: "PHP"
weight: 105
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/3.0.2/developing/usage) section.
