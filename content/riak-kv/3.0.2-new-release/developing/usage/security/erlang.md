...
toc: true
aliases:
  - /riak/3.0.2/dev/advanced/client-security/erlang
  - /openriak-kv/3.0.2/dev/advanced/client-security/erlang
linkTitle: "Erlang"
weight: 103
---
...
If you are using [trust]({{<baseurl>}}openriak-kv/3.0.2/using/security/managing-sources/), [PAM-]({{<baseurl>}}openriak-kv/3.0.2/using/security/managing-sources/#pam-based-authentication), you can use the security setup described [below](#erlang-client-basics). [Password]({{<baseurl>}}openriak-kv/3.0.2/using/security/managing-sources/#password-based-authentication)-based authentication is covered
...
on specifying trusted CIDRs can be found in [Trust-based Authentication]({{<baseurl>}}openriak-kv/3.0.2/using/security/managing-sources/#trust-based-authentication).
