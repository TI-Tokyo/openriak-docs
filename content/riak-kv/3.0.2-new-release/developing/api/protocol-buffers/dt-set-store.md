...
toc: true
aliases:
  - /riak/3.0.2/dev/references/protocol-buffers/dt-set-store
  - /openriak-kv/3.0.2/dev/references/protocol-buffers/dt-set-store
linkTitle: "Data Type Set Store"
weight: 118
---

An operation to update a set, either on its own (at the bucket/key
level) or [inside of a map]({{<baseurl>}}openriak-kv/3.0.2/developing/api/protocol-buffers/dt-map-store).
