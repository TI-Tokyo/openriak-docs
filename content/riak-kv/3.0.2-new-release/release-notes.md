...
aliases:
  ...
  - /openriak-kv/3.0.2/intro-v20
  - /riak/3.0.2/intro-v20
  - /openriak-kv/3.0.2/introduction
...
Please see the KV 3.0.1 release notes [here]({{<baseurl>}}openriak-kv/3.0.1/release-notes/) and the KV 2.9.7 release notes [here]({{<baseurl>}}openriak-kv/2.9.7/release-notes/).
