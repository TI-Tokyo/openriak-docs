...
toc: true
aliases:
  - /riak/3.0.2/ops/running/tools/riak-admin
  - /openriak-kv/3.0.2/ops/running/tools/riak-admin
...
[use admin commands#join]: {{<baseurl>}}openriak-kv/3.0.2/using/admin/commands/#join
[use admin commands#leave]: {{<baseurl>}}openriak-kv/3.0.2/using/admin/commands/#leave
[cluster ops backup]: {{<baseurl>}}openriak-kv/3.0.2/using/cluster-operations/backing-up
[config reference#node-metadata]: {{<baseurl>}}openriak-kv/3.0.2/configuring/reference/#node-metadata
...
[config reference#ring]: {{<baseurl>}}openriak-kv/3.0.2/configuring/reference/#ring
...
[downgrade]: {{<baseurl>}}openriak-kv/3.0.2/setup/downgrade
...
[use admin riak-admin#stats]: {{<baseurl>}}openriak-kv/3.0.2/using/admin/riak-admin/#stats
