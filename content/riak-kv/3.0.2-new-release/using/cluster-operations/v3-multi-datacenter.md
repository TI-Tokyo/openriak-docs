...
aliases:
  - /riak/3.0.2/ops/mdc/v3/operations
  - /openriak-kv/3.0.2/ops/mdc/v3/operations
...
[ref v3 stats]: {{<baseurl>}}openriak-kv/3.0.2/using/reference/multi-datacenter/statistics
