...
aliases:
  ...
  - /openriak-kv/3.0.2/ops/advanced/backends/leveled/
linkTitle: "Leveled"
weight: 101
---
...
[config reference#aae]: {{<baseurl>}}openriak-kv/3.0.2/configuring/reference/#active-anti-entropy
...
Leveled is included with Riak KV 2.9.8 and beyond, so there is no need to install anything further.
