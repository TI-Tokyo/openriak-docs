...
toc: true
aliases:
  - /riak/3.0.2/ops/upgrading/rolling-downgrades/
  - /openriak-kv/3.0.2/ops/upgrading/rolling-downgrades/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/3.0.2/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/3.0.2/using/admin/riak-admin/#aae-status
...
If you enabled LZ4 compression in LevelDB and/or enabled global expiration in LevelDB when you installed KV 3.0.2, you cannot downgrade.
...
### Stop Riak KV and remove Riak temporary data
...
Once riak-admin aae-status show values in the **All** column, the node will have successfully rebuilt all of the indexed data.
