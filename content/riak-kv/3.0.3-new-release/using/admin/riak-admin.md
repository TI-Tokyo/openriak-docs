...
toc: true
aliases:
  - /riak/3.0.3/ops/running/tools/riak admin
  - /openriak-kv/3.0.3/ops/running/tools/riak admin
...
[use admin commands#join]: {{<baseurl>}}openriak-kv/3.0.3/using/admin/commands/#join
[use admin commands#leave]: {{<baseurl>}}openriak-kv/3.0.3/using/admin/commands/#leave
[cluster ops backup]: {{<baseurl>}}openriak-kv/3.0.3/using/cluster-operations/backing-up
[config reference#node-metadata]: {{<baseurl>}}openriak-kv/3.0.3/configuring/reference/#node-metadata
...
[config reference#ring]: {{<baseurl>}}openriak-kv/3.0.3/configuring/reference/#ring
...
[downgrade]: {{<baseurl>}}openriak-kv/3.0.3/setup/downgrade
...
[use admin riak admin#stats]: {{<baseurl>}}openriak-kv/3.0.3/using/admin/riak-admin/#stats
