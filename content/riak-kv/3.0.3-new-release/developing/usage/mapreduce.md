...
toc: true
aliases:
  - /riak/3.0.3/dev/using/mapreduce
  - /openriak-kv/3.0.3/dev/using/mapreduce
linkTitle: "Using MapReduce"
weight: 106
---

[usage 2i]: {{<baseurl>}}openriak-kv/3.0.3/developing/usage/secondary-indexes
[usage search]: {{<baseurl>}}openriak-kv/3.0.3/developing/usage/search
[usage types]: {{<baseurl>}}openriak-kv/3.0.3/developing/usage/bucket-types
[api http]: {{<baseurl>}}openriak-kv/3.0.3/developing/api/http
[api pb]: {{<baseurl>}}openriak-kv/3.0.3/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}openriak-kv/3.0.3/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}openriak-kv/3.0.3/developing/app-guide/advanced-mapreduce
...
* When you want to return actual objects or pieces of objects and not
  ...
  non-key-based queries, but it only returns lists of keys and not
  whole objects.
