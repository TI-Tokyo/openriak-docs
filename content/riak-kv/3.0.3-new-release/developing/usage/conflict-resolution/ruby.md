...
toc: true
aliases:
  - /riak/3.0.3/dev/using/conflict-resolution/ruby
  - /openriak-kv/3.0.3/dev/using/conflict-resolution/ruby
linkTitle: "Ruby"
weight: 101
---
...
the official Ruby client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/3.0.3/developing/usage) section.
