...
toc: true
aliases:
  - /riak/3.0.3/dev/using/conflict-resolution/php
  - /openriak-kv/3.0.3/dev/using/conflict-resolution/php
linkTitle: "PHP"
weight: 105
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/3.0.3/developing/usage) section.
