...
aliases:
  ...
  - /openriak-kv/3.0.4/ops/upgrading/rolling-downgrades/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/3.0.4/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/3.0.4/using/admin/riak-admin/#aae-status
