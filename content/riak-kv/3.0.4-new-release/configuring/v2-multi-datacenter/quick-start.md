...
aliases:
  - /riak/3.0.4/ops/mdc/v2/quick-start
  - /openriak-kv/3.0.4/ops/mdc/v2/quick-start
linkTitle: "Quickstart"
weight: 100
---

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}openriak-kv/3.0.4/configuring/v3-multi-datacenter/quick-start/) instead.
{{% /note %}}
