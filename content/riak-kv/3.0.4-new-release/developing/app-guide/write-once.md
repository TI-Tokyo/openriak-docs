...
version_history:
  in: "2.1.0+"
aliases:
  - /riak/3.0.4/dev/advanced/write-once
  - /openriak-kv/3.0.4/dev/advanced/write-once
...
[Riak data types]: {{<baseurl>}}openriak-kv/3.0.4/developing/data-types
[strong consistency]: {{<baseurl>}}openriak-kv/3.0.4/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}openriak-kv/3.0.4/setup/planning/backend/multi) backend does not
