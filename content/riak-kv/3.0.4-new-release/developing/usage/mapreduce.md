...
toc: true
aliases:
  - /riak/3.0.4/dev/using/mapreduce
  - /openriak-kv/3.0.4/dev/using/mapreduce
linkTitle: "Using MapReduce"
weight: 106
---

[usage 2i]: {{<baseurl>}}openriak-kv/3.0.4/developing/usage/secondary-indexes
[usage types]: {{<baseurl>}}openriak-kv/3.0.4/developing/usage/bucket-types
[api http]: {{<baseurl>}}openriak-kv/3.0.4/developing/api/http
[api pb]: {{<baseurl>}}openriak-kv/3.0.4/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}openriak-kv/3.0.4/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}openriak-kv/3.0.4/developing/app-guide/advanced-mapreduce
...
* When you want to return actual objects or pieces of objects and not
  ...
  non-key-based queries, but it only return lists of keys and not
  whole objects.
