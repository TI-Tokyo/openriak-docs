...
<a href="{{<baseurl>}}openriak-kv/3.0.4/using/reference/strong-consistency/">strongly
...
<a href="{{<baseurl>}}openriak-kv/3.0.4/developing/app-guide/strong-consistency/">Using
...
documentation on [Bitcask][plan backend bitcask], [LevelDB][plan backend leveldb], and [multiple backends]({{<baseurl>}}openriak-kv/3.0.4/setup/planning/backend/multi).
...
refer to the tutorial on [basic key/value operations in Riak KV]({{<baseurl>}}openriak-kv/3.0.4/developing/getting-started)
