...
toc: true
aliases:
  - /riak/2.0.1/dev/taste-of-riak/python
  - /openriak-kv/2.0.1/dev/taste-of-riak/python
linkTitle: "Python"
weight: 102
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}openriak-kv/2.0.1/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}openriak-kv/2.0.1/developing/getting-started/python/crud-operations)
