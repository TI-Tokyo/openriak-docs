...
toc: true
aliases:
  - /riak/3.2.0/ops/running/cluster-admin
  - /openriak-kv/3.2.0/ops/running/cluster-admin
linkTitle: "Cluster Admin Commands"
weight: 100
---

[use admin riak admin#cluster]: {{<baseurl>}}openriak-kv/3.2.0/using/admin/riak-admin/#cluster
...
[use admin riak admin#cluster-plan]: {{<baseurl>}}openriak-kv/3.2.0/using/admin/riak-admin/#cluster-plan
[use admin riak admin#cluster-commit]: {{<baseurl>}}openriak-kv/3.2.0/using/admin/riak-admin/#cluster-commit
