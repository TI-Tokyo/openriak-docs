...
toc: true
aliases:
  - /riak/3.2.0/ops/running/recovery/rolling-restart
  - /openriak-kv/3.2.0/ops/running/recovery/rolling-restart
linkTitle: "Rolling Restarts"
weight: 103
---

Because Riak functions as a multi-node system, cluster-level [Riak version upgrades]({{<baseurl>}}openriak-kv/3.2.0/setup/upgrading/cluster) and restarts can be performed on a node-by-node, "rolling" basis.
