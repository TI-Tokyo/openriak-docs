...
aliases:
  ...
  - /openriak-kv/3.2.0/ops/upgrading/rolling-downgrades/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/3.2.0/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/3.2.0/using/admin/riak-admin/#aae-status
