...
toc: true
aliases:
  - /riak/3.2.0/dev/using/data-types
  - /openriak-kv/3.2.0/dev/using/data-types
  - /riak/3.2.0/dev/data-modeling/data-types
  - /openriak-kv/3.2.0/dev/data-modeling/data-types
