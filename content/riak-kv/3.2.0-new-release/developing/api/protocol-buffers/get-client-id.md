...
toc: true
aliases:
  - /riak/3.2.0/dev/references/protocol-buffers/get-client-id
  - /openriak-kv/3.2.0/dev/references/protocol-buffers/get-client-id
...
connected and can be changed using [Set Client ID]({{<baseurl>}}openriak-kv/3.2.0/developing/api/protocol-buffers/set-client-id).
