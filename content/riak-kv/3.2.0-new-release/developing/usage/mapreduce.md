...
toc: true
aliases:
  - /riak/3.2.0/dev/using/mapreduce
  - /openriak-kv/3.2.0/dev/using/mapreduce
...
[usage types]: {{<baseurl>}}openriak-kv/3.2.0/developing/usage/bucket-types
[api http]: {{<baseurl>}}openriak-kv/3.2.0/developing/api/http
[api pb]: {{<baseurl>}}openriak-kv/3.2.0/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}openriak-kv/3.2.0/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}openriak-kv/3.2.0/developing/app-guide/advanced-mapreduce
