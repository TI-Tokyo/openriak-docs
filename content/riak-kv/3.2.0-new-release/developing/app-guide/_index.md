...
toc: true
aliases:
  - /riak/3.2.0/dev/using/application-guide/
  - /openriak-kv/3.2.0/dev/using/application-guide/
linkTitle: "Application Guide"
weight: 105
---

[usage conflict resolution]: {{<baseurl>}}openriak-kv/3.2.0/developing/usage/conflict-resolution
[dev data model#log]: {{<baseurl>}}openriak-kv/3.2.0/developing/data-modeling/#log-data
[dev data model#sensor]: {{<baseurl>}}openriak-kv/3.2.0/developing/data-modeling/#sensor-data
[concept eventual consistency]: {{<baseurl>}}openriak-kv/3.2.0/learn/concepts/eventual-consistency
[dev data model#user]: {{<baseurl>}}openriak-kv/3.2.0/developing/data-modeling/#user-data
...
[dev data types#counters]: {{<baseurl>}}openriak-kv/3.2.0/developing/data-types/#counters
[dev data types#sets]: {{<baseurl>}}openriak-kv/3.2.0/developing/data-types/#sets
[dev data types#maps]: {{<baseurl>}}openriak-kv/3.2.0/developing/data-types/#maps
[usage create objects]: {{<baseurl>}}openriak-kv/3.2.0/developing/usage/creating-objects
[usage search]: {{<baseurl>}}openriak-kv/3.2.0/developing/usage/search
[use ref search]: {{<baseurl>}}openriak-kv/3.2.0/using/reference/search
