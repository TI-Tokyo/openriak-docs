...
aliases:
  ...
  - /docs/openriak-kv/2.0.0/ops/mdc/v3/cascading-writes
...
`riak-repl` command. Please see the [Version 3 Operations guide]({{<baseurl>}}openriak-kv/2.0.0/using/cluster-operations/v3-multi-datacenter) for more information.
