...
aliases:
  ...
  - /docs/openriak-kv/2.0.0/ops/mdc/v2/operations
...
participate in realtime replication. Please see the [Riak Enterprise MDC Replication Configuration]({{<baseurl>}}openriak-kv/2.0.0/configuring/v2-multi-datacenter/) guide for more information.
