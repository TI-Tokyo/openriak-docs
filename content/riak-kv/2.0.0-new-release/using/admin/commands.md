...
[use admin riak-admin#cluster-plan]: {{<baseurl>}}openriak-kv/2.0.0/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: {{<baseurl>}}openriak-kv/2.0.0/using/admin/riak-admin/#cluster-commit
