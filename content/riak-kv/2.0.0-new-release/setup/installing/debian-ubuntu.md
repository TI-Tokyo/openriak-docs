...
* [Lucid](https://packagecloud.io/basho/riak/packages/ubuntu/lucid/riak_2.0.0-1_amd64.deb)
* [Precise](https://packagecloud.io/basho/riak/packages/ubuntu/precise/riak_2.0.0-1_amd64.deb)
* [Squeeze](https://packagecloud.io/basho/riak/packages/debian/squeeze/riak_2.0.0-1_amd64.deb)
* [Trusty](https://packagecloud.io/basho/riak/packages/ubuntu/trusty/riak_2.0.0-1_amd64.deb)
* [Wheezy](https://packagecloud.io/basho/riak/packages/debian/wheezy/riak_2.0.0-1_amd64.deb)
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.0/ubuntu/lucid/riak_2.0.0-1_amd64.deb
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.0/ubuntu/natty/riak_2.0.0-1_amd64.deb
sudo dpkg -i riak_2.0.0-1_amd64.deb
```
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.0/ubuntu/precise/riak_2.0.0-1_amd64.deb
sudo dpkg -i riak_2.0.0-1_amd64.deb
```
