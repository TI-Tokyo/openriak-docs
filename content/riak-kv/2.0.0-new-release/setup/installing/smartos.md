...
```bash
curl -o /tmp/riak-2.0.0-SmartOS-x86_64.tgz http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.0/smartos/1.8/riak-2.0.0-SmartOS-x86_64.tgz
```

Next, install the package:

```
pkg_add /tmp/riak-2.0.0-SmartOS-x86_64.tgz
```
