...
toc: true
aliases:
  - /riak/2.0.0/ops/building/installing/Installing-on-Mac-OS-X
  - /docs/openriak-kv/2.0.0/ops/building/installing/Installing-on-Mac-OS-X
  - /riak/2.0.0/installing/mac-osx/
  - /docs/openriak-kv/2.0.0/installing/mac-osx/
linkTitle: "Mac OS X"
weight: 303
---
...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.0/osx/10.8/riak-2.0.0-OSX-x86_64.tar.gz
tar xzvf riak-2.0.0-osx-x86_64.tar.gz
```
...
By default, this will place a `2.0.0` folder in
