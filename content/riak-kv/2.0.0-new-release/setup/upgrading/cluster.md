...
[production checklist]: {{<baseurl>}}openriak-kv/2.0.0/setup/upgrading/checklist
...
[release notes]: {{<baseurl>}}openriak-kv/2.0.0/release-notes/
...
[jmx monitor]: {{<baseurl>}}openriak-kv/2.0.0/using/reference/jmx
[snmp]: {{<baseurl>}}openriak-kv/2.0.0/using/reference/snmp
...
If you run [Riak Control]({{<baseurl>}}openriak-kv/2.0.0/using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
...
If you use Riak KV's [secondary indexes]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/secondary-indexes) and are
upgrading from a version prior to Riak KV version 1.3.1, you need to
reformat the indexes using the [`riak-admin reformat-indexes`]({{<baseurl>}}openriak-kv/2.0.0/using/admin/riak-admin) command. More details about reformatting indexes are available in the [release notes]({{<baseurl>}}openriak-kv/2.0.0/release-notes/).
{{% /note %}}
