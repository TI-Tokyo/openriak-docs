...
toc: true
aliases:
  - /riak/2.0.0/ops/advanced/backends/multi/
  - /docs/openriak-kv/2.0.0/ops/advanced/backends/multi/
...
[use admin riak-admin cli]: {{<baseurl>}}openriak-kv/2.0.0/using/admin/riak-admin
