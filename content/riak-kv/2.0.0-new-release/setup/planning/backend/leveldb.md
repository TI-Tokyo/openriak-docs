...
toc: true
aliases:
  - /riak/2.0.0/ops/advanced/backends/leveldb/
  - /docs/openriak-kv/2.0.0/ops/advanced/backends/leveldb/
linkTitle: "LevelDB"
weight: 101
---
...
[config reference#aae]: {{<baseurl>}}openriak-kv/2.0.0/configuring/reference/#active-anti-entropy
