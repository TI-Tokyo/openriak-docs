...
special eventually consistent [Data Types]({{<baseurl>}}openriak-kv/2.0.0/developing/data-types/), or you can resolve those
...
or models]({{<baseurl>}}openriak-kv/2.0.0/developing/data-modeling/).
