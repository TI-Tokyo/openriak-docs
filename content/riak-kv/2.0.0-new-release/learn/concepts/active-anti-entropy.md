...
toc: true
aliases:
  - /riak/2.0.0/theory/concepts/aae
  - /docs/openriak-kv/2.0.0/theory/concepts/aae
linkTitle: "Active Anti-Entropy"
weight: 100
---

[cluster ops v3 mdc]: {{<baseurl>}}openriak-kv/2.0.0/using/cluster-operations/v3-multi-datacenter
[cluster ops aae]: {{<baseurl>}}openriak-kv/2.0.0/using/cluster-operations/active-anti-entropy
...
[config aae]: {{<baseurl>}}openriak-kv/2.0.0/configuring/reference/#active-anti-entropy
