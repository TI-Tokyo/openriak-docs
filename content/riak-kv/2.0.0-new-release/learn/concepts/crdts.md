...
[concept causal context dvv]: {{<baseurl>}}openriak-kv/2.0.0/learn/concepts/causal-context/#dotted-version-vectors
...
indexes]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/secondary-indexes/) and [Search]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/search/).
...
object]({{<baseurl>}}openriak-kv/2.0.0/developing/data-types/#Data-Types-and-Context) that is similar to a
