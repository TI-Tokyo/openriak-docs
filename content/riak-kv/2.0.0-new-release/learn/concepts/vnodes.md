...
toc: true
aliases:
  - /riak/2.0.0/theory/concepts/vnodes
  - /docs/openriak-kv/2.0.0/theory/concepts/vnodes
linkTitle: "Vnodes"
weight: 109
---

[concept causal context]: {{<baseurl>}}openriak-kv/2.0.0/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}openriak-kv/2.0.0/learn/concepts/clusters/#the-ring
...
[perf strong consistency]: {{<baseurl>}}openriak-kv/2.0.0/using/reference/strong-consistency
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}openriak-kv/2.0.0/setup/planning/backend/bitcask) as a backend, navigate
