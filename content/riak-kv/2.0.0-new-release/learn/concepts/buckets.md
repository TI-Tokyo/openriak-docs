...
[apps cluster metadata]: {{<baseurl>}}openriak-kv/2.0.0/developing/app-guide/cluster-metadata
...
[concept causal context sib]: {{<baseurl>}}openriak-kv/2.0.0/learn/concepts/causal-context/#siblings
...
[glossary ring]: {{<baseurl>}}openriak-kv/2.0.0/learn/glossary/#ring
...
[usage replication]: {{<baseurl>}}openriak-kv/2.0.0/developing/usage/replication
