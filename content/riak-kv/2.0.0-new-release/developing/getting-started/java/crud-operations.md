...
Riak, see [Updating Objects]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/updating-objects/)
and [Conflict Resolution]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/conflict-resolution/)
documentation.
