...
The JSON encoding is the same as [REST API]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/mapreduce/#rest) and
the external term format is the same as the [local Erlang API]({{<baseurl>}}openriak-kv/2.0.0/developing/app-guide/advanced-mapreduce/#erlang)
