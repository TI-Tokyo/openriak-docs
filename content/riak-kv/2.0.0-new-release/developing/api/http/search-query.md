...
aliases:
  - /riak/2.0.0/dev/references/http/search-query
  - /docs/openriak-kv/2.0.0/dev/references/http/search-query
linkTitle: "Search Query"
weight: 113
---

Performs a [Riak KV Search]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/search) query.
...
* `q` --- The actual Search query itself. Examples can be found in
    [Using Search]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/search). If a query is not specified, Riak will return
