...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}openriak-kv/2.0.0/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}openriak-kv/2.0.0/developing/api/http/fetch-object)) responses apply here.
