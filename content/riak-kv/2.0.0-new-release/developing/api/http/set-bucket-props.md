...
toc: true
aliases:
  - /riak/2.0.0/dev/references/http/set-bucket-props
  - /docs/openriak-kv/2.0.0/dev/references/http/set-bucket-props
...
clock) when writing
* `precommit` - [precommit hooks]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/commit-hooks)
