...
is a special case of [MapReduce]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/mapreduce), and can be expressed more verbosely as such.
[Read more about Links]({{<baseurl>}}openriak-kv/2.0.0/learn/glossary/#links).
...
response from [fetching the object]({{<baseurl>}}openriak-kv/2.0.0/developing/api/http/fetch-object), without the status
code.
