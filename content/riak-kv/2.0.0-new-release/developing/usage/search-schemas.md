...
aliases:
  ...
  - /docs/openriak-kv/2.0.0/dev/advanced/search-schema
...
under the hood to convert your values---plain text, JSON, XML, [Riak Data Types]({{<baseurl>}}openriak-kv/2.0.0/developing/data-types/), and [more]({{<baseurl>}}openriak-kv/2.0.0/developing/usage/custom-extractors)---into something that can be indexed and searched later.
...
`_yz_ed`  | Entropy Data | Data related to [active anti-entropy]({{<baseurl>}}openriak-kv/2.0.0/learn/concepts/active-anti-entropy)
