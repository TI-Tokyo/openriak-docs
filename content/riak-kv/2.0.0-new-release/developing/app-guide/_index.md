...
[dev data model#log]: {{<baseurl>}}openriak-kv/2.0.0/developing/data-modeling/#log-data
[dev data model#sensor]: {{<baseurl>}}openriak-kv/2.0.0/developing/data-modeling/#sensor-data
[concept eventual consistency]: {{<baseurl>}}openriak-kv/2.0.0/learn/concepts/eventual-consistency
[dev data model#user]: {{<baseurl>}}openriak-kv/2.0.0/developing/data-modeling/#user-data
...
[dev data types#counters]: {{<baseurl>}}openriak-kv/2.0.0/developing/data-types/counters
[dev data types#sets]: {{<baseurl>}}openriak-kv/2.0.0/developing/data-types/sets
[dev data types#maps]: {{<baseurl>}}openriak-kv/2.0.0/developing/data-types/maps
