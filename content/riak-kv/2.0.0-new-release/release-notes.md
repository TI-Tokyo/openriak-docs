---
title: "Riak KV 2.0.0 Release Notes"
description: ""
project: "riak_kv"
...
links to relevant documentation, can be found [in our official docs]({{<baseurl>}}openriak-kv/2.0.0/intro-v20/). You can find an
[Upgrading to 2.0 Guide]({{<baseurl>}}openriak-kv/2.0.0/upgrade-v20/)
...
For more details on bucket types see our [official documentation]({{<baseurl>}}openriak-kv/2.0.0/dev/advanced/bucket-types/).
...
Types]({{<baseurl>}}openriak-kv/2.0.0/dev/using/data-types/) and
[bucket
types]({{<baseurl>}}openriak-kv/2.0.0/dev/advanced/bucket-types/) for
more details.
...
[here]({{<baseurl>}}openriak-kv/2.0.0/developing/data-types/counters/).

#### Sets

Sets allow you to store multiple distinct opaque binary values against a
key. See the
[documentation]({{<baseurl>}}openriak-kv/2.0.0/developing/data-types/sets/)
...
[documentation]({{<baseurl>}}openriak-kv/2.0.0/developing/data-types/maps/)
...
[documentation]({{<baseurl>}}openriak-kv/2.0.0/dev/using/data-types/#Data-Types-and-Context)
for more details.
...
Vectors]({{<baseurl>}}openriak-kv/2.0.0/theory/concepts/dotted-version-vectors/)
document.
...
* [Using Search]({{<baseurl>}}openriak-kv/2.0.0/dev/using/search/)
* [Search Details]({{<baseurl>}}openriak-kv/2.0.0/dev/advanced/search/)
* [Search Schema]({{<baseurl>}}openriak-kv/2.0.0/dev/advanced/search-schema/)
...
* [Using Strong Consistency]({{<baseurl>}}openriak-kv/2.0.0/dev/advanced/strong-consistency/)
* [Managing Strong Consistency]({{<baseurl>}}openriak-kv/2.0.0/ops/advanced/strong-consistency)
* [Strong Consistency]({{<baseurl>}}openriak-kv/2.0.0/theory/concepts/strong-consistency/)
...
issues]({{<baseurl>}}openriak-kv/2.0.0/ops/advanced/strong-consistency/#Known-Issues).
...
feature]({{<baseurl>}}openriak-kv/2.0.0/ops/running/authz/). Several
...
* There are restrictions on Erlang modules exposed to MapReduce jobs
  ...
  [here]({{<baseurl>}}openriak-kv/2.0.0/ops/running/authz/#Security-Checklist).
...
* `riak-admin backup` has been disabled; see
  [our documentation]({{<baseurl>}}openriak-kv/2.0.0/ops/running/backups/)
...
* LevelDB configuration values `cache_size` and `max_open_files` have
  ...
  [Configuring eLevelDB]({{<baseurl>}}openriak-kv/2.0.0/ops/advanced/backends/leveldb/#Configuring-eLevelDB)
...
docs]({{<baseurl>}}openriak-kv/2.0.0/upgrade-v20/). The information
...
types]({{<baseurl>}}openriak-kv/2.0.0/dev/advanced/bucket-types/);
...
files
documentation]({{<baseurl>}}openriak-kv/2.0.0/ops/advanced/configs/configuration-files/).
