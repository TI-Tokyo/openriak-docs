...
menu:
  riak_kv-2.0.8:
    name: "Upgrading to 2.0.8"
    identifier: "upgrading_version"
    weight: 101
    parent: "upgrading"
toc: true
aliases:
  - /riak/2.0.8/upgrade-v20/
  - /openriak-kv/2.0.8/ops/upgrading/rolling-upgrades/
  - /openriak-kv/2.0.8/ops/upgrading/rolling-upgrades/
  - /openriak-kv/2.0.8/setup/upgrading/cluster/

linkTitle: "Upgrading to 2.0.8"
weight: 101
---

[production checklist]: {{<baseurl>}}openriak-kv/2.0.8/setup/upgrading/checklist
...
[release notes]: {{<baseurl>}}openriak-kv/2.0.8/release-notes
...
[jmx monitor]: {{<baseurl>}}openriak-kv/2.0.8/using/reference/jmx
[snmp]: {{<baseurl>}}openriak-kv/2.0.8/using/reference/snmp
[Release Notes]: {{<baseurl>}}openriak-kv/2.0.8/release-notes
