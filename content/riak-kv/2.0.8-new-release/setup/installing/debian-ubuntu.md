...
toc: true
aliases:
  - /riak/2.0.8/ops/building/installing/Installing-on-Debian-and-Ubuntu
  - /openriak-kv/2.0.8/ops/building/installing/Installing-on-Debian-and-Ubuntu
  - /riak/2.0.8/installing/debian-ubuntu/
  - /openriak-kv/2.0.8/installing/debian-ubuntu/
...
* [Ubuntu 16.04 (Xenial)](https://packagecloud.io/basho/riak/packages/ubuntu/xenial/riak_2.0.8-1_amd64.deb)
* [Ubuntu 14.04 (Trusty)](https://packagecloud.io/basho/riak/packages/ubuntu/trusty/riak_2.0.8-1_amd64.deb)
* [Ubuntu 12.04 (Precise)](https://packagecloud.io/basho/riak/packages/ubuntu/precise/riak_2.0.8-1_amd64.deb)
* [Debian 8 (Jessie)](https://packagecloud.io/basho/riak/packages/debian/jessie/riak_2.0.8-1_amd64.deb)
* [Debian 7 (Wheezy)](https://packagecloud.io/basho/riak/packages/debian/wheezy/riak_2.0.8-1_amd64.deb)
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.8/ubuntu/lucid/riak_2.0.8-1_amd64.deb
sudo dpkg -i riak_2.0.8-1_amd64.deb
```

#### Ubuntu Natty Narwhal (11.04)

```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.8/ubuntu/natty/riak_2.0.8-1_amd64.deb
sudo dpkg -i riak_2.0.8-1_amd64.deb
```
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.8/ubuntu/precise/riak_2.0.8-1_amd64.deb
sudo dpkg -i riak_2.0.8-1_amd64.deb
```
