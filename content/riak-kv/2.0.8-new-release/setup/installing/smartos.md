...
toc: true
aliases:
  - /riak/2.0.8/ops/building/installing/Installing-on-SmartOS
  - /openriak-kv/2.0.8/ops/building/installing/Installing-on-SmartOS
  - /riak/2.0.8/installing/smartos/
  - /openriak-kv/2.0.8/installing/smartos/
linkTitle: "SmartOS"
weight: 305
---
...
{{% note title="SmartOS End of Life (EOL) for Riak KV 2.0.8" %}}
SmartOS is no longer supported in Riak KV 2.0.8+. If you are interested in using Riak KV on SmartOS, you can still [build from source](../source).
{{% /note %}}
...
```bash
curl -o /tmp/riak-2.0.8-SmartOS-x86_64.tgz http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.8/smartos/1.8/riak-2.0.8-SmartOS-x86_64.tgz
```

Next, install the package:

```
pkg_add /tmp/riak-2.0.8-SmartOS-x86_64.tgz
```
