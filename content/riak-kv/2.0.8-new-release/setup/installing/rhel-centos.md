...
toc: true
aliases:
  - /riak/2.0.8/ops/building/installing/Installing-on-RHEL-and-CentOS
  - /openriak-kv/2.0.8/ops/building/installing/Installing-on-RHEL-and-CentOS
  - /riak/2.0.8/installing/rhel-centos/
  - /openriak-kv/2.0.8/installing/rhel-centos/
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.8/rhel/5/riak-2.0.8-1.el5.x86_64.rpm
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.8/rhel/6/riak-2.0.8-1.el6.x86_64.rpm
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.8/riak-2.0.8.tar.gz
