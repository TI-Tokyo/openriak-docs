...
Riak, see [Updating Objects]({{<baseurl>}}openriak-kv/2.0.8/developing/usage/updating-objects/)
and [Conflict Resolution]({{<baseurl>}}openriak-kv/2.0.8/developing/usage/conflict-resolution/)
documentation.
