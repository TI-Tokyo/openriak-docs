...
toc: true
aliases:
  - /riak/2.0.8/dev/advanced/client-security/java
  - /openriak-kv/2.0.8/dev/advanced/client-security/java
linkTitle: "Java"
weight: 100
---
...
security setup described [below](#java-client-basics). [Certificate]({{<baseurl>}}openriak-kv/2.0.8/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
