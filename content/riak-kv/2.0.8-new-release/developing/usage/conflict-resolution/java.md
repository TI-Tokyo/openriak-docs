...
toc: true
aliases:
  - /riak/2.0.8/dev/using/conflict-resolution/java
  - /openriak-kv/2.0.8/dev/using/conflict-resolution/java
linkTitle: "Java"
weight: 100
---
...
[bucket type]({{<baseurl>}}openriak-kv/2.0.8/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official Java client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.0.8/developing/usage) section.
