...
aliases:
  ...
  - /openriak-kv/2.0.8/dev/references/protocol-buffers/dt-counter-store
linkTitle: "Data Type Counter Store"
weight: 117
---

An operation to update a [counter]({{<baseurl>}}openriak-kv/2.0.8/developing/data-types).
...
stored on their own in a key or [within a map]({{<baseurl>}}openriak-kv/2.0.8/developing/api/protocol-buffers/dt-map-store).
