...
aliases:
  ...
  - /openriak-kv/2.0.8/dev/references/protocol-buffers/auth-req
...
For more on authentication, see our documentation on [Authentication and Authorization]({{<baseurl>}}openriak-kv/2.0.8/using/security/basics).
