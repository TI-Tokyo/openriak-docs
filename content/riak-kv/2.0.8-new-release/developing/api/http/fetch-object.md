...
toc: true
aliases:
  - /riak/2.0.8/dev/references/http/fetch-object
  - /openriak-kv/2.0.8/dev/references/http/fetch-object
...
object ([default is defined by the bucket]({{<baseurl>}}openriak-kv/2.0.8/developing/api/http/set-bucket-props))
* `pr` - how many primary replicas need to be online when doing the read
([default is defined by the bucket]({{<baseurl>}}openriak-kv/2.0.8/developing/api/http/set-bucket-props))
...
purposes of R ([default is defined by the bucket]({{<baseurl>}}openriak-kv/2.0.8/developing/api/http/set-bucket-props))
...
datetime format
* `Link` - user- and system-defined links to other resources. [Read more about Links.]({{<baseurl>}}openriak-kv/2.0.8/learn/glossary/#links)
