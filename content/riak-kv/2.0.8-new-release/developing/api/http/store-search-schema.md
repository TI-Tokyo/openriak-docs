...
aliases:
  ...
  - /openriak-kv/2.0.8/dev/references/http/store-search-schema
linkTitle: "Store Search Schema"
weight: 117
---

Creates a new Riak [Search schema]({{<baseurl>}}openriak-kv/2.0.8/developing/usage/search-schemas).
...
formed XML schema. More information can be found in the [Search Schema]({{<baseurl>}}openriak-kv/2.0.8/developing/usage/search-schemas) document. If you've created a schema and stored it in the filed
