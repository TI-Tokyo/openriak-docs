...
toc: true
aliases:
  - /riak/2.0.8/ops/running/cluster-admin
  - /openriak-kv/2.0.8/ops/running/cluster-admin
...
[use admin riak-admin#cluster-plan]: {{<baseurl>}}openriak-kv/2.0.8/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: {{<baseurl>}}openriak-kv/2.0.8/using/admin/riak-admin/#cluster-commit
