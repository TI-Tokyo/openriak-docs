...
[upgrade]: {{<baseurl>}}openriak-kv/2.0.8/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}openriak-kv/2.0.8/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}openriak-kv/2.0.8/using/cluster-operations/adding-removing-nodes
