...
by accessing the Erlang console directly using the [`riak attach`]({{<baseurl>}}openriak-kv/2.0.8/using/admin/riak-cli/#attach) command. Once you run this command and drop into the console, enter the following:
