...
toc: true
aliases:
  - /riak/2.0.5/ops/building/configuration/
  - /openriak-kv/2.0.5/ops/building/configuration/
...
[use admin riak-admin#member-status]: {{<baseurl>}}openriak-kv/2.0.5/using/admin/riak-admin/#member-status
...
[Cluster Capacity Planning]: {{<baseurl>}}openriak-kv/2.0.5/setup/planning/cluster-capacity/#ring-size-number-of-partitions
...
directly impacted, although the mechanism described in [HTTP Reset Bucket Properties]({{<baseurl>}}openriak-kv/2.0.5/developing/api/http/reset-bucket-props) can be used to force them to pick up the new
defaults.
