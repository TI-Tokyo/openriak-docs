...
toc: true
aliases:
  - /riak/2.0.5/ops/building/benchmarking
  - /openriak-kv/2.0.5/ops/building/benchmarking
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}openriak-kv/2.0.5/setup/installing/source/erlang) for instructions
