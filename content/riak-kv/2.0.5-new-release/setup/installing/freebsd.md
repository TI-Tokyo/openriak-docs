...
toc: true
aliases:
  - /riak/2.0.5/ops/building/installing/Installing-on-FreeBSD
  - /openriak-kv/2.0.5/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.0.5/installing/freebsd/
  - /openriak-kv/2.0.5/installing/freebsd/
linkTitle: "FreeBSD"
weight: 303
---
...
`pkg_add` remote option. For this example, we're installing `riak-2.0.5-FreeBSD-amd64.tbz`.

```bash
sudo pkg_add -r http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.5/freebsd/9/riak-2.0.5-FreeBSD-amd64.tbz
```
