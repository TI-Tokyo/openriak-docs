...
toc: true
aliases:
  - /riak/2.0.5/ops/building/installing/Installing-on-SmartOS
  - /openriak-kv/2.0.5/ops/building/installing/Installing-on-SmartOS
  - /riak/2.0.5/installing/smartos/
  - /openriak-kv/2.0.5/installing/smartos/
linkTitle: "SmartOS"
weight: 305
---
...
```bash
curl -o /tmp/riak-2.0.5-SmartOS-x86_64.tgz http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.5/smartos/1.8/riak-2.0.5-SmartOS-x86_64.tgz
```

Next, install the package:

```
pkg_add /tmp/riak-2.0.5-SmartOS-x86_64.tgz
```
