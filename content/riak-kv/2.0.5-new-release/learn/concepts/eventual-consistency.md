...
toc: true
aliases:
  - /riak/2.0.5/theory/concepts/Eventual-Consistency
  - /openriak-kv/2.0.5/theory/concepts/Eventual-Consistency
  - /riak/2.0.5/theory/concepts/eventual-consistency
  - /openriak-kv/2.0.5/theory/concepts/eventual-consistency
...
special eventually consistent [Data Types]({{<baseurl>}}openriak-kv/2.0.5/developing/data-types/), or you can resolve those
...
or models]({{<baseurl>}}openriak-kv/2.0.5/developing/data-modeling/).
