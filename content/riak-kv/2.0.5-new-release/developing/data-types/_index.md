...
toc: true
aliases:
  - /riak/2.0.5/dev/using/data-types
  - /openriak-kv/2.0.5/dev/using/data-types
  - /riak/2.0.5/dev/data-modeling/data-types
  - /openriak-kv/2.0.5/dev/data-modeling/data-types
