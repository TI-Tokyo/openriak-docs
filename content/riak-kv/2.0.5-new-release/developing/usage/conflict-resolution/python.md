...
aliases:
  ...
  - /openriak-kv/2.0.5/dev/using/conflict-resolution/python
linkTitle: "Python"
weight: 102
---
...
from the official Python client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.0.5/developing/usage) section.
