...
toc: true
aliases:
  - /riak/2.0.5/dev/using/conflict-resolution/php
  - /openriak-kv/2.0.5/dev/using/conflict-resolution/php
linkTitle: "PHP"
weight: 105
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.0.5/developing/usage) section.
