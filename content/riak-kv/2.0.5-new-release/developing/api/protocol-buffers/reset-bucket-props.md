...
toc: true
aliases:
  - /riak/2.0.5/dev/references/protocol-buffers/reset-bucket-props
  - /openriak-kv/2.0.5/dev/references/protocol-buffers/reset-bucket-props
...
[bucket type]({{<baseurl>}}openriak-kv/2.0.5/developing/usage/bucket-types) using the `type` value. If you do not
