...
aliases:
  ...
  - /openriak-kv/2.0.5/dev/references/protocol-buffers/dt-union
...
`DtOp` messages are sent only as part of a [`DtUpdateReq`]({{<baseurl>}}openriak-kv/2.0.5/developing/api/protocol-buffers/dt-store) message.
