...
toc: true
aliases:
  - /riak/2.0.6/ops/building/installing/Installing-on-FreeBSD
  - /openriak-kv/2.0.6/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.0.6/installing/freebsd/
  - /openriak-kv/2.0.6/installing/freebsd/
linkTitle: "FreeBSD"
weight: 303
---
...
```bash
sudo pkg_add -r http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.6/freebsd/9/riak-2.0.6-FreeBSD-amd64.tbz
```
