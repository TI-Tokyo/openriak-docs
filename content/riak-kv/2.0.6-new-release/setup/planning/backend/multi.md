...
toc: true
aliases:
  - /riak/2.0.6/ops/advanced/backends/multi/
  - /openriak-kv/2.0.6/ops/advanced/backends/multi/
...
[use admin riak-admin cli]: {{<baseurl>}}openriak-kv/2.0.6/using/admin/riak-admin
