...
toc: true
aliases:
  - /riak/2.0.6/ops/building/planning/cluster
  - /openriak-kv/2.0.6/ops/building/planning/cluster
...
[use admin riak-admin#cluster]: {{<baseurl>}}openriak-kv/2.0.6/using/admin/riak-admin/#cluster
