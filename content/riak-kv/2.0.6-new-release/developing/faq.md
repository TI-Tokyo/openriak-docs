...
toc: true
aliases:
  - /riak/2.0.6/community/faqs/developing
  - /openriak-kv/2.0.6/community/faqs/developing
...
[Bucket Properties]: {{<baseurl>}}openriak-kv/2.0.6/developing/usage
[built-in functions list]: https://github.com/basho/riak_kv/blob/master/priv/mapred_builtins.js
[commit hooks]: {{<baseurl>}}openriak-kv/2.0.6/developing/usage/commit-hooks
...
[Erlang Riak Client]: {{<baseurl>}}openriak-kv/2.0.6/developing/client-libraries
...
[System Planning]: {{<baseurl>}}openriak-kv/2.0.6/setup/planning/start/#network-configuration-load-balancing
[vector clocks]: {{<baseurl>}}openriak-kv/2.0.6/learn/concepts/causal-context#vector-clocks
