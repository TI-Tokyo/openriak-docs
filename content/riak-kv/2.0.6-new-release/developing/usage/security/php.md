...
toc: true
aliases:
  - /riak/2.0.6/dev/advanced/client-security/php
  - /openriak-kv/2.0.6/dev/advanced/client-security/php
linkTitle: "PHP"
weight: 104
---
...
If you are using [trust-]({{<baseurl>}}openriak-kv/2.0.6/using/security/managing-sources/#trust-based-authentication) or [PAM]({{<baseurl>}}openriak-kv/2.0.6/using/security/managing-sources/#pam-based-authentication)-based authentication, you can use the
security setup described [below](#php-client-basics). [Certificate]({{<baseurl>}}openriak-kv/2.0.6/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
...
regardless of which [security source]({{<baseurl>}}openriak-kv/2.0.6/using/security/managing-sources/) you choose. All clients should also provide a username, regardless of
