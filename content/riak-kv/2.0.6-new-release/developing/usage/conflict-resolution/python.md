...
toc: true
aliases:
  - /riak/2.0.6/dev/using/conflict-resolution/python
  - /openriak-kv/2.0.6/dev/using/conflict-resolution/python
linkTitle: "Python"
weight: 102
---

For reasons explained in the [Introduction to conflict resolution]({{<baseurl>}}openriak-kv/2.0.6/developing/usage/conflict-resolution), we strongly recommend adopting a
...
application will be stored in buckets that bear the [bucket type]({{<baseurl>}}openriak-kv/2.0.6/developing/usage/bucket-types) `siblings`, and for this bucket type `allow_mult` is set
...
from the official Python client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.0.6/developing/usage) section.
...
resolution is that Riak offers a variety of [Data Types]({{<baseurl>}}openriak-kv/2.0.6/developing/data-types/) that have
specific conflict resolution mechanics built in. If you have data that
can be modeled as a [counter]({{<baseurl>}}openriak-kv/2.0.6/developing/data-types/counters), [set]({{<baseurl>}}openriak-kv/2.0.6/developing/data-types/sets), or [map]({{<baseurl>}}openriak-kv/2.0.6/developing/data-types/maps), then you should seriously
...
resolution that we implemented above, see our [tutorial on Riak sets]({{<baseurl>}}openriak-kv/2.0.6/developing/data-types/sets).
