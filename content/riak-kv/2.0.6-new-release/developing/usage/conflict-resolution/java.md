...
aliases:
  ...
  - /openriak-kv/2.0.6/dev/using/conflict-resolution/java
linkTitle: "Java"
weight: 100
---
...
the official Java client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.0.6/developing/usage) section.
