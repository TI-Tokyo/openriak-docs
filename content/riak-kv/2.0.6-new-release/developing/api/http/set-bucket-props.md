...
toc: true
aliases:
  - /riak/2.0.6/dev/references/http/set-bucket-props
  - /openriak-kv/2.0.6/dev/references/http/set-bucket-props
...
clock) when writing
* `precommit` - [precommit hooks]({{<baseurl>}}openriak-kv/2.0.6/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks]({{<baseurl>}}openriak-kv/2.0.6/developing/usage/commit-hooks)
