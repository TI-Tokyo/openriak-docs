...
aliases:
  - /riak/2.0.6/dev/references/http/search-index-info
  - /openriak-kv/2.0.6/dev/references/http/search-index-info
linkTitle: "Search Index Info"
weight: 114
---

Retrieves information about all currently available [Search indexes]({{<baseurl>}}openriak-kv/2.0.6/developing/usage/search) in JSON format.
