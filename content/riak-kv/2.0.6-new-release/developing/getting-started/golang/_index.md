...
toc: true
aliases:
  - /riak/2.0.6/dev/taste-of-riak/golang
  - /openriak-kv/2.0.6/dev/taste-of-riak/golang
linkTitle: "Go"
weight: 107
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}openriak-kv/2.0.6/using/running-a-cluster) first and ensure you have
...
[CRUD Operations]({{<baseurl>}}openriak-kv/2.0.6/developing/getting-started/golang/crud-operations)
