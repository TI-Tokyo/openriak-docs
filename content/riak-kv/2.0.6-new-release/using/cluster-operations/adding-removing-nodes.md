...
toc: true
aliases:
  - /riak/2.0.6/ops/running/nodes/adding-removing
  - /openriak-kv/2.0.6/ops/running/nodes/adding-removing
...
simply the script [`riak`]({{<baseurl>}}openriak-kv/2.0.6/using/admin/riak-cli/):
