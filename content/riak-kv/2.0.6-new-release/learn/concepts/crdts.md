...
aliases:
  ...
  - /openriak-kv/2.0.6/theory/concepts/crdts
linkTitle: "Data Types"
weight: 104
---

[concept causal context dvv]: {{<baseurl>}}openriak-kv/2.0.6/learn/concepts/causal-context/#dotted-version-vectors
...
indexes]({{<baseurl>}}openriak-kv/2.0.6/developing/usage/secondary-indexes/) and [Search]({{<baseurl>}}openriak-kv/2.0.6/developing/usage/search/).
...
object]({{<baseurl>}}openriak-kv/2.0.6/developing/data-types/#Data-Types-and-Context) that is similar to a
