...
Creates a new Riak [Search schema]({{<baseurl>}}openriak-kv/2.0.2/developing/usage/search-schemas).
...
formed XML schema. More information can be found in the [Search Schema]({{<baseurl>}}openriak-kv/2.0.2/developing/usage/search-schemas) document. If you've created a schema and stored it in the filed
