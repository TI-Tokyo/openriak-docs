...
An operation to update a [counter]({{<baseurl>}}openriak-kv/2.0.2/developing/data-types).
...
stored on their own in a key or [within a map]({{<baseurl>}}openriak-kv/2.0.2/developing/api/protocol-buffers/dt-map-store).
