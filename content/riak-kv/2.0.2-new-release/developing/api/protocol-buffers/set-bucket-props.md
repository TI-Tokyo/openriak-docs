...
[PBC Get Bucket Properties]({{<baseurl>}}openriak-kv/2.0.2/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type]({{<baseurl>}}openriak-kv/2.0.2/developing/usage/bucket-types) using the
