...
toc: true
aliases:
  - /riak/2.0.2/dev/advanced/client-security/java
linkTitle: "Java"
weight: 100
---
...
security setup described [below](#java-client-basics). [Certificate]({{<baseurl>}}openriak-kv/2.0.2/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
