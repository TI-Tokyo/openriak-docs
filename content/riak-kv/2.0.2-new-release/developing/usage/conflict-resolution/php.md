...
toc: true
aliases:
  - /riak/2.0.2/dev/using/conflict-resolution/php
linkTitle: "PHP"
weight: 105
---
...
[bucket type]({{<baseurl>}}openriak-kv/2.0.2/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.0.2/developing/usage) section.
