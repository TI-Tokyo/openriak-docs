...
toc: true
aliases:
  - /riak/2.0.2/ops/running/cluster-admin
linkTitle: "Cluster Admin Commands"
weight: 100
---

[use admin riak-admin#cluster]: {{<baseurl>}}openriak-kv/2.0.2/using/admin/riak-admin/#cluster
...
[use admin riak-admin#cluster-plan]: {{<baseurl>}}openriak-kv/2.0.2/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: {{<baseurl>}}openriak-kv/2.0.2/using/admin/riak-admin/#cluster-commit
