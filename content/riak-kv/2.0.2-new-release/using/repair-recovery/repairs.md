...
[partitions]({{<baseurl>}}openriak-kv/2.0.2/learn/concepts/clusters/#the-ring). Repairs of Riak KV data are typically
...
repair data will depend mainly on your use case and on whether [active anti-entropy]({{<baseurl>}}openriak-kv/2.0.2/learn/concepts/active-anti-entropy/) is enabled.

You will need to run a repair if the following are both true:

* Active anti-entropy is [disabled]({{<baseurl>}}openriak-kv/2.0.2/learn/concepts/active-anti-entropy/#disabling-active-anti-entropy)
* You have both non-expiring data and keys that are not accessed
  ...
  [read repair]({{<baseurl>}}openriak-kv/2.0.2/learn/concepts/active-anti-entropy/#read-repair-vs-active-anti-entropy))

You will most likely not need to run a repair operation if _any_ of the
following is true:

* Active anti-entropy is [enabled]({{<baseurl>}}openriak-kv/2.0.2/learn/concepts/active-anti-entropy/#enabling-active-anti-entropy)
