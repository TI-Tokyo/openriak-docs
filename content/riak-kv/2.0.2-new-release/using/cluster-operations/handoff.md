...
aliases:
  ...
  - /openriak-kv/2.0.2/ops/running/handoff
linkTitle: "Handoff"
weight: 107
---
...
[`riak-admin`]({{<baseurl>}}openriak-kv/2.0.2/using/admin/riak-admin/) interface enables you to
...
This command displays the values for handoff-specific [configurable parameters]({{<baseurl>}}openriak-kv/2.0.2/configuring/reference/#intra-cluster-handoff) on each node in
