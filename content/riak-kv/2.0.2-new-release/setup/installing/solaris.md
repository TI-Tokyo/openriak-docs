...
aliases:
  ...
  - /openriak-kv/2.0.2/ops/building/installing/Installing-on-Solaris
  - /riak/2.0.2/installing/solaris/
  - /openriak-kv/2.0.2/installing/solaris/
linkTitle: "Solaris"
weight: 306
---
...
```bash
curl -o /tmp/BASHOriak-2.0.2-Solaris10-i386.pkg.gz http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.2/solaris/10/BASHOriak-2.0.2-Solaris10-x86_64.pkg.gz
```
