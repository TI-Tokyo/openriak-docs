...
aliases:
  ...
  - /openriak-kv/2.0.2/ops/building/Installing-Riak-from-Source
  - /riak/2.0.2/installing/source/
  - /openriak-kv/2.0.2/installing/source/
...
[install debian & ubuntu#source]: {{<baseurl>}}openriak-kv/2.0.2/setup/installing/debian-ubuntu/#installing-from-source
[install freebsd#source]: {{<baseurl>}}openriak-kv/2.0.2/setup/installing/freebsd/#installing-from-source
[install mac osx#source]: {{<baseurl>}}openriak-kv/2.0.2/setup/installing/mac-osx/#installing-from-source
[install rhel & centos#source]: {{<baseurl>}}openriak-kv/2.0.2/setup/installing/rhel-centos/#installing-from-source
