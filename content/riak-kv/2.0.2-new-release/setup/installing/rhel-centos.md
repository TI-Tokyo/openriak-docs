...
toc: true
aliases:
  - /riak/2.0.2/ops/building/installing/Installing-on-RHEL-and-CentOS
  - /openriak-kv/2.0.2/ops/building/installing/Installing-on-RHEL-and-CentOS
  - /riak/2.0.2/installing/rhel-centos/
  - /openriak-kv/2.0.2/installing/rhel-centos/
...
>
> Riak version 2.0.2 is not currently available for RHEL/CentOS due to a known issue. If you'd like to upgrade Riak, we'd recommend waiting for the 2.0.5 release.
...
* [el5](https://packagecloud.io/basho/riak/packages/el/5/riak-2.0.2-1.x86_64.rpm)
* [el6](https://packagecloud.io/basho/riak/packages/el/6/riak-2.0.2-1.el6.x86_64.rpm)
* [el7](https://packagecloud.io/basho/riak/packages/el/7/riak-2.0.2-1.el7.centos.x86_64.rpm)
* [Fedora 19](https://packagecloud.io/basho/riak/packages/fedora/19/riak-2.0.2-1.fc19.x86_64.rpm)
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.2/rhel/5/riak-2.0.2-1.el5.x86_64.rpm
sudo rpm -Uvh riak-2.0.2-1.el5.x86_64.rpm
```
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.2/rhel/6/riak-2.0.2-1.el6.x86_64.rpm
sudo rpm -Uvh riak-2.0.2-1.el6.x86_64.rpm
```
