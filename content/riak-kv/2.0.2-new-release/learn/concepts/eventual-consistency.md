...
toc: true
aliases:
  - /riak/2.0.2/theory/concepts/Eventual-Consistency
  - /riak/2.0.2/theory/concepts/eventual-consistency
...
special eventually consistent [Data Types]({{<baseurl>}}openriak-kv/2.0.2/developing/data-types/), or you can resolve those
...
or models]({{<baseurl>}}openriak-kv/2.0.2/developing/data-modeling/).
