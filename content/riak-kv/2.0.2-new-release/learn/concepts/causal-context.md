...
[dev key value]: {{<baseurl>}}openriak-kv/2.0.2/developing/key-value-modeling
[glossary read rep]: {{<baseurl>}}openriak-kv/2.0.2/learn/glossary/#read-repair
[perf latency reduc]: {{<baseurl>}}openriak-kv/2.0.2/using/performance/latency-reduction
...
[usage protocol buffers]: {{<baseurl>}}openriak-kv/2.0.2/developing/api/protocol-buffers
[usage updating objects]: {{<baseurl>}}openriak-kv/2.0.2/developing/usage/updating-objects
...
[using bucket types]({{<baseurl>}}openriak-kv/2.0.2/developing/usage/bucket-types), all writes to that bucket will create siblings
