...
[concept causal context vc]: {{<baseurl>}}openriak-kv/2.0.2/learn/concepts/causal-context/#vector-clocks
...
[glossary node]: {{<baseurl>}}openriak-kv/2.0.2/learn/glossary/#node
[glossary ring]: {{<baseurl>}}openriak-kv/2.0.2/learn/glossary/#ring
[usage replication]: {{<baseurl>}}openriak-kv/2.0.2/developing/usage/replication
...
bucket's [bucket type]({{<baseurl>}}openriak-kv/2.0.2/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}openriak-kv/2.0.2/setup/planning/backend/multi) capabilities.
...
type]({{<baseurl>}}openriak-kv/2.0.2/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}openriak-kv/2.0.2/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}openriak-kv/2.0.2/developing/usage/mapreduce/) queries. Lowering an object or bucket's
