...
toc: true
aliases:
  - /riak/2.0.2/theory/concepts/aae
  - /openriak-kv/2.0.2/theory/concepts/aae
...
[cluster ops aae]: {{<baseurl>}}openriak-kv/2.0.2/using/cluster-operations/active-anti-entropy
...
[config aae]: {{<baseurl>}}openriak-kv/2.0.2/configuring/reference/#active-anti-entropy
