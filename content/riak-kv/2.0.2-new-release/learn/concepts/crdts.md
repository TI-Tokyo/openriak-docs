...
[concept causal context dvv]: {{<baseurl>}}openriak-kv/2.0.2/learn/concepts/causal-context/#dotted-version-vectors
[concept causal context sib]: {{<baseurl>}}openriak-kv/2.0.2/learn/concepts/causal-context/#siblings
...
indexes]({{<baseurl>}}openriak-kv/2.0.2/developing/usage/secondary-indexes/) and [Search]({{<baseurl>}}openriak-kv/2.0.2/developing/usage/search/).
...
object]({{<baseurl>}}openriak-kv/2.0.2/developing/data-types/#Data-Types-and-Context) that is similar to a
