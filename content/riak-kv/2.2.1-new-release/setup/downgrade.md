...
toc: true
aliases:
  - /riak/2.2.1/ops/upgrading/rolling-downgrades/
  - /openriak-kv/2.2.1/ops/upgrading/rolling-downgrades/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/2.2.1/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/2.2.1/using/admin/riak-admin/#aae-status
...
If you enabled LZ4 compression in LevelDB and/or enabled global expiration in LevelDB when you installed KV 2.2.1, you cannot downgrade.
