...
aliases:
  ...
  - /openriak-kv/2.2.1/ops/building/installing/Installing-on-Mac-OS-X
  - /riak/2.2.1/installing/mac-osx/
  - /openriak-kv/2.2.1/installing/mac-osx/
linkTitle: "Mac OS X"
weight: 303
---
...
```bash
curl -O https://files.tiot.jp/riak/kv/2.2/2.2.1/osx/10.8/riak-2.2.1-OSX-x86_64.tar.gz
