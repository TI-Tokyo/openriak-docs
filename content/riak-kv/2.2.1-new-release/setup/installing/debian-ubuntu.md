...
toc: true
aliases:
  - /riak/2.2.1/ops/building/installing/Installing-on-Debian-and-Ubuntu
  - /openriak-kv/2.2.1/ops/building/installing/Installing-on-Debian-and-Ubuntu
  - /riak/2.2.1/installing/debian-ubuntu/
  - /openriak-kv/2.2.1/installing/debian-ubuntu/
...
* [Ubuntu 16.04 (Xenial)](https://files.tiot.jp/riak/kv/2.2/2.2.1/ubuntu/xenial/riak_2.2.1-1_amd64.deb)
* [Ubuntu 14.04 (Trusty)](https://files.tiot.jp/riak/kv/2.2/2.2.1/ubuntu/trusty/riak_2.2.1-1_amd64.deb)
* [Ubuntu 12.04 (Precise)](https://files.tiot.jp/riak/kv/2.2/2.2.1/ubuntu/precise/riak_2.2.1-1_amd64.deb)
* [Debian 8 (Jessie)](https://files.tiot.jp/riak/kv/2.2/2.2.1/debian/jessie/riak_2.2.1-1_amd64.deb)
* [Debian 7 (Wheezy)](https://files.tiot.jp/riak/kv/2.2/2.2.1/debian/wheezy/riak_2.2.1-1_amd64.deb)
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.2.1/ubuntu/lucid/riak_2.2.1-1_amd64.deb
sudo dpkg -i riak_2.2.1-1_amd64.deb
```

#### Ubuntu Natty Narwhal (11.04)

```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.2.1/ubuntu/natty/riak_2.2.1-1_amd64.deb
sudo dpkg -i riak_2.2.1-1_amd64.deb
```
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.2.1/ubuntu/precise/riak_2.2.1-1_amd64.deb
sudo dpkg -i riak_2.2.1-1_amd64.deb
```
