...
[upgrade]: {{<baseurl>}}openriak-kv/2.2.1/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}openriak-kv/2.2.1/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}openriak-kv/2.2.1/using/cluster-operations/adding-removing-nodes
