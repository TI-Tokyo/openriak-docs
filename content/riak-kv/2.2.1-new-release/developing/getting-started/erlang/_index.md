...
toc: true
aliases:
  - /riak/2.2.1/dev/taste-of-riak/erlang
  - /openriak-kv/2.2.1/dev/taste-of-riak/erlang
linkTitle: "Erlang"
weight: 105
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}openriak-kv/2.2.1/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}openriak-kv/2.2.1/developing/getting-started/erlang/crud-operations)
