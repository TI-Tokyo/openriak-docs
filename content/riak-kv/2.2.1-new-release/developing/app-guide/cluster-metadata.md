...
is Riak's [bucket types]({{<baseurl>}}openriak-kv/2.2.1/using/reference/bucket-types) feature. This feature
...
made both to memory and to disk. Logical clocks, namely [dotted version vectors]({{<baseurl>}}openriak-kv/2.2.1/learn/concepts/causal-context/#dotted-version-vectors), are used in place of [vector clocks]({{<baseurl>}}openriak-kv/2.2.1/learn/concepts/causal-context/#vector-clocks) or timestamps to resolve value conflicts. Values stored as cluster metadata are opaque Erlang
