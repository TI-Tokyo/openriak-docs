...
aliases:
  - /riak/2.2.1/dev/references/protocol-buffers/yz-schema-get
  - /openriak-kv/2.2.1/dev/references/protocol-buffers/yz-schema-get
linkTitle: "Yokozuna Schema Get"
weight: 123
---

Fetch a [search schema]({{<baseurl>}}openriak-kv/2.2.1/developing/usage/search-schemas) from Riak Search.
