...
toc: true
aliases:
  - /riak/2.2.1/dev/using/conflict-resolution/nodejs
  - /openriak-kv/2.2.1/dev/using/conflict-resolution/nodejs
linkTitle: "NodeJS"
weight: 104
---

For reasons explained in the [Introduction to conflict resolution]({{<baseurl>}}openriak-kv/2.2.1/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that
