...
aliases:
  ...
  - /openriak-kv/2.0.7/theory/concepts/crdts
linkTitle: "Data Types"
weight: 104
---

[concept causal context dvv]: {{<baseurl>}}openriak-kv/2.0.7/learn/concepts/causal-context/#dotted-version-vectors
...
indexes]({{<baseurl>}}openriak-kv/2.0.7/developing/usage/secondary-indexes/) and [Search]({{<baseurl>}}openriak-kv/2.0.7/developing/usage/search/).
...
object]({{<baseurl>}}openriak-kv/2.0.7/developing/data-types/#Data-Types-and-Context) that is similar to a
