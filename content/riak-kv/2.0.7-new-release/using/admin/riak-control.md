...
toc: true
aliases:
  - /riak/2.0.7/ops/advanced/riak-control
  - /openriak-kv/2.0.7/ops/advanced/riak-control
...
enabled on each Riak node. For more information, see our [security documentation]({{<baseurl>}}openriak-kv/2.0.7/using/security/basics#enabling-ssl). Once SSL is enabled, you can proceed to setting up [authentication](#authentication) for Riak Control.
...
see the health of each [vnode]({{<baseurl>}}openriak-kv/2.0.7/learn/glossary/#vnode).
