...
toc: true
aliases:
  - /riak/2.0.7/dev/taste-of-riak/nodejs
  - /openriak-kv/2.0.7/dev/taste-of-riak/nodejs
linkTitle: "NodeJS"
weight: 104
---
...
If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}openriak-kv/2.0.7/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}openriak-kv/2.0.7/developing/getting-started/nodejs/crud-operations)
