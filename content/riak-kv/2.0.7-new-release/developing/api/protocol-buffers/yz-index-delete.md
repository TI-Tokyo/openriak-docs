...
aliases:
  ...
  - /openriak-kv/2.0.7/dev/references/protocol-buffers/yz-index-delete
...
## Response
 ...
 Returns a [RpbDelResp]({{<baseurl>}}openriak-kv/2.0.7/developing/api/protocol-buffers/#message-codes) code with no data on success.
