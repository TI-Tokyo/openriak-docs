...
toc: true
aliases:
  - /riak/2.0.7/dev/references/protocol-buffers/reset-bucket-props
  - /openriak-kv/2.0.7/dev/references/protocol-buffers/reset-bucket-props
...
[bucket type]({{<baseurl>}}openriak-kv/2.0.7/developing/usage/bucket-types) using the `type` value. If you do not
