...
aliases:
  - /riak/2.0.7/dev/references/protocol-buffers/yz-index-get
  - /openriak-kv/2.0.7/dev/references/protocol-buffers/yz-index-get
...
binary (as `name`). Optionally, you can specify a [`schema`]({{<baseurl>}}openriak-kv/2.0.7/developing/usage/search-schemas) name and/or an `n_val`, i.e. the number of nodes on which the
