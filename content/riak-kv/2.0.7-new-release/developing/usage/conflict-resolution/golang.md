...
toc: true
aliases:
  - /riak/2.0.7/dev/using/conflict-resolution/golang
  - /openriak-kv/2.0.7/dev/using/conflict-resolution/golang
linkTitle: "Go"
weight: 106
---

For reasons explained in the [Introduction to conflict resolution]({{<baseurl>}}openriak-kv/2.0.7/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that
