...
aliases:
  ...
  - /openriak-kv/2.0.7/dev/advanced/client-security/erlang
linkTitle: "Erlang"
weight: 103
---
...
on specifying trusted CIDRs can be found in [Trust-based Authentication]({{<baseurl>}}openriak-kv/2.0.7/using/security/managing-sources/#trust-based-authentication).
