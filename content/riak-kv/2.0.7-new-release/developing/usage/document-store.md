...
aliases:
  ...
  - /openriak-kv/2.0.7/dev/search/document-store
linkTitle: "Implementing a Document Store"
weight: 112
---

Although Riak wasn't explicitly created as a document store, two
features recently added to Riak---[Riak Search]({{<baseurl>}}openriak-kv/2.0.7/developing/usage/search/) and [Riak Data Types]({{<baseurl>}}openriak-kv/2.0.7/developing/data-types/)---make it possible to use Riak as a
...
[Riak maps]({{<baseurl>}}openriak-kv/2.0.7/developing/data-types/#maps).
...
however, we will store data in [Riak maps]({{<baseurl>}}openriak-kv/2.0.7/developing/data-types/#maps),
...
In the documentation on [search schemas]({{<baseurl>}}openriak-kv/2.0.7/developing/usage/search-schemas), you'll find a
...
described in [Data Modeling with Riak Data Types]({{<baseurl>}}openriak-kv/2.0.7/developing/data-modeling), we can construct a
