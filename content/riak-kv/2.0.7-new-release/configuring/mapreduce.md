...
toc: true
aliases:
  - /riak/2.0.7/ops/advanced/configs/mapreduce/
  - /openriak-kv/2.0.7/ops/advanced/configs/mapreduce/
linkTitle: "MapReduce Settings"
weight: 107
---

[usage mapreduce]: {{<baseurl>}}openriak-kv/2.0.7/developing/usage/mapreduce
[config reference#appconfig]: {{<baseurl>}}openriak-kv/2.0.7/configuring/reference/#app-config
