...
toc: true
aliases:
  - /riak/2.0.7/ops/building/planning/cluster
  - /openriak-kv/2.0.7/ops/building/planning/cluster
...
[use admin riak-admin#cluster]: {{<baseurl>}}openriak-kv/2.0.7/using/admin/riak-admin/#cluster
