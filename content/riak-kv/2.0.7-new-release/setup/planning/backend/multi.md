...
toc: true
aliases:
  - /riak/2.0.7/ops/advanced/backends/multi/
  - /openriak-kv/2.0.7/ops/advanced/backends/multi/
...
[use admin riak-admin cli]: {{<baseurl>}}openriak-kv/2.0.7/using/admin/riak-admin
