...
toc: true
aliases:
  - /riak/2.0.7/ops/building/installing/Installing-on-Solaris
  - /openriak-kv/2.0.7/ops/building/installing/Installing-on-Solaris
  - /riak/2.0.7/installing/solaris/
  - /openriak-kv/2.0.7/installing/solaris/
linkTitle: "Solaris"
weight: 306
---
...
```bash
curl -o /tmp/BASHOriak-2.0.7-Solaris10-i386.pkg.gz http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.7/solaris/10/BASHOriak-2.0.7-Solaris10-x86_64.pkg.gz
```

Next, install the package:

```bash
gunzip /tmp/BASHOriak-2.0.7-Solaris10-i386.pkg.gz
pkgadd /tmp/BASHOriak-2.0.7-Solaris10-i386.pkg
```
