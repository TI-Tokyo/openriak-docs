...
toc: true
aliases:
  - /riak/2.0.7/ops/building/installing/Installing-on-FreeBSD
  - /openriak-kv/2.0.7/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.0.7/installing/freebsd/
  - /openriak-kv/2.0.7/installing/freebsd/
linkTitle: "FreeBSD"
weight: 303
---
...
`pkg_add` remote option. For this example, we're installing `riak-2.0.7-FreeBSD-amd64.tbz`.

```bash
sudo pkg_add -r http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.7/freebsd/9/riak-2.0.7-FreeBSD-amd64.tbz
```
...
```
Package dependency openssl-1.0.0_7 for /tmp/riak-2.0.7-FreeBSD-amd64.tbz not found!
```
