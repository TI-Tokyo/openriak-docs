...
by accessing the Erlang console directly using the [`riak attach`]({{<baseurl>}}openriak-kv/3.0.12/using/admin/riak-cli/#attach) command. Once you run this command and drop into the console, enter the following:
