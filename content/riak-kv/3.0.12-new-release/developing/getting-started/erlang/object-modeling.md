...
toc: true
aliases:
  - /riak/3.0.12/dev/taste-of-riak/object-modeling-erlang
  - /openriak-kv/3.0.12/dev/taste-of-riak/object-modeling-erlang
...
We'll be using the bucket `Users` to store our data. We won't be [using bucket types]({{<baseurl>}}openriak-kv/3.0.12/developing/usage/bucket-types) here, so we don't need to specify one.
