...
aliases:
  ...
  - /openriak-kv/3.0.12/dev/references/http/set-bucket-props
...
clock) when writing
* `precommit` - [precommit hooks]({{<baseurl>}}openriak-kv/3.0.12/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks]({{<baseurl>}}openriak-kv/3.0.12/developing/usage/commit-hooks)
