...
toc: true
aliases:
  - /riak/2.9.10/theory/concepts/vnodes
  - /openriak-kv/2.9.10/theory/concepts/vnodes
linkTitle: "Vnodes"
weight: 109
---

[concept causal context]: {{<baseurl>}}openriak-kv/2.9.10/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}openriak-kv/2.9.10/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}openriak-kv/2.9.10/setup/planning/backend/bitcask) as a backend, navigate
...
`1004782375664995756265033322.9.1044576013453623296`. These directories
