...
aliases:
  ...
  - /openriak-kv/2.9.10/dev/references/protocol-buffers/mapreduce
linkTitle: "MapReduce"
weight: 107
---
...
The JSON encoding is the same as [REST API]({{<baseurl>}}openriak-kv/2.9.10/developing/usage/mapreduce/#rest) and
the external term format is the same as the [local Erlang API]({{<baseurl>}}openriak-kv/2.9.10/developing/app-guide/advanced-mapreduce/#erlang)
