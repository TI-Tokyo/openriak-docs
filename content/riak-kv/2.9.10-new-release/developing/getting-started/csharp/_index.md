...
toc: true
aliases:
  - /riak/2.9.10/dev/taste-of-riak/csharp
  - /openriak-kv/2.9.10/dev/taste-of-riak/csharp
linkTitle: "C Sharp"
weight: 103
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}openriak-kv/2.9.10/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}openriak-kv/2.9.10/developing/getting-started/csharp/crud-operations)
