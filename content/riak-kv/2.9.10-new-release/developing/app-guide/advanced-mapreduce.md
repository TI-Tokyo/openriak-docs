...
toc: true
aliases:
  - /riak/2.9.10/dev/advanced/mapreduce/
  - /openriak-kv/2.9.10/dev/advanced/mapreduce/
...
[installing custom code]({{<baseurl>}}openriak-kv/2.9.10/using/reference/custom-code).
{{% /note %}}
