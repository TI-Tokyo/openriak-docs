...
version_history:
  in: "2.0.8+"
aliases:
  - /riak/2.9.10/dev/using/data-types/hyperloglogs
  - /openriak-kv/2.9.10/dev/using/data-types/hyperloglogs
  - /riak/2.9.10/dev/data-modeling/data-types/hyperloglogs
  - /openriak-kv/2.9.10/dev/data-modeling/data-types/hyperloglogs
