...
toc: true
aliases:
  - /riak/2.9.10/dev/using/data-types/counters
  - /openriak-kv/2.9.10/dev/using/data-types/counters
  - /riak/2.9.10/dev/data-modeling/data-types/counters
  - /openriak-kv/2.9.10/dev/data-modeling/data-types/counters
linkTitle: "Counters"
weight: 100
---
