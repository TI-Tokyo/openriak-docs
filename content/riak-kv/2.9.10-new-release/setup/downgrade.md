...
aliases:
  ...
  - /openriak-kv/2.9.10/ops/upgrading/rolling-downgrades/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/2.9.10/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/2.9.10/using/admin/riak-admin/#aae-status
