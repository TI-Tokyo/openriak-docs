...
toc: true
aliases:
  - /riak/2.0.9/theory/concepts/vnodes
  - /openriak-kv/2.0.9/theory/concepts/vnodes
linkTitle: "Vnodes"
weight: 109
---

[concept causal context]: {{<baseurl>}}openriak-kv/2.0.9/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}openriak-kv/2.0.9/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}openriak-kv/2.0.9/setup/planning/backend/bitcask) as a backend, navigate
