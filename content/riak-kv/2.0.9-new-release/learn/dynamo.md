...
toc: false
aliases:
  - /riak/2.0.9/theory/dynamo
  - /openriak-kv/2.0.9/theory/dynamo
linkTitle: "Dynamo"
weight: 110
---

[client libraries]: {{<baseurl>}}openriak-kv/2.0.9/developing/client-libraries/
...
[Consistent Hashing]: {{<baseurl>}}openriak-kv/2.0.9/learn/glossary/#consistent-hashing
[Gossip Protocol]: {{<baseurl>}}openriak-kv/2.0.9/learn/glossary/#gossiping
...
[HTTP API]: {{<baseurl>}}openriak-kv/2.0.9/developing/api/http/
[Protocol Buffers API]: {{<baseurl>}}openriak-kv/2.0.9/developing/api/protocol-buffers/
...
[Further Reading on Partitioning in Riak KV]: {{<baseurl>}}openriak-kv/2.0.9/learn/concepts/clusters/
[All about the Riak KV Ring]: {{<baseurl>}}openriak-kv/2.0.9/learn/concepts/clusters/#the-ring
...
>
> [Vector Clock on Riak KV Glossary]({{<baseurl>}}openriak-kv/2.0.9/learn/glossary/#vector-clock)
>
...
>
>[REST API]({{<baseurl>}}openriak-kv/2.0.9/developing/api/http/)
>
>[Writing Data]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/creating-objects/)
>
>[Reading Data]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/reading-objects/)
...
> [Read Repair]({{<baseurl>}}openriak-kv/2.0.9/learn/concepts/replication/#read-repair).
...
[Hinted handoff]: {{<baseurl>}}openriak-kv/2.0.9/learn/glossary/#hinted-handoff
[Replication]: {{<baseurl>}}openriak-kv/2.0.9/developing/usage/replication/
...
[Multi Datacenter Replication]: {{<baseurl>}}openriak-kv/2.0.9/using/reference/v3-multi-datacenter/architecture/
...
[Adding and Removing Nodes]: {{<baseurl>}}openriak-kv/2.0.9/using/cluster-operations/adding-removing-nodes/
[Failure Scenarios]: {{<baseurl>}}openriak-kv/2.0.9/learn/concepts/eventual-consistency/
...
[riak-admin command-line tool]: {{<baseurl>}}openriak-kv/2.0.9/using/admin/riak-admin/
...
[gossiping]: {{<baseurl>}}openriak-kv/2.0.9/learn/glossary/#gossiping
...
[The Node Join Process]: {{<baseurl>}}openriak-kv/2.0.9/using/cluster-operations/adding-removing-nodes/#joining-nodes-to-form-a-cluster
...
[backend options]: {{<baseurl>}}openriak-kv/2.0.9/setup/planning/backend/
[Bitcask]: {{<baseurl>}}openriak-kv/2.0.9/setup/planning/backend/bitcask/
[LevelDB]: {{<baseurl>}}openriak-kv/2.0.9/setup/planning/backend/leveldb/
[Memory]: {{<baseurl>}}openriak-kv/2.0.9/setup/planning/backend/memory/
[secondary indexes]: {{<baseurl>}}openriak-kv/2.0.9/developing/usage/secondary-indexes/
...
[Basho Bench]: {{<baseurl>}}openriak-kv/2.0.9/using/performance/benchmarking/
...
[CRDTs (Commutative Replicated Data Types)]: {{<baseurl>}}openriak-kv/2.0.9/developing/data-types/
...
[partitioning]: {{<baseurl>}}openriak-kv/2.0.9/learn/concepts/replication/#understanding-replication-by-example
...
[The Node Join Process]: {{<baseurl>}}openriak-kv/2.0.9/using/cluster-operations/adding-removing-nodes/#joining-nodes-to-form-a-cluster
[Replacing a Node]: {{<baseurl>}}openriak-kv/2.0.9/using/cluster-operations/replacing-node/
...
[Load Balancing]: {{<baseurl>}}openriak-kv/2.0.9/configuring/load-balancing-proxy/
