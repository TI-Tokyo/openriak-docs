...
aliases:
  ...
  - /openriak-kv/2.0.9/ops/upgrading/rolling-upgrades/
  - /openriak-kv/2.0.9/ops/upgrading/rolling-upgrades/
  - /openriak-kv/2.0.9/setup/upgrading/cluster/

linkTitle: "Upgrading to 2.0.9"
weight: 101
---

[production checklist]: {{<baseurl>}}openriak-kv/2.0.9/setup/upgrading/checklist
...
[release notes]: {{<baseurl>}}openriak-kv/2.0.9/release-notes
...
[jmx monitor]: {{<baseurl>}}openriak-kv/2.0.9/using/reference/jmx
[snmp]: {{<baseurl>}}openriak-kv/2.0.9/using/reference/snmp
[Release Notes]: {{<baseurl>}}openriak-kv/2.0.9/release-notes
