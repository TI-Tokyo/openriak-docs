...
aliases:
  ...
  - /openriak-kv/2.0.9/ops/upgrading/rolling-downgrades/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/2.0.9/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/2.0.9/using/admin/riak-admin/#aae-status
