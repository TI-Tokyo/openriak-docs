...
toc: true
aliases:
  - /riak/2.0.9/ops/building/installing/Installing-on-FreeBSD
  - /openriak-kv/2.0.9/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.0.9/installing/freebsd/
  - /openriak-kv/2.0.9/installing/freebsd/
linkTitle: "FreeBSD"
weight: 303
---
...
```bash
sudo pkg_add -r http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.9/freebsd/9/riak-2.0.9-FreeBSD-amd64.tbz
```
