...
toc: true
aliases:
  - /riak/2.0.9/ops/building/installing/Installing-on-Debian-and-Ubuntu
  - /openriak-kv/2.0.9/ops/building/installing/Installing-on-Debian-and-Ubuntu
  - /riak/2.0.9/installing/debian-ubuntu/
  - /openriak-kv/2.0.9/installing/debian-ubuntu/
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.9/ubuntu/lucid/riak_2.0.9-1_amd64.deb
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.9/ubuntu/natty/riak_2.0.9-1_amd64.deb
sudo dpkg -i riak_2.0.9-1_amd64.deb
```
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.9/ubuntu/precise/riak_2.0.9-1_amd64.deb
sudo dpkg -i riak_2.0.9-1_amd64.deb
```
