...
toc: true
aliases:
  - /riak/2.0.9/ops/building/planning/cluster
  - /openriak-kv/2.0.9/ops/building/planning/cluster
...
[use admin riak-admin#cluster]: {{<baseurl>}}openriak-kv/2.0.9/using/admin/riak-admin/#cluster
