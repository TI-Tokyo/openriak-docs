...
aliases:
  ...
  - /openriak-kv/2.0.9/dev/using/data-modeling
...
operations, use of Riak features including [Data Types]({{<baseurl>}}openriak-kv/2.0.9/developing/data-types/),
[MapReduce]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/mapreduce/), [Search]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/search/),
[secondary indexes (2i)]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/secondary-indexes/) and more. This guide
...
* [Session Storage]({{<baseurl>}}openriak-kv/2.0.9/developing/data-modeling/#session-storage)
* [Serving Advertisements]({{<baseurl>}}openriak-kv/2.0.9/developing/data-modeling/#serving-advertisements)
* [Log Data]({{<baseurl>}}openriak-kv/2.0.9/developing/data-modeling/#log-data)
* [Sensor Data]({{<baseurl>}}openriak-kv/2.0.9/developing/data-modeling/#sensor-data)
...
* [User Accounts]({{<baseurl>}}openriak-kv/2.0.9/developing/data-modeling/#user-accounts)
* [User Settings and Preferences]({{<baseurl>}}openriak-kv/2.0.9/developing/data-modeling/#user-settings-and-preferences)
* [User Events and Timelines]({{<baseurl>}}openriak-kv/2.0.9/developing/data-modeling/#user-events-and-timelines)
* [Articles, Blog Posts, and Other Content]({{<baseurl>}}openriak-kv/2.0.9/developing/data-modeling/#articles-blog-posts-and-other-content)
...
session expiry. Riak's [MapReduce]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/mapreduce/) system can also be
...
address), [using secondary indexes]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/secondary-indexes/) can provide an easy solution.
...
for analysis [using MapReduce]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/mapreduce) or as a storage system used in
...
[secondary index]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/secondary-indexes/), which would allow you to
perform queries on specific time interval ranges or to perform
[MapReduce]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/mapreduce/) queries against the indexes.
...
username as a [secondary index]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/secondary-indexes/) for efficient
lookup.
...
indexes or consider using [Riak Search]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/search/) to index the JSON
...
data in Riak is opaque, with the exception of [Riak Data Types]({{<baseurl>}}openriak-kv/2.0.9/developing/data-types),
and so Riak won't "know" about the object unless it is indexed
[using Riak Search]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/search/) or [using secondary indexes]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/secondary-indexes/).
...
key/value pairs. [Riak Search]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/search/) is recommended for use cases
involving full-text search. For lighter-weight querying,
[using secondary indexes]({{<baseurl>}}openriak-kv/2.0.9/developing/usage/secondary-indexes/) \(2i) enables you to add metadata to objects to
