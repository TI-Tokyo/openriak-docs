...
toc: true
aliases:
  - /riak/2.0.9/dev/using/data-types
  - /openriak-kv/2.0.9/dev/using/data-types
  - /riak/2.0.9/dev/data-modeling/data-types
  - /openriak-kv/2.0.9/dev/data-modeling/data-types
