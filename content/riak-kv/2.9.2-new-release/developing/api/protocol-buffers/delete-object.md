...
toc: true
aliases:
  - /riak/2.9.2/dev/references/protocol-buffers/delete-object
  - /openriak-kv/2.9.2/dev/references/protocol-buffers/delete-object
linkTitle: "Delete Object"
weight: 107
---

Delete an object in the specified [bucket type]({{<baseurl>}}openriak-kv/2.9.2/using/cluster-operations/bucket-types)/bucket/key location.
