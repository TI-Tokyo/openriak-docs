...
aliases:
  - /riak/2.9.2/dev/references/http/fetch-search-schema
  - /openriak-kv/2.9.2/dev/references/http/fetch-search-schema
linkTitle: "Fetch Search Schema"
weight: 116
---

Retrieves a Riak KV [search schema]({{<baseurl>}}openriak-kv/2.9.2/developing/usage/search-schemas).
