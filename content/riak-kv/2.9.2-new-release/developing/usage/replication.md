...
<a href="{{<baseurl>}}openriak-kv/2.9.2/using/reference/strong-consistency/">strongly
...
<a href="{{<baseurl>}}openriak-kv/2.9.2/developing/app-guide/strong-consistency/">Using
...
documentation on [Bitcask][plan backend bitcask], [LevelDB][plan backend leveldb], and [multiple backends]({{<baseurl>}}openriak-kv/2.9.2/setup/planning/backend/multi).
...
refer to the tutorial on [basic key/value operations in Riak KV]({{<baseurl>}}openriak-kv/2.9.2/developing/getting-started)
