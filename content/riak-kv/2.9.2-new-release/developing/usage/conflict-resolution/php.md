...
aliases:
  ...
  - /openriak-kv/2.9.2/dev/using/conflict-resolution/php
linkTitle: "PHP"
weight: 105
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.9.2/developing/usage) section.
