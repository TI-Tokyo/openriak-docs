...
aliases:
  - /riak/2.9.2/dev/search/search-data-types
  - /openriak-kv/2.9.2/dev/search/search-data-types
linkTitle: "Searching with Data Types"
weight: 111
---

Although [Riak Data Types]({{<baseurl>}}openriak-kv/2.9.2/developing/data-types) function differently from other
...
that you don't need to worry about as a user). Riak's [counters]({{<baseurl>}}openriak-kv/2.9.2/developing/data-types/#counters), [sets]({{<baseurl>}}openriak-kv/2.9.2/developing/data-types/#sets), and [maps]({{<baseurl>}}openriak-kv/2.9.2/developing/data-types/#maps)
...
The default schema for [counters]({{<baseurl>}}openriak-kv/2.9.2/developing/data-types/#counters) indexes each
...
The schema for [sets]({{<baseurl>}}openriak-kv/2.9.2/developing/data-types/#sets) indexes each element of a set as
...
For searching within [maps]({{<baseurl>}}openriak-kv/2.9.2/developing/data-types/#maps), there are four schemas
...
knowledge. We'll create and activate a [bucket type]({{<baseurl>}}openriak-kv/2.9.2/developing/usage/bucket-types) for [storing counters]({{<baseurl>}}openriak-kv/2.9.2/developing/data-types/#counters) simply called
`counters`, like so:
...
people in sets. We'll create and activate a [bucket type]({{<baseurl>}}openriak-kv/2.9.2/developing/usage/bucket-types) for [storing sets]({{<baseurl>}}openriak-kv/2.9.2/developing/data-types/#sets) simply called `sets`,
like so:
...
This example will build on the example in the [Using Data Types]({{<baseurl>}}openriak-kv/2.9.2/developing/data-types)
tutorial. That tutorial walks you through storing CMS-style user data in
Riak [maps]({{<baseurl>}}openriak-kv/2.9.2/developing/data-types/#maps), and we'd suggest that you
