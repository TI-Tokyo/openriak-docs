...
aliases:
  ...
  - /openriak-kv/2.9.2/dev/taste-of-riak/querying-erlang
linkTitle: "Querying"
weight: 101
---
...
A more comprehensive discussion can be found in [Key/Value Modeling]({{<baseurl>}}openriak-kv/2.9.2/developing/key-value-modeling).
...
{{% note %}}
Secondary indexes in Riak KV require a sorted backend: [Memory]({{<baseurl>}}openriak-kv/2.9.2/setup/planning/backend/memory) or [LevelDB]({{<baseurl>}}openriak-kv/2.9.2/setup/planning/backend/leveldb). [Bitcask]({{<baseurl>}}openriak-kv/2.9.2/setup/planning/backend/bitcask) does not support secondary indexes.

See [Using Secondary Indexes (2i)]({{<baseurl>}}openriak-kv/2.9.2/developing/usage/secondary-indexes) for more information on developing with secondary indexes.
{{% /note %}}
