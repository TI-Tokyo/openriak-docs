...
aliases:
  ...
  - /openriak-kv/2.9.2/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.9.2/installing/freebsd/
  - /openriak-kv/2.9.2/installing/freebsd/
linkTitle: "FreeBSD"
weight: 303
---
...
`pkg_add` remote option. For this example, we're installing `riak-2.9.2.txz`.
