...
toc: true
aliases:
  - /riak/2.9.2/ops/upgrading/rolling-downgrades/
  - /openriak-kv/2.9.2/ops/upgrading/rolling-downgrades/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/2.9.2/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/2.9.2/using/admin/riak-admin/#aae-status
...
If you enabled LZ4 compression in LevelDB and/or enabled global expiration in LevelDB when you installed KV 2.9.2, you cannot downgrade.
