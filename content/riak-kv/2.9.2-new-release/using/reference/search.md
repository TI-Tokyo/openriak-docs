...
aliases:
  ...
  - /openriak-kv/2.9.2/dev/advanced/search
linkTitle: "Search"
weight: 109
---

[concept clusters]: {{<baseurl>}}openriak-kv/2.9.2/learn/concepts/clusters
[configuring search]: {{<baseurl>}}openriak-kv/2.9.2/configuring/search
...
search, you should check out the [Using Search]({{<baseurl>}}openriak-kv/2.9.2/developing/usage/search) document.
...
See the [main Search documentation]({{<baseurl>}}openriak-kv/2.9.2/developing/usage/search/#simple-setup) for details on creating an index.
...
You can also find more information on to how customize your own [search schema]({{<baseurl>}}openriak-kv/2.9.2/developing/usage/search-schemas).
...
[Active Anti-Entropy]({{<baseurl>}}openriak-kv/2.9.2/learn/concepts/active-anti-entropy/) \(AAE) is the process of discovering and
...
information on analysis, see [Search Schema]({{<baseurl>}}openriak-kv/2.9.2/developing/usage/search-schemas).
