...
toc: true
aliases:
  - /riak/2.9.2/ops/mdc/comparison
  - /openriak-kv/2.9.2/ops/mdc/comparison
linkTitle: "Comparison"
weight: 103
---

This document is a systematic comparison of [Version 2]({{<baseurl>}}openriak-kv/2.9.2/using/reference/v2-multi-datacenter) and [Version 3]({{<baseurl>}}openriak-kv/2.9.2/using/reference/v3-multi-datacenter) of Riak's Multi-Datacenter
...
* Version 3 is able to take advantage of [Active Anti-Entropy]({{<baseurl>}}openriak-kv/2.9.2/learn/concepts/active-anti-entropy/) \(AAE)
