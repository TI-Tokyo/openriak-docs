...
toc: true
aliases:
  - /riak/2.9.2/ops/running/nodes/adding-removing
  - /openriak-kv/2.9.2/ops/running/nodes/adding-removing
...
simply the script [`riak`]({{<baseurl>}}openriak-kv/2.9.2/using/admin/riak-cli/):
