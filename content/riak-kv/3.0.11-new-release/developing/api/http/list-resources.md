...
toc: true
aliases:
  - /riak/3.0.11/dev/references/http/list-resources
  - /openriak-kv/3.0.11/dev/references/http/list-resources
...
* `riak_kv_wm_buckets` - [Bucket Operations]({{<baseurl>}}openriak-kv/3.0.11/developing/api/http/#bucket-operations)
* `riak_kv_wm_index` - [HTTP Secondary Indexes]({{<baseurl>}}openriak-kv/3.0.11/developing/api/http/secondary-indexes)
* `riak_kv_wm_link_walker` - [HTTP Link Walking]({{<baseurl>}}openriak-kv/3.0.11/developing/api/http/link-walking)
* `riak_kv_wm_mapred` - [HTTP MapReduce]({{<baseurl>}}openriak-kv/3.0.11/developing/api/http/mapreduce)
* `riak_kv_wm_object`- [Object/Key Operations]({{<baseurl>}}openriak-kv/3.0.11/developing/api/http/#object-key-operations)
* `riak_kv_wm_ping` - [HTTP Ping]({{<baseurl>}}openriak-kv/3.0.11/developing/api/http/ping)
* `riak_kv_wm_props` - [HTTP Set Bucket Properties]({{<baseurl>}}openriak-kv/3.0.11/developing/api/http/set-bucket-props)
* `riak_kv_wm_stats` - [HTTP Status]({{<baseurl>}}openriak-kv/3.0.11/developing/api/http/status)
