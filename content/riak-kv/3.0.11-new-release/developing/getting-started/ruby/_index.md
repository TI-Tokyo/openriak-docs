...
toc: true
aliases:
  - /riak/3.0.11/dev/taste-of-riak/ruby
  - /openriak-kv/3.0.11/dev/taste-of-riak/ruby
linkTitle: "Ruby"
weight: 101
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}openriak-kv/3.0.11/using/running-a-cluster) first. To try this flavor
...
[CRUD Operations]({{<baseurl>}}openriak-kv/3.0.11/developing/getting-started/ruby/crud-operations)
