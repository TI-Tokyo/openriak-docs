...
toc: true
aliases:
  - /riak/3.0.11/dev/advanced/mapreduce/
  - /openriak-kv/3.0.11/dev/advanced/mapreduce/
...
dramatically faster and more reliable in Riak KV, and tools such as 2i are simpler to use and may place less strain on a
cluster.
...
[installing custom code]({{<baseurl>}}openriak-kv/3.0.11/using/reference/custom-code).
{{% /note %}}
