...
aliases:
  - /riak/3.0.11/ops/mdc/v2/configuration
  - /openriak-kv/3.0.11/ops/mdc/v2/configuration
...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}openriak-kv/3.0.11/configuring/v3-multi-datacenter/) instead.
{{% /note %}}
