...
aliases:
  ...
  - /openriak-kv/3.0.11/ops/running/tools/riak-admin
...
[use admin commands#join]: {{<baseurl>}}openriak-kv/3.0.11/using/admin/commands/#join
[use admin commands#leave]: {{<baseurl>}}openriak-kv/3.0.11/using/admin/commands/#leave
[use admin commands#status] {{<baseurl>}}openriak-kv/3.0.11/using/admin/commands/#status
[cluster ops backup]: {{<baseurl>}}openriak-kv/3.0.11/using/cluster-operations/backing-up
[config reference#node-metadata]: {{<baseurl>}}openriak-kv/3.0.11/configuring/reference/#node-metadata
...
[config reference#ring]: {{<baseurl>}}openriak-kv/3.0.11/configuring/reference/#ring
...
[downgrade]: {{<baseurl>}}openriak-kv/3.0.11/setup/downgrade
...
[use admin riak admin#stats]: {{<baseurl>}}openriak-kv/3.0.11/using/admin/riak-admin/#stats
