...
toc: true
aliases:
  - /openriak-kv/3.0.11/ops/tuning/linux/
  - /riak/3.0.11/ops/tuning/linux/
...
clusters on the Amazon Web Services EC2 environment, see [AWS Performance Tuning]({{<baseurl>}}openriak-kv/3.0.11/using/performance/amazon-web-services).
...
open files limit is necessary. See [Open Files Limit]({{<baseurl>}}openriak-kv/3.0.11/using/performance/open-files-limit/) for more
details.

## Other Tuning Docs

* [AWS Performance Tuning]({{<baseurl>}}openriak-kv/3.0.11/using/performance/amazon-web-services)
* [Erlang VM Tuning]({{<baseurl>}}openriak-kv/3.0.11/using/performance/erlang)
* [Latency Reduction]({{<baseurl>}}openriak-kv/3.0.11/using/performance/latency-reduction)
* [Open Files Limit]({{<baseurl>}}openriak-kv/3.0.11/using/performance/open-files-limit/)
