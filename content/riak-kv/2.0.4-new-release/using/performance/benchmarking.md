...
aliases:
  ...
  - /openriak-kv/2.0.4/ops/building/benchmarking
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}openriak-kv/2.0.4/setup/installing/source/erlang) for instructions
