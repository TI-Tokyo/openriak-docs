...
toc: true
aliases:
  - /riak/2.0.4/theory/concepts/Replication
  - /openriak-kv/2.0.4/theory/concepts/Replication
  - /riak/2.0.4/theory/concepts/replication
  - /openriak-kv/2.0.4/theory/concepts/replication
...
[glossary node]: {{<baseurl>}}openriak-kv/2.0.4/learn/glossary/#node
...
bucket's [bucket type]({{<baseurl>}}openriak-kv/2.0.4/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}openriak-kv/2.0.4/setup/planning/backend/multi) capabilities.
...
type]({{<baseurl>}}openriak-kv/2.0.4/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}openriak-kv/2.0.4/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}openriak-kv/2.0.4/developing/usage/mapreduce/) queries. Lowering an object or bucket's
