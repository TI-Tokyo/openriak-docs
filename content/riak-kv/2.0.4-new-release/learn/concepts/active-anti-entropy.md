...
toc: true
aliases:
  - /riak/2.0.4/theory/concepts/aae
  - /openriak-kv/2.0.4/theory/concepts/aae
linkTitle: "Active Anti-Entropy"
weight: 100
---

[cluster ops v3 mdc]: {{<baseurl>}}openriak-kv/2.0.4/using/cluster-operations/v3-multi-datacenter
[cluster ops aae]: {{<baseurl>}}openriak-kv/2.0.4/using/cluster-operations/active-anti-entropy
...
[config aae]: {{<baseurl>}}openriak-kv/2.0.4/configuring/reference/#active-anti-entropy
