...
[concept causal context vc]: {{<baseurl>}}openriak-kv/2.0.4/learn/concepts/causal-context/#vector-clocks
...
[concept strong consistency]: {{<baseurl>}}openriak-kv/2.0.4/learn/concepts/strong-consistency
[dev kv model]: {{<baseurl>}}openriak-kv/2.0.4/developing/key-value-modeling
[concept replication aae]: {{<baseurl>}}openriak-kv/2.0.4/learn/concepts/replication/#active-anti-entropy
...
[learn dynamo]: {{<baseurl>}}openriak-kv/2.0.4/learn/dynamo
[plan cluster capacity]: {{<baseurl>}}openriak-kv/2.0.4/setup/planning/cluster-capacity
[repair recover failure recovery]: {{<baseurl>}}openriak-kv/2.0.4/using/repair-recovery/failure-recovery
[repair recover repairs]: {{<baseurl>}}openriak-kv/2.0.4/using/repair-recovery/repairs
...
[usage secondary-indexes]: {{<baseurl>}}openriak-kv/2.0.4/developing/usage/secondary-indexes
...
* [Bucket Types]({{<baseurl>}}openriak-kv/2.0.4/developing/usage/bucket-types)
