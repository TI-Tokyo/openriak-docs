...
aliases:
  ...
  - /openriak-kv/2.0.4/dev/using/conflict-resolution/ruby
linkTitle: "Ruby"
weight: 101
---
...
the official Ruby client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.0.4/developing/usage) section.
