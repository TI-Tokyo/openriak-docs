...
toc: true
aliases:
  - /riak/2.0.4/dev/using/conflict-resolution/csharp
  - /openriak-kv/2.0.4/dev/using/conflict-resolution/csharp
linkTitle: "C Sharp"
weight: 103
---

For reasons explained in the [Introduction to conflict resolution]({{<baseurl>}}openriak-kv/2.0.4/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that requires applications to resolve siblings according to use-case-specific
