...
toc: true
aliases:
  - /riak/2.0.4/ops/building/installing/Installing-on-Mac-OS-X
  - /openriak-kv/2.0.4/ops/building/installing/Installing-on-Mac-OS-X
  - /riak/2.0.4/installing/mac-osx/
  - /openriak-kv/2.0.4/installing/mac-osx/
linkTitle: "Mac OS X"
weight: 303
---
...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.4/osx/10.8/riak-2.0.4-OSX-x86_64.tar.gz
