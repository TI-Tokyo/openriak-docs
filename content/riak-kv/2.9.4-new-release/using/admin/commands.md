...
toc: true
aliases:
  - /riak/2.9.4/ops/running/cluster-admin
  - /openriak-kv/2.9.4/ops/running/cluster-admin
...
[use admin riak-admin#cluster-plan]: {{<baseurl>}}openriak-kv/2.9.4/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: {{<baseurl>}}openriak-kv/2.9.4/using/admin/riak-admin/#cluster-commit
