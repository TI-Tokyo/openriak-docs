...
[upgrade]: {{<baseurl>}}openriak-kv/2.9.4/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}openriak-kv/2.9.4/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}openriak-kv/2.9.4/using/cluster-operations/adding-removing-nodes
