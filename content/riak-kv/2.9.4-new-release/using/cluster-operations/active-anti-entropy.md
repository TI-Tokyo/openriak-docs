...
toc: true
aliases:
  - /openriak-kv/2.9.4/ops/advanced/aae/
  - /riak/2.9.4/ops/advanced/aae/
linkTitle: "Legacy AAE"
weight: 110
---
[config search#throttledelay]: {{<baseurl>}}openriak-kv/2.9.4/configuring/search/#search-anti-entropy-throttle-tier-delay
[config search#throttle]: {{<baseurl>}}openriak-kv/2.9.4/configuring/search/#search-anti-entropy-throttle
...
In Riak versions 2.9.1 and later, [TicTac AAE]({{<baseurl>}}openriak-kv/2.9.4/using/cluster-operations/tictac-active-anti-entropy/) is included with releases as an option to be used in addition to or instead of traditional AAE in Riak.
