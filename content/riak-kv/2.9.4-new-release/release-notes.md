...
aliases:
  ...
  - /openriak-kv/2.9.4/intro-v20
  - /riak/2.9.4/intro-v20
  - /openriak-kv/2.9.4/introduction
...
Please see the KV 2.9.2 release notes [here]({{<baseurl>}}openriak-kv/2.9.2/release-notes/), the KV 2.9.1 release notes [here]({{<baseurl>}}openriak-kv/2.9.1/release-notes/), and the KV 2.9.0p5 release notes [here]({{<baseurl>}}openriak-kv/2.9.4/release-notes/).
