...
toc: true
aliases:
  - /riak/2.9.4/dev/references/protocol-buffers/fetch-object
  - /openriak-kv/2.9.4/dev/references/protocol-buffers/fetch-object
...
[`RpbPutResp`]({{<baseurl>}}openriak-kv/2.9.4/developing/api/protocol-buffers/store-object), respectively):
...
* `vtag`
---
The object's [vtag]({{<baseurl>}}openriak-kv/2.9.4/learn/glossary/#vector-clock)
* `links`
---
...
This field stores user-specified key/value metadata
  ...
  send metadata of this sort are structured like this:
    ...
    `RpbPair` messages are also used to attach [secondary indexes]({{<baseurl>}}openriak-kv/2.9.4/developing/usage/secondary-indexes) to objects (in the optional
    `indexes` field).
* `deleted`
---
