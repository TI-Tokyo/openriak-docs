...
toc: true
aliases:
  - /riak/2.9.4/dev/references/protocol-buffers/set-bucket-props
  - /openriak-kv/2.9.4/dev/references/protocol-buffers/set-bucket-props
...
[PBC Get Bucket Properties]({{<baseurl>}}openriak-kv/2.9.4/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type]({{<baseurl>}}openriak-kv/2.9.4/developing/usage/bucket-types) using the
