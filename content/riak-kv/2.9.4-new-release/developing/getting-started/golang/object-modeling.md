...
toc: true
aliases:
  - /riak/2.9.4/dev/taste-of-riak/object-modeling-golang
  - /openriak-kv/2.9.4/dev/taste-of-riak/object-modeling-golang
...
We'll be using the bucket `Users` to store our data. We won't be [using bucket types]({{<baseurl>}}openriak-kv/2.9.4/developing/usage/bucket-types) here, so we don't need to specify one.
