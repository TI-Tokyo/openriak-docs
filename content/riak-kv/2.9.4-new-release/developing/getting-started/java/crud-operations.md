...
Riak, see [Updating Objects]({{<baseurl>}}openriak-kv/2.9.4/developing/usage/updating-objects/)
and [Conflict Resolution]({{<baseurl>}}openriak-kv/2.9.4/developing/usage/conflict-resolution/)
documentation.
