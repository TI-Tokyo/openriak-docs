...
toc: true
aliases:
  - /riak/2.9.4/ops/building/planning/cluster
  - /openriak-kv/2.9.4/ops/building/planning/cluster
...
[use admin riak-admin#cluster]: {{<baseurl>}}openriak-kv/2.9.4/using/admin/riak-admin/#cluster
