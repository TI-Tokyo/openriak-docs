...
toc: true
aliases:
  - /riak/2.9.4/ops/building/installing/Installing-on-AWS-Marketplace
  - /openriak-kv/2.9.4/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/2.9.4/installing/amazon-web-services/
  - /openriak-kv/2.9.4/installing/amazon-web-services/
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}openriak-kv/2.9.4/using/security/).
