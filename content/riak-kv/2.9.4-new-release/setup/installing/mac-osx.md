...
toc: true
aliases:
  - /riak/2.9.4/ops/building/installing/Installing-on-Mac-OS-X
  - /openriak-kv/2.9.4/ops/building/installing/Installing-on-Mac-OS-X
  - /riak/2.9.4/installing/mac-osx/
  - /openriak-kv/2.9.4/installing/mac-osx/
linkTitle: "Mac OS X"
weight: 303
---
...
```bash
curl -O https://files.tiot.jp/riak/kv/2.9/2.9.4/osx/10.11/riak-2.9.4-OSX-x86_64.tar.gz
tar xzvf riak-2.9.4-osx-x86_64.tar.gz
```
...
Installing Riak 2.9.4 with [Homebrew](http://brew.sh/) is easy:
