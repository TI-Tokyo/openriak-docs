...
aliases:
  ...
  - /openriak-kv/3.0.1/dev/references/protocol-buffers/dt-union
...
`DtOp` messages are sent only as part of a [`DtUpdateReq`]({{<baseurl>}}openriak-kv/3.0.1/developing/api/protocol-buffers/dt-store) message.
