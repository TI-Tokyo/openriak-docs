...
aliases:
  ...
  - /openriak-kv/3.0.1/dev/references/protocol-buffers/auth-req
...
For more on authentication, see our documentation on [Authentication and Authorization]({{<baseurl>}}openriak-kv/3.0.1/using/security/basics).
