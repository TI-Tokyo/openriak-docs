...
aliases:
  ...
  - /openriak-kv/3.0.1/dev/references/protocol-buffers/dt-set-store
...
level) or [inside of a map]({{<baseurl>}}openriak-kv/3.0.1/developing/api/protocol-buffers/dt-map-store).
