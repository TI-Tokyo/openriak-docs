...
aliases:
  ...
  - /openriak-kv/3.0.1/dev/references/http/counters
...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}openriak-kv/3.0.1/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}openriak-kv/3.0.1/developing/api/http/fetch-object)) responses apply here.
