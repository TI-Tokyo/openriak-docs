...
toc: true
aliases:
  - /riak/3.0.1/dev/advanced/client-security/java
  - /openriak-kv/3.0.1/dev/advanced/client-security/java
...
security setup described [below](#java-client-basics). [Certificate]({{<baseurl>}}openriak-kv/3.0.1/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
