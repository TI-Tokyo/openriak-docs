...
toc: true
aliases:
  - /riak/3.0.1/dev/using/conflict-resolution/java
  - /openriak-kv/3.0.1/dev/using/conflict-resolution/java
...
[bucket type]({{<baseurl>}}openriak-kv/3.0.1/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official Java client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/3.0.1/developing/usage) section.
