...
toc: true
aliases:
  - /riak/3.0.1/dev/using/conflict-resolution/ruby
  - /openriak-kv/3.0.1/dev/using/conflict-resolution/ruby
...
the official Ruby client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/3.0.1/developing/usage) section.
