...
toc: true
aliases:
  - /riak/3.0.1/dev/using/mapreduce
  - /openriak-kv/3.0.1/dev/using/mapreduce
...
[usage types]: {{<baseurl>}}openriak-kv/3.0.1/developing/usage/bucket-types
[api http]: {{<baseurl>}}openriak-kv/3.0.1/developing/api/http
[api pb]: {{<baseurl>}}openriak-kv/3.0.1/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}openriak-kv/3.0.1/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}openriak-kv/3.0.1/developing/app-guide/advanced-mapreduce
...
* When you want to return actual objects or pieces of objects and not
  just the keys. [Secondary indexes][usage 2i] are other means of returning objects based on
