...
toc: true
aliases:
  - /riak/3.0.1/dev/taste-of-riak/querying-erlang
  - /openriak-kv/3.0.1/dev/taste-of-riak/querying-erlang
...
A more comprehensive discussion can be found in [Key/Value Modeling]({{<baseurl>}}openriak-kv/3.0.1/developing/key-value-modeling).
...
{{% note %}}
Secondary indexes in Riak KV require a sorted backend: [Memory]({{<baseurl>}}openriak-kv/3.0.1/setup/planning/backend/memory) or [LevelDB]({{<baseurl>}}openriak-kv/3.0.1/setup/planning/backend/leveldb). [Bitcask]({{<baseurl>}}openriak-kv/3.0.1/setup/planning/backend/bitcask) does not support secondary indexes.

See [Using Secondary Indexes (2i)]({{<baseurl>}}openriak-kv/3.0.1/developing/usage/secondary-indexes) for more information on developing with secondary indexes.
{{% /note %}}
