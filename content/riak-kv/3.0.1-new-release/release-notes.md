...
aliases:
  ...
  - /openriak-kv/3.0.1/intro-v20
  - /riak/3.0.1/intro-v20
  - /openriak-kv/3.0.1/introduction
...
Please see the KV 2.9.7 release notes [here]({{<baseurl>}}openriak-kv/2.9.7/release-notes/), the KV 2.9.4 release notes [here]({{<baseurl>}}openriak-kv/2.9.4/release-notes/), and the KV 2.9.1 release notes [here]({{<baseurl>}}openriak-kv/2.9.1/release-notes/).
