...
toc: true
aliases:
  - /riak/3.0.1/ops/building/installing/Installing-on-FreeBSD
  - /openriak-kv/3.0.1/ops/building/installing/Installing-on-FreeBSD
  - /riak/3.0.1/installing/freebsd/
  - /openriak-kv/3.0.1/installing/freebsd/
...
`pkg_add` remote option. For this example, we're installing `riak-3.0.1.txz`.
...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/3.0/3.0.1/freebsd/10.4/riak-3.0.1.txz
```
