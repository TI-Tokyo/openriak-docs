...
aliases:
  ...
  - /openriak-kv/3.0.1/ops/upgrading/rolling-downgrades/

linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/3.0.1/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/3.0.1/using/admin/riak-admin/#aae-status
