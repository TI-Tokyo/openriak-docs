...
toc: true
aliases:
  - /riak/3.0.1/ops/advanced/backends/leveled/
  - /openriak-kv/3.0.1/ops/advanced/backends/leveled/
...
[config reference#aae]: {{<baseurl>}}openriak-kv/3.0.1/configuring/reference/#active-anti-entropy
...
Leveled is included with Riak KV 2.9.7 and beyond, so there is no need to install anything further.
