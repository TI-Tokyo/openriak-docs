...
aliases:
  ...
  - /openriak-kv/3.0.1/ops/mdc/v2/quick-start
...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}openriak-kv/3.0.1/configuring/v3-multi-datacenter/quick-start/) instead.
{{% /note %}}
