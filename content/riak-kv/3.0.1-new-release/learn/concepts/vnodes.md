...
aliases:
  ...
  - /openriak-kv/3.0.1/theory/concepts/vnodes
...
[concept clusters ring]: {{<baseurl>}}openriak-kv/3.0.1/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}openriak-kv/3.0.1/setup/planning/backend/bitcask) as a backend, navigate
