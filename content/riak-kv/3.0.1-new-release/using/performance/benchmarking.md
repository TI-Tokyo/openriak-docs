...
aliases:
  ...
  - /openriak-kv/3.0.1/ops/building/benchmarking
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}openriak-kv/3.0.1/setup/installing/source/erlang) for instructions
