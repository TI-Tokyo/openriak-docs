...
toc: true
aliases:
  - /riak/2.1.1/dev/using/data-types
  - /openriak-kv/2.1.1/dev/using/data-types
  - /riak/2.1.1/dev/data-modeling/data-types
  - /openriak-kv/2.1.1/dev/data-modeling/data-types
