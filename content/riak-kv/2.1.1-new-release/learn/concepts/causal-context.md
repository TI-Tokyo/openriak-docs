...
aliases:
  ...
  - /openriak-kv/2.1.1/theory/concepts/context
...
[dev key value]: {{<baseurl>}}openriak-kv/2.1.1/developing/key-value-modeling
[glossary read rep]: {{<baseurl>}}openriak-kv/2.1.1/learn/glossary/#read-repair
[perf latency reduc]: {{<baseurl>}}openriak-kv/2.1.1/using/performance/latency-reduction
...
[usage protocol buffers]: {{<baseurl>}}openriak-kv/2.1.1/developing/api/protocol-buffers
[usage updating objects]: {{<baseurl>}}openriak-kv/2.1.1/developing/usage/updating-objects
...
[using bucket types]({{<baseurl>}}openriak-kv/2.1.1/developing/usage/bucket-types), all writes to that bucket will create siblings
