...
toc: true
aliases:
  - /riak/2.1.1/ops/advanced/backends/multi/
  - /openriak-kv/2.1.1/ops/advanced/backends/multi/
...
[use admin riak-admin cli]: {{<baseurl>}}openriak-kv/2.1.1/using/admin/riak-admin
