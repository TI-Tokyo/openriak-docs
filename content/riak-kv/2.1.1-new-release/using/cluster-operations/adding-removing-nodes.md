...
toc: true
aliases:
  - /riak/2.1.1/ops/running/nodes/adding-removing
  - /openriak-kv/2.1.1/ops/running/nodes/adding-removing
...
simply the script [`riak`]({{<baseurl>}}openriak-kv/2.1.1/using/admin/riak-cli/):
