...
aliases:
  - /riak/2.1.1/ops/mdc/v2/operations
  - /openriak-kv/2.1.1/ops/mdc/v2/operations
...
participate in realtime replication. Please see the [Riak Enterprise MDC Replication Configuration]({{<baseurl>}}openriak-kv/2.1.1/configuring/v2-multi-datacenter/) guide for more information.
