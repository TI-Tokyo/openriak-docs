...
toc: true
aliases:
  - /riak/3.2.4/dev/using/data-types
  - /openriak-kv/3.2.4/dev/using/data-types
  - /riak/3.2.4/dev/data-modeling/data-types
  - /openriak-kv/3.2.4/dev/data-modeling/data-types
