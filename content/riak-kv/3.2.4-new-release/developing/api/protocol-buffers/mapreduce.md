...
toc: true
aliases:
  - /riak/3.2.4/dev/references/protocol-buffers/mapreduce
  - /openriak-kv/3.2.4/dev/references/protocol-buffers/mapreduce
linkTitle: "MapReduce"
weight: 107
---
...
The JSON encoding is the same as [REST API]({{<baseurl>}}openriak-kv/3.2.4/developing/usage/mapreduce/#rest) and
the external term format is the same as the [local Erlang API]({{<baseurl>}}openriak-kv/3.2.4/developing/app-guide/advanced-mapreduce/#erlang)
