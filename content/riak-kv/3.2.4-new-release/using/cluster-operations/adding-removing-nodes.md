...
toc: true
aliases:
  - /riak/3.2.4/ops/running/nodes/adding-removing
  - /openriak-kv/3.2.4/ops/running/nodes/adding-removing
...
simply the script [`riak`]({{<baseurl>}}openriak-kv/3.2.4/using/admin/riak-cli/):
