...
aliases:
  ...
  - /openriak-kv/3.0.14/dev/references/protocol-buffers/dt-union
...
`DtOp` messages are sent only as part of a [`DtUpdateReq`]({{<baseurl>}}openriak-kv/3.0.14/developing/api/protocol-buffers/dt-store) message.
