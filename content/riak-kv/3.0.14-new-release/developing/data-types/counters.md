...
toc: true
aliases:
  - /riak/3.0.14/dev/using/data-types/counters
  - /openriak-kv/3.0.14/dev/using/data-types/counters
  - /riak/3.0.14/dev/data-modeling/data-types/counters
  - /openriak-kv/3.0.14/dev/data-modeling/data-types/counters
linkTitle: "Counters"
weight: 100
---
