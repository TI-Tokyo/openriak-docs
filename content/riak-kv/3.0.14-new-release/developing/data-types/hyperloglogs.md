...
version_history:
  in: "2.0.8+"
aliases:
  - /riak/3.0.14/dev/using/data-types/hyperloglogs
  - /openriak-kv/3.0.14/dev/using/data-types/hyperloglogs
  - /riak/3.0.14/dev/data-modeling/data-types/hyperloglogs
  - /openriak-kv/3.0.14/dev/data-modeling/data-types/hyperloglogs
