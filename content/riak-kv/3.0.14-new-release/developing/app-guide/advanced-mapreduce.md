...
toc: true
aliases:
  - /riak/3.0.14/dev/advanced/mapreduce/
  - /openriak-kv/3.0.14/dev/advanced/mapreduce/
...
[installing custom code]({{<baseurl>}}openriak-kv/3.0.14/using/reference/custom-code).
{{% /note %}}
