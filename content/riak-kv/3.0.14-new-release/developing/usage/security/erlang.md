...
toc: true
aliases:
  - /riak/3.0.14/dev/advanced/client-security/erlang
  - /openriak-kv/3.0.14/dev/advanced/client-security/erlang
linkTitle: "Erlang"
weight: 103
---
...
on specifying trusted CIDRs can be found in [Trust-based Authentication]({{<baseurl>}}openriak-kv/3.0.14/using/security/managing-sources/#trust-based-authentication).
