---
title: "Upgrading to Riak KV 3.0.14"
description: ""
project: "riak_kv"
...
menu:
  riak_kv-3.0.14:
    name: "Upgrading to 3.0.14"
    identifier: "upgrading_version"
    weight: 101
    parent: "upgrading"
toc: true
aliases:
  - /riak/3.0.14/upgrade-v20/
  - /openriak-kv/3.0.14/ops/upgrading/rolling-upgrades/
  - /openriak-kv/3.0.14/ops/upgrading/rolling-upgrades/
  - /openriak-kv/3.0.14/setup/upgrading/cluster/

linkTitle: "Upgrading to 3.0.14"
weight: 101
---

[production checklist]: {{<baseurl>}}openriak-kv/3.0.14/setup/upgrading/checklist
...
[release notes]: {{<baseurl>}}openriak-kv/3.0.14/release-notes
...
[jmx monitor]: {{<baseurl>}}openriak-kv/3.0.14/using/reference/jmx
[snmp]: {{<baseurl>}}openriak-kv/3.0.14/using/reference/snmp
[Release Notes]: {{<baseurl>}}openriak-kv/3.0.14/release-notes

## Overview

You can upgrade one node or your whole cluster to Riak KV 3.0.14 by following the instructions below.
