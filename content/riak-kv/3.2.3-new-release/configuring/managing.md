...
[use admin riak cli#chkconfig]: {{<baseurl>}}openriak-kv/3.2.3/using/admin/riak-cli/#chkconfig

## Retrieving a Configuration Listing

**Note:** This command has been deprecated in Riak KV 3.2.3 onwards and will no longer function.
