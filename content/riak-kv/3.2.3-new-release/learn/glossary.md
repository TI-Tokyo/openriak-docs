...
[concept causal context vc]: {{<baseurl>}}openriak-kv/3.2.3/learn/concepts/causal-context/#vector-clocks
...
[concept strong consistency]: {{<baseurl>}}openriak-kv/3.2.3/learn/concepts/strong-consistency
[dev kv model]: {{<baseurl>}}openriak-kv/3.2.3/developing/key-value-modeling
[concept replication aae]: {{<baseurl>}}openriak-kv/3.2.3/learn/concepts/replication/#active-anti-entropy
...
[learn dynamo]: {{<baseurl>}}openriak-kv/3.2.3/learn/dynamo
[plan cluster capacity]: {{<baseurl>}}openriak-kv/3.2.3/setup/planning/cluster-capacity
[repair recover failure recovery]: {{<baseurl>}}openriak-kv/3.2.3/using/repair-recovery/failure-recovery
[repair recover repairs]: {{<baseurl>}}openriak-kv/3.2.3/using/repair-recovery/repairs
...
[usage secondary-indexes]: {{<baseurl>}}openriak-kv/3.2.3/developing/usage/secondary-indexes
...
* [Bucket Types]({{<baseurl>}}openriak-kv/3.2.3/developing/usage/bucket-types)
