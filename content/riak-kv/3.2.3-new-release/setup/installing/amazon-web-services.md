...
toc: true
aliases:
  - /riak/3.2.3/ops/building/installing/Installing-on-AWS-Marketplace
  - /openriak-kv/3.2.3/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/3.2.3/installing/amazon-web-services/
  - /openriak-kv/3.2.3/installing/amazon-web-services/
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}openriak-kv/3.2.3/using/security/).
