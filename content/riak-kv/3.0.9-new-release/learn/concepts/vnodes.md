...
toc: true
aliases:
  - /riak/3.0.9/theory/concepts/vnodes
  - /openriak-kv/3.0.9/theory/concepts/vnodes
linkTitle: "Vnodes"
weight: 109
---

[concept causal context]: {{<baseurl>}}openriak-kv/3.0.9/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}openriak-kv/3.0.9/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}openriak-kv/3.0.9/setup/planning/backend/bitcask) as a backend, navigate
...
`1004782375664995756265033323.0.944576013453623296`. These directories
