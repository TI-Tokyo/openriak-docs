...
aliases:
  - /riak/3.0.9/ops/mdc/v2/operations
  - /openriak-kv/3.0.9/ops/mdc/v2/operations
linkTitle: "V2 Multi-Datacenter"
weight: 115
---

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}openriak-kv/3.0.9/using/cluster-operations/v3-multi-datacenter/) instead.
{{% /note %}}
...
Field | Description
:-----|:-----------
`client_stats` | See <a href="{{<baseurl>}}openriak-kv/3.0.9/using/reference/multi-datacenter/statistics/#client-statistics">Client Statistics</a>
...
`server_stats` | See <a href="{{<baseurl>}}openriak-kv/3.0.9/using/reference/multi-datacenter/statistics/#server-statistics">Server Statistics</a>
...
participate in realtime replication. Please see the [Riak MDC Replication Configuration]({{<baseurl>}}openriak-kv/3.0.9/configuring/v2-multi-datacenter/) guide for more information.
...
`fullsync_worker` | The Erlang process ID of the fullsync worker
`bounded_queue` | See the <a href="{{<baseurl>}}openriak-kv/3.0.9/using/cluster-operations/v2-multi-datacenter/#bounded-queue">Bounded Queue</a> section above
