...
toc: true
aliases:
  - /riak/3.0.9/ops/building/benchmarking
  - /openriak-kv/3.0.9/ops/building/benchmarking
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}openriak-kv/3.0.9/setup/installing/source/erlang) for instructions
