...
aliases:
  - /riak/3.0.9/ops/mdc/v3/cascading-writes
  - /openriak-kv/3.0.9/ops/mdc/v3/cascading-writes
...
`riak repl` command. Please see the [Version 3 Operations guide]({{<baseurl>}}openriak-kv/3.0.9/using/cluster-operations/v3-multi-datacenter) for more information.
