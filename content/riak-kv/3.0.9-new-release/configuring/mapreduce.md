...
toc: true
aliases:
  - /riak/3.0.9/ops/advanced/configs/mapreduce/
  - /openriak-kv/3.0.9/ops/advanced/configs/mapreduce/
linkTitle: "MapReduce Settings"
weight: 170
---

[usage mapreduce]: {{<baseurl>}}openriak-kv/3.0.9/developing/usage/mapreduce
[config reference#appconfig]: {{<baseurl>}}openriak-kv/3.0.9/configuring/reference/#app-config
