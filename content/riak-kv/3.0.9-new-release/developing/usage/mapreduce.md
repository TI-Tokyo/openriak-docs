...
toc: true
aliases:
  - /riak/3.0.9/dev/using/mapreduce
  - /openriak-kv/3.0.9/dev/using/mapreduce
linkTitle: "Using MapReduce"
weight: 106
---

[usage 2i]: {{<baseurl>}}openriak-kv/3.0.9/developing/usage/secondary-indexes
[usage types]: {{<baseurl>}}openriak-kv/3.0.9/developing/usage/bucket-types
[api http]: {{<baseurl>}}openriak-kv/3.0.9/developing/api/http
[api pb]: {{<baseurl>}}openriak-kv/3.0.9/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}openriak-kv/3.0.9/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}openriak-kv/3.0.9/developing/app-guide/advanced-mapreduce
