...
toc: true
aliases:
  - /riak/3.0.9/dev/using/data-types
  - /openriak-kv/3.0.9/dev/using/data-types
  - /riak/3.0.9/dev/data-modeling/data-types
  - /openriak-kv/3.0.9/dev/data-modeling/data-types
