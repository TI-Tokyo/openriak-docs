...
version_history:
  in: "2.1.0+"
aliases:
  - /riak/3.2.5/dev/advanced/write-once
  - /riak/kv/3.2.5/dev/advanced/write-once
---

[glossary vnode]: {{< product-version-root >}}learn/glossary/#vnode
[bucket type]: {{< product-version-root >}}developing/usage/bucket-types
[Riak data types]: {{< product-version-root >}}developing/data-types
[strong consistency]: {{< product-version-root >}}developing/app-guide/strong-consistency
...
The [Multi]({{< product-version-root >}}setup/planning/backend/multi) backend does not
