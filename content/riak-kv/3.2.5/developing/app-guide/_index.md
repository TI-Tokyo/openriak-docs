...
[dev data model#log]: {{< product-version-root >}}developing/data-modeling/#log-data
[dev data model#sensor]: {{< product-version-root >}}developing/data-modeling/#sensor-data
[concept eventual consistency]: {{< product-version-root >}}learn/concepts/eventual-consistency
[dev data model#user]: {{< product-version-root >}}developing/data-modeling/#user-data
[dev kv model]: {{< product-version-root >}}developing/key-value-modeling
[dev data types]: {{< product-version-root >}}developing/data-types
[dev data types#counters]: {{< product-version-root >}}developing/data-types/#counters
[dev data types#sets]: {{< product-version-root >}}developing/data-types/#sets
[dev data types#maps]: {{< product-version-root >}}developing/data-types/#maps
[usage create objects]: {{< product-version-root >}}developing/usage/creating-objects
[usage search]: {{< product-version-root >}}deprecated/riak-search/
[use ref search]: {{< product-version-root >}}deprecated/riak-search/
[usage 2i]: {{< product-version-root >}}developing/usage/secondary-indexes
[dev client libraries]: {{< product-version-root >}}developing/client-libraries
[concept crdts]: {{< product-version-root >}}learn/concepts/crdts
[dev data model]: {{< product-version-root >}}developing/data-modeling
[usage mapreduce]: {{< product-version-root >}}developing/usage/mapreduce
[apps mapreduce]: {{< product-version-root >}}developing/app-guide/advanced-mapreduce
[use ref 2i]: {{< product-version-root >}}using/reference/secondary-indexes
...
[obj model java]: {{< product-version-root >}}developing/getting-started/java/object-modeling
[obj model ruby]: {{< product-version-root >}}developing/getting-started/ruby/object-modeling
[obj model python]: {{< product-version-root >}}developing/getting-started/python/object-modeling
[obj model csharp]: {{< product-version-root >}}developing/getting-started/csharp/object-modeling
[obj model nodejs]: {{< product-version-root >}}developing/getting-started/nodejs/object-modeling
[obj model erlang]: {{< product-version-root >}}developing/getting-started/erlang/object-modeling
[obj model golang]: {{< product-version-root >}}developing/getting-started/golang/object-modeling
...
[config strong consistency]: {{< product-version-root >}}configuring/strong-consistency
[apps strong consistency]: {{< product-version-root >}}developing/app-guide/strong-consistency
[usage update objects]: {{< product-version-root >}}developing/usage/updating-objects
[apps replication properties]: {{< product-version-root >}}developing/app-guide/replication-properties
[install index]: {{< product-version-root >}}setup/installing
[getting started]: {{< product-version-root >}}developing/getting-started
[usage index]: {{< product-version-root >}}developing/usage
[glossary]: {{< product-version-root >}}learn/glossary
