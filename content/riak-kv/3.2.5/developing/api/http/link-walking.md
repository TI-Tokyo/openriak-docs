...
aliases:
  ...
  - /riak/kv/3.2.5/dev/references/http/link-walking
---
...
is a special case of [MapReduce]({{< product-version-root >}}developing/usage/mapreduce), and can be expressed more verbosely as such.
[Read more about Links]({{< product-version-root >}}learn/glossary/#links).
...
response from [fetching the object]({{< product-version-root >}}developing/api/http/fetch-object), without the status
code.
