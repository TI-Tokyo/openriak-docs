...
aliases:
  ...
  - /riak/kv/3.2.5/dev/references/http/list-resources
---
...
* `riak_kv_wm_buckets` - [Bucket Operations]({{< product-version-root >}}developing/api/http/#bucket-operations)
* `riak_kv_wm_index` - [HTTP Secondary Indexes]({{< product-version-root >}}developing/api/http/secondary-indexes)
* `riak_kv_wm_link_walker` - [HTTP Link Walking]({{< product-version-root >}}developing/api/http/link-walking)
* `riak_kv_wm_mapred` - [HTTP MapReduce]({{< product-version-root >}}developing/api/http/mapreduce)
* `riak_kv_wm_object`- [Object/Key Operations]({{< product-version-root >}}developing/api/http/#object-key-operations)
* `riak_kv_wm_ping` - [HTTP Ping]({{< product-version-root >}}developing/api/http/ping)
* `riak_kv_wm_props` - [HTTP Set Bucket Properties]({{< product-version-root >}}developing/api/http/set-bucket-props)
* `riak_kv_wm_stats` - [HTTP Status]({{< product-version-root >}}developing/api/http/status)
