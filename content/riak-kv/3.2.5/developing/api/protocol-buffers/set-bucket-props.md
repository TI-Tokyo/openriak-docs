...
aliases:
  ...
  - /riak/kv/3.2.5/dev/references/protocol-buffers/set-bucket-props
---
...
[PBC Get Bucket Properties]({{< product-version-root >}}developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type]({{< product-version-root >}}developing/usage/bucket-types) using the
