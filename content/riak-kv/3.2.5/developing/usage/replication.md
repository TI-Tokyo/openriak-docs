...
<a href="{{< product-version-root >}}using/reference/strong-consistency/">strongly
...
<a href="{{< product-version-root >}}developing/app-guide/strong-consistency/">Using
...
documentation on [Bitcask][plan backend bitcask], [LevelDB][plan backend leveldb], and [multiple backends]({{< product-version-root >}}setup/planning/backend/multi).
...
refer to the tutorial on [basic key/value operations in Riak KV]({{< product-version-root >}}developing/getting-started)
