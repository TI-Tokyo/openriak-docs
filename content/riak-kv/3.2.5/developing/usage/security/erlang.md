...
on specifying trusted CIDRs can be found in [Trust-based Authentication]({{< product-version-root >}}using/security/managing-sources/#trust-based-authentication).
