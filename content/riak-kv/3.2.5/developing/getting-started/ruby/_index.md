...
aliases:
  ...
  - /riak/kv/3.2.5/dev/taste-of-riak/ruby
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{< product-version-root >}}using/running-a-cluster) first. To try this flavor
...
[CRUD Operations]({{< product-version-root >}}developing/getting-started/ruby/crud-operations)
