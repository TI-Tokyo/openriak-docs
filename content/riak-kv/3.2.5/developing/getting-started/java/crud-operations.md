...
Riak, see [Updating Objects]({{< product-version-root >}}developing/usage/updating-objects/)
and [Conflict Resolution]({{< product-version-root >}}developing/usage/conflict-resolution/)
documentation.
