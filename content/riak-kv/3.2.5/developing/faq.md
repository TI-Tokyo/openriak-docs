...
aliases:
  ...
  - /riak/kv/3.2.5/community/faqs/developing
---
...
[Bucket Properties]: {{< product-version-root >}}developing/usage
[built-in functions list]: https://github.com/basho/riak_kv/blob/master/priv/mapred_builtins.js
[commit hooks]: {{< product-version-root >}}developing/usage/commit-hooks
[Configuration Files]: {{< product-version-root >}}configuring/reference
[contrib.basho.com]: https://github.com/basho/riak_function_contrib
[Erlang Riak Client]: {{< product-version-root >}}developing/client-libraries
[MapReduce]: {{< product-version-root >}}developing/usage/mapreduce
[Memory]: {{< product-version-root >}}setup/planning/backend/memory
[Riak CS]: https://www.tiot.jp/riak-docs/riak/cs/2.1.1
[System Planning]: {{< product-version-root >}}setup/planning/start/#network-configuration-load-balancing
[vector clocks]: {{< product-version-root >}}learn/concepts/causal-context#vector-clocks
