...
toc: true
aliases:
  - /riak/3.2.5/ops/running/stats-and-monitoring
  - /riak/kv/3.2.5/ops/running/stats-and-monitoring
---
...
are made available through the HTTP API via the [`/stats`]({{< product-version-root >}}developing/api/http/status) endpoint, or through the [`riak admin`]({{< product-version-root >}}using/admin/riak-admin/) interface, in particular the `stat` and `status` commands.
...
Riak statistics provided in the [Inspecting a Node]({{< product-version-root >}}using/cluster-operations/inspecting-node) and [HTTP Status]({{< product-version-root >}}developing/api/http/status) documentation.
...
documentation on [system tuning]({{< product-version-root >}}using/performance/#storage-and-file-system-tuning).
...
If graphing all of the [available Riak metrics]({{< product-version-root >}}using/cluster-operations/inspecting-node) is
...
The [`riak admin`]({{< product-version-root >}}using/admin/riak-admin/) tool provides two
...
[Inspecting a Node]({{< product-version-root >}}using/cluster-operations/inspecting-node/#riak admin-status) document.
...
in the [Inspecting a Node]({{< product-version-root >}}using/admin/riak-admin/#stat) document.
...
[Riak Control]({{< product-version-root >}}using/admin/riak-control/) is Basho's REST-driven user-interface for managing Riak
...
the Riak HTTP [`/stats`]({{< product-version-root >}}developing/api/http/status) endpoint is also available.
...
A [Riak New Relic Agent][riak_new_relic] for collecting statistics from the Riak HTTP [`/stats`]({{< product-version-root >}}developing/api/http/status) endpoint is also available.
...
[`/stats`]({{< product-version-root >}}developing/api/http/status) endpoint.
...
* [Inspecting a Node]({{< product-version-root >}}using/cluster-operations/inspecting-node)
* [Riaknostic](http://riaknostic.basho.com)
* [Riak Control]({{< product-version-root >}}using/admin/riak-control/)
...
[data_types_counters]: {{< product-version-root >}}developing/data-types/counters/
[data_types_sets]: {{< product-version-root >}}developing/data-types/sets/
[data_types_maps]: {{< product-version-root >}}developing/data-types/maps/
