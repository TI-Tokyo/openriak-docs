...
aliases:
  ...
  - /riak/kv/3.2.5/ops/mdc/comparison
---

This document is a systematic comparison of [Version 2]({{< product-version-root >}}using/reference/v2-multi-datacenter) and [Version 3]({{< product-version-root >}}using/reference/v3-multi-datacenter) of Riak's Multi-Datacenter
...
* Version 3 is able to take advantage of [Active Anti-Entropy]({{< product-version-root >}}learn/concepts/active-anti-entropy/) \(AAE)
