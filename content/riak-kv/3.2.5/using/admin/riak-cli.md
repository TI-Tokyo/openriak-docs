...
[configuration file]: {{< product-version-root >}}configuring/reference/
[escript]: http://www.erlang.org/doc/man/escript.html
[`riak admin`]: {{< product-version-root >}}using/admin/riak-admin/#top
[configuration]: {{< product-version-root >}}configuring/reference/
