...
[use admin commands]: {{< product-version-root >}}using/admin/commands
[use admin commands#join]: {{< product-version-root >}}using/admin/commands/#join
[use admin commands#leave]: {{< product-version-root >}}using/admin/commands/#leave
[cluster ops backup]: {{< product-version-root >}}using/cluster-operations/backing-up
[config reference#node-metadata]: {{< product-version-root >}}configuring/reference/#node-metadata
[cluster ops change info]: {{< product-version-root >}}using/cluster-operations/changing-cluster-info
...
[config reference#ring]: {{< product-version-root >}}configuring/reference/#ring
[cluster ops inspect node]: {{< product-version-root >}}using/cluster-operations/inspecting-node
[use ref monitoring]: {{< product-version-root >}}using/reference/statistics-monitoring
[downgrade]: {{< product-version-root >}}setup/downgrade
[security index]: {{< product-version-root >}}using/security/
[security managing]: {{< product-version-root >}}using/security/managing-sources
...
[repair recover index]: {{< product-version-root >}}using/repair-recovery
[cluster ops strong consistency]: {{< product-version-root >}}using/cluster-operations/strong-consistency
[cluster ops handoff]: {{< product-version-root >}}using/cluster-operations/handoff
[use admin riak admin#stats]: {{< product-version-root >}}using/admin/riak-admin/#stats
