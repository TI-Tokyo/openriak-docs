...
toc: true
aliases:
  - /riak/kv/3.2.5/ops/tuning/linux/
...
clusters on the Amazon Web Services EC2 environment, see [AWS Performance Tuning]({{< product-version-root >}}using/performance/amazon-web-services).
...
open files limit is necessary. See [Open Files Limit]({{< product-version-root >}}using/performance/open-files-limit/) for more
details.

## Other Tuning Docs

* [AWS Performance Tuning]({{< product-version-root >}}using/performance/amazon-web-services)
* [Erlang VM Tuning]({{< product-version-root >}}using/performance/erlang)
* [Latency Reduction]({{< product-version-root >}}using/performance/latency-reduction)
* [Open Files Limit]({{< product-version-root >}}using/performance/open-files-limit/)
