...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{< product-version-root >}}configuring/v3-multi-datacenter/quick-start/) instead.
{{% /note %}}
...
`riak repl`'s [status output]({{< product-version-root >}}using/cluster-operations/v2-multi-datacenter/#status).
...
[config v2 mdc]: {{< product-version-root >}}configuring/v2-multi-datacenter
[cluster ops v2 mdc]: {{< product-version-root >}}using/cluster-operations/v2-multi-datacenter
