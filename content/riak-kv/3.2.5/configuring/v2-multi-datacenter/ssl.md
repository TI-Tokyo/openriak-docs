...
aliases:
  ...
  - /riak/kv/3.2.5/ops/mdc/v2/ssl
---

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{< product-version-root >}}configuring/v3-multi-datacenter/ssl/) instead.
{{% /note %}}
