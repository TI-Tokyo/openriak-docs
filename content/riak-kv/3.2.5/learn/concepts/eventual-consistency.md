...
special eventually consistent [Data Types]({{< product-version-root >}}developing/data-types/), or you can resolve those
...
or models]({{< product-version-root >}}developing/data-modeling/).
