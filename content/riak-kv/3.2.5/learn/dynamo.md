...
aliases:
  ...
  - /riak/kv/3.2.5/theory/dynamo
---

[client libraries]: {{< product-version-root >}}developing/client-libraries/
...
[Consistent Hashing]: {{< product-version-root >}}learn/glossary/#consistent-hashing
[Gossip Protocol]: {{< product-version-root >}}learn/glossary/#gossiping
...
[HTTP API]: {{< product-version-root >}}developing/api/http/
[Protocol Buffers API]: {{< product-version-root >}}developing/api/protocol-buffers/
...
[Further Reading on Partitioning in Riak KV]: {{< product-version-root >}}learn/concepts/clusters/
[All about the Riak KV Ring]: {{< product-version-root >}}learn/concepts/clusters/#the-ring
...
>
> [Vector Clock on Riak KV Glossary]({{< product-version-root >}}learn/glossary/#vector-clock)
>
...
>
>[REST API]({{< product-version-root >}}developing/api/http/)
>
>[Writing Data]({{< product-version-root >}}developing/usage/creating-objects/)
>
>[Reading Data]({{< product-version-root >}}developing/usage/reading-objects/)
...
> [Read Repair]({{< product-version-root >}}learn/concepts/replication/#read-repair).
...
[Hinted handoff]: {{< product-version-root >}}learn/glossary/#hinted-handoff
[Replication]: {{< product-version-root >}}developing/usage/replication/
...
[Multi Datacenter Replication]: {{< product-version-root >}}using/reference/v3-multi-datacenter/architecture/
...
[Adding and Removing Nodes]: {{< product-version-root >}}using/cluster-operations/adding-removing-nodes/
[Failure Scenarios]: {{< product-version-root >}}learn/concepts/eventual-consistency/
...
[riak admin command-line tool]: {{< product-version-root >}}using/admin/riak-admin/
...
[gossiping]: {{< product-version-root >}}learn/glossary/#gossiping
...
[The Node Join Process]: {{< product-version-root >}}using/cluster-operations/adding-removing-nodes/#joining-nodes-to-form-a-cluster
...
[backend options]: {{< product-version-root >}}setup/planning/backend/
[Bitcask]: {{< product-version-root >}}setup/planning/backend/bitcask/
[LevelDB]: {{< product-version-root >}}setup/planning/backend/leveldb/
[Memory]: {{< product-version-root >}}setup/planning/backend/memory/
[secondary indexes]: {{< product-version-root >}}developing/usage/secondary-indexes/
...
[Basho Bench]: {{< product-version-root >}}using/performance/benchmarking/
...
[CRDTs (Commutative Replicated Data Types)]: {{< product-version-root >}}developing/data-types/
...
[partitioning]: {{< product-version-root >}}learn/concepts/replication/#understanding-replication-by-example
...
[The Node Join Process]: {{< product-version-root >}}using/cluster-operations/adding-removing-nodes/#joining-nodes-to-form-a-cluster
[Replacing a Node]: {{< product-version-root >}}using/cluster-operations/replacing-node/
...
[Load Balancing]: {{< product-version-root >}}configuring/load-balancing-proxy/
