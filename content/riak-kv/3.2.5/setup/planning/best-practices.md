...
aliases:
  ...
  - /riak/kv/3.2.5/ops/building/planning/best-practices
---

[use ref handoff]: {{< product-version-root >}}using/reference/handoff
[config mapreduce]: {{< product-version-root >}}configuring/mapreduce
