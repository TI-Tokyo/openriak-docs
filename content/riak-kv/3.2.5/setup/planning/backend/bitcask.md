...
[learn clusters]: {{< product-version-root >}}learn/concepts/clusters
...
[plan bitcask capacity]: {{< product-version-root >}}setup/planning/bitcask-capacity-calc
[usage delete objects]: {{< product-version-root >}}developing/usage/deleting-objects
