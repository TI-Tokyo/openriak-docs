...
[security basics]: {{< product-version-root >}}using/security/basics
[cluster ops load balance]: {{< product-version-root >}}configuring/load-balancing-proxy
[config reference]: {{< product-version-root >}}configuring/reference
[config backend]: {{< product-version-root >}}configuring/backend
...
[use admin riak control]: {{< product-version-root >}}using/admin/riak-control
[cluster ops inspect node]: {{< product-version-root >}}using/cluster-operations/inspecting-node
[troubleshoot http]: {{< product-version-root >}}using/troubleshooting/http-204
