...
aliases:
  ...
  - /openriak-kv/2.1.4/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.1.4/installing/freebsd/
  - /openriak-kv/2.1.4/installing/freebsd/
linkTitle: "FreeBSD"
weight: 303
---
...
`pkg_add` remote option. For this example, we're installing `riak-2.1.4-FreeBSD-amd64.tbz`.

```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.1/2.1.4/freebsd/9.2/riak-2.1.4-FreeBSD-amd64.tbz
```
...
```
Package dependency openssl-1.0.0_7 for /tmp/riak-2.1.4-FreeBSD-amd64.tbz not found!
```
