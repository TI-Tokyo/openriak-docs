...
aliases:
  ...
  - /openriak-kv/2.1.4/dev/references/protocol-buffers/dt-union
...
`DtOp` messages are sent only as part of a [`DtUpdateReq`]({{<baseurl>}}openriak-kv/2.1.4/developing/api/protocol-buffers/dt-store) message.
