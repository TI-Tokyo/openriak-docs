...
aliases:
  ...
  - /openriak-kv/2.1.4/dev/references/http/counters
linkTitle: "Counters"
weight: 118
---
...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}openriak-kv/2.1.4/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}openriak-kv/2.1.4/developing/api/http/fetch-object)) responses apply here.
