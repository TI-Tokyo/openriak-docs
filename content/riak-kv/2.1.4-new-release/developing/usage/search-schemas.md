...
aliases:
  ...
  - /openriak-kv/2.1.4/dev/advanced/search-schema
...
under the hood to convert your values---plain text, JSON, XML, [Riak Data Types]({{<baseurl>}}openriak-kv/2.1.4/developing/data-types/), and [more]({{<baseurl>}}openriak-kv/2.1.4/developing/usage/custom-extractors)---into something that can be indexed and searched later.
...
`_yz_ed`  | Entropy Data | Data related to [active anti-entropy]({{<baseurl>}}openriak-kv/2.1.4/learn/concepts/active-anti-entropy)
