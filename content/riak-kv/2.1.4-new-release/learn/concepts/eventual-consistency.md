...
aliases:
  ...
  - /riak/2.1.4/theory/concepts/eventual-consistency
  - /openriak-kv/2.1.4/theory/concepts/Eventual-Consistency
  - /openriak-kv/2.1.4/theory/concepts/eventual-consistency
...
special eventually consistent [Data Types]({{<baseurl>}}openriak-kv/2.1.4/developing/data-types/), or you can resolve those
...
or models]({{<baseurl>}}openriak-kv/2.1.4/developing/data-modeling/).
