...
[use admin riak-admin cluster replace]: {{<baseurl>}}openriak-kv/2.1.4/using/admin/riak-admin/#cluster-replace
[use admin riak-admin force replace]: {{<baseurl>}}openriak-kv/2.1.4/using/admin/riak-admin/#cluster-force-replace
...
href="{{<baseurl>}}openriak-kv/2.1.4/configuring/">Configuration
