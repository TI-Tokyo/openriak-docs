...
[`riak-admin`]({{<baseurl>}}openriak-kv/2.1.4/using/admin/riak-admin/) interface enables you to
...
`Hinted` | Total number of <a href="{{<baseurl>}}openriak-kv/2.1.4/using/reference/handoff/#types-of-handoff">hinted handoffs</a>
...
This command displays the values for handoff-specific [configurable parameters]({{<baseurl>}}openriak-kv/2.1.4/configuring/reference/#intra-cluster-handoff) on each node in
