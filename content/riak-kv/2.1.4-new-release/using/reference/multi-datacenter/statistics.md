...
toc: true
aliases:
  - /riak/2.1.4/ops/mdc/statistics
  - /openriak-kv/2.1.4/ops/mdc/statistics
...
`socket` | See <a href="{{<baseurl>}}openriak-kv/2.1.4/using/reference/multi-datacenter/statistics/#socket-statistics">Socket Statistics</a>
...
`strategy` | A replication strategy defines an implementation of the Riak Replication protocol. Valid values: `keylist`, `syncv1`.
`fullsync_worker` | The Erlang process ID of the fullsync worker
`bounded_queue` | See <a href="{{<baseurl>}}openriak-kv/2.1.4/using/reference/multi-datacenter/statistics/#bounded-queue">Bounded Queue</a>
