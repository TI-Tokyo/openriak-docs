...
aliases:
  ...
  - /openriak-kv/2.1.4/ops/running/logging
linkTitle: "Logging"
weight: 100
---

[cluster ops log]: {{<baseurl>}}openriak-kv/2.1.4/using/cluster-operations/logging
[config reference lager]: {{<baseurl>}}openriak-kv/2.1.4/configuring/reference/#logging
...
[use admin riak cli attach direct]: {{<baseurl>}}openriak-kv/2.1.4/using/admin/riak-cli/#attach-direct
...
`erlang.log` | Logs emitted by the <a href="{{<baseurl>}}openriak-kv/2.1.4/using/performance/erlang/">Erlang VM</a> on which Riak runs.
`error.log` | <a href="{{<baseurl>}}openriak-kv/2.1.4/using/repair-recovery/errors/">Common errors</a> emitted by Riak.
