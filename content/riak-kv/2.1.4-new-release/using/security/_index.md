...
aliases:
  ...
  - /openriak-kv/2.1.4/ops/advanced/security
linkTitle: "Security"
weight: 205
---

[config reference search]: {{<baseurl>}}openriak-kv/2.1.4/configuring/reference/#search
[config search enabling]: {{<baseurl>}}openriak-kv/2.1.4/configuring/search/#enabling-riak-search
...
Protocol | Port
:--------|:----
<a href="{{<baseurl>}}openriak-kv/2.1.4/developing/api/http/">HTTP</a> | TCP port 8098
<a href="{{<baseurl>}}openriak-kv/2.1.4/developing/api/protocol-buffers/">Protocol Buffers</a> | TCP port 8087
