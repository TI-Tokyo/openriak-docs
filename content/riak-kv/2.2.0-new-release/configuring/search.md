...
aliases:
  ...
  - /openriak-kv/2.2.0/ops/advanced/configs/search/
...
[cluster-ops aae throttle]: {{<baseurl>}}openriak-kv/2.2.0/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}openriak-kv/2.2.0/configuring/reference
[config reference#search]: {{<baseurl>}}openriak-kv/2.2.0/configuring/reference/#search
