...
aliases:
  ...
  - /openriak-kv/2.2.0/ops/mdc/v2/scheduling-fullsync
linkTitle: "Scheduling Fullsync"
weight: 101
---

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}openriak-kv/2.2.0/using/reference/v3-multi-datacenter/scheduling-fullsync/) instead.
{{% /note %}}
