...
[upgrade]: {{<baseurl>}}openriak-kv/2.2.0/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}openriak-kv/2.2.0/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}openriak-kv/2.2.0/using/cluster-operations/adding-removing-nodes
