...
toc: true
aliases:
  - /riak/2.2.0/dev/data-modeling/
  - /openriak-kv/2.2.0/dev/data-modeling/
linkTitle: "Use Cases"
weight: 101
---

[dev data model articles etc]: {{<baseurl>}}openriak-kv/2.2.0/developing/data-modeling/#articles-blog-posts-and-other-content
[dev data model log data]: {{<baseurl>}}openriak-kv/2.2.0/developing/data-modeling/#log-data
[dev data model sensor data]: {{<baseurl>}}openriak-kv/2.2.0/developing/data-modeling/#sensor-data
[dev data model serve advertisements]: {{<baseurl>}}openriak-kv/2.2.0/developing/data-modeling/#serving-advertisements
[dev data model sess storage]: {{<baseurl>}}openriak-kv/2.2.0/developing/data-modeling/#session-storage
[dev data model user acct]: {{<baseurl>}}openriak-kv/2.2.0/developing/data-modeling/#user-accounts
[dev data model user events]: {{<baseurl>}}openriak-kv/2.2.0/developing/data-modeling/#user-events-and-timelines
[dev data model user settings]: {{<baseurl>}}openriak-kv/2.2.0/developing/data-modeling/#user-settings-and-preferences
...
[replication properties]: {{<baseurl>}}openriak-kv/2.2.0/developing/app-guide/replication-properties
