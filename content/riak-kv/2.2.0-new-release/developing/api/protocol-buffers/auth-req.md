...
aliases:
  ...
  - /openriak-kv/2.2.0/dev/references/protocol-buffers/auth-req
...
For more on authentication, see our documentation on [Authentication and Authorization]({{<baseurl>}}openriak-kv/2.2.0/using/security/basics).
