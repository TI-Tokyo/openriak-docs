...
toc: true
aliases:
  - /riak/2.2.0/dev/using/conflict-resolution/ruby
  - /openriak-kv/2.2.0/dev/using/conflict-resolution/ruby
linkTitle: "Ruby"
weight: 101
---
...
the official Ruby client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.2.0/developing/usage) section.
