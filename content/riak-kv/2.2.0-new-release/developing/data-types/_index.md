...
toc: true
aliases:
  - /riak/2.2.0/dev/using/data-types
  - /openriak-kv/2.2.0/dev/using/data-types
  - /riak/2.2.0/dev/data-modeling/data-types
  - /openriak-kv/2.2.0/dev/data-modeling/data-types
