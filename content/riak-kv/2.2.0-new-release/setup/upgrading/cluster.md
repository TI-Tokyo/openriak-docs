...
aliases:
  ...
  - /openriak-kv/2.2.0/ops/upgrading/rolling-upgrades/
linkTitle: "Upgrading a Cluster"
weight: 102
---

[production checklist]: {{<baseurl>}}openriak-kv/2.2.0/setup/upgrading/checklist
...
[jmx monitor]: {{<baseurl>}}openriak-kv/2.2.0/using/reference/jmx
[snmp]: {{<baseurl>}}openriak-kv/2.2.0/using/reference/snmp
...
If you run [Riak Control]({{<baseurl>}}openriak-kv/2.2.0/using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
