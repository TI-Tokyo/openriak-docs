...
toc: true
aliases:
  - /riak/2.2.0/ops/building/planning/cluster
  - /openriak-kv/2.2.0/ops/building/planning/cluster
...
[use admin riak-admin#cluster]: {{<baseurl>}}openriak-kv/2.2.0/using/admin/riak-admin/#cluster
