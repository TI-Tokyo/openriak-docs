...
toc: true
aliases:
  - /riak/2.2.0/ops/building/installing/Installing-on-Solaris
  - /openriak-kv/2.2.0/ops/building/installing/Installing-on-Solaris
  - /riak/2.2.0/installing/solaris/
  - /openriak-kv/2.2.0/installing/solaris/
linkTitle: "Solaris"
weight: 306
---
...
```bash
curl -o /tmp/BASHOriak-2.2.0-Solaris10-i386.pkg.gz https://files.tiot.jp/riak/kv/2.2/2.2.0/solaris/10/BASHOriak-2.2.0-Solaris10-x86_64.pkg.gz
```

Next, install the package:

```bash
gunzip /tmp/BASHOriak-2.2.0-Solaris10-i386.pkg.gz
pkgadd /tmp/BASHOriak-2.2.0-Solaris10-i386.pkg
```
