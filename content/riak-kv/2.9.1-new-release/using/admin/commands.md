...
aliases:
  ...
  - /openriak-kv/2.9.1/ops/running/cluster-admin
...
[use admin riak-admin#cluster-plan]: {{<baseurl>}}openriak-kv/2.9.1/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: {{<baseurl>}}openriak-kv/2.9.1/using/admin/riak-admin/#cluster-commit
