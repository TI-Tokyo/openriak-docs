...
aliases:
  ...
  - /openriak-kv/2.9.1/ops/advanced/configs/search/
...
[cluster-ops aae throttle]: {{<baseurl>}}openriak-kv/2.9.1/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}openriak-kv/2.9.1/configuring/reference
[config reference#search]: {{<baseurl>}}openriak-kv/2.9.1/configuring/reference/#search
