...
aliases:
  ...
  - /openriak-kv/2.9.1/theory/concepts/vnodes
linkTitle: "Vnodes"
weight: 109
---

[concept causal context]: {{<baseurl>}}openriak-kv/2.9.1/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}openriak-kv/2.9.1/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}openriak-kv/2.9.1/setup/planning/backend/bitcask) as a backend, navigate
