...
toc: true
aliases:
  - /riak/2.9.1/dev/references/protocol-buffers/reset-bucket-props
  - /openriak-kv/2.9.1/dev/references/protocol-buffers/reset-bucket-props
...
[bucket type]({{<baseurl>}}openriak-kv/2.9.1/developing/usage/bucket-types) using the `type` value. If you do not
