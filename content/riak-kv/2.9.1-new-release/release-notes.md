...
aliases:
  ...
  - /openriak-kv/2.9.1/intro-v20
  - /riak/2.9.1/intro-v20
  - /openriak-kv/2.9.1/introduction
...
Please see the KV 2.9.0p5 release notes [here]({{<baseurl>}}openriak-kv/2.9.0/release-notes/), and the KV 2.2.6 release notes [here]({{<baseurl>}}openriak-kv/2.2.6/release-notes/).
