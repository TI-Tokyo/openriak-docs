...
toc: true
aliases:
  - /riak/3.0.16/ops/upgrading/rolling-downgrades/
  - /openriak-kv/3.0.16/ops/upgrading/rolling-downgrades/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/3.0.16/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/3.0.16/using/admin/riak-admin/#aae-status
...
If you enabled LZ4 compression in LevelDB and/or enabled global expiration in LevelDB when you installed KV 3.0.16, you cannot downgrade.
