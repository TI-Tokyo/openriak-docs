...
toc: true
aliases:
  - /riak/3.0.16/ops/advanced/backends/multi/
  - /openriak-kv/3.0.16/ops/advanced/backends/multi/
...
[use admin riak admin cli]: {{<baseurl>}}openriak-kv/3.0.16/using/admin/riak admin
