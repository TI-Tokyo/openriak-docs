...
aliases:
  ...
  - /openriak-kv/3.0.16/ops/mdc/v2/ssl
linkTitle: "SSL"
weight: 103
---

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}openriak-kv/3.0.16/configuring/v3-multi-datacenter/ssl/) instead.
{{% /note %}}
