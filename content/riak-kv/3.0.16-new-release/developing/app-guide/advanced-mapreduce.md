...
toc: true
aliases:
  - /riak/3.0.16/dev/advanced/mapreduce/
  - /openriak-kv/3.0.16/dev/advanced/mapreduce/
...
[installing custom code]({{<baseurl>}}openriak-kv/3.0.16/using/reference/custom-code).
{{% /note %}}
