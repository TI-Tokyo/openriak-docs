...
toc: true
aliases:
  - /riak/3.0.16/dev/using/conflict-resolution/java
  - /openriak-kv/3.0.16/dev/using/conflict-resolution/java
linkTitle: "Java"
weight: 100
---
...
[bucket type]({{<baseurl>}}openriak-kv/3.0.16/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official Java client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/3.0.16/developing/usage) section.
