...
toc: true
aliases:
  - /riak/3.0.16/dev/references/http/counters
  - /openriak-kv/3.0.16/dev/references/http/counters
linkTitle: "Counters"
weight: 118
---
...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}openriak-kv/3.0.16/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}openriak-kv/3.0.16/developing/api/http/fetch-object)) responses apply here.
