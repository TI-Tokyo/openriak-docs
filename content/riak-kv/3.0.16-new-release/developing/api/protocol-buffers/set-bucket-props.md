...
toc: true
aliases:
  - /riak/3.0.16/dev/references/protocol-buffers/set-bucket-props
  - /openriak-kv/3.0.16/dev/references/protocol-buffers/set-bucket-props
...
[PBC Get Bucket Properties]({{<baseurl>}}openriak-kv/3.0.16/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type]({{<baseurl>}}openriak-kv/3.0.16/developing/usage/bucket-types) using the
