...
toc: true
aliases:
  - /riak/3.0.16/ops/running/nodes/adding-removing
  - /openriak-kv/3.0.16/ops/running/nodes/adding-removing
...
simply the script [`riak`]({{<baseurl>}}openriak-kv/3.0.16/using/admin/riak-cli/):
