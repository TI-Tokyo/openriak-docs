...
toc: true
aliases:
  - /riak/3.0.8/dev/references/protocol-buffers/reset-bucket-props
  - /openriak-kv/3.0.8/dev/references/protocol-buffers/reset-bucket-props
...
[bucket type]({{<baseurl>}}openriak-kv/3.0.8/developing/usage/bucket-types) using the `type` value. If you do not
