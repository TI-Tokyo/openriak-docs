...
toc: true
aliases:
  - /riak/3.0.8/dev/references/protocol-buffers/dt-union
  - /openriak-kv/3.0.8/dev/references/protocol-buffers/dt-union
...
`DtOp` messages are sent only as part of a [`DtUpdateReq`]({{<baseurl>}}openriak-kv/3.0.8/developing/api/protocol-buffers/dt-store) message.
