...
aliases:
  ...
  - /openriak-kv/3.0.8/intro-v20
  - /riak/3.0.8/intro-v20
  - /openriak-kv/3.0.8/introduction
...
Please see the KV 3.0.7 release notes [here]({{<baseurl>}}openriak-kv/3.0.7/release-notes/).
