...
toc: true
aliases:
  - /riak/3.0.15/ops/building/installing/Installing-on-AWS-Marketplace
  - /openriak-kv/3.0.15/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/3.0.15/installing/amazon-web-services/
  - /openriak-kv/3.0.15/installing/amazon-web-services/
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}openriak-kv/3.0.15/using/security/).
