...
toc: true
aliases:
  - /riak/3.0.15/theory/concepts/crdts
  - /openriak-kv/3.0.15/theory/concepts/crdts
linkTitle: "Data Types"
weight: 104
---

[crdts pdf]: http://hal.upmc.fr/docs/00/55/55/88/PDF/techreport.pdf
[data types converg]: {{<baseurl>}}openriak-kv/3.0.15/learn/concepts/crdts/#convergence
[crdts reading list]: http://christophermeiklejohn.com/crdt/2014/07/22/readings-in-crdts.html
[data types impl]: {{<baseurl>}}openriak-kv/3.0.15/learn/concepts/crdts/#implementation
[concept causal context dvv]: {{<baseurl>}}openriak-kv/3.0.15/learn/concepts/causal-context/#dotted-version-vectors
...
[dev data types context]: {{<baseurl>}}openriak-kv/3.0.15/developing/data-types/#data-types-and-context
