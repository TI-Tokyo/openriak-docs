...
version_history:
  in: "2.1.0+"
aliases:
  - /riak/3.0.15/dev/advanced/write-once
  - /openriak-kv/3.0.15/dev/advanced/write-once
linkTitle: "Write Once"
weight: 102
---

[glossary vnode]: {{<baseurl>}}openriak-kv/3.0.15/learn/glossary/#vnode
[bucket type]: {{<baseurl>}}openriak-kv/3.0.15/developing/usage/bucket-types
[Riak data types]: {{<baseurl>}}openriak-kv/3.0.15/developing/data-types
[strong consistency]: {{<baseurl>}}openriak-kv/3.0.15/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}openriak-kv/3.0.15/setup/planning/backend/multi) backend does not
