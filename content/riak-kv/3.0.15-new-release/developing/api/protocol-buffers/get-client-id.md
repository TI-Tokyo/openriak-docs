...
toc: true
aliases:
  - /riak/3.0.15/dev/references/protocol-buffers/get-client-id
  - /openriak-kv/3.0.15/dev/references/protocol-buffers/get-client-id
...
connected and can be changed using [Set Client ID]({{<baseurl>}}openriak-kv/3.0.15/developing/api/protocol-buffers/set-client-id).
