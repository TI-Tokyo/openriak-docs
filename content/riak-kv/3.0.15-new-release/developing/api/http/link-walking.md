...
toc: true
aliases:
  - /riak/3.0.15/dev/references/http/link-walking
  - /openriak-kv/3.0.15/dev/references/http/link-walking
...
is a special case of [MapReduce]({{<baseurl>}}openriak-kv/3.0.15/developing/usage/mapreduce), and can be expressed more verbosely as such.
[Read more about Links]({{<baseurl>}}openriak-kv/3.0.15/learn/glossary/#links).
...
response from [fetching the object]({{<baseurl>}}openriak-kv/3.0.15/developing/api/http/fetch-object), without the status
code.
