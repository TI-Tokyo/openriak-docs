...
toc: true
aliases:
  - /riak/3.0.15/dev/taste-of-riak/object-modeling-golang
  - /openriak-kv/3.0.15/dev/taste-of-riak/object-modeling-golang
...
We'll be using the bucket `Users` to store our data. We won't be [using bucket types]({{<baseurl>}}openriak-kv/3.0.15/developing/usage/bucket-types) here, so we don't need to specify one.
