...
toc: true
aliases:
  - /riak/2.9.8/ops/running/tools/riak
  - /openriak-kv/2.9.8/ops/running/tools/riak
linkTitle: "riak CLI"
weight: 102
---

[configuration file]: {{<baseurl>}}openriak-kv/2.9.8/configuring/reference/
[escript]: http://www.erlang.org/doc/man/escript.html
[`riak-admin`]: {{<baseurl>}}openriak-kv/2.9.8/using/admin/riak-admin/#top
[configuration]: {{<baseurl>}}openriak-kv/2.9.8/configuring/reference/
