...
toc: true
aliases:
  - /riak/2.9.8/ops/running/cluster-admin
  - /openriak-kv/2.9.8/ops/running/cluster-admin
linkTitle: "Cluster Admin Commands"
weight: 100
---

[use admin riak-admin#cluster]: {{<baseurl>}}openriak-kv/2.9.8/using/admin/riak-admin/#cluster
...
[use admin riak-admin#cluster-plan]: {{<baseurl>}}openriak-kv/2.9.8/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: {{<baseurl>}}openriak-kv/2.9.8/using/admin/riak-admin/#cluster-commit
...
`1004782375664995756265033322.9.844576013453623296`. You can convert
that index to an ID like this:

```bash
riak-admin cluster partition index=1004782375664995756265033322.9.844576013453623296
```
