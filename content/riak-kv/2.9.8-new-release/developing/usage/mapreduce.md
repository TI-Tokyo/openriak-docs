...
aliases:
  ...
  - /openriak-kv/2.9.8/dev/using/mapreduce
...
[usage types]: {{<baseurl>}}openriak-kv/2.9.8/developing/usage/bucket-types
[api http]: {{<baseurl>}}openriak-kv/2.9.8/developing/api/http
[api pb]: {{<baseurl>}}openriak-kv/2.9.8/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}openriak-kv/2.9.8/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}openriak-kv/2.9.8/developing/app-guide/advanced-mapreduce
