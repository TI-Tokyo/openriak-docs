...
version_history:
  in: "2.1.0+"
aliases:
  - /riak/2.9.8/dev/advanced/write-once
  - /openriak-kv/2.9.8/dev/advanced/write-once
...
[strong consistency]: {{<baseurl>}}openriak-kv/2.9.8/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}openriak-kv/2.9.8/setup/planning/backend/multi) backend does not
