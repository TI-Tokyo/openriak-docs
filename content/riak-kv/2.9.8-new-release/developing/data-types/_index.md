...
toc: true
aliases:
  - /riak/2.9.8/dev/using/data-types
  - /openriak-kv/2.9.8/dev/using/data-types
  - /riak/2.9.8/dev/data-modeling/data-types
  - /openriak-kv/2.9.8/dev/data-modeling/data-types
