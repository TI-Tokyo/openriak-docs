...
toc: true
aliases:
  - /riak/2.9.8/dev/taste-of-riak/object-modeling-erlang
  - /openriak-kv/2.9.8/dev/taste-of-riak/object-modeling-erlang
...
We'll be using the bucket `Users` to store our data. We won't be [using bucket types]({{<baseurl>}}openriak-kv/2.9.8/developing/usage/bucket-types) here, so we don't need to specify one.
