...
aliases:
  ...
  - /openriak-kv/2.9.8/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.9.8/installing/freebsd/
  - /openriak-kv/2.9.8/installing/freebsd/
linkTitle: "FreeBSD"
weight: 303
---
...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.9/2.9.8/freebsd/11.1/riak-2.9.8.txz
```

### For FreeBSD 10.x

```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.9/2.9.8/freebsd/10.4/riak-2.9.8.txz
```
