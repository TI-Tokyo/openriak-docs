...
aliases:
  ...
  - /openriak-kv/2.9.8/ops/building/installing/Installing-on-Mac-OS-X
  - /riak/2.9.8/installing/mac-osx/
  - /openriak-kv/2.9.8/installing/mac-osx/
linkTitle: "Mac OS X"
weight: 303
---
...
```bash
curl -O https://files.tiot.jp/riak/kv/2.9/2.9.8/osx/10.11/riak-2.9.8-OSX-x86_64.tar.gz
...
By default, this will place a `2.9.8` folder in
