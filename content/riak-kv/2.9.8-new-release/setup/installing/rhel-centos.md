...
aliases:
  ...
  - /openriak-kv/2.9.8/ops/building/installing/Installing-on-RHEL-and-CentOS
  - /riak/2.9.8/installing/rhel-centos/
  - /openriak-kv/2.9.8/installing/rhel-centos/
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.8/rhel/8/riak-2.9.8-1.el8.x86_64.rpm
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.8/rhel/7/riak-2.9.8-1.el7.x86_64.rpm
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.8/rhel/6/riak-2.9.8-1.el6.x86_64.rpm
