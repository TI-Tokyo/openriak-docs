...
toc: true
aliases:
  - /riak/2.9.9/ops/advanced/configs/mapreduce/
  - /openriak-kv/2.9.9/ops/advanced/configs/mapreduce/
linkTitle: "MapReduce Settings"
weight: 170
---

[usage mapreduce]: {{<baseurl>}}openriak-kv/2.9.9/developing/usage/mapreduce
[config reference#appconfig]: {{<baseurl>}}openriak-kv/2.9.9/configuring/reference/#app-config
