...
aliases:
  ...
  - /openriak-kv/2.9.9/ops/advanced/configs/search/
...
[cluster-ops aae throttle]: {{<baseurl>}}openriak-kv/2.9.9/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}openriak-kv/2.9.9/configuring/reference
[config reference#search]: {{<baseurl>}}openriak-kv/2.9.9/configuring/reference/#search
