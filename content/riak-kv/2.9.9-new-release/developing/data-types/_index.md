...
toc: true
aliases:
  - /riak/2.9.9/dev/using/data-types
  - /openriak-kv/2.9.9/dev/using/data-types
  - /riak/2.9.9/dev/data-modeling/data-types
  - /openriak-kv/2.9.9/dev/data-modeling/data-types
