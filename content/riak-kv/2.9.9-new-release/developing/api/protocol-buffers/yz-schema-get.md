...
aliases:
  - /riak/2.9.9/dev/references/protocol-buffers/yz-schema-get
  - /openriak-kv/2.9.9/dev/references/protocol-buffers/yz-schema-get
linkTitle: "Yokozuna Schema Get"
weight: 123
---

Fetch a [search schema]({{<baseurl>}}openriak-kv/2.9.9/developing/usage/search-schemas) from Riak Search.
