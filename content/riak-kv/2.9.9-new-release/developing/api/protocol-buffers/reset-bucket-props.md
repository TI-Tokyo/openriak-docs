...
aliases:
  ...
  - /openriak-kv/2.9.9/dev/references/protocol-buffers/reset-bucket-props
...
[bucket type]({{<baseurl>}}openriak-kv/2.9.9/developing/usage/bucket-types) using the `type` value. If you do not
