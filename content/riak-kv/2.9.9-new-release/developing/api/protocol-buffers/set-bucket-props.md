...
aliases:
  ...
  - /openriak-kv/2.9.9/dev/references/protocol-buffers/set-bucket-props
...
[PBC Get Bucket Properties]({{<baseurl>}}openriak-kv/2.9.9/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type]({{<baseurl>}}openriak-kv/2.9.9/developing/usage/bucket-types) using the
