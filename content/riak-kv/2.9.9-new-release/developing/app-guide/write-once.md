...
version_history:
  in: "2.1.0+"
aliases:
  - /riak/2.9.9/dev/advanced/write-once
  - /openriak-kv/2.9.9/dev/advanced/write-once
linkTitle: "Write Once"
weight: 102
---

[glossary vnode]: {{<baseurl>}}openriak-kv/2.9.9/learn/glossary/#vnode
[bucket type]: {{<baseurl>}}openriak-kv/2.9.9/developing/usage/bucket-types
[Riak data types]: {{<baseurl>}}openriak-kv/2.9.9/developing/data-types
[strong consistency]: {{<baseurl>}}openriak-kv/2.9.9/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}openriak-kv/2.9.9/setup/planning/backend/multi) backend does not
