...
[upgrade]: {{<baseurl>}}openriak-kv/2.9.9/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}openriak-kv/2.9.9/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}openriak-kv/2.9.9/using/cluster-operations/adding-removing-nodes
