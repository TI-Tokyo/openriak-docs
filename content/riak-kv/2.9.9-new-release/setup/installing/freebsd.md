...
aliases:
  ...
  - /openriak-kv/2.9.9/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.9.9/installing/freebsd/
  - /openriak-kv/2.9.9/installing/freebsd/
linkTitle: "FreeBSD"
weight: 303
---
...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.9/2.9.9/freebsd/11.1/riak-2.9.9.txz
```

### For FreeBSD 10.x

```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.9/2.9.9/freebsd/10.4/riak-2.9.9.txz
```
