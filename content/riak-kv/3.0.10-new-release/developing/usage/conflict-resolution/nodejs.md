...
toc: true
aliases:
  - /riak/3.0.10/dev/using/conflict-resolution/nodejs
  - /openriak-kv/3.0.10/dev/using/conflict-resolution/nodejs
linkTitle: "NodeJS"
weight: 104
---

For reasons explained in the [Introduction to conflict resolution]({{<baseurl>}}openriak-kv/3.0.10/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that
