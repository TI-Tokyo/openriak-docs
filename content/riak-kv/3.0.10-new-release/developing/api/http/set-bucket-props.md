...
toc: true
aliases:
  - /riak/3.0.10/dev/references/http/set-bucket-props
  - /openriak-kv/3.0.10/dev/references/http/set-bucket-props
...
clock) when writing
* `precommit` - [precommit hooks]({{<baseurl>}}openriak-kv/3.0.10/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks]({{<baseurl>}}openriak-kv/3.0.10/developing/usage/commit-hooks)
