...
Riak, see [Updating Objects]({{<baseurl>}}openriak-kv/3.0.10/developing/usage/updating-objects/)
and [Conflict Resolution]({{<baseurl>}}openriak-kv/3.0.10/developing/usage/conflict-resolution/)
documentation.
