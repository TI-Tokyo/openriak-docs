...
toc: true
aliases:
  - /riak/3.0.10/ops/building/installing/Installing-on-FreeBSD
  - /openriak-kv/3.0.10/ops/building/installing/Installing-on-FreeBSD
  - /riak/3.0.10/installing/freebsd/
  - /openriak-kv/3.0.10/installing/freebsd/
linkTitle: "FreeBSD"
weight: 304
---
...
`pkg_add` remote option. For this example, we're installing `riak-3.0.10.txz`.

### For FreeBSD 11.x

```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/3.0/3.0.10/freebsd/11.1/riak-3.0.10.txz
```

### For FreeBSD 10.x

```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/3.0/3.0.10/freebsd/10.4/riak-3.0.10.txz
```
