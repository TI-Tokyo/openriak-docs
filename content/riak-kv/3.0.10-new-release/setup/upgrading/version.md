---
title: "Upgrading to Riak KV 3.0.10"
description: ""
project: "riak_kv"
...
menu:
  riak_kv-3.0.10:
    name: "Upgrading to 3.0.10"
    identifier: "upgrading_version"
    weight: 101
    parent: "upgrading"
toc: true
aliases:
  - /riak/3.0.10/upgrade-v20/
  - /openriak-kv/3.0.10/ops/upgrading/rolling-upgrades/
  - /openriak-kv/3.0.10/ops/upgrading/rolling-upgrades/
  - /openriak-kv/3.0.10/setup/upgrading/cluster/

linkTitle: "Upgrading to 3.0.10"
weight: 101
---

[production checklist]: {{<baseurl>}}openriak-kv/3.0.10/setup/upgrading/checklist
...
[release notes]: {{<baseurl>}}openriak-kv/3.0.10/release-notes
...
[jmx monitor]: {{<baseurl>}}openriak-kv/3.0.10/using/reference/jmx
[snmp]: {{<baseurl>}}openriak-kv/3.0.10/using/reference/snmp
[Release Notes]: {{<baseurl>}}openriak-kv/3.0.10/release-notes

## Overview

You can upgrade one node or your whole cluster to Riak KV 3.0.10 by following the instructions below.
...
{{% note %}}
You must have [Java version 7 or higher](http://www.oracle.com/technetwork/java/javase/downloads/index.html) in order to upgrade to Riak KV 3.0.10 if you wish to use Riak search. If you do not have it installed, please install it now.
{{% /note %}}
