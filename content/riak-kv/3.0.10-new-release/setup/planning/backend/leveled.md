...
toc: true
aliases:
  - /riak/3.0.10/ops/advanced/backends/leveled/
  - /openriak-kv/3.0.10/ops/advanced/backends/leveled/
linkTitle: "Leveled"
weight: 101
---
...
[config reference#aae]: {{<baseurl>}}openriak-kv/3.0.10/configuring/reference/#active-anti-entropy
...
Leveled is included with Riak KV 3.0.10 and beyond, so there is no need to install anything further.
