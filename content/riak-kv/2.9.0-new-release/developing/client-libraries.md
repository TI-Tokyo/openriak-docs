...
toc: true
aliases:
  - /riak/2.9.0/dev/using/libraries
  - /openriak-kv/2.9.0/dev/using/libraries
  - /riak/2.9.0/developing/client-libraries/
  - /riak/2.9.0/developing/client-libraries/
  - /openriak-kv/2.9.0/developing/client-libraries/
  - /openriak-kv/2.9.0p1/developing/client-libraries/
  - /openriak-kv/2.9.0p2/developing/client-libraries/
  - /openriak-kv/2.9.0p3/developing/client-libraries/
  - /openriak-kv/2.9.0p4/developing/client-libraries/
