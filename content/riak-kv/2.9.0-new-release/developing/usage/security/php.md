...
toc: true
aliases:
  - /riak/2.9.0/dev/advanced/client-security/php
  - /openriak-kv/2.9.0/dev/advanced/client-security/php
  - /riak/2.9.0/developing/usage/security/php/
  - /riak/2.9.0/developing/usage/security/php/
  - /openriak-kv/2.9.0/developing/usage/security/php/
  - /openriak-kv/2.9.0p1/developing/usage/security/php/
  - /openriak-kv/2.9.0p2/developing/usage/security/php/
  - /openriak-kv/2.9.0p3/developing/usage/security/php/
  - /openriak-kv/2.9.0p4/developing/usage/security/php/
linkTitle: "PHP"
weight: 104
---
...
If you are using [trust-]({{<baseurl>}}openriak-kv/2.9.0/using/security/managing-sources/#trust-based-authentication) or [PAM]({{<baseurl>}}openriak-kv/2.9.0/using/security/managing-sources/#pam-based-authentication)-based authentication, you can use the
security setup described [below](#php-client-basics). [Certificate]({{<baseurl>}}openriak-kv/2.9.0/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
...
regardless of which [security source]({{<baseurl>}}openriak-kv/2.9.0/using/security/managing-sources/) you choose. All clients should also provide a username, regardless of
