...
aliases:
  - /riak/2.9.0/dev/advanced/search-schema
  - /openriak-kv/2.9.0/dev/advanced/search-schema
  - /riak/2.9.0/developing/usage/search-schemas/
  - /riak/2.9.0/developing/usage/search-schemas/
  - /openriak-kv/2.9.0/developing/usage/search-schemas/
  - /openriak-kv/2.9.0p1/developing/usage/search-schemas/
  - /openriak-kv/2.9.0p2/developing/usage/search-schemas/
  - /openriak-kv/2.9.0p3/developing/usage/search-schemas/
  - /openriak-kv/2.9.0p4/developing/usage/search-schemas/
linkTitle: "Creating Search Schemas"
weight: 110
---
...
under the hood to convert your values---plain text, JSON, XML, [Riak Data Types]({{<baseurl>}}openriak-kv/2.9.0/developing/data-types/), and [more]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/custom-extractors)---into something that can be indexed and searched later.
...
`_yz_ed`  | Entropy Data | Data related to [active anti-entropy]({{<baseurl>}}openriak-kv/2.9.0/learn/concepts/active-anti-entropy)
