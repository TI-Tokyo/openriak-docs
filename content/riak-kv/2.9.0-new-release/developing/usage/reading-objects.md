...
aliases:
  ...
  - /riak/2.9.0/developing/usage/reading-objects/
  - /openriak-kv/2.9.0/developing/usage/reading-objects/
  - /openriak-kv/2.9.0p1/developing/usage/reading-objects/
  - /openriak-kv/2.9.0p2/developing/usage/reading-objects/
  - /openriak-kv/2.9.0p3/developing/usage/reading-objects/
  - /openriak-kv/2.9.0p4/developing/usage/reading-objects/
linkTitle: "Reading Objects"
weight: 101
---
...
object that's stored there---including its [siblings]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/conflict-resolution/#siblings) /(more on that later)---or it returns `not found` (the
...
`dogs`, which bears the bucket type `animals`. Please note that for this example to work, you must have first created the bucket-type `animals` as per the instructions on the [bucket type]({{<baseurl>}}openriak-kv/2.9.0/using/cluster-operations/bucket-types) page.
