...
toc: true
aliases:
  - /riak/2.9.0/dev/using/mapreduce
  - /openriak-kv/2.9.0/dev/using/mapreduce
  - /riak/2.9.0/developing/usage/mapreduce/
  - /riak/2.9.0/developing/usage/mapreduce/
  - /openriak-kv/2.9.0/developing/usage/mapreduce/
  - /openriak-kv/2.9.0p1/developing/usage/mapreduce/
  - /openriak-kv/2.9.0p2/developing/usage/mapreduce/
  - /openriak-kv/2.9.0p3/developing/usage/mapreduce/
  - /openriak-kv/2.9.0p4/developing/usage/mapreduce/
...
[usage types]: {{<baseurl>}}openriak-kv/2.9.0/developing/usage/bucket-types
[api http]: {{<baseurl>}}openriak-kv/2.9.0/developing/api/http
[api pb]: {{<baseurl>}}openriak-kv/2.9.0/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}openriak-kv/2.9.0/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}openriak-kv/2.9.0/developing/app-guide/advanced-mapreduce
