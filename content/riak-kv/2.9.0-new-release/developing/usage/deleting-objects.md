...
aliases:
  ...
  - /riak/2.9.0/developing/usage/deleting-objects/
  - /openriak-kv/2.9.0/developing/usage/deleting-objects/
  - /openriak-kv/2.9.0p1/developing/usage/deleting-objects/
  - /openriak-kv/2.9.0p2/developing/usage/deleting-objects/
  - /openriak-kv/2.9.0p3/developing/usage/deleting-objects/
  - /openriak-kv/2.9.0p4/developing/usage/deleting-objects/
linkTitle: "Deleting Objects"
weight: 103
---
...
you first fetch the [causal context]({{<baseurl>}}openriak-kv/2.9.0/learn/concepts/causal-context) of the object prior to updating.
This can be done by setting the `deletedvclock` parameter to `true` as
part of the [fetch operation]({{<baseurl>}}openriak-kv/2.9.0/developing/api/protocol-buffers/fetch-object). This can also be done
