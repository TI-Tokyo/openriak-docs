...
toc: true
aliases:
  - /riak/2.9.0/dev/using/conflict-resolution/php
  - /openriak-kv/2.9.0/dev/using/conflict-resolution/php
  - /riak/2.9.0/developing/usage/conflict-resolution/php/
  - /riak/2.9.0/developing/usage/conflict-resolution/php/
  - /openriak-kv/2.9.0/developing/usage/conflict-resolution/php/
  - /openriak-kv/2.9.0p1/developing/usage/conflict-resolution/php/
  - /openriak-kv/2.9.0p2/developing/usage/conflict-resolution/php/
  - /openriak-kv/2.9.0p3/developing/usage/conflict-resolution/php/
  - /openriak-kv/2.9.0p4/developing/usage/conflict-resolution/php/
linkTitle: "PHP"
weight: 105
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.9.0/developing/usage) section.
