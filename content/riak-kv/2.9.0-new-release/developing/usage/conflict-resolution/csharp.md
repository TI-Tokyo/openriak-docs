...
toc: true
aliases:
  - /riak/2.9.0/dev/using/conflict-resolution/csharp
  - /openriak-kv/2.9.0/dev/using/conflict-resolution/csharp
  - /riak/2.9.0/developing/usage/conflict-resolution/csharp/
  - /riak/2.9.0/developing/usage/conflict-resolution/csharp/
  - /openriak-kv/2.9.0/developing/usage/conflict-resolution/csharp/
  - /openriak-kv/2.9.0p1/developing/usage/conflict-resolution/csharp/
  - /openriak-kv/2.9.0p2/developing/usage/conflict-resolution/csharp/
  - /openriak-kv/2.9.0p3/developing/usage/conflict-resolution/csharp/
  - /openriak-kv/2.9.0p4/developing/usage/conflict-resolution/csharp/
linkTitle: "C Sharp"
weight: 103
---

For reasons explained in the [Introduction to conflict resolution]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that requires applications to resolve siblings according to use-case-specific
