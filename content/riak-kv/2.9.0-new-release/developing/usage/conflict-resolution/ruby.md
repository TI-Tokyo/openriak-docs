...
toc: true
aliases:
  - /riak/2.9.0/dev/using/conflict-resolution/ruby
  - /openriak-kv/2.9.0/dev/using/conflict-resolution/ruby
  - /riak/2.9.0/developing/usage/conflict-resolution/ruby/
  - /riak/2.9.0/developing/usage/conflict-resolution/ruby/
  - /openriak-kv/2.9.0/developing/usage/conflict-resolution/ruby/
  - /openriak-kv/2.9.0p1/developing/usage/conflict-resolution/ruby/
  - /openriak-kv/2.9.0p2/developing/usage/conflict-resolution/ruby/
  - /openriak-kv/2.9.0p3/developing/usage/conflict-resolution/ruby/
  - /openriak-kv/2.9.0p4/developing/usage/conflict-resolution/ruby/
linkTitle: "Ruby"
weight: 101
---
...
the official Ruby client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.9.0/developing/usage) section.
