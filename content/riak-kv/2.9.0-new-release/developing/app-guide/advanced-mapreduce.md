...
toc: true
aliases:
  - /riak/2.9.0/dev/advanced/mapreduce/
  - /openriak-kv/2.9.0/dev/advanced/mapreduce/
  - /riak/2.9.0/developing/app-guide/advanced-mapreduce/
  - /riak/2.9.0/developing/app-guide/advanced-mapreduce/
  - /openriak-kv/2.9.0/developing/app-guide/advanced-mapreduce/
  - /openriak-kv/2.9.0p1/developing/app-guide/advanced-mapreduce/
  - /openriak-kv/2.9.0p2/developing/app-guide/advanced-mapreduce/
  - /openriak-kv/2.9.0p3/developing/app-guide/advanced-mapreduce/
  - /openriak-kv/2.9.0p4/developing/app-guide/advanced-mapreduce/
...
[`set-union`] function. In that case, the first set of inputs might be `[1,2.9.0]`,
...
[installing custom code]({{<baseurl>}}openriak-kv/2.9.0/using/reference/custom-code).
{{% /note %}}
