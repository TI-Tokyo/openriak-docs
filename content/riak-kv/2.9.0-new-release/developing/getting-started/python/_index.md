...
toc: true
aliases:
  - /riak/2.9.0/dev/taste-of-riak/python
  - /openriak-kv/2.9.0/dev/taste-of-riak/python
  - /riak/2.9.0/developing/getting-started/python/
  - /riak/2.9.0/developing/getting-started/python/
  - /openriak-kv/2.9.0/developing/getting-started/python/
  - /openriak-kv/2.9.0p1/developing/getting-started/python/
  - /openriak-kv/2.9.0p2/developing/getting-started/python/
  - /openriak-kv/2.9.0p3/developing/getting-started/python/
  - /openriak-kv/2.9.0p4/developing/getting-started/python/
linkTitle: "Python"
weight: 102
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}openriak-kv/2.9.0/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}openriak-kv/2.9.0/developing/getting-started/python/crud-operations)
