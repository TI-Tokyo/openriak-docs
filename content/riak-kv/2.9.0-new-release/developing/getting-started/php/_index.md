...
toc: true
aliases:
  - /riak/2.9.0/dev/taste-of-riak/php
  - /openriak-kv/2.9.0/dev/taste-of-riak/php
  - /riak/2.9.0/developing/getting-started/php/
  - /riak/2.9.0/developing/getting-started/php/
  - /openriak-kv/2.9.0/developing/getting-started/php/
  - /openriak-kv/2.9.0p1/developing/getting-started/php/
  - /openriak-kv/2.9.0p2/developing/getting-started/php/
  - /openriak-kv/2.9.0p3/developing/getting-started/php/
  - /openriak-kv/2.9.0p4/developing/getting-started/php/
linkTitle: "PHP"
weight: 107
---
...
[CRUD Operations]({{<baseurl>}}openriak-kv/2.9.0/developing/getting-started/php/crud-operations)
