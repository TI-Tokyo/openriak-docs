...
aliases:
  ...
  - /riak/2.9.0/developing/getting-started/php/crud-operations/
  - /openriak-kv/2.9.0/developing/getting-started/php/crud-operations/
  - /openriak-kv/2.9.0p1/developing/getting-started/php/crud-operations/
  - /openriak-kv/2.9.0p2/developing/getting-started/php/crud-operations/
  - /openriak-kv/2.9.0p3/developing/getting-started/php/crud-operations/
  - /openriak-kv/2.9.0p4/developing/getting-started/php/crud-operations/
...
More complex use cases can be composed from these initial create, read, update, and delete (CRUD) operations. [In the next chapter]({{<baseurl>}}openriak-kv/2.9.0/developing/getting-started/php/querying) we will look at how to store and query more complicated and interconnected data, such as documents.
