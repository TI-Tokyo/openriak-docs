...
toc: true
aliases:
  - /riak/2.9.0/dev/taste-of-riak/object-modeling-golang
  - /openriak-kv/2.9.0/dev/taste-of-riak/object-modeling-golang
  - /riak/2.9.0/developing/getting-started/golang/object-modeling/
  - /riak/2.9.0/developing/getting-started/golang/object-modeling/
  - /openriak-kv/2.9.0/developing/getting-started/golang/object-modeling/
  - /openriak-kv/2.9.0p1/developing/getting-started/golang/object-modeling/
  - /openriak-kv/2.9.0p2/developing/getting-started/golang/object-modeling/
  - /openriak-kv/2.9.0p3/developing/getting-started/golang/object-modeling/
  - /openriak-kv/2.9.0p4/developing/getting-started/golang/object-modeling/
...
We'll be using the bucket `Users` to store our data. We won't be [using bucket types]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/bucket-types) here, so we don't need to specify one.
