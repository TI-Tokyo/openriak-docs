...
toc: true
aliases:
  - /riak/2.9.0/dev/taste-of-riak/ruby
  - /openriak-kv/2.9.0/dev/taste-of-riak/ruby
  - /riak/2.9.0/developing/getting-started/ruby/
  - /riak/2.9.0/developing/getting-started/ruby/
  - /openriak-kv/2.9.0/developing/getting-started/ruby/
  - /openriak-kv/2.9.0p1/developing/getting-started/ruby/
  - /openriak-kv/2.9.0p2/developing/getting-started/ruby/
  - /openriak-kv/2.9.0p3/developing/getting-started/ruby/
  - /openriak-kv/2.9.0p4/developing/getting-started/ruby/
linkTitle: "Ruby"
weight: 101
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}openriak-kv/2.9.0/using/running-a-cluster) first. To try this flavor
...
[CRUD Operations]({{<baseurl>}}openriak-kv/2.9.0/developing/getting-started/ruby/crud-operations)
