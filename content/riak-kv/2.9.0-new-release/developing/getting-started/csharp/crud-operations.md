...
toc: true
aliases:
  - /riak/2.9.0/developing/getting-started/csharp/crud-operations/
  - /riak/2.9.0/developing/getting-started/csharp/crud-operations/
  - /openriak-kv/2.9.0/developing/getting-started/csharp/crud-operations/
  - /openriak-kv/2.9.0p1/developing/getting-started/csharp/crud-operations/
  - /openriak-kv/2.9.0p2/developing/getting-started/csharp/crud-operations/
  - /openriak-kv/2.9.0p3/developing/getting-started/csharp/crud-operations/
  - /openriak-kv/2.9.0p4/developing/getting-started/csharp/crud-operations/
