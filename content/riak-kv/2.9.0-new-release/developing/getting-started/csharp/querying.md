...
toc: true
aliases:
  - /riak/2.9.0/dev/taste-of-riak/querying-csharp
  - /openriak-kv/2.9.0/dev/taste-of-riak/querying-csharp
  - /riak/2.9.0/developing/getting-started/csharp/querying/
  - /riak/2.9.0/developing/getting-started/csharp/querying/
  - /openriak-kv/2.9.0/developing/getting-started/csharp/querying/
  - /openriak-kv/2.9.0p1/developing/getting-started/csharp/querying/
  - /openriak-kv/2.9.0p2/developing/getting-started/csharp/querying/
  - /openriak-kv/2.9.0p3/developing/getting-started/csharp/querying/
  - /openriak-kv/2.9.0p4/developing/getting-started/csharp/querying/
linkTitle: "Querying"
weight: 101
---
...
CheckResult(result);
Console.WriteLine("Customer     1: {0}/n", GetValueAsString(result));

result = client.Get(orderSummariesBucketName, key);
CheckResult(result);
Console.WriteLine("OrderSummary 1: {0}/n", GetValueAsString(result));
```
