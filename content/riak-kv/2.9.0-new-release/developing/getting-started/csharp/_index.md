...
toc: true
aliases:
  - /riak/2.9.0/dev/taste-of-riak/csharp
  - /openriak-kv/2.9.0/dev/taste-of-riak/csharp
  - /riak/2.9.0/developing/getting-started/csharp/
  - /riak/2.9.0/developing/getting-started/csharp/
  - /openriak-kv/2.9.0/developing/getting-started/csharp/
  - /openriak-kv/2.9.0p1/developing/getting-started/csharp/
  - /openriak-kv/2.9.0p2/developing/getting-started/csharp/
  - /openriak-kv/2.9.0p3/developing/getting-started/csharp/
  - /openriak-kv/2.9.0p4/developing/getting-started/csharp/
linkTitle: "C Sharp"
weight: 103
---
...
[CRUD Operations]({{<baseurl>}}openriak-kv/2.9.0/developing/getting-started/csharp/crud-operations)
