...
toc: true
aliases:
  - /riak/2.9.0/dev/references/protocol-buffers/list-buckets
  - /openriak-kv/2.9.0/dev/references/protocol-buffers/list-buckets
  - /riak/2.9.0/developing/api/protocol-buffers/list-buckets/
  - /riak/2.9.0/developing/api/protocol-buffers/list-buckets/
  - /openriak-kv/2.9.0/developing/api/protocol-buffers/list-buckets/
  - /openriak-kv/2.9.0p1/developing/api/protocol-buffers/list-buckets/
  - /openriak-kv/2.9.0p2/developing/api/protocol-buffers/list-buckets/
  - /openriak-kv/2.9.0p3/developing/api/protocol-buffers/list-buckets/
  - /openriak-kv/2.9.0p4/developing/api/protocol-buffers/list-buckets/
linkTitle: "List Buckets"
weight: 100
---
