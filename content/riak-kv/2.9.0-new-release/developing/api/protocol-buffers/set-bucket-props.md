...
toc: true
aliases:
  - /riak/2.9.0/dev/references/protocol-buffers/set-bucket-props
  - /openriak-kv/2.9.0/dev/references/protocol-buffers/set-bucket-props
  - /riak/2.9.0/developing/api/protocol-buffers/set-bucket-props/
  - /riak/2.9.0/developing/api/protocol-buffers/set-bucket-props/
  - /openriak-kv/2.9.0/developing/api/protocol-buffers/set-bucket-props/
  - /openriak-kv/2.9.0p1/developing/api/protocol-buffers/set-bucket-props/
  - /openriak-kv/2.9.0p2/developing/api/protocol-buffers/set-bucket-props/
  - /openriak-kv/2.9.0p3/developing/api/protocol-buffers/set-bucket-props/
  - /openriak-kv/2.9.0p4/developing/api/protocol-buffers/set-bucket-props/
...
[PBC Get Bucket Properties]({{<baseurl>}}openriak-kv/2.9.0/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/bucket-types) using the
