...
toc: true
aliases:
  - /riak/2.9.0/dev/references/protocol-buffers/reset-bucket-props
  - /openriak-kv/2.9.0/dev/references/protocol-buffers/reset-bucket-props
  - /riak/2.9.0/developing/api/protocol-buffers/reset-bucket-props/
  - /riak/2.9.0/developing/api/protocol-buffers/reset-bucket-props/
  - /openriak-kv/2.9.0/developing/api/protocol-buffers/reset-bucket-props/
  - /openriak-kv/2.9.0p1/developing/api/protocol-buffers/reset-bucket-props/
  - /openriak-kv/2.9.0p2/developing/api/protocol-buffers/reset-bucket-props/
  - /openriak-kv/2.9.0p3/developing/api/protocol-buffers/reset-bucket-props/
  - /openriak-kv/2.9.0p4/developing/api/protocol-buffers/reset-bucket-props/
linkTitle: "Reset Bucket Properties"
weight: 104
---
...
[bucket type]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/bucket-types) using the `type` value. If you do not
