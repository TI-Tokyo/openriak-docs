...
toc: true
aliases:
  - /riak/2.9.0/dev/references/protocol-buffers/get-bucket-props
  - /openriak-kv/2.9.0/dev/references/protocol-buffers/get-bucket-props
  - /riak/2.9.0/developing/api/protocol-buffers/get-bucket-props/
  - /riak/2.9.0/developing/api/protocol-buffers/get-bucket-props/
  - /openriak-kv/2.9.0/developing/api/protocol-buffers/get-bucket-props/
  - /openriak-kv/2.9.0p1/developing/api/protocol-buffers/get-bucket-props/
  - /openriak-kv/2.9.0p2/developing/api/protocol-buffers/get-bucket-props/
  - /openriak-kv/2.9.0p3/developing/api/protocol-buffers/get-bucket-props/
  - /openriak-kv/2.9.0p4/developing/api/protocol-buffers/get-bucket-props/
...
The bucket's name (`bucket`) must be specified. The [bucket type]({{<baseurl>}}openriak-kv/2.9.0/using/cluster-operations/bucket-types) parameter (`type`) is optional. If it is not specified,
...
[configuration file]({{<baseurl>}}openriak-kv/2.9.0/configuring/reference/#default-bucket-properties) documentation.
