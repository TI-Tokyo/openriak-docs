...
aliases:
  - /riak/2.9.0/dev/references/protocol-buffers/yz-index-get
  - /openriak-kv/2.9.0/dev/references/protocol-buffers/yz-index-get
  - /riak/2.9.0/developing/api/protocol-buffers/yz-index-get/
  - /riak/2.9.0/developing/api/protocol-buffers/yz-index-get/
  - /openriak-kv/2.9.0/developing/api/protocol-buffers/yz-index-get/
  - /openriak-kv/2.9.0p1/developing/api/protocol-buffers/yz-index-get/
  - /openriak-kv/2.9.0p2/developing/api/protocol-buffers/yz-index-get/
  - /openriak-kv/2.9.0p3/developing/api/protocol-buffers/yz-index-get/
  - /openriak-kv/2.9.0p4/developing/api/protocol-buffers/yz-index-get/
linkTitle: "Yokozuna Index Get"
weight: 120
---
...
binary (as `name`). Optionally, you can specify a [`schema`]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/search-schemas) name and/or an `n_val`, i.e. the number of nodes on which the
