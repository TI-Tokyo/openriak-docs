...
toc: true
aliases:
  - /riak/2.9.0/dev/references/protocol-buffers/mapreduce
  - /openriak-kv/2.9.0/dev/references/protocol-buffers/mapreduce
  - /riak/2.9.0/developing/api/protocol-buffers/mapreduce/
  - /riak/2.9.0/developing/api/protocol-buffers/mapreduce/
  - /openriak-kv/2.9.0/developing/api/protocol-buffers/mapreduce/
  - /openriak-kv/2.9.0p1/developing/api/protocol-buffers/mapreduce/
  - /openriak-kv/2.9.0p2/developing/api/protocol-buffers/mapreduce/
  - /openriak-kv/2.9.0p3/developing/api/protocol-buffers/mapreduce/
  - /openriak-kv/2.9.0p4/developing/api/protocol-buffers/mapreduce/
linkTitle: "MapReduce"
weight: 107
---
...
The JSON encoding is the same as [REST API]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/mapreduce/#rest) and
the external term format is the same as the [local Erlang API]({{<baseurl>}}openriak-kv/2.9.0/developing/app-guide/advanced-mapreduce/#erlang)
