...
aliases:
  - /riak/2.9.0/ops/mdc/v2/hooks
  - /openriak-kv/2.9.0/ops/mdc/v2/hooks
  - /riak/2.9.0/developing/api/repl-hooks/
  - /riak/2.9.0/developing/api/repl-hooks/
  - /openriak-kv/2.9.0/developing/api/repl-hooks/
  - /openriak-kv/2.9.0p1/developing/api/repl-hooks/
  - /openriak-kv/2.9.0p2/developing/api/repl-hooks/
  - /openriak-kv/2.9.0p3/developing/api/repl-hooks/
  - /openriak-kv/2.9.0p4/developing/api/repl-hooks/
linkTitle: "Multi-Datacenter REPL Hooks API"
weight: 100
---
