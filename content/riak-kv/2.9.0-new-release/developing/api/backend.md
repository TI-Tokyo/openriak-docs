...
toc: true
aliases:
  - /riak/2.9.0/dev/references/backend-api
  - /openriak-kv/2.9.0/dev/references/backend-api
  - /riak/2.9.0/developing/api/backend/
  - /riak/2.9.0/developing/api/backend/
  - /openriak-kv/2.9.0/developing/api/backend/
  - /openriak-kv/2.9.0p1/developing/api/backend/
  - /openriak-kv/2.9.0p2/developing/api/backend/
  - /openriak-kv/2.9.0p3/developing/api/backend/
  - /openriak-kv/2.9.0p4/developing/api/backend/
