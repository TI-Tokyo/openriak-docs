...
toc: true
aliases:
  - /riak/2.9.0/dev/references/http/link-walking
  - /openriak-kv/2.9.0/dev/references/http/link-walking
  - /riak/2.9.0/developing/api/http/link-walking/
  - /riak/2.9.0/developing/api/http/link-walking/
  - /openriak-kv/2.9.0/developing/api/http/link-walking/
  - /openriak-kv/2.9.0p1/developing/api/http/link-walking/
  - /openriak-kv/2.9.0p2/developing/api/http/link-walking/
  - /openriak-kv/2.9.0p3/developing/api/http/link-walking/
  - /openriak-kv/2.9.0p4/developing/api/http/link-walking/
...
is a special case of [MapReduce]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/mapreduce), and can be expressed more verbosely as such.
[Read more about Links]({{<baseurl>}}openriak-kv/2.9.0/learn/glossary/#links).
...
response from [fetching the object]({{<baseurl>}}openriak-kv/2.9.0/developing/api/http/fetch-object), without the status
code.
