...
toc: true
aliases:
  - /riak/2.9.0/dev/references/http/list-buckets
  - /openriak-kv/2.9.0/dev/references/http/list-buckets
  - /riak/2.9.0/developing/api/http/list-buckets/
  - /riak/2.9.0/developing/api/http/list-buckets/
  - /openriak-kv/2.9.0/developing/api/http/list-buckets/
  - /openriak-kv/2.9.0p1/developing/api/http/list-buckets/
  - /openriak-kv/2.9.0p2/developing/api/http/list-buckets/
  - /openriak-kv/2.9.0p3/developing/api/http/list-buckets/
  - /openriak-kv/2.9.0p4/developing/api/http/list-buckets/
