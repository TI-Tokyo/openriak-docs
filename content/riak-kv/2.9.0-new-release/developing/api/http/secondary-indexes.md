...
toc: true
aliases:
  - /riak/2.9.0/dev/references/http/secondary-indexes
  - /openriak-kv/2.9.0/dev/references/http/secondary-indexes
  - /riak/2.9.0/developing/api/http/secondary-indexes/
  - /riak/2.9.0/developing/api/http/secondary-indexes/
  - /openriak-kv/2.9.0/developing/api/http/secondary-indexes/
  - /openriak-kv/2.9.0p1/developing/api/http/secondary-indexes/
  - /openriak-kv/2.9.0p2/developing/api/http/secondary-indexes/
  - /openriak-kv/2.9.0p3/developing/api/http/secondary-indexes/
  - /openriak-kv/2.9.0p4/developing/api/http/secondary-indexes/
linkTitle: "Secondary Indexes"
weight: 109
---

[Secondary Indexes]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/secondary-indexes) allows an application to tag a Riak object with one or more field/value pairs. The object is indexed under these field/value pairs, and the application can later query the index to retrieve a list of matching keys.
