...
toc: true
aliases:
  - /riak/2.9.0/dev/references/http/status
  - /openriak-kv/2.9.0/dev/references/http/status
  - /riak/2.9.0/developing/api/http/status/
  - /riak/2.9.0/developing/api/http/status/
  - /openriak-kv/2.9.0/developing/api/http/status/
  - /openriak-kv/2.9.0p1/developing/api/http/status/
  - /openriak-kv/2.9.0p2/developing/api/http/status/
  - /openriak-kv/2.9.0p3/developing/api/http/status/
  - /openriak-kv/2.9.0p4/developing/api/http/status/
linkTitle: "Status"
weight: 111
---
...
The output of `/stats` contains the output of `riak-admin status` detailed in the [Inspecting a Node]({{<baseurl>}}openriak-kv/2.9.0/using/cluster-operations/inspecting-node) doc, plus the below stats generated by the Riak Core application.
