...
toc: true
aliases:
  - /riak/2.9.0/dev/references/http/set-bucket-props
  - /openriak-kv/2.9.0/dev/references/http/set-bucket-props
  - /riak/2.9.0/developing/api/http/set-bucket-props/
  - /riak/2.9.0/developing/api/http/set-bucket-props/
  - /openriak-kv/2.9.0/developing/api/http/set-bucket-props/
  - /openriak-kv/2.9.0p1/developing/api/http/set-bucket-props/
  - /openriak-kv/2.9.0p2/developing/api/http/set-bucket-props/
  - /openriak-kv/2.9.0p3/developing/api/http/set-bucket-props/
  - /openriak-kv/2.9.0p4/developing/api/http/set-bucket-props/
...
clock) when writing
* `precommit` - [precommit hooks]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/commit-hooks)
