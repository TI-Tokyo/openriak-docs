...
toc: true
aliases:
  - /riak/2.9.0/dev/references/http/reset-bucket-props
  - /openriak-kv/2.9.0/dev/references/http/reset-bucket-props
  - /riak/2.9.0/developing/api/http/reset-bucket-props/
  - /riak/2.9.0/developing/api/http/reset-bucket-props/
  - /openriak-kv/2.9.0/developing/api/http/reset-bucket-props/
  - /openriak-kv/2.9.0p1/developing/api/http/reset-bucket-props/
  - /openriak-kv/2.9.0p2/developing/api/http/reset-bucket-props/
  - /openriak-kv/2.9.0p3/developing/api/http/reset-bucket-props/
  - /openriak-kv/2.9.0p4/developing/api/http/reset-bucket-props/
