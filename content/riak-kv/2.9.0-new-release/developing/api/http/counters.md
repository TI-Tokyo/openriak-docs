...
toc: true
aliases:
  - /riak/2.9.0/dev/references/http/counters
  - /openriak-kv/2.9.0/dev/references/http/counters
  - /riak/2.9.0/developing/api/http/counters/
  - /riak/2.9.0/developing/api/http/counters/
  - /openriak-kv/2.9.0/developing/api/http/counters/
  - /openriak-kv/2.9.0p1/developing/api/http/counters/
  - /openriak-kv/2.9.0p2/developing/api/http/counters/
  - /openriak-kv/2.9.0p3/developing/api/http/counters/
  - /openriak-kv/2.9.0p4/developing/api/http/counters/
linkTitle: "Counters"
weight: 118
---
...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}openriak-kv/2.9.0/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}openriak-kv/2.9.0/developing/api/http/fetch-object)) responses apply here.
