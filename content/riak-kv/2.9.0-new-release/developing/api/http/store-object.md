...
toc: true
aliases:
  - /riak/2.9.0/dev/references/http/store-object
  - /openriak-kv/2.9.0/dev/references/http/store-object
  - /riak/2.9.0/developing/api/http/store-object/
  - /riak/2.9.0/developing/api/http/store-object/
  - /openriak-kv/2.9.0/developing/api/http/store-object/
  - /openriak-kv/2.9.0p1/developing/api/http/store-object/
  - /openriak-kv/2.9.0p2/developing/api/http/store-object/
  - /openriak-kv/2.9.0p3/developing/api/http/store-object/
  - /openriak-kv/2.9.0p4/developing/api/http/store-object/
...
[Read more about Secondary Indexing]({{<baseurl>}}openriak-kv/2.9.0/developing/api/http/secondary-indexes)
* `Link` - user and system-defined links to other resources. [Read more about Links.]({{<baseurl>}}openriak-kv/2.9.0/developing/api/http/link-walking)
...
If `returnbody=true`, any of the response headers expected from [HTTP Fetch Object]({{<baseurl>}}openriak-kv/2.9.0/developing/api/http/fetch-object) may be present. Like when fetching the object, `300 Multiple Choices`
