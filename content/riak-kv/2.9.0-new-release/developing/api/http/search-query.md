...
aliases:
  - /riak/2.9.0/dev/references/http/search-query
  - /openriak-kv/2.9.0/dev/references/http/search-query
  - /riak/2.9.0/developing/api/http/search-query/
  - /riak/2.9.0/developing/api/http/search-query/
  - /openriak-kv/2.9.0/developing/api/http/search-query/
  - /openriak-kv/2.9.0p1/developing/api/http/search-query/
  - /openriak-kv/2.9.0p2/developing/api/http/search-query/
  - /openriak-kv/2.9.0p3/developing/api/http/search-query/
  - /openriak-kv/2.9.0p4/developing/api/http/search-query/
linkTitle: "Search Query"
weight: 113
---

Performs a [Riak KV Search]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/search) query.
...
* `q` --- The actual Search query itself. Examples can be found in
    [Using Search]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/search). If a query is not specified, Riak will return
