...
toc: true
aliases:
  - /riak/2.9.0/dev/references/http/delete-object
  - /openriak-kv/2.9.0/dev/references/http/delete-object
  - /riak/2.9.0/developing/api/http/delete-object/
  - /riak/2.9.0/developing/api/http/delete-object/
  - /openriak-kv/2.9.0/developing/api/http/delete-object/
  - /openriak-kv/2.9.0p1/developing/api/http/delete-object/
  - /openriak-kv/2.9.0p2/developing/api/http/delete-object/
  - /openriak-kv/2.9.0p3/developing/api/http/delete-object/
  - /openriak-kv/2.9.0p4/developing/api/http/delete-object/
