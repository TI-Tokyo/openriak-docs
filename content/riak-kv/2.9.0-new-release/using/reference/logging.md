...
toc: true
aliases:
  - /riak/2.9.0/ops/running/logging
  - /openriak-kv/2.9.0/ops/running/logging
  - /riak/2.9.0/using/reference/logging/
  - /riak/2.9.0/using/reference/logging/
  - /openriak-kv/2.9.0/using/reference/logging/
  - /openriak-kv/2.9.0p1/using/reference/logging/
  - /openriak-kv/2.9.0p2/using/reference/logging/
  - /openriak-kv/2.9.0p3/using/reference/logging/
  - /openriak-kv/2.9.0p4/using/reference/logging/
linkTitle: "Logging"
weight: 100
---
...
As of Riak KV 2.9.0 a few of the log messages may contain newline
...
* `file` --- Console logs will be emitted to a file. This is Riak's
    ...
    `./log/console.log` on an installation from [source]({{<baseurl>}}openriak-kv/2.9.0/setup/installing/source), but will differ on platform-specific installation,
...
* `console` --- Console logs will be emitted to standard output, which
    can be viewed by running the [`riak attach-direct`]({{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-cli/#attach-direct) command
