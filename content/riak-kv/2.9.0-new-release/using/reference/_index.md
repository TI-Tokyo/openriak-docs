...
aliases:
  ...
  - /riak/2.9.0/using/reference/
  - /openriak-kv/2.9.0/using/reference/
  - /openriak-kv/2.9.0p1/using/reference/
  - /openriak-kv/2.9.0p2/using/reference/
  - /openriak-kv/2.9.0p3/using/reference/
  - /openriak-kv/2.9.0p4/using/reference/
linkTitle: "Reference"
weight: 208
---
