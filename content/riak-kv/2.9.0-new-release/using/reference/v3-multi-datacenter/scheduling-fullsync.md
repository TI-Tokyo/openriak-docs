...
aliases:
  - /riak/2.9.0/ops/mdc/v3/scheduling-fullsync
  - /openriak-kv/2.9.0/ops/mdc/v3/scheduling-fullsync
  - /riak/2.9.0/using/reference/v3-multi-datacenter/scheduling-fullsync/
  - /riak/2.9.0/using/reference/v3-multi-datacenter/scheduling-fullsync/
  - /openriak-kv/2.9.0/using/reference/v3-multi-datacenter/scheduling-fullsync/
  - /openriak-kv/2.9.0p1/using/reference/v3-multi-datacenter/scheduling-fullsync/
  - /openriak-kv/2.9.0p2/using/reference/v3-multi-datacenter/scheduling-fullsync/
  - /openriak-kv/2.9.0p3/using/reference/v3-multi-datacenter/scheduling-fullsync/
  - /openriak-kv/2.9.0p4/using/reference/v3-multi-datacenter/scheduling-fullsync/
