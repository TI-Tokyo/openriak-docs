...
aliases:
  - /riak/2.9.0/ops/mdc/v3/cascading-writes
  - /openriak-kv/2.9.0/ops/mdc/v3/cascading-writes
  - /riak/2.9.0/using/reference/v3-multi-datacenter/cascading-writes/
  - /riak/2.9.0/using/reference/v3-multi-datacenter/cascading-writes/
  - /openriak-kv/2.9.0/using/reference/v3-multi-datacenter/cascading-writes/
  - /openriak-kv/2.9.0p1/using/reference/v3-multi-datacenter/cascading-writes/
  - /openriak-kv/2.9.0p2/using/reference/v3-multi-datacenter/cascading-writes/
  - /openriak-kv/2.9.0p3/using/reference/v3-multi-datacenter/cascading-writes/
  - /openriak-kv/2.9.0p4/using/reference/v3-multi-datacenter/cascading-writes/
linkTitle: "Cascading Writes"
weight: 102
---
...
`riak-repl` command. Please see the [Version 3 Operations guide]({{<baseurl>}}openriak-kv/2.9.0/using/cluster-operations/v3-multi-datacenter) for more information.
