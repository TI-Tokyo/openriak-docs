...
toc: true
aliases:
  - /riak/2.9.0/ops/advanced/deletion
  - /riak/2.9.0/using/reference/object-deletion/
  - /riak/2.9.0/using/reference/object-deletion/
  - /openriak-kv/2.9.0/using/reference/object-deletion/
  - /openriak-kv/2.9.0p1/using/reference/object-deletion/
  - /openriak-kv/2.9.0p2/using/reference/object-deletion/
  - /openriak-kv/2.9.0p3/using/reference/object-deletion/
  - /openriak-kv/2.9.0p4/using/reference/object-deletion/
