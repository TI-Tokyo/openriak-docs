...
aliases:
  - /riak/2.9.0/ops/running/monitoring/jmx
  - /openriak-kv/2.9.0/ops/running/monitoring/jmx
  - /riak/2.9.0/using/reference/jmx/
  - /riak/2.9.0/using/reference/jmx/
  - /openriak-kv/2.9.0/using/reference/jmx/
  - /openriak-kv/2.9.0p1/using/reference/jmx/
  - /openriak-kv/2.9.0p2/using/reference/jmx/
  - /openriak-kv/2.9.0p3/using/reference/jmx/
  - /openriak-kv/2.9.0p4/using/reference/jmx/
linkTitle: "JMX Monitoring"
weight: 108
---

Riak exposes monitoring data via JMX.  To enable JMX monitoring, edit the [`app.config`]({{<baseurl>}}openriak-kv/2.9.0/configuring/reference/#app-config) associated with your Riak installation and set the `enabled` property of the `riak_jmx` section to `true` as shown below.  The TCP port on which the JMX provider listens is also configurable in this section (the default JMX port is `41110`).
...
int
        ...
        <td>
Number of GETs since node start
</td>
    </tr>
    <tr>
        <td>
...
int
        ...
        <td>
Number of PUTs since node start
</td>
    </tr>
    <tr>
        <td>
...
int
        ...
        <td>
Number of Protocol Buffers connections in past minute
</td>
    </tr>
    <tr>
        <td>
<tt>PBCConnectsTotal</tt>
</td>
        <td>
int
</td>
        <td>
Number of Protocol Buffers connections since node start
</td>
    </tr>
    <tr>
        <td>
<tt>RingCreationSize</tt>
</td>
        <td>
int
</td>
        <td>
Number of partitions in Riak ring
</td>
    </tr>
    <tr>
        <td>
...
Number of vnode-level GETs in past minute
    ...
    <tr>
        <td>
<tt>VnodeGetsTotal</tt>
</td>
        <td>
int
</td>
        <td>
Number of vnode-level GETs since node start
</td>
    </tr>
    <tr>
        <td>
...
Number of vnode-level PUTs in past minute
    ...
    <tr>
        <td>
<tt>VnodePutsTotal</tt>
</td>
        <td>
int
</td>
        <td>
Number of vnode-level PUTs since node start
</td>
    </tr>
</table>
