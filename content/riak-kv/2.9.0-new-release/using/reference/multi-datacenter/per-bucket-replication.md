...
toc: true
aliases:
  - /riak/2.9.0/ops/mdc/per-bucket
  - /openriak-kv/2.9.0/ops/mdc/per-bucket
  - /riak/2.9.0/using/reference/multi-datacenter/per-bucket-replication/
  - /riak/2.9.0/using/reference/multi-datacenter/per-bucket-replication/
  - /openriak-kv/2.9.0/using/reference/multi-datacenter/per-bucket-replication/
  - /openriak-kv/2.9.0p1/using/reference/multi-datacenter/per-bucket-replication/
  - /openriak-kv/2.9.0p2/using/reference/multi-datacenter/per-bucket-replication/
  - /openriak-kv/2.9.0p3/using/reference/multi-datacenter/per-bucket-replication/
  - /openriak-kv/2.9.0p4/using/reference/multi-datacenter/per-bucket-replication/
