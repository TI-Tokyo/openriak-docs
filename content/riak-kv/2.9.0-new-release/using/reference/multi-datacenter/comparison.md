...
toc: true
aliases:
  - /riak/2.9.0/ops/mdc/comparison
  - /openriak-kv/2.9.0/ops/mdc/comparison
  - /riak/2.9.0/using/reference/multi-datacenter/comparison/
  - /riak/2.9.0/using/reference/multi-datacenter/comparison/
  - /openriak-kv/2.9.0/using/reference/multi-datacenter/comparison/
  - /openriak-kv/2.9.0p1/using/reference/multi-datacenter/comparison/
  - /openriak-kv/2.9.0p2/using/reference/multi-datacenter/comparison/
  - /openriak-kv/2.9.0p3/using/reference/multi-datacenter/comparison/
  - /openriak-kv/2.9.0p4/using/reference/multi-datacenter/comparison/
linkTitle: "Comparison"
weight: 103
---

This document is a systematic comparison of [Version 2]({{<baseurl>}}openriak-kv/2.9.0/using/reference/v2-multi-datacenter) and [Version 3]({{<baseurl>}}openriak-kv/2.9.0/using/reference/v3-multi-datacenter) of Riak's Multi-Datacenter
...
* Version 3 is able to take advantage of [Active Anti-Entropy]({{<baseurl>}}openriak-kv/2.9.0/learn/concepts/active-anti-entropy/) /(AAE)
