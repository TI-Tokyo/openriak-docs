...
toc: true
aliases:
  - /riak/2.9.0/ops/mdc/statistics
  - /openriak-kv/2.9.0/ops/mdc/statistics
  - /riak/2.9.0/using/reference/multi-datacenter/statistics/
  - /riak/2.9.0/using/reference/multi-datacenter/statistics/
  - /openriak-kv/2.9.0/using/reference/multi-datacenter/statistics/
  - /openriak-kv/2.9.0p1/using/reference/multi-datacenter/statistics/
  - /openriak-kv/2.9.0p2/using/reference/multi-datacenter/statistics/
  - /openriak-kv/2.9.0p3/using/reference/multi-datacenter/statistics/
  - /openriak-kv/2.9.0p4/using/reference/multi-datacenter/statistics/
