...
toc: true
aliases:
  - /riak/2.9.0/ops/mdc/monitoring
  - /openriak-kv/2.9.0/ops/mdc/monitoring
  - /riak/2.9.0/using/reference/multi-datacenter/monitoring/
  - /riak/2.9.0/using/reference/multi-datacenter/monitoring/
  - /openriak-kv/2.9.0/using/reference/multi-datacenter/monitoring/
  - /openriak-kv/2.9.0p1/using/reference/multi-datacenter/monitoring/
  - /openriak-kv/2.9.0p2/using/reference/multi-datacenter/monitoring/
  - /openriak-kv/2.9.0p3/using/reference/multi-datacenter/monitoring/
  - /openriak-kv/2.9.0p4/using/reference/multi-datacenter/monitoring/
