...
toc: true
aliases:
  - /riak/2.9.0/ops/advanced/security
  - /openriak-kv/2.9.0/ops/advanced/security
  - /riak/2.9.0/using/security/
  - /riak/2.9.0/using/security/
  - /openriak-kv/2.9.0/using/security/
  - /openriak-kv/2.9.0p1/using/security/
  - /openriak-kv/2.9.0p2/using/security/
  - /openriak-kv/2.9.0p3/using/security/
  - /openriak-kv/2.9.0p4/using/security/
linkTitle: "Security"
weight: 205
---

[config reference search]: {{<baseurl>}}openriak-kv/2.9.0/configuring/reference/#search
[config search enabling]: {{<baseurl>}}openriak-kv/2.9.0/configuring/search/#enabling-riak-search
