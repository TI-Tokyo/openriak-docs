...
aliases:
  ...
  - /riak/2.9.0/using/security/best-practices/
  - /openriak-kv/2.9.0/using/security/best-practices/
  - /openriak-kv/2.9.0p1/using/security/best-practices/
  - /openriak-kv/2.9.0p2/using/security/best-practices/
  - /openriak-kv/2.9.0p3/using/security/best-practices/
  - /openriak-kv/2.9.0p4/using/security/best-practices/
