...
aliases:
  ...
  - /riak/2.9.0/using/cluster-operations/handoff/
  - /openriak-kv/2.9.0/using/cluster-operations/handoff/
  - /openriak-kv/2.9.0p1/using/cluster-operations/handoff/
  - /openriak-kv/2.9.0p2/using/cluster-operations/handoff/
  - /openriak-kv/2.9.0p3/using/cluster-operations/handoff/
  - /openriak-kv/2.9.0p4/using/cluster-operations/handoff/
linkTitle: "Handoff"
weight: 107
---
...
[`riak-admin`]({{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-admin/) interface enables you to
...
This command displays the values for handoff-specific [configurable parameters]({{<baseurl>}}openriak-kv/2.9.0/configuring/reference/#intra-cluster-handoff) on each node in
