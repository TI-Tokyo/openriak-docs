...
aliases:
  ...
  - /riak/2.9.0/using/cluster-operations/bucket-types/
  - /openriak-kv/2.9.0/using/cluster-operations/bucket-types/
  - /openriak-kv/2.9.0p1/using/cluster-operations/bucket-types/
  - /openriak-kv/2.9.0p2/using/cluster-operations/bucket-types/
  - /openriak-kv/2.9.0p3/using/cluster-operations/bucket-types/
  - /openriak-kv/2.9.0p4/using/cluster-operations/bucket-types/
...
In Riak versions 2.0 and later, Basho suggests that you [use bucket types]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/bucket-types) to namespace and configure all buckets you use. Bucket types have a lower overhead within the cluster than the
