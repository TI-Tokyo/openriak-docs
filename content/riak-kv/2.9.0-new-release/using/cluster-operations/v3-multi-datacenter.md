...
aliases:
  - /riak/2.9.0/ops/mdc/v3/operations
  - /openriak-kv/2.9.0/ops/mdc/v3/operations
  - /riak/2.9.0/using/cluster-operations/v3-multi-datacenter/
  - /riak/2.9.0/using/cluster-operations/v3-multi-datacenter/
  - /openriak-kv/2.9.0/using/cluster-operations/v3-multi-datacenter/
  - /openriak-kv/2.9.0p1/using/cluster-operations/v3-multi-datacenter/
  - /openriak-kv/2.9.0p2/using/cluster-operations/v3-multi-datacenter/
  - /openriak-kv/2.9.0p3/using/cluster-operations/v3-multi-datacenter/
  - /openriak-kv/2.9.0p4/using/cluster-operations/v3-multi-datacenter/
...
[ref v3 stats]: {{<baseurl>}}openriak-kv/2.9.0/using/reference/multi-datacenter/statistics
