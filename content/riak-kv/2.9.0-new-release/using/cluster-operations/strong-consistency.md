...
toc: true
aliases:
  - /riak/2.9.0/using/cluster-operations/strong-consistency/
  - /riak/2.9.0/using/cluster-operations/strong-consistency/
  - /openriak-kv/2.9.0/using/cluster-operations/strong-consistency/
  - /openriak-kv/2.9.0p1/using/cluster-operations/strong-consistency/
  - /openriak-kv/2.9.0p2/using/cluster-operations/strong-consistency/
  - /openriak-kv/2.9.0p3/using/cluster-operations/strong-consistency/
  - /openriak-kv/2.9.0p4/using/cluster-operations/strong-consistency/
linkTitle: "Monitoring Strong Consistency"
weight: 110
---
...
status of a node. This data is available by running the [`riak-admin status`]({{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-admin/#status) command. That data now
includes statistics specific to strongly consistent operations.

A full listing of these stats is available in [Inspecting a Node]({{<baseurl>}}openriak-kv/2.9.0/using/cluster-operations/inspecting-node).
