...
toc: true
aliases:
  - /riak/2.9.0/using/cluster-operations/logging/
  - /riak/2.9.0/using/cluster-operations/logging/
  - /openriak-kv/2.9.0/using/cluster-operations/logging/
  - /openriak-kv/2.9.0p1/using/cluster-operations/logging/
  - /openriak-kv/2.9.0p2/using/cluster-operations/logging/
  - /openriak-kv/2.9.0p3/using/cluster-operations/logging/
  - /openriak-kv/2.9.0p4/using/cluster-operations/logging/
linkTitle: "Logging"
weight: 105
---
...
by accessing the Erlang console directly using the [`riak attach`]({{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-cli/#attach) command. Once you run this command and drop into the console, enter the following:
