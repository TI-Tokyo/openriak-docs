...
toc: true
aliases:
  - /openriak-kv/2.9.0/ops/advanced/aae/
  - /riak/2.9.0/ops/advanced/aae/
  - /riak/2.9.0/using/cluster-operations/active-anti-entropy/
  - /riak/2.9.0/using/cluster-operations/active-anti-entropy/
  - /openriak-kv/2.9.0/using/cluster-operations/active-anti-entropy/
  - /openriak-kv/2.9.0p1/using/cluster-operations/active-anti-entropy/
  - /openriak-kv/2.9.0p2/using/cluster-operations/active-anti-entropy/
  - /openriak-kv/2.9.0p3/using/cluster-operations/active-anti-entropy/
  - /openriak-kv/2.9.0p4/using/cluster-operations/active-anti-entropy/
linkTitle: "Managing Active Anti-Entropy"
weight: 111
---

[config search#throttledelay]: {{<baseurl>}}openriak-kv/2.9.0/configuring/search/#search-anti-entropy-throttle-tier-delay
[config search#throttle]: {{<baseurl>}}openriak-kv/2.9.0/configuring/search/#search-anti-entropy-throttle
...
In Riak versions 2.9.0 and later, [TicTac AAE]({{<baseurl>}}openriak-kv/2.9.0/using/cluster-operations/tictac-active-anti-entropy) is included with releases as an option to be used in addition to or instead of traditional AAE in Riak.
