...
version_history:
  in: "2.9.0+"
aliases:
  - /openriak-kv/2.9.0/ops/advanced/tictacaae/
  - /riak/2.9.0/ops/advanced/ticktacaae/
  - /riak/2.9.0/using/cluster-operations/tictac-active-anti-entropy/
  - /riak/2.9.0/using/cluster-operations/tictac-active-anti-entropy/
  - /openriak-kv/2.9.0/using/cluster-operations/tictac-active-anti-entropy/
  - /openriak-kv/2.9.0p1/using/cluster-operations/tictac-active-anti-entropy/
  - /openriak-kv/2.9.0p2/using/cluster-operations/tictac-active-anti-entropy/
  - /openriak-kv/2.9.0p3/using/cluster-operations/tictac-active-anti-entropy/
  - /openriak-kv/2.9.0p4/using/cluster-operations/tictac-active-anti-entropy/
linkTitle: "TicTac Active Anti-Entropy"
weight: 111
---
