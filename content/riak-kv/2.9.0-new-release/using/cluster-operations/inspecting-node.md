...
toc: true
aliases:
  - /riak/2.9.0/ops/running/nodes/inspecting
  - /openriak-kv/2.9.0/ops/running/nodes/inspecting
  - /riak/2.9.0/using/cluster-operations/inspecting-node/
  - /riak/2.9.0/using/cluster-operations/inspecting-node/
  - /openriak-kv/2.9.0/using/cluster-operations/inspecting-node/
  - /openriak-kv/2.9.0p1/using/cluster-operations/inspecting-node/
  - /openriak-kv/2.9.0p2/using/cluster-operations/inspecting-node/
  - /openriak-kv/2.9.0p3/using/cluster-operations/inspecting-node/
  - /openriak-kv/2.9.0p4/using/cluster-operations/inspecting-node/
linkTitle: "Inspecting a Node"
weight: 103
---
