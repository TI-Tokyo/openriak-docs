...
toc: true
aliases:
  - /riak/2.9.0/ops/running/nodes/adding-removing
  - /openriak-kv/2.9.0/ops/running/nodes/adding-removing
  - /riak/2.9.0/using/cluster-operations/adding-removing-nodes/
  - /riak/2.9.0/using/cluster-operations/adding-removing-nodes/
  - /openriak-kv/2.9.0/using/cluster-operations/adding-removing-nodes/
  - /openriak-kv/2.9.0p1/using/cluster-operations/adding-removing-nodes/
  - /openriak-kv/2.9.0p2/using/cluster-operations/adding-removing-nodes/
  - /openriak-kv/2.9.0p3/using/cluster-operations/adding-removing-nodes/
  - /openriak-kv/2.9.0p4/using/cluster-operations/adding-removing-nodes/
...
simply the script [`riak`]({{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-cli/):
