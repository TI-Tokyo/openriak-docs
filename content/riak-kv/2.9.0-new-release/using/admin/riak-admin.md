...
toc: true
aliases:
  - /riak/2.9.0/ops/running/tools/riak-admin
  - /openriak-kv/2.9.0/ops/running/tools/riak-admin
  - /riak/2.9.0/using/admin/riak-admin/
  - /riak/2.9.0/using/admin/riak-admin/
  - /openriak-kv/2.9.0/using/admin/riak-admin/
  - /openriak-kv/2.9.0p1/using/admin/riak-admin/
  - /openriak-kv/2.9.0p2/using/admin/riak-admin/
  - /openriak-kv/2.9.0p3/using/admin/riak-admin/
  - /openriak-kv/2.9.0p4/using/admin/riak-admin/
...
[use admin commands#join]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/commands/#join
[use admin commands#leave]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/commands/#leave
[cluster ops backup]: {{<baseurl>}}openriak-kv/2.9.0/using/cluster-operations/backing-up
[config reference#node-metadata]: {{<baseurl>}}openriak-kv/2.9.0/configuring/reference/#node-metadata
...
[config reference#ring]: {{<baseurl>}}openriak-kv/2.9.0/configuring/reference/#ring
...
[downgrade]: {{<baseurl>}}openriak-kv/2.9.0/setup/downgrade
...
[use admin riak-admin#stats]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-admin/#stats
