...
toc: true
aliases:
  - /riak/2.9.0/ops/advanced/riak-control
  - /openriak-kv/2.9.0/ops/advanced/riak-control
  - /riak/2.9.0/using/admin/riak-control/
  - /riak/2.9.0/using/admin/riak-control/
  - /openriak-kv/2.9.0/using/admin/riak-control/
  - /openriak-kv/2.9.0p1/using/admin/riak-control/
  - /openriak-kv/2.9.0p2/using/admin/riak-control/
  - /openriak-kv/2.9.0p3/using/admin/riak-control/
  - /openriak-kv/2.9.0p4/using/admin/riak-control/
...
enabled on each Riak node. For more information, see our [security documentation]({{<baseurl>}}openriak-kv/2.9.0/using/security/basics#enabling-ssl). Once SSL is enabled, you can proceed to setting up [authentication](#authentication) for Riak Control.
...
see the health of each [vnode]({{<baseurl>}}openriak-kv/2.9.0/learn/glossary/#vnode).
