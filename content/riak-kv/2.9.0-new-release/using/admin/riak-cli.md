...
toc: true
aliases:
  - /riak/2.9.0/ops/running/tools/riak
  - /openriak-kv/2.9.0/ops/running/tools/riak
  - /riak/2.9.0/using/admin/riak-cli/
  - /riak/2.9.0/using/admin/riak-cli/
  - /openriak-kv/2.9.0/using/admin/riak-cli/
  - /openriak-kv/2.9.0p1/using/admin/riak-cli/
  - /openriak-kv/2.9.0p2/using/admin/riak-cli/
  - /openriak-kv/2.9.0p3/using/admin/riak-cli/
  - /openriak-kv/2.9.0p4/using/admin/riak-cli/
linkTitle: "riak CLI"
weight: 102
---

[configuration file]: {{<baseurl>}}openriak-kv/2.9.0/configuring/reference/
[escript]: http://www.erlang.org/doc/man/escript.html
[`riak-admin`]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-admin/#top
[configuration]: {{<baseurl>}}openriak-kv/2.9.0/configuring/reference/
