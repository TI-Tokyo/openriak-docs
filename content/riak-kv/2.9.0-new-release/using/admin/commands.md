...
toc: true
aliases:
  - /riak/2.9.0/ops/running/cluster-admin
  - /openriak-kv/2.9.0/ops/running/cluster-admin
  - /riak/2.9.0/using/admin/commands/
  - /riak/2.9.0/using/admin/commands/
  - /openriak-kv/2.9.0/using/admin/commands/
  - /openriak-kv/2.9.0p1/using/admin/commands/
  - /openriak-kv/2.9.0p2/using/admin/commands/
  - /openriak-kv/2.9.0p3/using/admin/commands/
  - /openriak-kv/2.9.0p4/using/admin/commands/
linkTitle: "Cluster Admin Commands"
weight: 100
---
...
[use admin riak-admin#cluster-plan]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-admin/#cluster-plan
[use admin riak-admin#cluster-commit]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-admin/#cluster-commit
