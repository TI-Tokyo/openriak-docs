...
toc: true
aliases:
  - /riak/2.9.0/ops/running/recovery/failure-recovery
  - /openriak-kv/2.9.0/ops/running/recovery/failure-recovery
  - /riak/2.9.0/using/repair-recovery/failure-recovery/
  - /riak/2.9.0/using/repair-recovery/failure-recovery/
  - /openriak-kv/2.9.0/using/repair-recovery/failure-recovery/
  - /openriak-kv/2.9.0p1/using/repair-recovery/failure-recovery/
  - /openriak-kv/2.9.0p2/using/repair-recovery/failure-recovery/
  - /openriak-kv/2.9.0p3/using/repair-recovery/failure-recovery/
  - /openriak-kv/2.9.0p4/using/repair-recovery/failure-recovery/
linkTitle: "Failure & Recovery"
weight: 100
---
...
returns to service (also called [hinted handoff]({{<baseurl>}}openriak-kv/2.9.0/learn/glossary/#hinted-handoff)).
...
See [Changing Cluster Information]({{<baseurl>}}openriak-kv/2.9.0/using/cluster-operations/changing-cluster-info/#clusters-from-backups) for instructions on cluster recovery.
