...
aliases:
  ...
  - /riak/2.9.0/using/repair-recovery/failed-node/
  - /openriak-kv/2.9.0/using/repair-recovery/failed-node/
  - /openriak-kv/2.9.0p1/using/repair-recovery/failed-node/
  - /openriak-kv/2.9.0p2/using/repair-recovery/failed-node/
  - /openriak-kv/2.9.0p3/using/repair-recovery/failed-node/
  - /openriak-kv/2.9.0p4/using/repair-recovery/failed-node/
