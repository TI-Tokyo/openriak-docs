...
toc: true
aliases:
  - /riak/2.9.0/ops/running/recovery/rolling-restart
  - /openriak-kv/2.9.0/ops/running/recovery/rolling-restart
  - /riak/2.9.0/using/repair-recovery/rolling-restart/
  - /riak/2.9.0/using/repair-recovery/rolling-restart/
  - /openriak-kv/2.9.0/using/repair-recovery/rolling-restart/
  - /openriak-kv/2.9.0p1/using/repair-recovery/rolling-restart/
  - /openriak-kv/2.9.0p2/using/repair-recovery/rolling-restart/
  - /openriak-kv/2.9.0p3/using/repair-recovery/rolling-restart/
  - /openriak-kv/2.9.0p4/using/repair-recovery/rolling-restart/
linkTitle: "Rolling Restarts"
weight: 103
---

Because Riak functions as a multi-node system, cluster-level [Riak version upgrades]({{<baseurl>}}openriak-kv/2.9.0/setup/upgrading/cluster) and restarts can be performed on a node-by-node, "rolling" basis.
