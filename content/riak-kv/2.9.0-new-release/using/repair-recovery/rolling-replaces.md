...
aliases:
  ...
  - /riak/2.9.0/using/repair-recovery/rolling-replaces/
  - /openriak-kv/2.9.0/using/repair-recovery/rolling-replaces/
  - /openriak-kv/2.9.0p1/using/repair-recovery/rolling-replaces/
  - /openriak-kv/2.9.0p2/using/repair-recovery/rolling-replaces/
  - /openriak-kv/2.9.0p3/using/repair-recovery/rolling-replaces/
  - /openriak-kv/2.9.0p4/using/repair-recovery/rolling-replaces/
linkTitle: "Rolling Replaces"
weight: 106
---

[upgrade]: {{<baseurl>}}openriak-kv/2.9.0/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}openriak-kv/2.9.0/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}openriak-kv/2.9.0/using/cluster-operations/adding-removing-nodes
