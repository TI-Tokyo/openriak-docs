...
toc: true
aliases:
  - /riak/2.9.0/ops/tuning/latency-reduction
  - /openriak-kv/2.9.0/ops/tuning/latency-reduction
  - /riak/2.9.0/using/performance/latency-reduction/
  - /riak/2.9.0/using/performance/latency-reduction/
  - /openriak-kv/2.9.0/using/performance/latency-reduction/
  - /openriak-kv/2.9.0p1/using/performance/latency-reduction/
  - /openriak-kv/2.9.0p2/using/performance/latency-reduction/
  - /openriak-kv/2.9.0p3/using/performance/latency-reduction/
  - /openriak-kv/2.9.0p4/using/performance/latency-reduction/
