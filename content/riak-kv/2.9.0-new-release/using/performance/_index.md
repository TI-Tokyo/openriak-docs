...
toc: true
aliases:
  - /openriak-kv/2.9.0/ops/tuning/linux/
  - /riak/2.9.0/ops/tuning/linux/
  - /riak/2.9.0/using/performance/
  - /riak/2.9.0/using/performance/
  - /openriak-kv/2.9.0/using/performance/
  - /openriak-kv/2.9.0p1/using/performance/
  - /openriak-kv/2.9.0p2/using/performance/
  - /openriak-kv/2.9.0p3/using/performance/
  - /openriak-kv/2.9.0p4/using/performance/
...
clusters on the Amazon Web Services EC2 environment, see [AWS Performance Tuning]({{<baseurl>}}openriak-kv/2.9.0/using/performance/amazon-web-services).
...
open files limit is necessary. See [Open Files Limit]({{<baseurl>}}openriak-kv/2.9.0/using/performance/open-files-limit/) for more
details.

## Other Tuning Docs

* [AWS Performance Tuning]({{<baseurl>}}openriak-kv/2.9.0/using/performance/amazon-web-services)
* [Erlang VM Tuning]({{<baseurl>}}openriak-kv/2.9.0/using/performance/erlang)
* [Latency Reduction]({{<baseurl>}}openriak-kv/2.9.0/using/performance/latency-reduction)
* [Open Files Limit]({{<baseurl>}}openriak-kv/2.9.0/using/performance/open-files-limit/)
