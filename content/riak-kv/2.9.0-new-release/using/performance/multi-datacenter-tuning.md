...
aliases:
  ...
  - /riak/2.9.0/using/performance/multi-datacenter-tuning/
  - /openriak-kv/2.9.0/using/performance/multi-datacenter-tuning/
  - /openriak-kv/2.9.0p1/using/performance/multi-datacenter-tuning/
  - /openriak-kv/2.9.0p2/using/performance/multi-datacenter-tuning/
  - /openriak-kv/2.9.0p3/using/performance/multi-datacenter-tuning/
  - /openriak-kv/2.9.0p4/using/performance/multi-datacenter-tuning/
linkTitle: "Multi-Datacenter Replication"
weight: 110
---
