...
toc: true
aliases:
  - /riak/2.9.0/ops/building/benchmarking
  - /openriak-kv/2.9.0/ops/building/benchmarking
  - /riak/2.9.0/using/performance/benchmarking/
  - /riak/2.9.0/using/performance/benchmarking/
  - /openriak-kv/2.9.0/using/performance/benchmarking/
  - /openriak-kv/2.9.0p1/using/performance/benchmarking/
  - /openriak-kv/2.9.0p2/using/performance/benchmarking/
  - /openriak-kv/2.9.0p3/using/performance/benchmarking/
  - /openriak-kv/2.9.0p4/using/performance/benchmarking/
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}openriak-kv/2.9.0/setup/installing/source/erlang) for instructions
