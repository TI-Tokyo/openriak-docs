...
aliases:
  ...
  - /riak/2.9.0/using/performance/v2-scheduling-fullsync/
  - /openriak-kv/2.9.0/using/performance/v2-scheduling-fullsync/
  - /openriak-kv/2.9.0p1/using/performance/v2-scheduling-fullsync/
  - /openriak-kv/2.9.0p2/using/performance/v2-scheduling-fullsync/
  - /openriak-kv/2.9.0p3/using/performance/v2-scheduling-fullsync/
  - /openriak-kv/2.9.0p4/using/performance/v2-scheduling-fullsync/
linkTitle: "V2 Scheduling Fullsync"
weight: 103
---

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}openriak-kv/2.9.0/using/cluster-operations/v3-multi-datacenter/#fullsync-replication-commands/) instead.
{{% /note %}}
