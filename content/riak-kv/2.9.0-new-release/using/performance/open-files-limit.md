...
toc: true
aliases:
  - /riak/2.9.0/ops/tuning/open-files-limit/
  - /openriak-kv/2.9.0/ops/tuning/open-files-limit/
  - /riak/2.9.0/using/performance/open-files-limit/
  - /riak/2.9.0/using/performance/open-files-limit/
  - /openriak-kv/2.9.0/using/performance/open-files-limit/
  - /openriak-kv/2.9.0p1/using/performance/open-files-limit/
  - /openriak-kv/2.9.0p2/using/performance/open-files-limit/
  - /openriak-kv/2.9.0p3/using/performance/open-files-limit/
  - /openriak-kv/2.9.0p4/using/performance/open-files-limit/
