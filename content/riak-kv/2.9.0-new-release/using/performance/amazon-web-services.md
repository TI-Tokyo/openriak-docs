...
toc: true
aliases:
  - /riak/2.9.0/ops/tuning/aws
  - /openriak-kv/2.9.0/ops/tuning/aws
  - /riak/2.9.0/using/performance/amazon-web-services/
  - /riak/2.9.0/using/performance/amazon-web-services/
  - /openriak-kv/2.9.0/using/performance/amazon-web-services/
  - /openriak-kv/2.9.0p1/using/performance/amazon-web-services/
  - /openriak-kv/2.9.0p2/using/performance/amazon-web-services/
  - /openriak-kv/2.9.0p3/using/performance/amazon-web-services/
  - /openriak-kv/2.9.0p4/using/performance/amazon-web-services/
