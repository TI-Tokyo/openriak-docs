...
aliases:
  - /openriak-kv/2.9.0/add-ons/redis/get-started-with-rra
  - /riak/2.9.0/add-ons/redis/using-rra/
  - /riak/2.9.0/add-ons/redis/using-rra/
  - /openriak-kv/2.9.0/add-ons/redis/using-rra/
  - /openriak-kv/2.9.0p1/add-ons/redis/using-rra/
  - /openriak-kv/2.9.0p2/add-ons/redis/using-rra/
  - /openriak-kv/2.9.0p3/add-ons/redis/using-rra/
  - /openriak-kv/2.9.0p4/add-ons/redis/using-rra/
