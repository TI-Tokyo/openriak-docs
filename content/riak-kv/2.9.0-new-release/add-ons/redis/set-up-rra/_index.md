...
aliases:
  ...
  - /riak/2.9.0/add-ons/redis/set-up-rra/
  - /openriak-kv/2.9.0/add-ons/redis/set-up-rra/
  - /openriak-kv/2.9.0p1/add-ons/redis/set-up-rra/
  - /openriak-kv/2.9.0p2/add-ons/redis/set-up-rra/
  - /openriak-kv/2.9.0p3/add-ons/redis/set-up-rra/
  - /openriak-kv/2.9.0p4/add-ons/redis/set-up-rra/
linkTitle: "Set Up Redis Add-on"
weight: 201
---
...
[perf open files]: {{<baseurl>}}openriak-kv/2.9.0/using/performance/open-files-limit/#changing-the-limit
