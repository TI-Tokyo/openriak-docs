...
aliases:
  ...
  - /riak/2.9.0/add-ons/redis/set-up-rra/deployment-models/
  - /openriak-kv/2.9.0/add-ons/redis/set-up-rra/deployment-models/
  - /openriak-kv/2.9.0p1/add-ons/redis/set-up-rra/deployment-models/
  - /openriak-kv/2.9.0p2/add-ons/redis/set-up-rra/deployment-models/
  - /openriak-kv/2.9.0p3/add-ons/redis/set-up-rra/deployment-models/
  - /openriak-kv/2.9.0p4/add-ons/redis/set-up-rra/deployment-models/
linkTitle: "Redis Add-on Deployment Models"
weight: 201
---
