...
aliases:
  ...
  - /riak/2.9.0/add-ons/redis/redis-add-on-features/
  - /openriak-kv/2.9.0/add-ons/redis/redis-add-on-features/
  - /openriak-kv/2.9.0p1/add-ons/redis/redis-add-on-features/
  - /openriak-kv/2.9.0p2/add-ons/redis/redis-add-on-features/
  - /openriak-kv/2.9.0p3/add-ons/redis/redis-add-on-features/
  - /openriak-kv/2.9.0p4/add-ons/redis/redis-add-on-features/
linkTitle: "Redis Add-on Features"
weight: 504
---
