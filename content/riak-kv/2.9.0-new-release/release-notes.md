...
toc: false
aliases:
  - /riak/2.9.0/community/release-notes
  - /openriak-kv/2.9.0/intro-v20
  - /riak/2.9.0/intro-v20
  - /openriak-kv/2.9.0/introduction
  - /riak/2.9.0/release-notes/
  - /riak/2.9.0/release-notes/
  - /openriak-kv/2.9.0/release-notes/
  - /openriak-kv/2.9.0p1/release-notes/
  - /openriak-kv/2.9.0p2/release-notes/
  - /openriak-kv/2.9.0p3/release-notes/
  - /openriak-kv/2.9.0p4/release-notes/
...
Please see the KV 2.2.6 release notes [here]({{<baseurl>}}openriak-kv/2.2.6/release-notes/), and the KV 2.2.3 release notes [here]({{<baseurl>}}openriak-kv/2.2.3/release-notes/).
