...
toc: true
aliases:
  - /riak/2.9.0/ops/building/configuration/
  - /openriak-kv/2.9.0/ops/building/configuration/
  - /riak/2.9.0/configuring/basic/
  - /riak/2.9.0/configuring/basic/
  - /openriak-kv/2.9.0/configuring/basic/
  - /openriak-kv/2.9.0p1/configuring/basic/
  - /openriak-kv/2.9.0p2/configuring/basic/
  - /openriak-kv/2.9.0p3/configuring/basic/
  - /openriak-kv/2.9.0p4/configuring/basic/
...
[use admin riak-admin#member-status]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-admin/#member-status
...
[Cluster Capacity Planning]: {{<baseurl>}}openriak-kv/2.9.0/setup/planning/cluster-capacity/#ring-size-number-of-partitions
...
directly impacted, although the mechanism described in [HTTP Reset Bucket Properties]({{<baseurl>}}openriak-kv/2.9.0/developing/api/http/reset-bucket-props) can be used to force them to pick up the new
defaults.
