...
toc: true
aliases:
  - /riak/2.9.0/configuring/managing/
  - /riak/2.9.0/configuring/managing/
  - /openriak-kv/2.9.0/configuring/managing/
  - /openriak-kv/2.9.0p1/configuring/managing/
  - /openriak-kv/2.9.0p2/configuring/managing/
  - /openriak-kv/2.9.0p3/configuring/managing/
  - /openriak-kv/2.9.0p4/configuring/managing/
linkTitle: "Managing Configuration"
weight: 130
---

[use admin riak cli]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-cli
[use admin riak cli#chkconfig]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-cli/#chkconfig
