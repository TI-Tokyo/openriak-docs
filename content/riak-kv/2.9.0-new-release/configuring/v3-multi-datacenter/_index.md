...
aliases:
  - /riak/2.9.0/ops/mdc/v3/configuration
  - /openriak-kv/2.9.0/ops/mdc/v3/configuration
  - /riak/2.9.0/configuring/v3-multi-datacenter/
  - /riak/2.9.0/configuring/v3-multi-datacenter/
  - /openriak-kv/2.9.0/configuring/v3-multi-datacenter/
  - /openriak-kv/2.9.0p1/configuring/v3-multi-datacenter/
  - /openriak-kv/2.9.0p2/configuring/v3-multi-datacenter/
  - /openriak-kv/2.9.0p3/configuring/v3-multi-datacenter/
  - /openriak-kv/2.9.0p4/configuring/v3-multi-datacenter/
...
[config v3 ssl#verify-peer]: {{<baseurl>}}openriak-kv/2.9.0/configuring/v3-multi-datacenter/ssl/#verifying-peer-certificates
