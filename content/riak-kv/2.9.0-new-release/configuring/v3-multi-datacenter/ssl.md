...
aliases:
  - /riak/2.9.0/ops/mdc/v3/ssl
  - /openriak-kv/2.9.0/ops/mdc/v3/ssl
  - /riak/2.9.0/configuring/v3-multi-datacenter/ssl/
  - /riak/2.9.0/configuring/v3-multi-datacenter/ssl/
  - /openriak-kv/2.9.0/configuring/v3-multi-datacenter/ssl/
  - /openriak-kv/2.9.0p1/configuring/v3-multi-datacenter/ssl/
  - /openriak-kv/2.9.0p2/configuring/v3-multi-datacenter/ssl/
  - /openriak-kv/2.9.0p3/configuring/v3-multi-datacenter/ssl/
  - /openriak-kv/2.9.0p4/configuring/v3-multi-datacenter/ssl/
linkTitle: "SSL"
weight: 103
---

[config reference#advanced.config]: {{<baseurl>}}openriak-kv/2.9.0/configuring/reference/#the-advanced-config-file
