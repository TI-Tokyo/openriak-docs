...
aliases:
  - /riak/2.9.0/ops/mdc/v2/ssl
  - /openriak-kv/2.9.0/ops/mdc/v2/ssl
  - /riak/2.9.0/configuring/v2-multi-datacenter/ssl/
  - /riak/2.9.0/configuring/v2-multi-datacenter/ssl/
  - /openriak-kv/2.9.0/configuring/v2-multi-datacenter/ssl/
  - /openriak-kv/2.9.0p1/configuring/v2-multi-datacenter/ssl/
  - /openriak-kv/2.9.0p2/configuring/v2-multi-datacenter/ssl/
  - /openriak-kv/2.9.0p3/configuring/v2-multi-datacenter/ssl/
  - /openriak-kv/2.9.0p4/configuring/v2-multi-datacenter/ssl/
linkTitle: "SSL"
weight: 103
---

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}openriak-kv/2.9.0/configuring/v3-multi-datacenter/ssl/) instead.
{{% /note %}}
