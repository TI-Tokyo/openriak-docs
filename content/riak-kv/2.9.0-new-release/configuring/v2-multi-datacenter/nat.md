...
aliases:
  - /riak/2.9.0/ops/mdc/v2/nat
  - /openriak-kv/2.9.0/ops/mdc/v2/nat
  - /riak/2.9.0/configuring/v2-multi-datacenter/nat/
  - /riak/2.9.0/configuring/v2-multi-datacenter/nat/
  - /openriak-kv/2.9.0/configuring/v2-multi-datacenter/nat/
  - /openriak-kv/2.9.0p1/configuring/v2-multi-datacenter/nat/
  - /openriak-kv/2.9.0p2/configuring/v2-multi-datacenter/nat/
  - /openriak-kv/2.9.0p3/configuring/v2-multi-datacenter/nat/
  - /openriak-kv/2.9.0p4/configuring/v2-multi-datacenter/nat/
linkTitle: "With NAT"
weight: 101
---
...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}openriak-kv/2.9.0/configuring/v3-multi-datacenter/nat/) instead.
{{% /note %}}
