...
aliases:
  - /riak/2.9.0/ops/advanced/configs/search/
  - /openriak-kv/2.9.0/ops/advanced/configs/search/
  - /riak/2.9.0/configuring/search/
  - /riak/2.9.0/configuring/search/
  - /openriak-kv/2.9.0/configuring/search/
  - /openriak-kv/2.9.0p1/configuring/search/
  - /openriak-kv/2.9.0p2/configuring/search/
  - /openriak-kv/2.9.0p3/configuring/search/
  - /openriak-kv/2.9.0p4/configuring/search/
linkTitle: "Riak Search Settings"
weight: 160
---
...
[cluster-ops aae throttle]: {{<baseurl>}}openriak-kv/2.9.0/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}openriak-kv/2.9.0/configuring/reference
[config reference#search]: {{<baseurl>}}openriak-kv/2.9.0/configuring/reference/#search
