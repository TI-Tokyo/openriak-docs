...
toc: true
aliases:
  - /riak/2.9.0/theory/concepts/vnodes
  - /openriak-kv/2.9.0/theory/concepts/vnodes
  - /riak/2.9.0/learn/concepts/vnodes/
  - /riak/2.9.0/learn/concepts/vnodes/
  - /openriak-kv/2.9.0/learn/concepts/vnodes/
  - /openriak-kv/2.9.0p1/learn/concepts/vnodes/
  - /openriak-kv/2.9.0p2/learn/concepts/vnodes/
  - /openriak-kv/2.9.0p3/learn/concepts/vnodes/
  - /openriak-kv/2.9.0p4/learn/concepts/vnodes/
linkTitle: "Vnodes"
weight: 109
---

[concept causal context]: {{<baseurl>}}openriak-kv/2.9.0/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}openriak-kv/2.9.0/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}openriak-kv/2.9.0/setup/planning/backend/bitcask) as a backend, navigate
