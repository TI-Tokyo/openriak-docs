...
toc: true
aliases:
  - /riak/2.9.0/theory/concepts/Replication
  - /openriak-kv/2.9.0/theory/concepts/Replication
  - /riak/2.9.0/theory/concepts/replication
  - /openriak-kv/2.9.0/theory/concepts/replication
  - /riak/2.9.0/learn/concepts/replication/
  - /riak/2.9.0/learn/concepts/replication/
  - /openriak-kv/2.9.0/learn/concepts/replication/
  - /openriak-kv/2.9.0p1/learn/concepts/replication/
  - /openriak-kv/2.9.0p2/learn/concepts/replication/
  - /openriak-kv/2.9.0p3/learn/concepts/replication/
  - /openriak-kv/2.9.0p4/learn/concepts/replication/
...
[glossary node]: {{<baseurl>}}openriak-kv/2.9.0/learn/glossary/#node
...
bucket's [bucket type]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}openriak-kv/2.9.0/configuring/planning/v3-multi-datacenter) capabilities.
...
type]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/mapreduce/) queries. Lowering an object or bucket's
