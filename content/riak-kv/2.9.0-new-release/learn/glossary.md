...
toc: true
aliases:
  - /riak/2.9.0/learn/glossary/
  - /riak/2.9.0/learn/glossary/
  - /openriak-kv/2.9.0/learn/glossary/
  - /openriak-kv/2.9.0p1/learn/glossary/
  - /openriak-kv/2.9.0p2/learn/glossary/
  - /openriak-kv/2.9.0p3/learn/glossary/
  - /openriak-kv/2.9.0p4/learn/glossary/
linkTitle: "Riak KV Glossary"
weight: 103
---
...
[concept causal context vc]: {{<baseurl>}}openriak-kv/2.9.0/learn/concepts/causal-context/#vector-clocks
...
[concept strong consistency]: {{<baseurl>}}openriak-kv/2.9.0/learn/concepts/strong-consistency
[dev kv model]: {{<baseurl>}}openriak-kv/2.9.0/developing/key-value-modeling
[concept replication aae]: {{<baseurl>}}openriak-kv/2.9.0/learn/concepts/replication/#active-anti-entropy
...
[learn dynamo]: {{<baseurl>}}openriak-kv/2.9.0/learn/dynamo
[plan cluster capacity]: {{<baseurl>}}openriak-kv/2.9.0/setup/planning/cluster-capacity
[repair recover failure recovery]: {{<baseurl>}}openriak-kv/2.9.0/using/repair-recovery/failure-recovery
[repair recover repairs]: {{<baseurl>}}openriak-kv/2.9.0/using/repair-recovery/repairs
...
[usage secondary-indexes]: {{<baseurl>}}openriak-kv/2.9.0/developing/usage/secondary-indexes
...
* [Bucket Types]({{<baseurl>}}openriak-kv/2.9.0/developing/usage/bucket-types)
