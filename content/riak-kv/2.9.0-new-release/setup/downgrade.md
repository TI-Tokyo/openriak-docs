...
toc: true
aliases:
  - /riak/2.9.0/ops/upgrading/rolling-downgrades/
  - /openriak-kv/2.9.0/ops/upgrading/rolling-downgrades/
  - /riak/2.9.0/setup/downgrade/
  - /riak/2.9.0/setup/downgrade/
  - /openriak-kv/2.9.0/setup/downgrade/
  - /openriak-kv/2.9.0p1/setup/downgrade/
  - /openriak-kv/2.9.0p2/setup/downgrade/
  - /openriak-kv/2.9.0p3/setup/downgrade/
  - /openriak-kv/2.9.0p4/setup/downgrade/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/2.9.0/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-admin/#aae-status
...
If you enabled LZ4 compression in LevelDB and/or enabled global expiration in LevelDB when you installed KV 2.9.0, you cannot downgrade.
