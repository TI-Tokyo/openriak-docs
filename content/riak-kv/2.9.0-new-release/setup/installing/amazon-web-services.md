...
toc: true
aliases:
  - /riak/2.9.0/ops/building/installing/Installing-on-AWS-Marketplace
  - /openriak-kv/2.9.0/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/2.9.0/installing/amazon-web-services/
  - /openriak-kv/2.9.0/installing/amazon-web-services/
  - /riak/2.9.0/setup/installing/amazon-web-services/
  - /riak/2.9.0/setup/installing/amazon-web-services/
  - /openriak-kv/2.9.0/setup/installing/amazon-web-services/
  - /openriak-kv/2.9.0p1/setup/installing/amazon-web-services/
  - /openriak-kv/2.9.0p2/setup/installing/amazon-web-services/
  - /openriak-kv/2.9.0p3/setup/installing/amazon-web-services/
  - /openriak-kv/2.9.0p4/setup/installing/amazon-web-services/
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}openriak-kv/2.9.0/using/security/).
