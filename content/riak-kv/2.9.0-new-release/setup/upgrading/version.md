...
toc: true
aliases:
  - /riak/2.9.0/upgrade-v20/
  - /openriak-kv/2.9.0/ops/upgrading/rolling-upgrades/
  - /openriak-kv/2.9.0/ops/upgrading/rolling-upgrades/
  - /openriak-kv/2.9.0/setup/upgrading/cluster/
  - /riak/2.9.0/setup/upgrading/version/
  - /riak/2.9.0/setup/upgrading/version/
  - /openriak-kv/2.9.0/setup/upgrading/version/
  - /openriak-kv/2.9.0p1/setup/upgrading/version/
  - /openriak-kv/2.9.0p2/setup/upgrading/version/
  - /openriak-kv/2.9.0p3/setup/upgrading/version/
  - /openriak-kv/2.9.0p4/setup/upgrading/version/
linkTitle: "Upgrading to 2.9.0"
weight: 101
---

[production checklist]: {{<baseurl>}}openriak-kv/2.9.0/setup/upgrading/checklist
...
[release notes]: {{<baseurl>}}openriak-kv/2.9.0/release-notes
...
[jmx monitor]: {{<baseurl>}}openriak-kv/2.9.0/using/reference/jmx
[snmp]: {{<baseurl>}}openriak-kv/2.9.0/using/reference/snmp
[Release Notes]: {{<baseurl>}}openriak-kv/2.9.0/release-notes

## Overview

You can upgrade one node or your whole cluster to Riak KV 2.9.0 by following the instructions below.
