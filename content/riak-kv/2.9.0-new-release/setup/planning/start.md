...
toc: true
aliases:
  - /riak/2.9.0/ops/building/planning/system-planning
  - /openriak-kv/2.9.0/ops/building/planning/system-planning
  - /riak/2.9.0/setup/planning/start/
  - /riak/2.9.0/setup/planning/start/
  - /openriak-kv/2.9.0/setup/planning/start/
  - /openriak-kv/2.9.0p1/setup/planning/start/
  - /openriak-kv/2.9.0p2/setup/planning/start/
  - /openriak-kv/2.9.0p3/setup/planning/start/
  - /openriak-kv/2.9.0p4/setup/planning/start/
