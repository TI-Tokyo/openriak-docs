...
toc: true
aliases:
  - /riak/2.9.0/ops/building/planning/cluster
  - /openriak-kv/2.9.0/ops/building/planning/cluster
  - /riak/2.9.0/setup/planning/cluster-capacity/
  - /riak/2.9.0/setup/planning/cluster-capacity/
  - /openriak-kv/2.9.0/setup/planning/cluster-capacity/
  - /openriak-kv/2.9.0p1/setup/planning/cluster-capacity/
  - /openriak-kv/2.9.0p2/setup/planning/cluster-capacity/
  - /openriak-kv/2.9.0p3/setup/planning/cluster-capacity/
  - /openriak-kv/2.9.0p4/setup/planning/cluster-capacity/
...
[use admin riak-admin#cluster]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-admin/#cluster
