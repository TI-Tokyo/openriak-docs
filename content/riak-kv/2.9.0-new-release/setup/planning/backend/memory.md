...
toc: true
aliases:
  - /riak/2.9.0/ops/advanced/backends/memory/
  - /openriak-kv/2.9.0/ops/advanced/backends/memory/
  - /riak/2.9.0/setup/planning/backend/memory/
  - /riak/2.9.0/setup/planning/backend/memory/
  - /openriak-kv/2.9.0/setup/planning/backend/memory/
  - /openriak-kv/2.9.0p1/setup/planning/backend/memory/
  - /openriak-kv/2.9.0p2/setup/planning/backend/memory/
  - /openriak-kv/2.9.0p3/setup/planning/backend/memory/
  - /openriak-kv/2.9.0p4/setup/planning/backend/memory/
linkTitle: "Memory"
weight: 102
---
