...
toc: true
aliases:
  - /riak/2.9.0/ops/advanced/backends/multi/
  - /openriak-kv/2.9.0/ops/advanced/backends/multi/
  - /riak/2.9.0/setup/planning/backend/multi/
  - /riak/2.9.0/setup/planning/backend/multi/
  - /openriak-kv/2.9.0/setup/planning/backend/multi/
  - /openriak-kv/2.9.0p1/setup/planning/backend/multi/
  - /openriak-kv/2.9.0p2/setup/planning/backend/multi/
  - /openriak-kv/2.9.0p3/setup/planning/backend/multi/
  - /openriak-kv/2.9.0p4/setup/planning/backend/multi/
linkTitle: "Multi-backend"
weight: 103
---
...
[use admin riak-admin cli]: {{<baseurl>}}openriak-kv/2.9.0/using/admin/riak-admin
