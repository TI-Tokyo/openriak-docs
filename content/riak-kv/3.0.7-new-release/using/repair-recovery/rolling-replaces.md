...
[upgrade]: {{<baseurl>}}openriak-kv/3.0.7/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}openriak-kv/3.0.7/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}openriak-kv/3.0.7/using/cluster-operations/adding-removing-nodes
