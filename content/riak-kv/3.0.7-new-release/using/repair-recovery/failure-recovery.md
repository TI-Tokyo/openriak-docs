...
toc: true
aliases:
  - /riak/3.0.7/ops/running/recovery/failure-recovery
  - /openriak-kv/3.0.7/ops/running/recovery/failure-recovery
...
returns to service (also called [hinted handoff]({{<baseurl>}}openriak-kv/3.0.7/learn/glossary/#hinted-handoff)).
...
See [Changing Cluster Information]({{<baseurl>}}openriak-kv/3.0.7/using/cluster-operations/changing-cluster-info/#clusters-from-backups) for instructions on cluster recovery.
