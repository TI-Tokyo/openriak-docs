...
toc: true
aliases:
  - /riak/3.0.7/ops/running/handoff/
  - /openriak-kv/3.0.7/ops/running/handoff/
linkTitle: "Handoff"
weight: 101
---
...
It occurs when a [vnode]({{<baseurl>}}openriak-kv/3.0.7/learn/glossary/#vnode) no longer belongs to the node on which it's running. This typically happens when the very
...
[configuration files]({{<baseurl>}}openriak-kv/3.0.7/configuring/reference/#intra-cluster-handoff)
...
duration that a [vnode]({{<baseurl>}}openriak-kv/3.0.7/learn/glossary/#vnode) can be blocked by multiplying the
`handoff.max_rejects` setting by the value of
[`vnode_management_timer`]({{<baseurl>}}openriak-kv/3.0.7/configuring/reference/#vnode_management_timer).
