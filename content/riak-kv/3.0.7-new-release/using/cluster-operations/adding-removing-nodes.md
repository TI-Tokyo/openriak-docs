...
toc: true
aliases:
  - /riak/3.0.7/ops/running/nodes/adding-removing
  - /openriak-kv/3.0.7/ops/running/nodes/adding-removing
...
simply the script [`riak`]({{<baseurl>}}openriak-kv/3.0.7/using/admin/riak-cli/):
