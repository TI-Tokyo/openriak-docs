...
aliases:
  ...
  - /openriak-kv/3.0.7/dev/references/protocol-buffers/reset-bucket-props
...
[bucket type]({{<baseurl>}}openriak-kv/3.0.7/developing/usage/bucket-types) using the `type` value. If you do not
