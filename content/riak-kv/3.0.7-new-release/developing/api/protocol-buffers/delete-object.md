...
toc: true
aliases:
  - /riak/3.0.7/dev/references/protocol-buffers/delete-object
  - /openriak-kv/3.0.7/dev/references/protocol-buffers/delete-object
linkTitle: "Delete Object"
weight: 107
---

Delete an object in the specified [bucket type]({{<baseurl>}}openriak-kv/3.0.7/using/cluster-operations/bucket-types)/bucket/key location.
