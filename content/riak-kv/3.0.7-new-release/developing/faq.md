...
toc: true
aliases:
  - /riak/3.0.7/community/faqs/developing
  - /openriak-kv/3.0.7/community/faqs/developing
...
[Bucket Properties]: {{<baseurl>}}openriak-kv/3.0.7/developing/usage
[built-in functions list]: https://github.com/basho/riak_kv/blob/master/priv/mapred_builtins.js
[commit hooks]: {{<baseurl>}}openriak-kv/3.0.7/developing/usage/commit-hooks
[Configuration Files]: {{<baseurl>}}openriak-kv/3.0.7/configuring/reference
[contrib.basho.com]: https://github.com/basho/riak_function_contrib
[Erlang Riak Client]: {{<baseurl>}}openriak-kv/3.0.7/developing/client-libraries
...
[System Planning]: {{<baseurl>}}openriak-kv/3.0.7/setup/planning/start/#network-configuration-load-balancing
[vector clocks]: {{<baseurl>}}openriak-kv/3.0.7/learn/concepts/causal-context#vector-clocks
