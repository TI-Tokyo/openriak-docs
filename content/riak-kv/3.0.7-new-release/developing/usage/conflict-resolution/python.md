...
aliases:
  ...
  - /openriak-kv/3.0.7/dev/using/conflict-resolution/python
linkTitle: "Python"
weight: 102
---
...
from the official Python client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/3.0.7/developing/usage) section.
