...
[config reference#strong-cons]: {{<baseurl>}}openriak-kv/3.0.7/configuring/reference/#strong-consistency
...
[use admin riak admin#ensemble]: {{<baseurl>}}openriak-kv/3.0.7/using/admin/riak-admin/#ensemble-status
[use admin riak admin]: {{<baseurl>}}openriak-kv/3.0.7/using/admin/riak-admin
[config reference#advanced]: {{<baseurl>}}openriak-kv/3.0.7/configuring/reference/#advanced-configuration
