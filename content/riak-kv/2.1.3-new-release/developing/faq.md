...
aliases:
  ...
  - /openriak-kv/2.1.3/community/faqs/developing
...
[Bucket Properties]: {{<baseurl>}}openriak-kv/2.1.3/developing/usage
[built-in functions list]: https://github.com/basho/riak_kv/blob/master/priv/mapred_builtins.js
[commit hooks]: {{<baseurl>}}openriak-kv/2.1.3/developing/usage/commit-hooks
...
[Erlang Riak Client]: {{<baseurl>}}openriak-kv/2.1.3/developing/client-libraries
...
[System Planning]: {{<baseurl>}}openriak-kv/2.1.3/setup/planning/start/#network-configuration-load-balancing
[vector clocks]: {{<baseurl>}}openriak-kv/2.1.3/learn/concepts/causal-context#vector-clocks
