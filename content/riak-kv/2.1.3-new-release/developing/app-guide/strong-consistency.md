...
aliases:
  ...
  - /openriak-kv/2.1.3/dev/advanced/strong-consistency
...
[use ref strong consistency#trade-offs]: {{<baseurl>}}openriak-kv/2.1.3/using/reference/strong-consistency/#trade-offs
[glossary vnode]: {{<baseurl>}}openriak-kv/2.1.3/learn/glossary/#vnode
[config strong consistency#enable]: {{<baseurl>}}openriak-kv/2.1.3/configuring/strong-consistency/#enabling-strong-consistency
...
[config strong consistency#fault]: {{<baseurl>}}openriak-kv/2.1.3/configuring/strong-consistency/#fault-tolerance
[concept causal context]: {{<baseurl>}}openriak-kv/2.1.3/learn/concepts/causal-context
[concept causal context#vector]: {{<baseurl>}}openriak-kv/2.1.3/learn/concepts/causal-context/#vector-clocks
[concept version vector]: {{<baseurl>}}openriak-kv/2.1.3/learn/concepts/causal-context/#dotted-version-vectors
...
[use ref strong consistency#vs]: {{<baseurl>}}openriak-kv/2.1.3/using/reference/strong-consistency/#strong-vs.-eventual-consistency
...
[config strong consistency#details]: {{<baseurl>}}openriak-kv/2.1.3/configuring/strong-consistency/#implementation-details
