...
aliases:
  ...
  - /openriak-kv/2.1.3/ops/building/benchmarking
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}openriak-kv/2.1.3/setup/installing/source/erlang) for instructions
