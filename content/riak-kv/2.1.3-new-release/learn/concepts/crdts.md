...
aliases:
  ...
  - /openriak-kv/2.1.3/theory/concepts/crdts
linkTitle: "Data Types"
weight: 104
---

[concept causal context dvv]: {{<baseurl>}}openriak-kv/2.1.3/learn/concepts/causal-context/#dotted-version-vectors
...
indexes]({{<baseurl>}}openriak-kv/2.1.3/developing/usage/secondary-indexes/) and [Search]({{<baseurl>}}openriak-kv/2.1.3/developing/usage/search/).
...
object]({{<baseurl>}}openriak-kv/2.1.3/developing/data-types/#Data-Types-and-Context) that is similar to a
