...
toc: true
aliases:
  - /riak/2.1.3/ops/building/installing/Installing-on-FreeBSD
  - /openriak-kv/2.1.3/ops/building/installing/Installing-on-FreeBSD
  - /riak/2.1.3/installing/freebsd/
  - /openriak-kv/2.1.3/installing/freebsd/
linkTitle: "FreeBSD"
weight: 303
---
...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.1/2.1.2/freebsd/9.2/riak-2.1.2-FreeBSD-amd64.tbz
```
