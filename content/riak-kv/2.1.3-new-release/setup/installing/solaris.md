...
aliases:
  ...
  - /openriak-kv/2.1.3/ops/building/installing/Installing-on-Solaris
  - /riak/2.1.3/installing/solaris/
  - /openriak-kv/2.1.3/installing/solaris/
linkTitle: "Solaris"
weight: 306
---
...
```bash
curl -o /tmp/BASHOriak-2.1.3-Solaris10-i386.pkg.gz https://files.tiot.jp/riak/kv/2.1/2.1.1/solaris/10/BASHOriak-2.1.1-Solaris10-x86_64.pkg.gz
```
