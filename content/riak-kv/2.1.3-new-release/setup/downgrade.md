...
aliases:
  ...
  - /openriak-kv/2.1.3/ops/upgrading/rolling-downgrades/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/2.1.3/setup/upgrading/cluster
[config ref]: {{<baseurl>}}openriak-kv/2.1.3/configuring/reference
[concept aae]: {{<baseurl>}}openriak-kv/2.1.3/learn/concepts/active-anti-entropy/
[aae status]: {{<baseurl>}}openriak-kv/2.1.3/using/admin/riak-admin/#aae-status
