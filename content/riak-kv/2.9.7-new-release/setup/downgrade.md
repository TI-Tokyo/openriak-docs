...
toc: true
aliases:
  - /riak/2.9.7/ops/upgrading/rolling-downgrades/
  - /openriak-kv/2.9.7/ops/upgrading/rolling-downgrades/
linkTitle: "Downgrading"
weight: 103
---

[rolling upgrade]: {{<baseurl>}}openriak-kv/2.9.7/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}openriak-kv/2.9.7/using/admin/riak-admin/#aae-status
