...
[upgrade]: {{<baseurl>}}openriak-kv/2.9.7/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}openriak-kv/2.9.7/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}openriak-kv/2.9.7/using/cluster-operations/adding-removing-nodes
