...
aliases:
  ...
  - /openriak-kv/2.9.7/ops/building/benchmarking
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}openriak-kv/2.9.7/setup/installing/source/erlang) for instructions
