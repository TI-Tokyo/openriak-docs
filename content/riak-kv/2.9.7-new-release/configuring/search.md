...
aliases:
  ...
  - /openriak-kv/2.9.7/ops/advanced/configs/search/
...
[cluster-ops aae throttle]: {{<baseurl>}}openriak-kv/2.9.7/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}openriak-kv/2.9.7/configuring/reference
[config reference#search]: {{<baseurl>}}openriak-kv/2.9.7/configuring/reference/#search
