...
aliases:
  ...
  - /openriak-kv/2.9.7/dev/using/conflict-resolution/java
linkTitle: "Java"
weight: 100
---
...
the official Java client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}openriak-kv/2.9.7/developing/usage) section.
