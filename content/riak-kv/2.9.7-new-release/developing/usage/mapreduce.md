...
aliases:
  ...
  - /openriak-kv/2.9.7/dev/using/mapreduce
...
[usage types]: {{<baseurl>}}openriak-kv/2.9.7/developing/usage/bucket-types
[api http]: {{<baseurl>}}openriak-kv/2.9.7/developing/api/http
[api pb]: {{<baseurl>}}openriak-kv/2.9.7/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}openriak-kv/2.9.7/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}openriak-kv/2.9.7/developing/app-guide/advanced-mapreduce
