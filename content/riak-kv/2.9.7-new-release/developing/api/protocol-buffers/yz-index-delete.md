...
aliases:
  ...
  - /openriak-kv/2.9.7/dev/references/protocol-buffers/yz-index-delete
...
Returns a [RpbDelResp]({{<baseurl>}}openriak-kv/2.9.7/developing/api/protocol-buffers/#message-codes) code with no data on success.
