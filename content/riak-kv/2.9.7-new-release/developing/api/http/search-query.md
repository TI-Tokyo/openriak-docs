...
aliases:
  ...
  - /openriak-kv/2.9.7/dev/references/http/search-query
linkTitle: "Search Query"
weight: 113
---

Performs a [Riak KV Search]({{<baseurl>}}openriak-kv/2.9.7/developing/usage/search) query.
...
* `q` - The actual Search query itself. Examples can be found in
    [Using Search]({{<baseurl>}}openriak-kv/2.9.7/developing/usage/search). If a query is not specified, Riak will return
