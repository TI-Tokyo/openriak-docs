...
aliases:
  ...
  - /openriak-kv/2.9.7/dev/references/http/set-bucket-props
...
clock) when writing
* `precommit` - [precommit hooks]({{<baseurl>}}openriak-kv/2.9.7/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks]({{<baseurl>}}openriak-kv/2.9.7/developing/usage/commit-hooks)
