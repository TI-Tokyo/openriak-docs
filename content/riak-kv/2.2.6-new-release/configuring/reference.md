...
toc: true
aliases:
  - /riak/2.2.6/ops/advanced/configs/configuration-files/
  - /openriak-kv/2.2.6/ops/advanced/configs/configuration-files/
...
as <a href="{{<baseurl>}}openriak-kv/2.2.6/learn/glossary/#active-anti-entropy-aae">active anti-entropy</a> data, and cluster metadata
</td>
<td>
<code>./data</code>
</td>
...
Owing to lack of usage, SNMP support has been removed from Riak KV 2.2.6 and higher.

## JMX

Owing to lack of usage, JMX support has also been removed from Riak KV 2.2.6 and higher.
...
associated <a href="{{<baseurl>}}openriak-kv/2.2.6/learn/glossary/#vnode">vnode</a> before assuming that the vnode
...
href="{{<baseurl>}}openriak-kv/2.2.6/learn/glossary/#vnode">vnodes</a> attempt to trigger <a
href="{{<baseurl>}}openriak-kv/2.2.6/learn/glossary/#hinted-handoff">handoff</a> between
