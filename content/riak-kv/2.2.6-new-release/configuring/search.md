...
aliases:
  ...
  - /openriak-kv/2.2.6/ops/advanced/configs/search/
...
[cluster-ops aae throttle]: {{<baseurl>}}openriak-kv/2.2.6/using/cluster-operations/active-anti-entropy/#throttling
[config reference]: {{<baseurl>}}openriak-kv/2.2.6/configuring/reference
[config reference#search]: {{<baseurl>}}openriak-kv/2.2.6/configuring/reference/#search
