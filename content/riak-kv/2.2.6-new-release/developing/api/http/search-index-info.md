...
aliases:
  ...
  - /openriak-kv/2.2.6/dev/references/http/search-index-info
linkTitle: "Search Index Info"
weight: 114
---

Retrieves information about all currently available [Search indexes]({{<baseurl>}}openriak-kv/2.2.6/developing/usage/search) in JSON format.
