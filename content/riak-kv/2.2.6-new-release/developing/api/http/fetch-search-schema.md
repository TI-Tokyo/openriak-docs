...
aliases:
  - /riak/2.2.6/dev/references/http/fetch-search-schema
  - /openriak-kv/2.2.6/dev/references/http/fetch-search-schema
linkTitle: "Fetch Search Schema"
weight: 116
---

Retrieves a Riak KV [search schema]({{<baseurl>}}openriak-kv/2.2.6/developing/usage/search-schemas).
