...
aliases:
  ...
  - /openriak-kv/2.2.6/dev/references/protocol-buffers/yz-index-get
...
binary (as `name`). Optionally, you can specify a [`schema`]({{<baseurl>}}openriak-kv/2.2.6/developing/usage/search-schemas) name and/or an `n_val`, i.e. the number of nodes on which the
