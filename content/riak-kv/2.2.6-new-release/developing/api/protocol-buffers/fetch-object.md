...
toc: true
aliases:
  - /riak/2.2.6/dev/references/protocol-buffers/fetch-object
  - /openriak-kv/2.2.6/dev/references/protocol-buffers/fetch-object
...
[`RpbPutResp`]({{<baseurl>}}openriak-kv/2.2.6/developing/api/protocol-buffers/store-object), respectively):
...
* `content_encoding` --- The content encoding of the object, e.g.
  `video/mp4`
* `vtag` --- The object's [vtag]({{<baseurl>}}openriak-kv/2.2.6/learn/glossary/#vector-clock)
...
* `usermeta` --- This field stores user-specified key/value metadata
  ...
  send metadata of this sort are structured like this:
    ...
    `RpbPair` messages are also used to attach [secondary indexes]({{<baseurl>}}openriak-kv/2.2.6/developing/usage/secondary-indexes) to objects (in the optional
    `indexes` field).
...
Erlang <<0,0,0,74,10,10,38,10,2,118,50,42,22,51,83,68,108,102,52,73,78,75,122,
         ...
         224,185,6,18,31,107,206,97,96,96,96,204,96,2.2.6,82,44,172,194,91,63,
