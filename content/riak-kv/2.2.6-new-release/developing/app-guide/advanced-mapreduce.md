...
toc: true
aliases:
  - /riak/2.2.6/dev/advanced/mapreduce/
  - /openriak-kv/2.2.6/dev/advanced/mapreduce/
...
[`set-union`] function. In that case, the first set of inputs might be `[1,2.2.6]`,
...
[installing custom code]({{<baseurl>}}openriak-kv/2.2.6/using/reference/custom-code).
{{% /note %}}
