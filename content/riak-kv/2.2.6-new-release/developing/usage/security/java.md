...
aliases:
  ...
  - /openriak-kv/2.2.6/dev/advanced/client-security/java
linkTitle: "Java"
weight: 100
---
...
security setup described [below](#java-client-basics). [Certificate]({{<baseurl>}}openriak-kv/2.2.6/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
