---
title: "Riak KV 2.2.6 Release Notes"
description: ""
project: "riak_kv"
...
aliases:
  ...
  - /openriak-kv/2.2.6/intro-v20
  - /riak/2.2.6/intro-v20
  - /openriak-kv/2.2.6/introduction
...
website running, the mailing list, the documents site (after [TI Tokyo](https://www.tiot.jp/)
...
[MDC]({{<baseurl>}}openriak-kv/2.2.6/configuring/v3-multi-datacenter/). Again,
...
With the inclusion of Multi-Datacentre Replication in riak-2.2.6 there
...
of riak-2.2.6. Some package installs will simply replace the old with
...
[MDC]({{<baseurl>}}openriak-kv/2.2.6/configuring/v3-multi-datacenter/)
replication.
...
Please see the KV 2.2.3 release notes [here]({{<baseurl>}}openriak-kv/2.2.6/release-notes/), and the KV 2.2.2 release notes [here]({{<baseurl>}}openriak-kv/2.2.6/release-notes/).
