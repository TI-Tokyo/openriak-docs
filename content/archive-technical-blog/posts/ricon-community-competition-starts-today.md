...
date: "2015-10-27T13:25:51+00:00"
author: "Stephen Condon"
original_url: "http://basho.com/posts/technical/ricon-community-competition-starts-today/"
archive_url: "https://web.archive.org/web/20170801115355http://basho.com/posts/technical/ricon-community-competition-starts-today/"
categories:
  - "Community & Events"
---
...
- Details of the [Community Competition](http://bit.ly/ricon15comp)
- [Specific requirements](https://github.com/basho-labs/the-basho-community/blob/master/events/community-comp-ricon15.md) of the demo
...
Yes, every project — if it wants to win — will need to include some way of seeing how it works. This requirement can be achieved through something as easy as a -v functionality that verbosely outlines what it’s doing. It could be something as feature rich as the Sinatra app in front of the [Zombie Riak project](https://github.com/basho-labs/vagrant-zombie-riak). No matter your approach, your code must have an easy-to-understand guide of what’s happening to be considered feature complete.
...
All participants will be rated by a panel of users lead by the [new Taishi members](http://basho.com/posts/business/announcing-taishi-the-basho-community-recognition-program/). The 3 categories of review will be:
...
Specific questions will be made public in [the community-comp-ricon15.md file](https://github.com/basho-labs/the-basho-community/blob/master/events/community-comp-ricon15.md). Feel free to review them!
...
To participate, anyone can give a :+1: to projects [on the GitHub Issue](http://bit.ly/ricon15comp), which will tally up toward this award! Here are the details:
...
- Add updates to [Zombie Riak](https://github.com/basho-labs/vagrant-zombie-riak) to leverage Riak 2.x features (or BDP!)
- Update [Basho Didgeridoo](https://github.com/cmeiklejohn/BashoDidgeridoo) to play distributed music
- Build a session store that shows you the session store! It’s an idea that we’ve [discussed here](https://github.com/basho-labs/the-basho-community/issues/70)

# You Can Be There

If you are available to join us in San Francisco, [buy your ticket to RICON](http://bit.ly/ricon15t) and we’ll see you next week.
