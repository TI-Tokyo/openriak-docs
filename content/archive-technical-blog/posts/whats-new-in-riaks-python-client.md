...
original_url: "http://basho.com/posts/technical/whats-new-in-riaks-python-client/"
archive_url: "https://web.archive.org/web/20170801115633http://basho.com/posts/technical/whats-new-in-riaks-python-client/"
categories:
  - "Developer Tools"
---
*August 4, 2011*
...
[Ripple](https://github.com/basho/ripple) has had an in-memory test server for a while now, and I thought the Python client should have something similar too. By the way, a lot of the features here draw heavy inspiration from Ripple in general, so credit where credit is due.
...
When building [Riagi](http://github.com/basho/riagi), the application showcased in the recent webinar, I missed Luwak support in the Python client. [Luwak](http://wiki.basho.com/Luwak.html) is Riak’s way of storing large files, chunked into smaller bits and stored across your Riak cluster. So we added it. The API consists of three simple functions, `store_file`, `get_file`, and `delete_file`.
