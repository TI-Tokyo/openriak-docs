...
date: "2013-04-03T10:00:32+00:00"
author: "Basho"
original_url: "http://basho.com/posts/technical/use-cases-for-riak-cs/"
archive_url: "https://web.archive.org/web/20170801115012http://basho.com/posts/technical/use-cases-for-riak-cs/"
categories:
  - "Use Cases"
---
*April 3, 2013*

As you might have heard, we recently [open sourced Riak CS](http://basho.com/riak-cs-is-now-open-source/), cloud storage built on Riak. You can find all of the code on our [GitHub account](https://github.com/basho) and download Riak CS [here](http://docs.basho.com/riakcs/latest/). To help you get started with Riak CS, here are some common use cases.
...
For more information about Riak CS, visit our [site](http://basho.com/riak-cloud-storage/) and [download the technical overview](http://info.basho.com/RiakCSTechnicalOverview.html).
