...
author: "Jeff Massung"
original_url: "http://basho.com/posts/technical/riak-control/"
archive_url: "https://web.archive.org/web/20170801115439http://basho.com/posts/technical/riak-control/"
categories:
  - "Operations"
---
*February 22, 2012*

Riak Control is Basho’s new OSS, REST-driven, user-interface for Riak. The code has been available for a few months now, but it’s officially supported in [Riak 1.1](http://lists.basho.com/pipermail/riak-users_lists.basho.com/2012-February/007573.html), so we wanted share some details on what it’s about and why you should be excited about it.
...
![Snapshot](../images/riak-control/control_snapshot.png)
...
![Custer](../images/riak-control/control_cluster.png)
...
![Ring](../images/riak-control/control_ring.png)
...
Anything you’d like to share or ask? Join the [Riak-Users Mailing List](http://lists.basho.com/mailman/listinfo/riak-users_lists.basho.com) and tell us what you think. The other option is to [fork the code](https://github.com/basho/riak_control) and make your opinions known with a pull request or by filing an issue. You can also find some ~~formal documentation on the Riak Wiki~~.
