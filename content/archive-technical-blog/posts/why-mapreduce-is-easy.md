...
date: "2011-03-30T21:21:53+00:00"
author: "Mathias Meyer"
original_url: "http://basho.com/posts/technical/why-mapreduce-is-easy/"
archive_url: "https://web.archive.org/web/20170801114958http://basho.com/posts/technical/why-mapreduce-is-easy/"
categories:
  - "Search & Analytics"
---
*March 30, 2011*
...
For our webinar on Riak and Node.js we built a little application with [Node.js](http://nodejs.org) and [Riak Search](http://wiki.basho.com/Riak-Search.html) to store and search syslog messages. It’s called [Riaktant](http://github.com/basho/riaktant) and handily converts and stores syslog messages in a way that’s friendlier for both Riak Search and MapReduce. We’ll base this on examples we used in building the application.
...
Let’s take the data Riaktant stores in Riak and see how easy it is to sift through it without even having to go distributed. It uses a JavaScript library called [glossy](https://github.com/squeeks/glossy) to parse a syslog message and turn it into this nice JSON data structure.
