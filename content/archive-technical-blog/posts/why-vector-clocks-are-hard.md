...
date: "2010-04-05T23:10:33+00:00"
author: "Justin Sheehy"
original_url: "http://basho.com/posts/technical/why-vector-clocks-are-hard/"
archive_url: "https://web.archive.org/web/20170520140046http://basho.com/posts/technical/why-vector-clocks-are-hard/"
categories:
  - "Architecture & Distributed Systems"
---
*April 5, 2010*

A couple of months ago, [Bryan wrote about vector clocks](./why-vector-clocks-are-easy.md) on this blog. The title of the post was “Why Vector Clocks are Easy”; anyone who read the post would realize that he meant that they’re easy for a client to use when talking to a system that implements them. For that reason, there is no reason to fear or avoid using a service that exposes the existence of vector clocks in its API.
...
Let’s run through that same example again, but this time visualize the vector clocks throughout the scenario. If you don’t recall the whole story in the example, you should [read Bryan’s post again](./why-vector-clocks-are-easy.md) as I am just going to show the data flow aspect of it here.
...
![](../images/why-vector-clocks-are-hard/a-vectors-6.png)
...
![](../images/why-vector-clocks-are-hard/a-vectors-5.png)
...
![](../images/why-vector-clocks-are-hard/a-vectors-4.png)
...
![](../images/why-vector-clocks-are-hard/a-vectors-3.png)
...
![](../images/why-vector-clocks-are-hard/a-vectors-2.png)
...
![](../images/why-vector-clocks-are-hard/a-vectors-1.png)
...
![](../images/why-vector-clocks-are-hard/a-vectors.png)
...
![](../images/why-vector-clocks-are-hard/c-vectors-1.png)
...
![](../images/why-vector-clocks-are-hard/c-vectors.png)
