...
date: "2013-07-22T09:00:03+00:00"
author: "Adron Hall"
original_url: "http://basho.com/posts/technical/riak-1-4-client-api-enhancements/"
archive_url: "https://web.archive.org/web/20170801115544http://basho.com/posts/technical/riak-1-4-client-api-enhancements/"
categories:
  - "Developer Tools"
  - "Releases"
---
...
With the release of Riak 1.4, we have made some important additions and changes to the Client API features, with a goal of strengthening the real-time, streaming, and timeout behaviors for clients. To take a deeper look at all of the changes in Riak 1.4, check out the [release notes](https://github.com/basho/riak/blob/1.4/RELEASE-NOTES.md).
...
Milliseconds can now be assigned to a timeout value for clients. Client-specified timeouts can be used for object manipulation around fetch, store and delete, listing buckets, or keys. This addition will be useful for asynchronous requests and pivotal for use with synchronous requests. For more on the client-specified timeouts, take a look at the [relevant GitHub issue](https://github.com/basho/riak-python-client/issues/253).

To explore response times and where timeout conditions can occur, check out the [Basho Bench docs](http://docs.basho.com/riak/latest/cookbooks/Benchmarking/). There are examples for testing various scenarios and identifying bottlenecks that may need custom timeouts or performance improvements.

## Bucket Properties for Protocol Buffers

Bucket properties can now be reset to default values and all built-in properties can be configured via the protocol buffers API. This helps client usage of protocol buffers in a dramatic way and, again, steps closer to feature parity with HTTP. For more information on setting and using these bucket properties, check out the [bucket properties documentation](http://docs.basho.com/riak/latest/dev/references/protocol-buffers/set-bucket-props/).
...
To get started, download Riak 1.4 on our [docs site](http://docs.basho.com/riak/latest/downloads/). Also, be sure and grab a ticket to [RICON West](http://ricon.io/west.html) before they sell out.
