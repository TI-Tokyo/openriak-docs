...
date: "2015-04-08T22:00:59+00:00"
author: "Peter Coppola"
original_url: "http://basho.com/posts/technical/riak-2-1-and-riak-cs-2-0-increased-performance-and-product-enhancements/"
archive_url: "https://web.archive.org/web/20170421113107http://basho.com/posts/technical/riak-2-1-and-riak-cs-2-0-increased-performance-and-product-enhancements"
categories:
  - "Releases"
  - "Performance"
---
...
At the beginning of 2015, Adam Wray, our CEO and president, made a bold statement in a post entitled *[Basho is Back! Record Year and a Strong Start to 2015](http://basho.com/basho-is-back-record-year-and-a-strong-start-to-2015/)* he claimed:
...
**OS X Installers**  
In addition to clients and monitoring, we have invested in several new and/or updated installation options for Riak. Many application developers use OS X as their primary development machine. Basho already provides a simple project, [riak-dev-cluster](https://github.com/basho-labs/riak-dev-cluster), for quickly getting started with a 5 node Riak Cluster. Now we are making it even easier by offering an [OS X installer](https://github.com/basho-labs/riak-app) that lets you locally deploy a single node of Riak, for development purposes, with a series of simple clicks.

**Community**  
We continue our commitment to our community by working with the open-source contributors to our Chef, Puppet, and Ansible tools to ensure they are optimized for use with this release. In fact, improvements to the [puppet-riak](https://github.com/basho-labs/puppet-riak) module make it one of the first to be built on Puppet 4.0, the latest release from Puppet Labs. To ensure clarity, and broader commitment to open-source development, we have arranged repositories driven by community contribution into the [Basho Labs organization](https://github.com/basho-labs) on Github. While our core codebase remains in the [Basho organization](https://github.com/basho), and undergo a rigorous review process, the Basho Labs invites community commitment and is actively monitored.
...
- [Sign up for a Tech Talk](http://info.basho.com/SignUpRiakTechTalk.html)
- [Download Riak 2.1](http://docs.basho.com/riak/latest/downloads/) (Available April 15)
- [Download Riak CS 2.0](http://docs.basho.com/riakcs/latest/riakcs-downloads/)

[Peter Coppola](https://twitter.com/pbcoppola)  
