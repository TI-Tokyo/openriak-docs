...
date: "2013-11-18T19:32:24+00:00"
author: "Basho"
original_url: "http://basho.com/posts/technical/relational-to-riak-tradeoffs/"
archive_url: "https://web.archive.org/web/20170801120748http://basho.com/posts/technical/relational-to-riak-tradeoffs/"
categories:
  - "Data Modeling"
...
This series of blog posts will discuss how [Riak](http://basho.com/riak/) differs from traditional relational databases. For more information about any of the points discussed, download our technical overview, “[From Relational to Riak](http://basho.com/assets/RelationaltoRiak.pdf).” The previous post in the series discussed [High Availability](http://basho.com/relational-to-riak-high-availability-part-1/) and [Cost of Scale](http://basho.com/relational-to-riak-cost-of-scale-part-2/).
...
Relational databases are ingrained habits for many of us, but moving beyond them can be liberating. Further information about data modeling, including sample configurations, are available on [Use Cases](http://docs.basho.com/riak/latest/dev/data-modeling/) section of the documentation.
...
For many users, the tradeoffs of moving to Riak are worthwhile due to the overall benefits; however, it can be a bit of an adjustment. To see why others have chosen to switch to Riak from both relational systems and other NoSQL databases, check out our [Users Page](http://basho.com/riak-users/).
