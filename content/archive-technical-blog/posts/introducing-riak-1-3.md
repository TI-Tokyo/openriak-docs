...
date: "2013-02-21T14:14:43+00:00"
author: "Basho"
original_url: "http://basho.com/posts/technical/introducing-riak-1-3/"
archive_url: "https://web.archive.org/web/20170801115159http://basho.com/posts/technical/introducing-riak-1-3/"
categories:
  - "Releases"
...
- **Improved Riak Enterprise’s multi-datacenter replication performance.** New advanced mode for multi-datacenter replication capabilities, with better performance, more TCP connections and easier configuration. Read more in [this write up from GigaOM](http://gigaom.com/2013/02/21/basho-technologies-takes-aim-at-more-enterprises-with-upgrades/).
...
Ready to get started or upgrade? [Download the new release here](http://docs.basho.com/riak/latest/downloads/), check out [the official release notes](https://github.com/basho/riak/blob/1.3/RELEASE-NOTES.md), or read on for more details. Documentation for all products and releases is available on the [documentation site](http://docs.basho.com/). For an introduction to Riak and what’s new in Riak 1.3, [sign up for our webcast](http://info.basho.com/IntroToRiakMarch7.html) on Thursday, March 7.
...
For more details about multi-datacenter replication, download our whitepaper, “[Multi-Datacenter Replication: A Technical Overview](http://info.basho.com/RiakMDC_Whitepaper.html).”
