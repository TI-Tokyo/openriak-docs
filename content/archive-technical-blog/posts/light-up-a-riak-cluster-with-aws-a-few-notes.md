...
date: "2013-03-14T17:06:52+00:00"
author: "Adron Hall"
original_url: "http://basho.com/posts/technical/light-up-a-riak-cluster-with-aws-a-few-notes/"
archive_url: "https://web.archive.org/web/20170801120829http://basho.com/posts/technical/light-up-a-riak-cluster-with-aws-a-few-notes/"
categories:
  - "Cloud & Deployment"
---
This is a cross post from [compositecode.com](http://www.compositecode.com) written by [Adron Hall](http://twitter.com/Adron), one of the Basho Technical Evangelists. In it he walks through one of the methods of setting up and configuring a cluster on AWS. Other options are enumerated in a post entitled [*Riak on AWS – Deployment Options*](http://basho.com/riak-on-aws-deployment-options/)
...
![Security Group](../images/light-up-a-riak-cluster-with-aws-a-few-notes/install-02.png)
...
![Create Security Group](../images/light-up-a-riak-cluster-with-aws-a-few-notes/install-01-M.png)
...
![Apply Rule Changes](../images/light-up-a-riak-cluster-with-aws-a-few-notes/install-03-M.png)
...
![Virtual Machines](../images/light-up-a-riak-cluster-with-aws-a-few-notes/install-5-M.png)
...
![Request Instances](../images/light-up-a-riak-cluster-with-aws-a-few-notes/install-6-M.png)

Continue again until you can select the *security group* that we created above.

![SecurityGroupRequestImages](../images/light-up-a-riak-cluster-with-aws-a-few-notes/install-8.png)
...
![Connect to Instance](../images/light-up-a-riak-cluster-with-aws-a-few-notes/install-9-M.png)
...
![Launch More](../images/light-up-a-riak-cluster-with-aws-a-few-notes/raw-M.png)
...
That’s it; all done. You now have a Riak Cluster. For more operations to try out on your cluster, check out this list of basic [API Operations](http://docs.basho.com/riak/latest/tutorials/fast-track/Basic-Riak-API-Operations/).
