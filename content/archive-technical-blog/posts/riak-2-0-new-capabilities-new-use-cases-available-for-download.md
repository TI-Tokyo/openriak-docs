...
date: "2014-09-16T05:00:54+00:00"
author: "Tyler Hannan"
original_url: "http://basho.com/posts/technical/riak-2-0-new-capabilities-new-use-cases-available-for-download/"
archive_url: "https://web.archive.org/web/20170801115321http://basho.com/posts/technical/riak-2-0-new-capabilities-new-use-cases-available-for-download/"
categories:
  - "Releases"
  - "Use Cases"
---
...
We are excited to announce that Riak 2.0 the open source version, and Riak Enterprise 2.0 are now publicly available. Since the Technical Preview, we have been finalizing and testing features for the final release. After months of work, we are thrilled to present the groundbreaking [Riak 2.0](http://docs.basho.com/riak/latest/downloads/).
...
*Additional Resources*[RICON West 2013: Riak Search 2.0](http://basho.com/ricon-west-videos-riak-search-2-0/)  
[Riak Docs: Using Search](http://docs.basho.com/riak/latest/dev/using/search/)
...
*Additional Resources*[RICON West 2013: Riak Security; Locking the Distributed Chicken Coop](http://www.youtube.com/watch?v=T6i8S6_dV7U)  
[Riak Docs: Authentication and Authorization](http://docs.basho.com/riak/latest/ops/running/authz/)
...
*Additional Resources*[RICON West 2013: Strong Consistency in Riak](http://basho.com/ricon-west-videos-strong-consistency-in-riak/)  
[Riak Docs: Using Strong Consistency](http://docs.basho.com/riak/2.0.0/dev/advanced/strong-consistency/)
...
*Additional Resources*[RICON West 2013: Riak Data Types](http://basho.com/ricon-west-videos-riak-data-types/)  
[Riak Docs: Using Riak Data Types](http://docs.basho.com/riak/2.0.0/dev/using/data-types/)

In addition to these three concepts, we have worked to simplify configuration, added tiered storage, and bucket types. For a full list of what’s changed, check out [Github](https://github.com/basho/riak/blob/2.0/RELEASE-NOTES.md).
