...
date: "2010-11-17T05:41:35+00:00"
author: "Scott Fritchie"
original_url: "http://basho.com/posts/technical/two-new-erlangotp-applications-added-to-riak-products-riak_err-and-cluster_info/"
archive_url: "https://web.archive.org/web/20170801115046http://basho.com/posts/technical/two-new-erlangotp-applications-added-to-riak-products-riak_err-and-cluster_info/"
categories:
  - "Erlang & BEAM"
---
*November 17, 2010*
...
![](../images/two-new-erlangotp-applications-added-to-riak-products-riak_err-and-cluster_info/kernel-proc-tree-large.png)

And here is the process tree for the `riak_kv` application.

![](../images/two-new-erlangotp-applications-added-to-riak-products-riak_err-and-cluster_info/riak-kv-proc-tree-large.png)

## The `riak_err` application

See the GitHub [README](http://github.com/basho/riak_err) for `riak_err`for more details.
...
The `riak_err` application was written by [Basho Technologies, Inc.](http://www.basho.com/) and is licensed under the [Apache Public License version 2.0](http://www.apache.org/licenses/). We’re very interested in bug reports and fixes: our mailbox is open 24 hours per day for [GitHub](http://github.com/) comments and pull requests.

## The `cluster_info` application

The `cluster_info` application is included in the packaging for the [Hibari key-value store](http://hibari.sourceforge.net/), which is also written in Erlang. It provides a flexible and easily-extendible way to dump the state of a cluster of Erlang nodes.
...
The `cluster_info` application was written by [Gemini Mobile Technologies, Inc.](http://www.geminimobile.com/) and is licensed under the [Apache Public License version 2.0](http://www.apache.org/licenses/).

[Scott](http://twitter.com/slfritchie)
