...
date: "2013-02-25T09:00:10+00:00"
author: "Basho"
original_url: "http://basho.com/posts/technical/advanced-mode-now-available-for-riak-enterprises-multi-datacenter-replication/"
archive_url: "https://web.archive.org/web/20170801115207http://basho.com/posts/technical/advanced-mode-now-available-for-riak-enterprises-multi-datacenter-replication/"
categories:
  - "Replication"
  - "Releases"
---
...
This post takes an in-depth look at Riak Enterprise’s new multi-datacenter replication capabilities, available in the recent [1.3 release](http://basho.com/introducing-riak-1-3/). Riak Enterprise’s multi-datacenter replication now ships with “advanced mode,” which features some performance and resiliency improvements that we’ve developed by working with production customers:
...
*Details of the advanced mode capabilities are below. For more about the multi-datacenter replication upgrades and our 1.3 release, check out this [recent article from GigaOM](http://gigaom.com/2013/02/21/basho-technologies-takes-aim-at-more-enterprises-with-upgrades/). For full technical details, [check out our documentation on multi-datacenter replication](http://docs.basho.com/riakee/latest/). For an examination of common architectures and use cases for Riak Enterprise, including datacenter failover, active-active cluster configurations, availability zones, and cloud bursting, [download our technical overview](http://info.basho.com/RiakMDC_Whitepaper.html).*
...
To learn more about Riak 1.3 and the new advanced mode for multi-datacenter replication, sign up for our [webcast](http://info.basho.com/IntroToRiakMarch7.html) on Thursday, March 7th.
