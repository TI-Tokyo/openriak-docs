...
date: "2011-01-20T06:47:04+00:00"
author: "Bryan Fink"
original_url: "http://basho.com/posts/technical/baseball-batting-average-using-riak-mapreduce/"
archive_url: "https://web.archive.org/web/20170801115533http://basho.com/posts/technical/baseball-batting-average-using-riak-mapreduce/"
categories:
  - "Search & Analytics"
  - "Developer Tools"
---
...
A few days ago, I announced a tool that I assembled last weekend, called [luwak\_mr](http://github.com/beerriot/luwak_mr). That tool extends Riak’s map/reduce functionality to “[Luwak](http://github.com/basho/luwak)” files.
...
I’ll use [Retrosheet’s](http://www.retrosheet.org/game.htm) [Play-by-Play Event Files](http://www.retrosheet.org/game.htm) as input. Specifically, I’ll use the regular season, by decade, 1950-1959. If you’d like to follow along download “1950seve.zip” and unzip to a directory called “1950s”
...
I’ve put this code in [a module named “baseball”](https://github.com/beerriot/baseball/blob/master/src/baseball.erl)[,](https://github.com/beerriot/baseball/blob/master/src/baseball.erl) so running it is as simple as:
...
[2] Forgive me if I botch these calculations. I stopped playing baseball when the coach was still pitching. The closest I’ve come since is intramural softball. But, it’s all numbers, and I can handle numbers. [Wikipedia](http://en.wikipedia.org/wiki/Baseball_statistics) has been my guide, for better or worse.
