...
date: "2013-10-29T15:57:11+00:00"
author: "Basho"
original_url: "http://basho.com/posts/technical/introducing-riak-2-0/"
archive_url: "https://web.archive.org/web/20170801115414http://basho.com/posts/technical/introducing-riak-2-0/"
categories:
  - "Releases"
  - "Data Modeling"
  - "Search & Analytics"
...
- **Riak Data Types.** Building on the eventually consistent counters introduced in [Riak 1.4](http://basho.com/counters-in-riak-1-4/), Riak 2.0 adds sets and maps as new distributed data types. These Riak Data Types simplify application development without sacrificing Riak’s availability and partition tolerance characteristics.
...
Ready to get started? Download the [Technical Preview](http://docs.basho.com/riak/2.0.0pre5/downloads/).
...
As we are finalizing Riak 2.0, we welcome your feedback for our Technical Preview. We are always available to discuss via the [Riak Users mailing list](http://lists.basho.com/mailman/listinfo/riak-users_lists.basho.com), IRC (#riak on freenode), or [contact us](http://basho.com/contact/).
...
A more detailed overview of Riak Data Types is [available](https://gist.github.com/russelldb/7316f83ddd38965d9f76) that examines implementation considerations and the basics of usage.
...
A RICON West 2012 talk entitled, *[Bringing Consistency to Riak](https://vimeo.com/51973001)*, shares much of the initial thinking behind this effort. In addition, the [pull request](https://github.com/basho/riak_kv/pull/710) that adds consistency to `riak_kv` provides detailed information about related repositories and the implementation approach.

**Redesigned Full-Text Search**  
Riak is a key/value store and the values are simply stored on disk as binary. With previous versions of Riak Search, Riak developers have long been able to index the content of these stored values. In Riak 2.0, Riak Search (code-named [Yokozuna](https://github.com/basho/yokozuna)) has been completely redesigned and now uses the Apache Solr full-text document indexing engine directly. Together, Riak and Solr provide a reliable full-text context indexing solution that is highly available and built for scale. In addition, Riak Search 2.0 also fully supports the Solr client query APIs, which enables integration with existing software solutions (either homegrown or commercial).

The Basho engineers responsible for Yokozuna have created a [resources page](https://github.com/basho/yokozuna/blob/develop/docs/RESOURCES.md) that includes recorded talks, Solr documentation links, and books on the topic.
...
The initial RFC that describes the security effort, including related Pull Requests, is available at [github.com/basho/riak/issues/355](https://github.com/basho/riak/issues/355).
...
More information on the vision and specific implementation considerations are contained in the repository at [github.com/basho/cuttlefish](https://github.com/basho/cuttlefish).
...
More information about Bucket Types can be found in the Github Issue at [github.com/basho/riak/issues/362](https://github.com/basho/riak/issues/362). This issue describes the planned functionality, discussions about implementation, and includes related pull requests.
...
In a blog series entitled, *[Understanding Riak’s Configurable Behaviours](http://basho.com/riaks-config-behaviors-epilogue/)*, Basho Evangelist [John Daily](https://twitter.com/macintux) discusses the configuration of Last Write Wins, and many other options, in great detail.
