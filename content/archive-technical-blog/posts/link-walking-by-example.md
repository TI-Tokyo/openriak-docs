...
date: "2010-02-24T22:13:25+00:00"
author: "Bryan Fink"
original_url: "http://basho.com/posts/technical/link-walking-by-example/"
archive_url: "https://web.archive.org/web/20170324115910http://basho.com/posts/technical/link-walking-by-example/"
categories:
  - "Data Modeling"
  - "Developer Tools"
---
...
|  |  |
| --- | --- |
| 1. `hb/first` will link to `hb/second` and `hb/third` 2. `hb/second` will link to `hb/fourth` 3. `hb/third` will also link to `hb/fourth` 4. `hb/fouth` doesn’t link anywhere |  |
