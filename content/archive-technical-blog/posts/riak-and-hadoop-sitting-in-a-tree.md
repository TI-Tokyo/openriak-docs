...
original_url: "http://basho.com/posts/technical/riak-and-hadoop-sitting-in-a-tree/"
archive_url: "https://web.archive.org/web/20170801115134http://basho.com/posts/technical/riak-and-hadoop-sitting-in-a-tree/"
categories:
  - "Integrations & Plugins"
---
*November 29, 2011*

It has been pointed out on occasion that Riak MapReduce isn’t *real*“MapReduce”, often with reference to Hadoop, which *is*. There are many times that [Riak’s data processing pipeline](http://basho.com/blog/technical/2011/09/19/Riak-Pipe-The-New-Map-Reduce-Power/) is exactly what you want, but in case it isn’t, and you want to leverage existing Hadoop expertise and investment, you may now use Riak as an input/output, instead of HDFS.

This started off as a tinkering project, and it is currently released as [riak-hadoop-0.2](https://github.com/basho/riak-hadoop). I wouldn’t recommend it for production use today, but it is ready for exploratory work, whilst we work on some more serious integration for the future.
...
Please clone, build, and play with this project. [Have at it](https://github.com/basho/riak-hadoop). There’s a follow up post with a look at an example [Word Count Hadoop Map/Reduce job](https://github.com/russelldb/riak-hadoop-wordcount) coming soon. If you can’t wait, just add a dependency on riak-hadoop, version 0.2 to your pom.xml and get started. Let me know how you get on, via the [Riak mailing list](http://lists.basho.com/mailman/listinfo/riak-users_lists.basho.com).
