...
date: "2010-05-27T02:02:40+00:00"
author: "Mark Phillips"
original_url: "http://basho.com/posts/technical/riak-fast-track-revisited/"
archive_url: "https://web.archive.org/web/20170801115120http://basho.com/posts/technical/riak-fast-track-revisited/"
categories:
  - "Developer Tools"
---
*May 27, 2010*

You may remember a few weeks back [we posted a blog](http://blog.basho.com/2010/05/04/introducing-the-riak-fast-track/) about a new feature on the Riak Wiki called [The Riak Fast Track.](https://wiki.basho.com/The-Riak-Fast-Track.html) To refresh your memory, “The Fast Track is a 30-45 minute interactive tutorial that introduces the basics of using and understanding Riak, from building a three node cluster up through MapReduce.”
...
- The most-noticeable alterations are on the [MapReduce page](https://wiki.basho.com/Loading-Data-and-Running-MapReduce-Queries.html), where we worked a lot to make it flow better and more interactive. This continues to be improved.
- The [Basic API Operations page](http://wiki.basho.com/Basic-Riak-API-Operations.html) got some love in the form of simplification. After reading your comments, we went back and realized that we were probably throwing too much information at you too fast.
- There are now several [graphics relating to the Riak Ring and Consistent Hashing.](http://wiki.basho.com/What-is-Riak%3F.html#The-Riak-Cluster) There will be more.

And, as I said, this is still ongoing.

## Thank You!

I’ve added a [Thank You page](http://wiki.basho.com/Thank-You.html) to the end of the Fast Track to serve as a permanent shout-out to those who help revise and refine the Fast Track. (I hope to see this list grow, too.) Future newcomers to Riak will surely benefit from your time, effort, and input.
