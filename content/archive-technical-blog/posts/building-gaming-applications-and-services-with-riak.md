...
date: "2013-03-13T10:00:46+00:00"
author: "Basho"
original_url: "http://basho.com/posts/technical/building-gaming-applications-and-services-with-riak/"
archive_url: "https://web.archive.org/web/20170801120833http://basho.com/posts/technical/building-gaming-applications-and-services-with-riak/"
categories:
  - "Use Cases"
---
*March 13, 2013*

For a complete overview, download the whitepaper, “[Gaming on Riak: A Technical Introduction](http://info.basho.com/RiakonGaming.html).” To see how other gaming companies are using Riak, visit us at the Game Developers Conference at Booth #202!

As discussed in our previous post, “[Gaming on Riak: A Brief Overview and User Case Studies](http://basho.com/gaming-on-riak-a-brief-overview-and-user-case-studies/),” Riak can provide a number of advantages for gaming platforms. Content agnostic, an HTTP API, many client libraries, and a simple key/value data model, Riak is a flexible data store that can be used for a variety of different use cases in the gaming industry. This post looks at some common examples and how to start building them in Riak.
...
![](../images/building-gaming-applications-and-services-with-riak/Screen-Shot-2013-03-12-at-1.53.41-PM.png)

Riak offers robust additional functionality on top of the fundamental key/value model. For more information on these options as well as how to implement them, their architecture, and their limitations, check out the documentation on [searching and accessing data in Riak](http://docs.basho.com/riak/kv/2.1.4/learn/).
...
To learn more about how your gaming platform can benefit from Riak, download “[Gaming on Riak: A Technical Introduction](http://info.basho.com/RiakonGaming.html).” For more information about Riak, [~~sign up for our webcas~~t](http://info.basho.com/IntroToRiakMarch14.html) on Thursday, March 14.
