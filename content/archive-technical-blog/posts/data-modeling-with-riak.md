...
date: "2015-01-22T16:39:14+00:00"
author: "Tyler Hannan"
original_url: "http://basho.com/posts/technical/data-modeling-with-riak/"
archive_url: "https://web.archive.org/web/20170427135510http://basho.com/posts/technical/data-modeling-with-riak"
categories:
  - "Data Modeling"
---
*January 22, 2015*
...
- [Riak Search](http://docs.basho.com/riak/latest/dev/using/search/): Integration with Apache Solr provides full-text search and support for Solr’s client query APIs.
- [Secondary Indexes](http://docs.basho.com/riak/latest/dev/using/2i/): Secondary Indexes (2i) give developers the ability to tag an object stored in Riak with one or more query values. Indexes can be either integers or strings, and can be queried by either exact matches or ranges of values.
- [MapReduce](http://docs.basho.com/riak/latest/dev/using/mapreduce/): Developers can leverage Riak MapReduce for tasks like filtering documents by tag, counting words in documents, and extracting links to related data.

For more information, check out the Riak documentation on [Querying Data](http://docs.basho.com/riak/latest/dev/taste-of-riak/querying/).
...
Riak, in contrast, provides flexibility in how this data can be modeled based upon the application use case. It may be desirable to create a Users bucket, with the UserName (or Unique Identifier) as the key and a JSON object storing all user attributes as the value. Or, as we describe in *[Data Modeling with Riak Data Types](http://docs.basho.com/riak/latest/dev/data-modeling/data-types/)*, leverage the power of [Riak Data Types](http://basho.com/distributed-data-types-riak-2-0/) by creating a map type for each user storing:
...
For additional information, and more complex considerations such as modeling relationship and advanced social applications, see the Riak documentation on [use cases and data modeling](http://docs.basho.com/riak/latest/dev/data-modeling/).
...
Full documentation for multi-datacenter replication in Riak Enterprise is available in the [online documentation](http://docs.basho.com/riakee/latest/cookbooks/Multi-Data-Center-Replication-Architecture/).
...
For more information on Data Modeling, or to chat with a member of the Basho team on the topic, please request a [Tech Talk](http://info.basho.com/SignUpRiakTechTalk.html).
