...
date: "2013-04-05T16:46:14+00:00"
author: "Basho"
original_url: "http://basho.com/posts/technical/riak-cs-building-a-virtual-testing-environment/"
archive_url: "https://web.archive.org/web/20170801115014http://basho.com/posts/technical/riak-cs-building-a-virtual-testing-environment/"
categories:
  - "Cloud & Deployment"
---
*This blog post excerpts content from the [Riak CS Fast Track](http://docs.basho.com/riakcs/latest/riakcs-tutorials/fast-track/). It walks through how to build a Riak CS environment using Vagrant and Chef.*
...
Congratulations, you have deployed a virtualized environment of Riak CS. You are ready to progress to [Testing the Riak CS Installation](http://docs.basho.com/riakcs/latest/tutorials/fast-track/Testing-the-Installation/) in the Riak CS Fast Track.
...
*Congratulations on setting up your first Riak CS testing environment! Make sure to try the entire [Riak CS Fast Track](http://docs.basho.com/riakcs/latest/riakcs-tutorials/fast-track/). Full documentation is [available here.](http://docs.basho.com/riakcs/latest/)*
