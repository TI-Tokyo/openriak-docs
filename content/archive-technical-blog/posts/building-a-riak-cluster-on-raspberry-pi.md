...
author: "Eric Redmond"
original_url: "http://basho.com/posts/technical/building-a-riak-cluster-on-raspberry-pi/"
archive_url: "https://web.archive.org/web/20170327140147http://basho.com/posts/technical/building-a-riak-cluster-on-raspberry-pi/"
categories:
  - "Cloud & Deployment"
  - "Community & Events"
---
...
![Raspberry Pi Parts](../images/building-a-riak-cluster-on-raspberry-pi/raspi-parts.jpg)
...
Get your laptop (or desktop) and insert your SD card, after you [download the Raspbian image](http://www.raspberrypi.org/downloads) (the current release is “wheezy”).

Unzip the download, and you should have an `img` file.

You’ll need to unmount the (probably) default partition your SD card started with, then write the image to the device. There are several [detailed instructions](http://elinux.org/RPi_config.txt) for many operating systems on elinux.
...
![RPi Plugged In](../images/building-a-riak-cluster-on-raspberry-pi/raspi-single.jpg)
...
![Raspbi Bootup](../images/building-a-riak-cluster-on-raspberry-pi/raspi-boot.jpg)
...
Now that all of that housekeeping is out of the way, it’s time to get cracking on some Riak. The first thing you’ll need, however, is Erlang. Thankfully, the awesome [Erlang Solutions](http://www.erlang-solutions.com) folks created a Raspbi distro, which was way easier than the first two weeks when I tried to create my own build. So unless you’re masochistic, I suggest using theirs.
...
![Raspbi Cluster](../images/building-a-riak-cluster-on-raspberry-pi/raspi-cluster.jpg)
...
curl http://192.168.10.12:8098/riak/druplets?keys=true | json_pp`
...
[Eric Redmond](http://twitter.com/coderoshi)
