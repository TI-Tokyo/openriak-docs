...
[![](../images/open-source-101-building-community-in-raleigh-nc/Craig-bug.png)](../images/open-source-101-building-community-in-raleigh-nc/Craig-bug.png)“How hard could it be to hand draw twenty slides?” I thought. It turns out that it was actually pretty hard. The biggest struggle I experienced was simply not trying to make each slide a “work of art.”
...
If you are looking for Open Source conferences to attend or speak at, I can’t recommend highly enough [All Things Open](http://allthingsopen.org/) and [Open Source 101](http://opensource101.com/). [Todd Lewis](http://twitter.com/toddlew) and his team do an amazing job at putting together events that have an embarrassing richness of content in a welcoming and inclusive environment.

My presentation, [Create your first open source project the “right way”](https://github.com/cvitter/Open-Source-101-Doing-It-Right) is Open Source material released under the Apache 2.0 License. You can find the full presentation on Github.

You can get more information about Basho’s Open Source community initiatives at the following links:
