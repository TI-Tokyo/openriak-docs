...
date: "2014-01-07T11:00:42+00:00"
author: "John Daily"
original_url: "http://basho.com/posts/technical/riak-development-anti-patterns/"
archive_url: "https://web.archive.org/web/20170427141511http://basho.com/posts/technical/riak-development-anti-patterns"
categories:
  - "Developer Tools"
  - "Data Modeling"
---
...
[Riak 2.0](http://basho.com/introducing-riak-2-0/), when installed on new clusters, will default to retaining conflicts and requiring the application to resolve them, but we’re also providing replicated data types to automate conflict resolution on the servers.
...
For significantly larger objects, [Riak CS](http://basho.com/riak-cloud-storage/) offers an Amazon S3-compatible (and also OpenStack Swift-compatible) key/value object store that uses Riak under the hood.
...
As always, we recommend visiting [Basho’s docs website](http://docs.basho.com/) for more details on how to build and run Riak, and many of our customers have given presentations on their use cases of Riak, including data modeling.

Also, keep an eye on the [Basho blog](http://basho.com/blog) where we provide high-level overviews like this of Riak and the larger non-relational database world.

For a detailed analysis of your needs and modeling options, [contact Basho](https://basho.com/contact/) regarding our professional services team.
...
[John Daily](http://twitter.com/macintux)
