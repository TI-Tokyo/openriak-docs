...
date: "2015-05-12T04:59:40+00:00"
author: "Mark Allen"
original_url: "http://basho.com/posts/technical/understanding-riak_core-handoff/"
archive_url: "https://web.archive.org/web/20170801115251http://basho.com/posts/technical/understanding-riak_core-handoff/"
categories:
  - "Operations"
...
If you’re even had a little sip of Basho kool-aid over the past six years, you’re probably sick of hearing about “the ring” unless you’re a fan of [Japanese horror movie remakes](http://en.wikipedia.org/wiki/The_Ring_%282002_film%29).

But in case you’re just joining us, Riak stores data as a key/value pair and uses a special function called a [consistent hash](http://en.wikipedia.org/wiki/Consistent_hashing) to turn a key into a location inside of a keyspace. The keyspace in Riak is divided up into equal sized partitions which are managed by “virtual nodes” or vnodes.
...
A handoff is a transfer over the network of the keys and associated values from one cluster member to another cluster member. There are [four types of handoffs](https://github.com/basho/riak_core/blob/develop/include/riak_core_handoff.hrl#L23) that are supported in riak\_core: ownership, hinted, repair, and resize. Of these, the most commonly encountered types are ownership and hinted. We will talk about them all in the following sections.
