...
date: "2010-07-07T04:03:47+00:00"
author: "Sean Cribbs"
original_url: "http://basho.com/posts/technical/webinar-recap-mapreduce-querying-in-riak/"
archive_url: "https://web.archive.org/web/20170801120921http://basho.com/posts/technical/webinar-recap-mapreduce-querying-in-riak/"
categories:
  - "Search & Analytics"
  - "Community & Events"
---
...
Riak only looks for “\*.js” files in the `js_source_dir`folder (see ~~Configuration Files~~ on the [wiki](http://wiki.basho.com/)). Erlang modules that contain map and reduce functions need to be on the code path, which could be completely separate from where the Javascript files are located.
...
— [Dan](http://twitter.com/reverri) and [Sean](http://twitter.com/seancribbs)
