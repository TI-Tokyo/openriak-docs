...
date: "2013-09-04T22:22:06+00:00"
author: "Dan Kerrigan"
original_url: "http://basho.com/posts/technical/indexing-the-zombie-apocalypse-with-riak/"
archive_url: "https://web.archive.org/web/20170731134157http://basho.com/posts/technical/indexing-the-zombie-apocalypse-with-riak"
categories:
  - "Data Modeling"
  - "Search & Analytics"
  - "Developer Tools"
...
*For more background on the indexing techniques described, check out our blog “[Index for Fun and for Profit](http://basho.com/index-for-fun-and-for-profit/)“*
...
[server.rb endpoints](https://github.com/drewkerrigan/riak-inverted-index-demo/blob/master/server.rb)

Our zombie model does the work to retrieve the indexes and build the result set:

[zombie.rb search index](https://github.com/drewkerrigan/riak-inverted-index-demo/blob/master/models/zombie.rb)

## Saving the world, one UI at a time

Everything is wired up with a basic HTML and JavaScript application:

![ZombieSearch](../images/indexing-the-zombie-apocalypse-with-riak/ZombieSearch.png)

Searching for zombies in the Zip Code 39201 yields the following:

![ZombieZipResults](../images/indexing-the-zombie-apocalypse-with-riak/ZombieZipResults.png)

Clicking on Downtown New York confirms your fears and suspicions:

![ZombieGeohashResults](../images/indexing-the-zombie-apocalypse-with-riak/ZombieGeoHashResults.png)
...
[Dan Kerrigan](http://github.com/dankerrigan) & [Drew Kerrigan](http://github.com/drewkerrigan)
