...
toc: true
aliases:
  - /riakcs/2.1.0/references/apis/storage/s3/RiakCS-PUT-Bucket-policy/
  - /openriak-cs/2.1.0/references/apis/storage/s3/RiakCS-PUT-Bucket-policy/
---
...
This operation uses only request headers that are common to all operations. For more information, see [Common Riak CS Request Headers]({{<baseurl>}}openriak-cs/2.1.0/references/apis/storage/s3/common-request-headers).
