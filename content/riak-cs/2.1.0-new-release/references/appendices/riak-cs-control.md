...
sitemap:
  priority: 0.2
aliases:
  - /riakcs/2.1.0/references/appendices/RiakCS-Control/
  - /openriak-cs/2.1.0/references/appendices/RiakCS-Control/
...
Riak CS Control [is maintained as a separate application](https://github.com/basho/riak_cs_control) and can be installed via [source or package]({{<baseurl>}}openriak-cs/2.1.0/downloads).
