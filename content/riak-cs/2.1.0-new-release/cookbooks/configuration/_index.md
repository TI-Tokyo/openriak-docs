...
* Riak CS --- The cloud storage layer over Riak which exposes the storage and 
billing APIs, storing files and metadata in Riak, and streaming them back to 
users
* Stanchion --- Manages requests involving globally unique system entities, such as 
...
* [Configuring Riak]({{<baseurl>}}openriak-cs/2.1.0/cookbooks/configuration/riak-for-cs)
* [configuring Riak CS]({{<baseurl>}}openriak-cs/2.1.0/cookbooks/configuration/riak-cs)
* [Configuring Stanchion]({{<baseurl>}}openriak-cs/2.1.0/cookbooks/configuration/stanchion)
* [Configuring an S3 client]({{<baseurl>}}openriak-cs/2.1.0/cookbooks/configuration/s3-client)
