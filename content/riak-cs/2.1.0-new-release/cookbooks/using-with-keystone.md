...
aliases:
  ...
  - /openriak-cs/2.1.0/cookbooks/Using-Riak-CS-With-Keystone/
...
Follow the procedures documented in [Keystone Setup]({{<baseurl>}}openriak-cs/2.1.0/cookbooks/keystone-setup) to set up and run
Keystone.
