...
aliases:
  ...
  - /openriak-cs/2.1.0/cookbooks/tutorials/fast-track/Testing-the-Installation/
...
* [Details about API operations]({{<baseurl>}}openriak-cs/2.1.0/references/apis/storage)
* [Information about the Ruby Fog client]({{<baseurl>}}openriak-cs/2.1.0/cookbooks/fog)
* [Release Notes]({{<baseurl>}}openriak-cs/2.1.0/cookbooks/release-notes)
