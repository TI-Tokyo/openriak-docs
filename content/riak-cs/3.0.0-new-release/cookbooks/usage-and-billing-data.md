...
sitemap:
  priority: 0.2
aliases:
  - /riakcs/3.0.0/cookbooks/Usage-and-Billing-Data/
...
please read [Querying Access Statistics]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/querying-access-statistics).
...
query parameter is a `KeyWrite` operation. See [Querying Access Statistics]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/querying-access-statistics) for a list of all operation types.
...
See [Configuring Riak for CS]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/configuration/riak-for-cs) for directions on setting this up.
