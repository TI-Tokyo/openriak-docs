...
aliases:
  ...
  - /openriak-cs/3.0.0/cookbooks/installing/Installing-Riak-CS/
...
is built
* Riak CS itself
* [Stanchion]({{<baseurl>}}openriak-cs/3.0.0/theory/stanchion) --- An application used to manage [globally unique entities]({{<baseurl>}}openriak-cs/3.0.0/theory/stanchion/#globally-unique-entities) such as users and buckets.
...
We strongly recommend using one of the documented [version combinations]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/version-compatibility/)
...
documentation on [configuring Riak KV for CS]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/configuration/riak-for-cs/).

## Installing Riak CS on a Node

Riak CS and Stanchion packages are available on the [Download Riak CS]({{<baseurl>}}openriak-cs/3.0.0/downloads/)
...
the [downloads]({{<baseurl>}}openriak-cs/3.0.0/downloads) page:
...
At this point, you can move on to [configuring Riak CS]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/configuration/riak-cs/).
...
details can be found in [Specifying the Stanchion Node]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/configuration/stanchion).

### Installing Stanchion on Mac OS X

First, download the appropriate package from the [downloads]({{<baseurl>}}openriak-cs/3.0.0/downloads/#stanchion-3-0-0) page.
...
learn more about [configuring Riak CS]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/configuration/riak-cs).
