...
aliases:
  ...
  - /openriak-cs/3.0.0/cookbooks/installing/Riak-CS-Using-Chef/
...
* [Building a Local Test Environment]({{<baseurl>}}openriak-cs/3.0.0/tutorials/fast-track/local-testing-environment)
* [Building a Virtual Testing Environment]({{<baseurl>}}openriak-cs/3.0.0/tutorials/fast-track/virtual-test-environment)
