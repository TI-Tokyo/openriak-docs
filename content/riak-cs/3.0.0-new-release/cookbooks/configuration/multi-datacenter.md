...
sitemap:
  priority: 0.2
aliases:
  - /riakcs/3.0.0/cookbooks/configuration/Configuring-MDC/
  - /openriak-cs/3.0.0/cookbooks/configuration/Configuring-MDC/
...
Though there is no specific configuration for [Stanchion]({{<baseurl>}}openriak-cs/3.0.0/theory/stanchion), note that
...
updates to [globally unique entities]({{<baseurl>}}openriak-cs/3.0.0/theory/stanchion/#globally-unique-entities) like users and buckets.
