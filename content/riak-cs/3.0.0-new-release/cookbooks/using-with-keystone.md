...
sitemap:
  priority: 0.2
aliases:
  - /riakcs/3.0.0/cookbooks/Using-Riak-CS-With-Keystone/
...
Follow the procedures documented in [Keystone Setup]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/keystone-setup) to set up and run
Keystone.
