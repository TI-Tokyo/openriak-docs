...
sitemap:
  priority: 0.2
aliases:
  - /riakcs/3.0.0/references/apis/storage/
  - /openriak-cs/3.0.0/references/apis/storage/
...
* [GET Service]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/get-service) --- Returns a list of all buckets owned by the user who sent the request

## Bucket-level Operations

* [GET Bucket]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/get-bucket) --- Returns a list of the objects
  within a bucket
* [GET Bucket ACL]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/get-bucket-acl) --- Returns the [Access Control List (ACL)](http://docs.aws.amazon.com/AmazonS3/latest/dev/ACLOverview.html) associated with a bucket
* [GET Bucket policy]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/get-bucket-policy) --- Gets the policy of a bucket
* [PUT Bucket]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/put-bucket) --- Creates a new bucket
* [PUT Bucket ACL]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/put-bucket-acl) --- Sets the ACL permissions
  for a bucket
* [PUT Bucket policy]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/put-bucket-policy) --- Sets the policy for a bucket
* [DELETE Bucket]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/delete-bucket) --- Deletes a bucket
* [DELETE Bucket policy]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/delete-bucket-policy) --- Deletes the policy of a bucket

## Object-level Operations

* [GET Object]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/get-object) --- Retrieves an object
* [GET Object ACL]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/get-object-acl) --- Returns the ACLs associated with an object
* [PUT Object]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/put-object) --- Stores an object to a bucket
* [PUT Object (Copy)]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/put-object-copy) --- Creates a copy of an object
* [PUT Object ACL]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/put-object-acl) --- Sets the ACLs associated with an object
* [HEAD Object]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/head-object) --- Retrieves object metadata (not the full content of the object)
* [DELETE Object]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/delete-object) --- Deletes an object
...
about multipart uploads on the [overview page]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/multipart-upload-overview).

* [Initiate Multipart Upload]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/initiate-multipart-upload) --- Initiates a multipart upload and returns an upload ID
* [Upload Part]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/upload-part) --- Uploads a part in a multipart upload
* [Complete Multipart Upload]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/complete-multipart-upload) --- Completes a multipart upload and assembles previously uploaded parts
* [Abort Multipart Upload]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/abort-multipart-upload) --- Aborts a multipart upload and eventually frees storage consumed by previously uploaded parts
* [List Parts]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/list-parts) --- Lists the parts that have been uploaded for a specific multipart upload.
* [List Multipart Uploads]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/list-multipart-uploads) --- Lists multipart uploads that have not yet been completed or aborted.

## Common Headers

* [Common Riak CS Request Headers]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/common-request-headers)
* [Common Riak CS Response Headers]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/common-response-headers)
...
* [Mapping]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/mapping-from-s3-api-to-riak-cs-internal-api)
...
* [Mapping]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/openstack/mapping-from-oos-api-to-riak-cs-internal-api)
...
* [S3 API]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/s3/)
* [OpenStack API]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage/openstack/)
