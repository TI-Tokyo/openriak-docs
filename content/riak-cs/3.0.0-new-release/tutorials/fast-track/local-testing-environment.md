...
sitemap:
  priority: 0.2
aliases:
  - /riakcs/3.0.0/cookbooks/tutorials/fast-track/Building-a-Local-Test-Environment/
  - /openriak-cs/3.0.0/cookbooks/tutorials/fast-track/Building-a-Local-Test-Environment/
...
configuration, there is an option for [Building a Virtual Testing Environment]({{<baseurl>}}openriak-cs/3.0.0/tutorials/fast-track/virtual-test-environment).
...
[Download Riak]({{<baseurl>}}riak/kv/latest/downloads/) and [Download Riak CS]({{<baseurl>}}openriak-cs/3.0.0/downloads).
...
[
 {riak_kv, [
              {add_paths, ["/usr/lib/riak-cs/lib/riak_cs-3.0.0/ebin"]},
...
Once you have completed this step, You can progress to [testing the Riak CS installation]({{<baseurl>}}openriak-cs/3.0.0/tutorials/fast-track/test-installation) using s3cmd.
