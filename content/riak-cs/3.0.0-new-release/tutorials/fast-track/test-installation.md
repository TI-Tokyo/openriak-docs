...
sitemap:
  priority: 0.2
aliases:
  - /riakcs/3.0.0/cookbooks/tutorials/fast-track/Testing-the-Installation/
  - /openriak-cs/3.0.0/cookbooks/tutorials/fast-track/Testing-the-Installation/
...
* [Details about API operations]({{<baseurl>}}openriak-cs/3.0.0/references/apis/storage)
* [Information about the Ruby Fog client]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/fog)
* [Release Notes]({{<baseurl>}}openriak-cs/3.0.0/cookbooks/release-notes)
