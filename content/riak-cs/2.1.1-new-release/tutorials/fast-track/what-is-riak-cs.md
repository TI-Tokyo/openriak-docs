...
sitemap:
  priority: 0.2
aliases:
  - /riakcs/2.1.1/cookbooks/tutorials/fast-track/What-is-Riak-CS/
  - /openriak-cs/2.1.1/cookbooks/tutorials/fast-track/What-is-Riak-CS/
linkTitle: "What Is Riak CS?"
weight: 100
---
...
When an object is uploaded via the [storage API]({{<baseurl>}}openriak-cs/2.1.1/references/apis/storage), Riak CS breaks the object into smaller chunks that are streamed,
