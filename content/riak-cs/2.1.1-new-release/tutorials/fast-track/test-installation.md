...
sitemap:
  priority: 0.2
aliases:
  - /riakcs/2.1.1/cookbooks/tutorials/fast-track/Testing-the-Installation/
  - /openriak-cs/2.1.1/cookbooks/tutorials/fast-track/Testing-the-Installation/
...
* [Details about API operations]({{<baseurl>}}openriak-cs/2.1.1/references/apis/storage)
* [Information about the Ruby Fog client]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/fog)
* [Release Notes]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/release-notes)
