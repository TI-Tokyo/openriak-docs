...
sitemap:
  priority: 0.2
aliases:
  - /riakcs/2.1.1/references/apis/storage/openstack/Mapping-From-OOS-API-to-Riak-CS-internal-API
  - /openriak-cs/2.1.1/references/apis/storage/openstack/Mapping-From-OOS-API-to-Riak-CS-internal-API
---
