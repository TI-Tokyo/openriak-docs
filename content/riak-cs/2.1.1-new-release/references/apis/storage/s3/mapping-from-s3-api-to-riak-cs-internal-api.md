...
toc: true
aliases:
  - /riakcs/2.1.1/references/apis/storage/s3/Mapping-From-S3-API-to-Riak-CS-internal-API
  - /openriak-cs/2.1.1/references/apis/storage/s3/Mapping-From-S3-API-to-Riak-CS-internal-API
---
