...
3. Set your desired Stanchion [configuration]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/configuration/stanchion)
...
When a new supercluster member is added, you must first set the weight of that member to zero using the [`riak-cs-supercluster`]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/command-line-tools) command-line interface.
...
in our documentation on [Riak CS Command Line Tools]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/command-line-tools/#riak-cs-supercluster).
