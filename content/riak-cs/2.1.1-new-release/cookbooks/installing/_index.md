...
aliases:
  ...
  - /openriak-cs/2.1.1/cookbooks/installing/Installing-Riak-CS/
...
is built
* Riak CS itself
* [Stanchion]({{<baseurl>}}openriak-cs/2.1.1/theory/stanchion) --- An application used to manage [globally unique entities]({{<baseurl>}}openriak-cs/2.1.1/theory/stanchion/#globally-unique-entities) such as users and buckets.
...
We strongly recommend using one of the documented [version combinations]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/version-compatibility/)
...
documentation on [configuring Riak KV for CS]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/configuration/riak-for-cs/).

## Installing Riak CS on a Node

Riak CS and Stanchion packages are available on the [Download Riak CS]({{<baseurl>}}openriak-cs/2.1.1/downloads/)
...
```bash
curl -O https://files.tiot.jp/riak/cs/2.1/2.1.1/osx/10.8/riak-cs-2.1.1-OSX-x86_64.tar.gz
```
...
* [Lucid](https://files.tiot.jp/riak/cs/2.1/2.1.1/ubuntu/lucid/riak-cs_2.1.1-1_amd64.deb)
* [Precise](https://files.tiot.jp/riak/cs/2.1/2.1.1/ubuntu/precise/riak-cs_2.1.1-1_amd64.deb)
* [Squeeze](https://files.tiot.jp/riak/cs/2.1/2.1.1/debian/6/riak-cs_2.1.1-1_amd64.deb)
* [Trusty](https://files.tiot.jp/riak/cs/2.1/2.1.1/ubuntu/trusty/riak-cs_2.1.1-1_amd64.deb)
* [Wheezy](https://files.tiot.jp/riak/cs/2.1/2.1.1/debian/7/riak-cs_2.1.1-1_amd64.deb)
...
* [el5](https://files.tiot.jp/riak/cs/2.1/2.1.1/rhel/5/riak-cs-2.1.1-1.el5.x86_64.rpm)
* [el6](https://files.tiot.jp/riak/cs/2.1/2.1.1/rhel/6/riak-cs-2.1.1-1.el6.x86_64.rpm)
* [el7](https://files.tiot.jp/riak/cs/2.1/2.1.1/rhel/7/riak-cs-2.1.1-1.el7.centos.x86_64.rpm)
...
details can be found in [Specifying the Stanchion Node]({{<baseurl>}}openriak-cs/2.1.0/cookbooks/configuration/#specifying-the-stanchion-node).

### Installing Stanchion on Mac OS X

First, download the appropriate package from the [downloads]({{<baseurl>}}openriak-cs/2.1.1/downloads/#stanchion-1-4-3) page.

```bash
curl -O https://files.tiot.jp/riak/stanchion/2.1/2.1.1/osx/10.8/stanchion-2.1.1-OSX-x86_64.tar.gz
```
...
At this point, you can move on to [configuring Riak CS]({{<baseurl>}}openriak-cs/2.1.0/cookbooks/configuration/riak-cs).
...
learn more about [configuring Riak CS]({{<baseurl>}}openriak-cs/2.1.0/cookbooks/configuration/riak-cs).
