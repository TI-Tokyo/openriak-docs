...
aliases:
  ...
  - /openriak-cs/2.1.1/cookbooks/installing/Riak-CS-Using-Chef/
...
* [Building a Local Test Environment]({{<baseurl>}}openriak-cs/2.1.1/tutorials/fast-track/local-testing-environment)
* [Building a Virtual Testing Environment]({{<baseurl>}}openriak-cs/2.1.1/tutorials/fast-track/virtual-test-environment)
