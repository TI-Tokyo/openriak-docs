...
system, please see our documentation on [configuring Riak CS]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/configuration/riak-cs).
...
[CS configuration doc]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/configuration/riak-cs/#garbage-collection-settings).
...
For more information, see our documentation on [Riak CS command-line tools]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/command-line-tools).
...
can be found in our documentation on [configuring Riak CS]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/configuration/riak-cs/#garbage-collection-settings).
