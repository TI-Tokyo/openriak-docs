...
* [Configuring Riak]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/configuration/riak-for-cs)
* [configuring Riak CS]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/configuration/riak-cs)
* [Configuring Stanchion]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/configuration/stanchion)
* [Configuring an S3 client]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/configuration/s3-client)
