...
sitemap:
  priority: 0.2
aliases:
  - /riakcs/2.1.1/cookbooks/configuration/Configuring-Stanchion/
  - /openriak-cs/2.1.1/cookbooks/configuration/Configuring-Stanchion/
...
The admin user is created during the [configuration of Riak CS]({{<baseurl>}}openriak-cs/2.1.1/cookbooks/configuration/riak-cs/#specifying-the-admin-user).
