...
sitemap:
  priority: 0.3
aliases:
  - /riakcs/2.1.2/cookbooks/tutorials/fast-track/Testing-the-Installation/
  - /openriak-cs/2.1.2/cookbooks/tutorials/fast-track/Testing-the-Installation/

linkTitle: "Testing the Installation"
weight: 103
---
...
* [Details about API operations]({{<baseurl>}}openriak-cs/2.1.2/references/apis/storage)
* [Information about the Ruby Fog client]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/fog)
* [Release Notes]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/release-notes)
