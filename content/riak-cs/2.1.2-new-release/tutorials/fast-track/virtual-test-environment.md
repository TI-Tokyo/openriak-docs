...
aliases:
  ...
  - /openriak-cs/2.1.2/cookbooks/tutorials/fast-track/Building-a-Virtual-Test-Environment/
...
instructions for [Building a Local Test Environment]({{<baseurl>}}openriak-cs/2.1.2/tutorials/fast-track/local-testing-environment).
...
You are ready to progress to [Testing the Riak CS Installation]({{<baseurl>}}openriak-cs/2.1.2/tutorials/fast-track/test-installation).
