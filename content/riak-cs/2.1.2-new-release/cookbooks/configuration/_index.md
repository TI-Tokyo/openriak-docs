...
* [Configuring Riak]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/configuration/riak-for-cs)
...
* [Configuring an S3 client]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/configuration/s3-client)
