...
aliases:
  ...
  - /openriak-cs/2.1.2/cookbooks/installing/Installing-Riak-CS/
...
is built
* Riak CS itself
* [Stanchion]({{<baseurl>}}openriak-cs/2.1.2/theory/stanchion) --- An application used to manage [globally unique entities]({{<baseurl>}}openriak-cs/2.1.2/theory/stanchion/#globally-unique-entities) such as users and buckets.
...
We strongly recommend using one of the documented [version combinations]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/version-compatibility/)
...
documentation on [configuring Riak KV for CS]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/configuration/riak-for-cs/).

## Installing Riak CS on a Node

Riak CS and Stanchion packages are available on the [Download Riak CS]({{<baseurl>}}openriak-cs/2.1.2/downloads/)
...
At this point, you can move on to [configuring Riak CS]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/configuration/riak-cs/).
...
First, download the appropriate package from the [downloads]({{<baseurl>}}openriak-cs/2.1.2/downloads/#stanchion-1-4-3) page.
