...
sitemap:
  priority: 0.3
aliases:
  - /riakcs/2.1.2/cookbooks/installing/Riak-CS-Using-Chef/
  - /openriak-cs/2.1.2/cookbooks/installing/Riak-CS-Using-Chef/
...
* [Building a Local Test Environment]({{<baseurl>}}openriak-cs/2.1.2/tutorials/fast-track/local-testing-environment)
* [Building a Virtual Testing Environment]({{<baseurl>}}openriak-cs/2.1.2/tutorials/fast-track/virtual-test-environment)
