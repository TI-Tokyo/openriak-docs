...
sitemap:
  priority: 0.3
aliases:
  - /riakcs/2.1.2/cookbooks/Usage-and-Billing-Data/
...
please read [Querying Access Statistics]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/querying-access-statistics).
...
query parameter is a `KeyWrite` operation. See [Querying Access Statistics]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/querying-access-statistics) for a list of all operation types.
...
See [Configuring Riak for CS]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/configuration/riak-for-cs) for directions on setting this up.
