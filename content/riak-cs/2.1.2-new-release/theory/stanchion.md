...
sitemap:
  priority: 0.3
aliases:
  - /riakcs/2.1.2/theory/stanchion/
  - /openriak-cs/2.1.2/theory/stanchion/
...
* [Configuring Stanchion]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/configuration/stanchion)
* [Installing Stanchion]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/installing#installing-stanchion-on-a-node)
* [The Stantion Command-line Interface]({{<baseurl>}}openriak-cs/2.1.2/cookbooks/command-line-tools#stanchion)
