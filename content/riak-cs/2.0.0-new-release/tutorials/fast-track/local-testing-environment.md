...
aliases:
  ...
  - /openriak-cs/2.0.0/cookbooks/tutorials/fast-track/Building-a-Local-Test-Environment/
...
configuration, there is an option for [Building a Virtual Testing Environment]({{<baseurl>}}openriak-cs/2.0.0/tutorials/fast-track/virtual-test-environment).
...
[Download Riak]({{<baseurl>}}riak/kv/2.1.3/downloads/) and [Download Riak CS]({{<baseurl>}}openriak-cs/2.0.0/downloads).
...
Once you have completed this step, You can progress to [testing the Riak CS installation]({{<baseurl>}}openriak-cs/2.0.0/tutorials/fast-track/test-installation) using s3cmd.
