...
sitemap:
  priority: 0.1
aliases:
  - /riakcs/2.0.0/cookbooks/tutorials/fast-track/What-is-Riak-CS/
  - /openriak-cs/2.0.0/cookbooks/tutorials/fast-track/What-is-Riak-CS/
...
When an object is uploaded via the [storage API]({{<baseurl>}}openriak-cs/2.0.0/references/apis/storage), Riak CS breaks the object into smaller chunks that are streamed,
