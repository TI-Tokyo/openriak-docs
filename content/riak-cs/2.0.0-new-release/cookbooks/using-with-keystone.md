...
sitemap:
  priority: 0.1
aliases:
  - /riakcs/2.0.0/cookbooks/Using-Riak-CS-With-Keystone/
  - /openriak-cs/2.0.0/cookbooks/Using-Riak-CS-With-Keystone/
...
Follow the procedures documented in [Keystone Setup]({{<baseurl>}}openriak-cs/2.0.0/cookbooks/keystone-setup) to set up and run
Keystone.
