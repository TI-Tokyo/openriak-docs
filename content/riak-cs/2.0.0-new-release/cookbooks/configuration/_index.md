...
* [Configuring Riak]({{<baseurl>}}openriak-cs/2.0.0/cookbooks/configuration/riak-for-cs)
...
* [Configuring an S3 client]({{<baseurl>}}openriak-cs/2.0.0/cookbooks/configuration/s3-client)
