...
sitemap:
  priority: 0.1
aliases:
  - /riakcs/2.0.0/cookbooks/configuration/Configuring-Transmit/
  - /openriak-cs/2.0.0/cookbooks/configuration/Configuring-Transmit/
...
> **Note**
>
> Transmit expects a secure connection, so ensure that your Riak CS proxy server is configured with SSL support. For information on configuring a software solution like HAProxy with SSL for use with Riak CS, see [Load Balancing and Proxy Configuration]({{<baseurl>}}openriak-cs/2.0.0/cookbooks/configuration/load-balancing-proxy).
