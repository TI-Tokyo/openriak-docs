...
useful for local testing with Riak CS can be found [here]({{<baseurl>}}openriak-cs/2.0.0/cookbooks/keystone-conf-sample/). This configuration file sets up logging to
