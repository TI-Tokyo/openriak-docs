...
sitemap:
  priority: 0.1
aliases:
  - /riakcs/2.0.1/references/apis/storage/openstack/Mapping-From-OOS-API-to-Riak-CS-internal-API
  - /openriak-cs/2.0.1/references/apis/storage/openstack/Mapping-From-OOS-API-to-Riak-CS-internal-API
---
