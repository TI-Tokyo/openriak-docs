...
aliases:
  ...
  - /openriak-cs/2.0.1/cookbooks/Rolling-Upgrades-For-Riak-CS/
...
6. Riak CS 2.0 introduces a new style of configuration known as `riak-cs.conf`.
    ...
    **If you choose to use the legacy `app.config` files for Riak CS and/or
    ...
    and so on. More details can be found at [configuring Riak CS]({{<baseurl>}}openriak-cs/2.0.1/cookbooks/configuration/riak-cs).
    </div>
