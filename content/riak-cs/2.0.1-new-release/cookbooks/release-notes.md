...
sitemap:
  priority: 0.1
aliases:
  - /riakcs/2.0.1/cookbooks/Riak-CS-Release-Notes/
  - /openriak-cs/2.0.1/cookbooks/Riak-CS-Release-Notes/
linkTitle: "Riak CS Release Notes"
weight: 102
---
[riak_cs_multibag_support]: {{<baseurl>}}openriak-cs/2.0.1/cookbooks/supercluster
...
**Note:** stats item names from prior to 2.0.x are not preserved; they have been renamed or removed. No backward consistency is maintained. Please see [the documentation]({{<baseurl>}}openriak-cs/latest/cookbooks/monitoring-and-metrics/) for more information.
...
The following administration CLIs have been replaced by the [`riak-cs-admin` command]({{<baseurl>}}openriak-cs/latest/cookbooks/command-line-tools/):
...
More information on garbage collection can be found in the [documentation]({{<baseurl>}}openriak-cs/latest/cookbooks/garbage-collection/).
...
* Several user-friendly features have been added to [`riak-cs-debug`]({{<baseurl>}}openriak-cs/latest/cookbooks/command-line-tools/): fine-grained information gathering options, user-defined filtering for configuration files, and verbose output for failed commands. [[PR 1236](https://github.com/basho/riak_cs/pull/1236)]
...
Page]({{<baseurl>}}openriak-cs/latest/downloads/).
...
* Bucket restrictions --- Similar to S3, you can now limit the number of buckets created per user to prevent users from creating an unusually large number of buckets. More details are included [here]({{<baseurl>}}openriak-cs/latest/cookbooks/configuration/riak-cs/).
...
Please see the [Riak CS Downloads Page]({{<baseurl>}}openriak-cs/latest/downloads/).
...
* Added Multibag Technical Preview to Riak CS. More info is available [here]({{<baseurl>}}openriak-cs/latest/cookbooks/multibag/)
