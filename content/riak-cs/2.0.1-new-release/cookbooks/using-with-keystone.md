...
sitemap:
  priority: 0.1
aliases:
  - /riakcs/2.0.1/cookbooks/Using-Riak-CS-With-Keystone/
  - /openriak-cs/2.0.1/cookbooks/Using-Riak-CS-With-Keystone/
linkTitle: "Using Riak CS With Keystone"
weight: 103
---
...
Follow the procedures documented in [Keystone Setup]({{<baseurl>}}openriak-cs/2.0.1/cookbooks/keystone-setup) to set up and run
Keystone.
