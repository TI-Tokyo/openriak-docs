...
aliases:
  ...
  - /openriak-cs/2.0.1/cookbooks/configuration/Configuring-Stanchion/
...
The admin user is created during the [configuration of Riak CS]({{<baseurl>}}openriak-cs/2.0.1/cookbooks/configuration/riak-cs/#specifying-the-admin-user).
