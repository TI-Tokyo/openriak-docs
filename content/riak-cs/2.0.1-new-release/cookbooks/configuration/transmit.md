...
aliases:
  ...
  - /openriak-cs/2.0.1/cookbooks/configuration/Configuring-Transmit/
...
> **Note**
>
> Transmit expects a secure connection, so ensure that your Riak CS proxy server is configured with SSL support. For information on configuring a software solution like HAProxy with SSL for use with Riak CS, see [Load Balancing and Proxy Configuration]({{<baseurl>}}openriak-cs/2.0.1/cookbooks/configuration/load-balancing-proxy).
