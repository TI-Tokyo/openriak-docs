...
aliases:
  ...
  - /openriak-cs/2.0.1/cookbooks/configuration/Configuring-MDC/
...
Though there is no specific configuration for [Stanchion]({{<baseurl>}}openriak-cs/2.0.1/theory/stanchion), note that
...
updates to [globally unique entities]({{<baseurl>}}openriak-cs/2.0.1/theory/stanchion/#globally-unique-entities) like users and buckets.
