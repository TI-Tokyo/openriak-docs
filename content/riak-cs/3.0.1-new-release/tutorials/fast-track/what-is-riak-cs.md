...
aliases:
  ...
  - /openriak-cs/3.0.1/cookbooks/tutorials/fast-track/What-is-Riak-CS/
  - /openriak-cs/latest/tutorials/fast-track/what-is-riak-cs/
...
When an object is uploaded via the [storage API]({{<baseurl>}}openriak-cs/3.0.1/references/apis/storage), Riak CS breaks the object into smaller chunks that are streamed,
