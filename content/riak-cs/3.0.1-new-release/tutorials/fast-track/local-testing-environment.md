...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/cookbooks/tutorials/fast-track/Building-a-Local-Test-Environment/
  - /openriak-cs/3.0.1/cookbooks/tutorials/fast-track/Building-a-Local-Test-Environment/
  - /openriak-cs/latest/tutorials/fast-track/local-testing-environment/
linkTitle: "Building a Local Test Environment"
weight: 101
---
...
configuration, there is an option for [Building a Virtual Testing Environment]({{<baseurl>}}openriak-cs/3.0.1/tutorials/fast-track/virtual-test-environment).
...
operation. See the [Open Files Limit]({{<baseurl>}}riak/kv/latest/using/performance/open-files-limit) document for more information on
...
For Mac OS X, consult the [open files limit]({{<baseurl>}}riak/kv/latest/using/performance/open-files-limit/#mac-os-x) documentation.
...
[Download Riak]({{<baseurl>}}riak/kv/latest/downloads/) and [Download Riak CS]({{<baseurl>}}openriak-cs/3.0.1/downloads).
...
document.**
  ...
  * [Debian and Ubuntu]({{<baseurl>}}riak/kv/latest/setup/installing/debian-ubuntu)
  * [RHEL and CentOS]({{<baseurl>}}riak/kv/latest/setup/installing/rhel-centos)
  * [Mac OS X]({{<baseurl>}}riak/kv/latest/setup/installing/mac-osx)
  * [FreeBSD]({{<baseurl>}}riak/kv/latest/setup/installing/freebsd)
  * [SUSE]({{<baseurl>}}riak/kv/latest/setup/installing/suse)
  * [Windows Azure]({{<baseurl>}}riak/kv/latest/setup/installing/windows-azure)
  * [AWS Marketplace]({{<baseurl>}}riak/kv/latest/setup/installing/amazon-web-services)
  * [From Source]({{<baseurl>}}riak/kv/latest/setup/installing/source)
...
[
 {riak_kv, [
              {add_paths, ["/usr/lib/riak-cs/lib/riak_cs-3.0.1/ebin"]},
...
available in the [Command Line Tools]({{<baseurl>}}riak/kv/latest/using/admin/riak-admin/#cluster) documentation.
...
Once you have completed this step, You can progress to [testing the Riak CS installation]({{<baseurl>}}openriak-cs/3.0.1/tutorials/fast-track/test-installation) using s3cmd.
