...
aliases:
  ...
  - /openriak-cs/3.0.1/cookbooks/tutorials/fast-track/Testing-the-Installation/
  - /openriak-cs/latest/tutorials/fast-track/test-installation/
...
* [Details about API operations]({{<baseurl>}}openriak-cs/3.0.1/references/apis/storage)
* [Information about the Ruby Fog client]({{<baseurl>}}openriak-cs/3.0.1/cookbooks/fog)
* [Release Notes]({{<baseurl>}}openriak-cs/3.0.1/cookbooks/release-notes)
