...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/cookbooks/tutorials/fast-track/Building-a-Virtual-Test-Environment/
  - /openriak-cs/3.0.1/cookbooks/tutorials/fast-track/Building-a-Virtual-Test-Environment/
  - /openriak-cs/latest/tutorials/fast-track/virtual-test-environment/
linkTitle: "Building a Virtual Test Environment"
weight: 102
---
...
instructions for [Building a Local Test Environment]({{<baseurl>}}openriak-cs/3.0.1/tutorials/fast-track/local-testing-environment).
...
You are ready to progress to [Testing the Riak CS Installation]({{<baseurl>}}openriak-cs/3.0.1/tutorials/fast-track/test-installation).
