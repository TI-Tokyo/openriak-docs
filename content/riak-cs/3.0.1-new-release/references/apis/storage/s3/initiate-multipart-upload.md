...
toc: true
aliases:
  - /riakcs/3.0.1/references/apis/storage/s3/RiakCS-Initiate-Multipart-Upload/
  - /openriak-cs/3.0.1/references/apis/storage/s3/RiakCS-Initiate-Multipart-Upload/
  - /openriak-cs/latest/references/apis/storage/s3/initiate-multipart-upload/
---
...
This implementation of the operation uses only response headers that are common to most responses. For more information, see [Common RiakCS Response Headers]({{<baseurl>}}openriak-cs/3.0.1/references/apis/storage/s3/common-response-headers).
