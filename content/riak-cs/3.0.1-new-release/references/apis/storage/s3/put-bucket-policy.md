...
toc: true
aliases:
  - /riakcs/3.0.1/references/apis/storage/s3/RiakCS-PUT-Bucket-policy/
  - /openriak-cs/3.0.1/references/apis/storage/s3/RiakCS-PUT-Bucket-policy/
  - /openriak-cs/latest/references/apis/storage/s3/put-bucket-policy/
---
...
This operation uses only request headers that are common to all operations. For more information, see [Common Riak CS Request Headers]({{<baseurl>}}openriak-cs/3.0.1/references/apis/storage/s3/common-request-headers).
