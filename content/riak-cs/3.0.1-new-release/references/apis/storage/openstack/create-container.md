...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/references/apis/storage/openstack/RiakCS-OpenStack-Create-Container
  - /openriak-cs/3.0.1/references/apis/storage/openstack/RiakCS-OpenStack-Create-Container
  - /openriak-cs/latest/references/apis/storage/openstack/create-container/
---
