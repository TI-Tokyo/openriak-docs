...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/references/apis/storage/openstack/Mapping-From-OOS-API-to-Riak-CS-internal-API
  - /openriak-cs/3.0.1/references/apis/storage/openstack/Mapping-From-OOS-API-to-Riak-CS-internal-API
  - /openriak-cs/latest/references/apis/storage/openstack/mapping-from-oos-api-to-riak-cs-internal-api/
---
