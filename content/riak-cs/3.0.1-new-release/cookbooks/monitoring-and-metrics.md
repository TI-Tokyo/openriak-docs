...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/cookbooks/monitoring-and-metrics/
  - /openriak-cs/latest/cookbooks/monitoring-and-metrics/
linkTitle: "Monitoring & Metrics"
weight: 101
---

[amazon]: http://docs.aws.amazon.com/AmazonS3/latest/dev/RESTAuthentication.html
[s3 api]: {{<baseurl>}}openriak-cs/latest/references/apis/storage/s3/
