...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/cookbooks/Rolling-Upgrades-For-Riak-CS/
  - /openriak-cs/3.0.1/cookbooks/Rolling-Upgrades-For-Riak-CS/
  - /openriak-cs/latest/cookbooks/rolling-upgrades/
...
<a href="https://github.com/basho/riak_cs/blob/release/1.5/RELEASE-NOTES.md#incomplete-multipart-uploads">to clean up incomplete multipart under deleted buckets</a> is needed. Otherwise
...
the 1.5.0 release. Consult the
 <a href="https://github.com/basho/riak_cs/blob/release/1.5/RELEASE-NOTES.md#leeway-seconds-and-disk-space">Leeway seconds and disk space</a> section of the 1.5 release notes
...
4. Upgrade Riak, Riak CS, and Stanchion. See the <a
    href="{{<baseurl>}}openriak-cs/latest/downloads">Riak
