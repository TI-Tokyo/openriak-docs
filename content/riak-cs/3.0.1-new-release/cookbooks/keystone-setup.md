...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/cookbooks/Keystone-Setup/
  - /openriak-cs/latest/cookbooks/keystone-setup/
---
...
useful for local testing with Riak CS can be found [here]({{<baseurl>}}openriak-cs/3.0.1/cookbooks/keystone-conf-sample/). This configuration file sets up logging to
