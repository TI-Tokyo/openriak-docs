...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/cookbooks/garbage-collection/
  - /openriak-cs/latest/cookbooks/garbage-collection/
...
system, please see our documentation on [configuring Riak CS]({{<baseurl>}}openriak-cs/3.0.1/cookbooks/configuration/riak-cs).
...
[CS configuration doc]({{<baseurl>}}openriak-cs/3.0.1/cookbooks/configuration/riak-cs/#garbage-collection-settings).
...
For more information, see our documentation on [Riak CS command-line tools]({{<baseurl>}}openriak-cs/3.0.1/cookbooks/command-line-tools).
...
can be found in our documentation on [configuring Riak CS]({{<baseurl>}}openriak-cs/3.0.1/cookbooks/configuration/riak-cs/#garbage-collection-settings).
