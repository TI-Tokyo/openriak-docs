...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/cookbooks/configuration/Configuring-MDC/
  - /openriak-cs/3.0.1/cookbooks/configuration/Configuring-MDC/
  - /openriak-cs/latest/cookbooks/configuration/multi-datacenter/
linkTitle: "Configuring MDC"
weight: 104
---
...
Though there is no specific configuration for [Stanchion]({{<baseurl>}}openriak-cs/3.0.1/theory/stanchion), note that
...
updates to [globally unique entities]({{<baseurl>}}openriak-cs/3.0.1/theory/stanchion/#globally-unique-entities) like users and buckets.
