...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/cookbooks/configuration/Configuring-Transmit/
  - /openriak-cs/3.0.1/cookbooks/configuration/Configuring-Transmit/
  - /openriak-cs/latest/cookbooks/configuration/transmit/
linkTitle: "Configuring Transmit"
weight: 104
---
...
> **Note**
>
> Transmit expects a secure connection, so ensure that your Riak CS proxy server is configured with SSL support. For information on configuring a software solution like HAProxy with SSL for use with Riak CS, see [Load Balancing and Proxy Configuration]({{<baseurl>}}openriak-cs/3.0.1/cookbooks/configuration/load-balancing-proxy).
