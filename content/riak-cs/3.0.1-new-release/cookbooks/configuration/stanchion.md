...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/cookbooks/configuration/Configuring-Stanchion/
  - /openriak-cs/3.0.1/cookbooks/configuration/Configuring-Stanchion/
  - /openriak-cs/latest/cookbooks/configuration/stanchion/
linkTitle: "Configuring Stanchion"
weight: 102
---
...
The admin user is created during the [configuration of Riak CS]({{<baseurl>}}openriak-cs/3.0.1/cookbooks/configuration/riak-cs/#specifying-the-admin-user).
