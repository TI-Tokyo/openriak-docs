...
sitemap:
  priority: 0.9
aliases:
  - /riakcs/3.0.1/cookbooks/installing/Riak-CS-Using-Chef/
  - /openriak-cs/3.0.1/cookbooks/installing/Riak-CS-Using-Chef/
  - /openriak-cs/latest/cookbooks/installing/chef/
linkTitle: "Installing With Chef"
weight: 201
---
...
* [Building a Local Test Environment]({{<baseurl>}}openriak-cs/3.0.1/tutorials/fast-track/local-testing-environment)
* [Building a Virtual Testing Environment]({{<baseurl>}}openriak-cs/3.0.1/tutorials/fast-track/virtual-test-environment)
