...
aliases:
  ...
  - /openriak-cs/latest/cookbooks/using-with-keystone/
...
Follow the procedures documented in [Keystone Setup]({{<baseurl>}}openriak-cs/3.0.1/cookbooks/keystone-setup) to set up and run
Keystone.
