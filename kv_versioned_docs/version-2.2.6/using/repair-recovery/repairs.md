...
sidebar_label: Repairs
pagination_label: "Repairs"
...
[cluster ops aae]: ./../../cluster-operations/active-anti-entropy
[config ref]: ./../../../configuring/reference
[Erlang shell]: http://learnyousomeerlang.com/starting-out
[glossary AAE]: ./../../../learn/glossary/#active-anti-entropy-aae
[glossary readrep]: ./../../../learn/glossary/#read-repair
[search config]: ./../../../configuring/search/#search-config-settings
[tiered storage]: ./../../../setup/planning/backend/leveldb/#tiered-storage
...
<RiakDocsNote title="Erlang version">
...
[partitions](./../../../learn/concepts/clusters/#the-ring). Repairs of Riak KV data are typically
...
repair data will depend mainly on your use case and on whether [active anti-entropy](./../../../learn/concepts/active-anti-entropy) is enabled.

You will need to run a repair if the following are both true:

* Active anti-entropy is [disabled](./../../../learn/concepts/active-anti-entropy/#disabling-active-anti-entropy)
* You have both non-expiring data and keys that are not accessed
  ...
  [read repair](./../../../learn/concepts/active-anti-entropy/#read-repair-vs-active-anti-entropy))

You will most likely not need to run a repair operation if _any_ of the
following is true:

* Active anti-entropy is [enabled](./../../../learn/concepts/active-anti-entropy/#enabling-active-anti-entropy)
