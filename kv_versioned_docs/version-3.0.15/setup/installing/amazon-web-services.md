...
```bash
wget https://files.tiot.jp/riak/kv/3.0/3.0.15/amazon/2/riak-3.0.15-1.amzn2x86_64.rpm
sudo yum localinstall -y riak-3.0.15-1.amzn2x86_64.rpm
```
...
```bash
wget https://files.tiot.jp/riak/kv/3.0/3.0.15/amazon/2/riak-3.0.15-1.amzn2x86_64.rpm
sudo rpm -i riak-3.0.15-1.amzn2x86_64.rpm
```
