...
At the bottom of the page, you'll find a [screencast](./../../app-guide/replication-properties#screencast) that briefly explains how to adjust your
...
<a href="/kv/3.0.15/using/reference/strong-consistency/">strongly
...
<a href="/kv/3.0.15/developing/app-guide/strong-consistency/">Using
...
that they can be at the bucket level. You can use [bucket types](./../bucket-types)
...
documentation on [Bitcask][plan backend bitcask], [LevelDB][plan backend leveldb], and [multiple backends](./../../../setup/planning/backend/multi).
...
refer to the tutorial on [basic key/value operations in Riak KV](./../../getting-started)
