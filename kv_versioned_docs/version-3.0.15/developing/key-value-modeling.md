...
that can be useful in application development, such as [secondary indexes (2i)](./../usage/secondary-indexes), and [Riak Data Types](./../data-types), Riak almost always performs best when you
