...
Field | Description
:-----|:-----------
`client_stats` | See <a href="/kv/2.2.3/using/reference/multi-datacenter/statistics/#client-statistics">Client Statistics</a>
...
`server_stats` | See <a href="/kv/2.2.3/using/reference/multi-datacenter/statistics/#server-statistics">Server Statistics</a>
...
`fullsync_worker` | The Erlang process ID of the fullsync worker
`bounded_queue` | See the <a href="/kv/2.2.3/using/cluster-operations/v2-multi-datacenter/#bounded-queue">Bounded Queue</a> section above
