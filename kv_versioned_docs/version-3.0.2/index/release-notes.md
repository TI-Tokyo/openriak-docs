...
pagination_label: "Riak KV 3.0.2 Release Notes"
...
Please see the KV 3.0.1 release notes [here](./../../3.0.1/release-notes) and the KV 2.9.7 release notes [here](./../../2.9.7/release-notes).
