...
pagination_label: "Riak KV 3.0.2"
...
[config index]: ./../3.0.1/configuring
[downloads]: ./../3.0.1/downloads
[install index]: ./../3.0.1/setup/installing
[plan index]: ./../3.0.1/setup/planning
[perf open files]: ./../3.0.1/using/performance/open-files-limit
[install debian & ubuntu]: ./../3.0.1/setup/installing/debian-ubuntu
[getting started]: ./../3.0.1/developing/getting-started
[dev client libraries]: ./../3.0.1/developing/client-libraries
...
If you are looking to integrate Riak KV with your existing tools, check out the [Developing with Riak KV](./../3.0.1/developing) docs. They provide instructions and examples for languages such as: Java, Ruby, Python, Go, Haskell, NodeJS, Erlang, and more.
</RiakDocsNote>
