...
as <a href="/kv/3.0.2/learn/glossary/#active-anti-entropy-aae">active anti-entropy</a> data, and cluster metadata.
</td>
<td>
<code>./data</code>
</td>
...
<td>
The maximum number of times that a secondary system within Ria can block <a href="../../using/cluster-operations/handoff">handoff</a>
...
associated <a href="/kv/3.0.2/learn/glossary/#vnode">vnode</a> before assuming that the vnode
...
href="/kv/3.0.2/learn/glossary/#vnode">vnodes</a> attempt to trigger <a
href="/kv/3.0.2/learn/glossary/#hinted-handoff">handoff</a> between
