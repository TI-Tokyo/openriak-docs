...
pagination_label: "Riak KV 2.1.3 Release Notes"
...
If you have been depending on this behavior unintentionally, learn more about what  `allow_mult` and `dvv_enabled` imply in our [Conflict Resolution](./../dev/using/conflict-resolution) documentation.
...
Detailed information on the issue is available in the Basho Documentation [Product Advisories](/community/productadvisories/210-dataloss/).
