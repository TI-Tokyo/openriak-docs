...
sidebar_label: Set Bucket Properties
pagination_label: "HTTP Set Bucket Properties"
...
clock) when writing
* `precommit` - [precommit hooks](./../../../usage/commit-hooks)
* `postcommit` - [postcommit hooks](./../../../usage/commit-hooks)
...
<RiakDocsNote title="Property types">
...
<RiakDocsNote title="Node Confirms">
...
<RiakDocsNote title="sync_on_write">
