...
<RiakDocsNote>
Next Gen Replication relies on the TicTac AAE system, which needs to be enabled and configured. See the [TicTac AAE configuration](./../../../3.0.11/configuring/active-anti-entropy/tictac-aae) documentaion.
</RiakDocsNote>
