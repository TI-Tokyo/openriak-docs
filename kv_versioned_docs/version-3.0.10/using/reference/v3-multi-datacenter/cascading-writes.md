...
sidebar_label: Cascading Writes
pagination_label: "Cascading Realtime Writes"
...
<RiakDocsNote title="Note on cascading tracking">
...
`riak repl` command. Please see the [Version 3 Operations guide](./../../../cluster-operations/v3-multi-datacenter) for more information.
