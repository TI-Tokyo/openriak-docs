...
sidebar_label: Object Modeling
pagination_label: "Object Modeling with Erlang"
...
<RiakDocsNote title="Code Download">
...
We'll be using the bucket `Users` to store our data. We won't be [using bucket types](./../../../usage/bucket-types) here, so we don't need to specify one.
