...
If you are using [trust-](./../../../../using/security/managing-sources) or [PAM](./../../../../using/security/managing-sources/#pam-based-authentication)-based authentication, you
can use the security setup described in the [Ruby Client Basics](#ruby-client-basics) section.
[Password](./../../../../using/security/managing-sources/#password-based-authentication)-based authentication is covered
in a [later section](#password-based-authentication), while [certificate](./../../../../using/security/managing-sources/#certificate-based-authentication)-based authentication
is covered [further down](#certificate-based-authentication).

<RiakDocsNote title="Note on certificate generation">
...
regardless of which [security source](./../../../../using/security/managing-sources) you choose. All clients should also provide a username. The example below sets up a client object (we'll simply call it `client`) that connects
...
this in [Trust-based Authentication](./../../../../using/security/managing-sources/#trust-based-authentication).
...
[PAM](./../../../../using/security/managing-sources/#pam-based-authentication), you will
...
documentation on [User Management](./../../../../using/security/basics#user-management).
