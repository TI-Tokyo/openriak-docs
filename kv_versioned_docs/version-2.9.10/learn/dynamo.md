...
pagination_label: "Dynamo: Amazon’s Highly Available Key-value Store"
...
[Consistent Hashing]: ./../glossary/#consistent-hashing
[Gossip Protocol]: ./../glossary/#gossiping
...
<RiakDocsFigure id="figure-1" url="/riakdocs-resources/images/dynamo/figure1.png">Figure 1: Service-oriented architecture of Amazon’s platform.</RiakDocsFigure>
...
[HTTP API]: ./../../developing/api/http
[Protocol Buffers API]: ./../../developing/api/protocol-buffers
...
[Further Reading on Partitioning in Riak KV]: ./../concepts/clusters
[All about the Riak KV Ring]: ./../concepts/clusters/#the-ring
...
<RiakDocsFigure id="figure-2" url="/riakdocs-resources/images/dynamo/figure2.png">Figure 2: Partitioning and replication of keys in Dynamo ring.</RiakDocsFigure>
...
>
> [Vector Clock on Riak KV Glossary](./../glossary/#vector-clock)
>
...
<RiakDocsFigure id="figure-3" url="/riakdocs-resources/images/dynamo/figure3.png">Figure 3: Version evolution of an object over time.</RiakDocsFigure>
...
>
>[REST API](./../../developing/api/http)
>
>[Writing Data](./../../developing/usage/creating-objects)
>
>[Reading Data](./../../developing/usage/reading-objects)
...
> [Read Repair](./../concepts/replication/#read-repair).
...
[Hinted handoff]: ./../glossary/#hinted-handoff
[Replication]: ./../../developing/usage/replication
...
> Riak KV, called [Riak KV Enterprise Edition]. Now it is available in all versions from Riak KV 2.9.10 onwards.

[Multi Datacenter Replication]: ./../../using/reference/v3-multi-datacenter/architecture
...
[Adding and Removing Nodes]: ./../../using/cluster-operations/adding-removing-nodes
[Failure Scenarios]: ./../concepts/eventual-consistency
...
[riak-admin command-line tool]: ./../../using/admin/riak-admin
...
[The Node Join Process]: ./../../using/cluster-operations/adding-removing-nodes/#joining-nodes-to-form-a-cluster
...
[backend options]: ./../../setup/planning/backend
[Bitcask]: ./../../setup/planning/backend/bitcask
[LevelDB]: ./../../setup/planning/backend/leveldb
[Memory]: ./../../setup/planning/backend/memory
[secondary indexes]: ./../../developing/usage/secondary-indexes
...
[Basho Bench]: ./../../using/performance/benchmarking
...
[CRDTs (Commutative Replicated Data Types)]: ./../../developing/data-types
...
<RiakDocsFigure id="figure-4" url="/riakdocs-resources/images/dynamo/figure4.png">Figure 4: Average and 99.9 percentiles of latencies for read and write
    ...
    latencies are an order of magnitude higher than averages.</RiakDocsFigure>
...
<RiakDocsFigure id="figure-5" url="/riakdocs-resources/images/dynamo/figure5.png">Figure 5: Comparison of performance of 99.9th percentile latencies for
    buffered vs. non-buffered writes over a period of 24 hours. The intervals
    between consecutive ticks in the x-axis correspond to one hour.</RiakDocsFigure>
...
[partitioning]: ./../concepts/replication/#understanding-replication-by-example
...
<RiakDocsFigure id="figure-6" url="/riakdocs-resources/images/dynamo/figure6.png">Figure 6: Fraction of nodes that are out-of-balance (i.e., nodes whose
    ...
    corresponds to a time period of 30 minutes.</RiakDocsFigure>
...
<RiakDocsFigure id="figure-7" url="/riakdocs-resources/images/dynamo/figure7-small.png">Figure 7: Partitioning and placement of keys in the three strategies. A, B,
    ...
    indicate the token locations for various nodes.</RiakDocsFigure>
...
[The Node Join Process]: ./../../using/cluster-operations/adding-removing-nodes/#joining-nodes-to-form-a-cluster
[Replacing a Node]: ./../../using/cluster-operations/replacing-node
...
<RiakDocsFigure id="figure-8" url="/riakdocs-resources/images/dynamo/figure8.png">Figure 8: Comparison of the load distribution efficiency of different
...
[Load Balancing]: ./../../configuring/load-balancing-proxy
