...
pagination_label: "Enabling and Disabling Debug Logging"
...
by accessing the Erlang console directly using the [`riak attach`](./../../admin/riak-cli/#attach) command. Once you run this command and drop into the console, enter the following:
