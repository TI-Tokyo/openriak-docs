...
sidebar_label: Upgrading to 2.9.10
pagination_label: "Upgrading to Riak KV 2.9.10"
...
[use admin riak control]: ./../../../using/admin/riak-control
[use admin commands]: ./../../../using/admin/commands
...
[cluster ops mdc]: ./../../../using/cluster-operations/v3-multi-datacenter
[config v3 mdc]: ./../../../configuring/v3-multi-datacenter
[jmx monitor]: ./../../../using/reference/jmx
[snmp]: ./../../../using/reference/snmp
[Release Notes]: ./../../../release-notes
...
<RiakDocsNote title="Upgrading from KV Enterprise Edition">
