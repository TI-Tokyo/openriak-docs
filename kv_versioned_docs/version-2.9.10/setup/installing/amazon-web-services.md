...
pagination_label: "Amazon Web Services"
...
3. Set your desired AWS region, EC2 instance type, firewall settings, and key pair
    ...
    ![AWS Marketplace Instance Settings](/riakdocs-resources/images/aws-marketplace-settings.png)
...
4. When complete, your security group should contain all of the rules listed below. If you are missing any rules, add them in the lower panel and then click the **Apply Rule Changes** button.
    ...
    ![EC2 Security Group Settings](/riakdocs-resources/images/aws-marketplace-security-group.png)

We also recommend that you read more about Riak's [Security and Firewalls](./../../../using/security).
...
<RiakDocsNote title="Note on Package Based Installation">
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.10/amazon/2/riak-2.9.10-1.amzn2x86_64.rpm
sudo yum localinstall -y riak-2.9.10-1.amzn2x86_64.rpm
```
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.10/amazon/2/riak-2.9.10-1.amzn2x86_64.rpm
sudo rpm -i riak-2.9.10-1.amzn2x86_64.rpm
```
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.10/amazon/2016.09/riak-2.9.10-1.amzn1x86_64.rpm
sudo yum localinstall -y riak-2.9.10-1.amzn1x86_64.rpm
```
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.10/amazon/2016.09/riak-2.9.10-1.amzn1x86_64.rpm
sudo rpm -i riak-2.9.10-1.amzn1x86_64.rpm
```
## Next Steps
