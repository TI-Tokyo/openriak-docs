...
pagination_label: "PBC MapReduce"
...
The JSON encoding is the same as [REST API](./../../../usage/mapreduce/#rest) and
the external term format is the same as the [local Erlang API](./../../../app-guide/advanced-mapreduce/#erlang)
