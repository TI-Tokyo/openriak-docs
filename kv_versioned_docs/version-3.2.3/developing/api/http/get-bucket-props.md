...
pagination_label: "HTTP Get Bucket Properties"
...
default). See also [HTTP List Keys](./../list-keys).
...
See [HTTP Set Bucket Properties](./../set-bucket-props) for more information about the available
bucket properties. See [Managing Bucket Types Through the Command Line](./../../../../using/reference/bucket-types/#managing-bucket-types-through-the-command-line) for more details about reading bucket types using  the `riak admin bucket-type` interface.
