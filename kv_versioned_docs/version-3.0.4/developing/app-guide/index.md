...
sidebar_label: Application Guide
pagination_label: "Riak KV Application Guide"
...
[usage conflict resolution]: ./../usage/conflict-resolution
[dev data model#log]: ./../data-modeling/#log-data
[dev data model#sensor]: ./../data-modeling/#sensor-data
[concept eventual consistency]: ./../../learn/concepts/eventual-consistency
[dev data model#user]: ./../data-modeling/#user-data
[dev kv model]: ./../key-value-modeling
[dev data types]: ./../data-types
[dev data types#counters]: ./../data-types/#counters
[dev data types#sets]: ./../data-types/#sets
[dev data types#maps]: ./../data-types/#maps
[usage create objects]: ./../usage/creating-objects
[usage 2i]: ./../usage/secondary-indexes
[dev client libraries]: ./../client-libraries
[concept crdts]: ./../../learn/concepts/crdts
[dev data model]: ./../data-modeling
[usage mapreduce]: ./../usage/mapreduce
[apps mapreduce]: ./advanced-mapreduce
[use ref 2i]: ./../../using/reference/secondary-indexes
...
[obj model java]: ./../getting-started/java/object-modeling
[obj model ruby]: ./../getting-started/ruby/object-modeling
[obj model python]: ./../getting-started/python/object-modeling
[obj model csharp]: ./../getting-started/csharp/object-modeling
[obj model nodejs]: ./../getting-started/nodejs/object-modeling
[obj model erlang]: ./../getting-started/erlang/object-modeling
[obj model golang]: ./../getting-started/golang/object-modeling
...
[apps strong consistency]: ./strong-consistency
[usage update objects]: ./../usage/updating-objects
[apps replication properties]: ./replication-properties
...
* **Objects that exceed 1-2MB in size** - If you will be
  ...
  out [Riak CS](/cs/) instead, as Riak
