...
sidebar_label: Riak Control
pagination_label: "Riak Control"
...
<RiakDocsNote title="Note on SSL">
...
enabled on each Riak node. For more information, see our [security documentation](./../../security/basics#enabling-ssl). Once SSL is enabled, you can proceed to setting up [authentication](#authentication) for Riak Control.
...
<RiakDocsNote title="Note on browser TLS">
...
[ ![Snapshot View](/riakdocs-resources/images/control_current_snapshot.png) ] (/riakdocs-resources/images/control_current_snapshot.png)
...
[ ![Cluster Management Staged](/riakdocs-resources/images/control_cluster_management_staged.png) ] (/riakdocs-resources/images/control_cluster_management_staged.png)

Changes committed; transfers active:

[ ![Cluster Management Transfers](/riakdocs-resources/images/control_cluster_management_transfers.png) ] (/riakdocs-resources/images/control_cluster_management_transfers.png)

Cluster stabilizes after changes:

[ ![Cluster Management Stable](/riakdocs-resources/images/control_cluster_management_stable.png) ] (/riakdocs-resources/images/control_cluster_management_stable.png)
...
[ ![Node Management](/riakdocs-resources/images/control_node_management.png) ] (/riakdocs-resources/images/control_node_management.png)

### Ring View

One level deeper than the cluster view is the ring view. This is where you can
see the health of each [vnode](./../../../learn/glossary/#vnode).

[ ![Ring View](/riakdocs-resources/images/control_current_ring.png) ] (/riakdocs-resources/images/control_current_ring.png)
