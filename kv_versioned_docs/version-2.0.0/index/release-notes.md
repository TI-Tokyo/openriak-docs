...
pagination_label: "Riak KV 2.0.0 Release Notes"
...
links to relevant documentation, can be found [in our official docs](./../intro-v20). You can find an
[Upgrading to 2.0 Guide](./../upgrade-v20)
...
For more details on bucket types see our [official documentation](./../dev/advanced/bucket-types).
...
Types](./../dev/using/data-types) and
[bucket
types](./../dev/advanced/bucket-types) for
more details.
...
[here](./../developing/data-types/counters).

#### Sets

Sets allow you to store multiple distinct opaque binary values against a
key. See the
[documentation](./../developing/data-types/sets)
...
[documentation](./../developing/data-types/maps)
...
[documentation](./../dev/using/data-types/#Data-Types-and-Context)
for more details.
...
Vectors](./../theory/concepts/dotted-version-vectors)
document.
...
* [Using Search](./../dev/using/search)
* [Search Details](./../dev/advanced/search)
* [Search Schema](./../dev/advanced/search-schema)
...
* [Using Strong Consistency](./../dev/advanced/strong-consistency)
* [Managing Strong Consistency](./../ops/advanced/strong-consistency)
* [Strong Consistency](./../theory/concepts/strong-consistency)
...
issues](./../ops/advanced/strong-consistency/#Known-Issues).
...
feature](./../ops/running/authz). Several
...
* There are restrictions on Erlang modules exposed to MapReduce jobs
  ...
  [here](./../ops/running/authz/#Security-Checklist).
...
libraries](./../dev/using/libraries) have
...
* [Link Walking](./../dev/using/link-walking)
  is deprecated and will not work if security is enabled.
* [Key Filters](./../dev/using/keyfilters)
...
* Some users in the past have used Riak's internal API (e.g.,
  ...
  other libraries](./../dev/using/libraries)
  we support) instead.

## Termination Notices

* `riak-admin backup` has been disabled; see
  [our documentation](./../ops/running/backups)
...
* LevelDB configuration values `cache_size` and `max_open_files` have
  ...
  [Configuring eLevelDB](./../ops/advanced/backends/leveldb/#Configuring-eLevelDB)
...
docs](./../upgrade-v20). The information
...
types](./../dev/advanced/bucket-types);
...
files
documentation](./../ops/advanced/configs/configuration-files).
