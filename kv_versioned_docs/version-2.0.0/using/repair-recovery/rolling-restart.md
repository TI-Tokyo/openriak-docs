...
pagination_label: "Rolling Restarts"
...
Because Riak functions as a multi-node system, cluster-level [Riak version upgrades](./../../../setup/upgrading/cluster) and restarts can be performed on a node-by-node, "rolling" basis.
