...
pagination_label: "Querying with C Sharp"
...
<RiakDocsNote>
Secondary indexes in Riak KV require a sorted backend: [Memory](./../../../../setup/planning/backend/memory) or [LevelDB](./../../../../setup/planning/backend/leveldb). [Bitcask](./../../../../setup/planning/backend/bitcask) does not support secondary indexes.

See [Using Secondary Indexes (2i)](./../../../usage/secondary-indexes) for more information on developing with secondary indexes.
</RiakDocsNote>
