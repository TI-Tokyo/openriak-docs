...
[usage bucket types]: ./../../../../2.9.1/developing/usage/bucket-types
[concept eventual consistency]: ./../../../../2.9.1/learn/concepts/eventual-consistency
[plan backend leveldb]: ./../../../../2.9.1/setup/planning/backend/leveldb
[plan backend bitcask]: ./../../../../2.9.1/setup/planning/backend/bitcask
[use ref strong consistency]: ./../../../../2.9.1/using/reference/strong-consistency
[concept clusters]: ./../../../../2.9.1/learn/concepts/clusters
...
At the bottom of the page, you'll find a [screencast](./../../../../2.9.1/developing/app-guide/replication-properties#screencast) that briefly explains how to adjust your
replication levels to match your application and business needs.

<RiakDocsNote title="Note on strong consistency">
An option introduced in Riak version 2.0 is to use Riak as a
<a href="/kv/2.9.1/using/reference/strong-consistency/">strongly
...
<a href="/kv/2.9.1/developing/app-guide/strong-consistency/">Using
...
of 3, and a `w` of 3 to all of the data in some of the [buckets](./../../../../2.9.1/learn/concepts/buckets) that
...
`pr` | PR | `0` | The number of primary <a href="/kv/2.9.1/learn/concepts/vnodes/">vnodes</a> that must respond to a read request
`pw` | PW | `0` | The number of primary <a href="/kv/2.9.1/learn/concepts/vnodes/">vnodes</a> that must respond to a write request
...
that they can be at the bucket level. You can use [bucket types](./../../../../2.9.1/developing/usage/bucket-types)
...
<RiakDocsNote title="A Word on Setting the N Value">
...
In Riak's replication model, there are N [vnodes](./../../../../2.9.1/learn/glossary/#vnode),
...
documentation on [Bitcask][plan backend bitcask], [LevelDB][plan backend leveldb], and [multiple backends](./../../../../2.9.1/setup/planning/backend/multi).

## Delete Quorum with RW

<RiakDocsNote title="Deprecation notice">
...
All of Basho's [official Riak clients](./../../../../2.9.1/developing/client-libraries) enable you to
set replication properties this way. For more detailed information,
refer to the tutorial on [basic key/value operations in Riak KV](./../../../../2.9.1/developing/getting-started)
...
and siblings, so we recommend reading the [Vector Clocks](./../../../../2.9.1/learn/concepts/causal-context#vector-clocks) documentation for more information.
...
2 of 3 vnodes agree on the value, and those 2 are the first to reach the coordinating node | The value is returned to the client. Read repair will deal with the conflict per the later scenarios, which means that a future read may return a different value or <a href="/kv/2.9.1/learn/concepts/causal-context#siblings">siblings</a>
2 conflicting values reach the coordinating node and <a href="/kv/2.9.1/learn/concepts/causal-context#vector-clocks">vector clocks</a> allow for resolution | The vector clocks are used to resolve the conflict and return a single value, which is propagated via read repair to the relevant vnodes
