...
In Riak versions 2.9.0 and later, [TicTac AAE](./../tictac-active-anti-entropy) is included with releases as an option to be used in addition to or instead of traditional AAE in Riak.
