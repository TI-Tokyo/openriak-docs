...
pagination_label: "Statistics & Monitoring Reference"
...
are made available through the HTTP API via the [`/stats`](./../../../developing/api/http/status) endpoint, or through the [`riak admin`](./../../admin/riak-admin) interface, in particular the `stat` and `status` commands.
...
Riak statistics provided in the [Inspecting a Node](./../../cluster-operations/inspecting-node) and [HTTP Status](./../../../developing/api/http/status) documentation.
...
documentation on [system tuning](./../../performance/#storage-and-file-system-tuning).
...
If graphing all of the [available Riak metrics](./../../cluster-operations/inspecting-node) is
...
<RiakDocsNote title="Note on FSM Time Stats">
...
The [`riak admin`](./../../admin/riak-admin) tool provides two
...
[Inspecting a Node](./../../cluster-operations/inspecting-node/#riak admin-status) document.
...
in the [Inspecting a Node](./../../admin/riak-admin/#stat) document.
...
<RiakDocsNote title="Note on Riak 2.x Statistics Support">
...
[Riak Control](./../../admin/riak-control) is Basho's REST-driven user-interface for managing Riak
...
the Riak HTTP [`/stats`](./../../../developing/api/http/status) endpoint is also available.
...
A [Riak New Relic Agent][riak_new_relic] for collecting statistics from the Riak HTTP [`/stats`](./../../../developing/api/http/status) endpoint is also available.
...
[`/stats`](./../../../developing/api/http/status) endpoint.
...
* [Inspecting a Node](./../../cluster-operations/inspecting-node)
* [Riaknostic](http://riaknostic.basho.com)
* [Riak Control](./../../admin/riak-control)
...
[data_types_counters]: ./../../../developing/data-types/counters
[data_types_sets]: ./../../../developing/data-types/sets
[data_types_maps]: ./../../../developing/data-types/maps
