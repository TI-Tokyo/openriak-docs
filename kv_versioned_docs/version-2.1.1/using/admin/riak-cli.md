...
sidebar_label: riak CLI
pagination_label: "riak Command Line Interface"
...
[configuration file]: ./../../../configuring/reference
[escript]: http://www.erlang.org/doc/man/escript.html
[`riak-admin`]: ./../riak-admin/#top
[configuration]: ./../../../configuring/reference
...
Checks whether the [configuration file](./../../../configuring/reference) is valid. If so, `config is OK` will be included in the output.
...
More detailed information can be found in the [`riak-admin`](./../riak-admin/#top) documentation.

## config

Provides information about the current [configuration](./../../../configuring/reference) of a Riak node, i.e. the parameters and values in the node's `riak.conf` or `app.config` (depending on which configuration system is being used).
