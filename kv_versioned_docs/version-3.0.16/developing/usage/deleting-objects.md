...
sidebar_label: Deleting Objects
pagination_label: "Deleting Objects"
...
you first fetch the [causal context](./../../../learn/concepts/causal-context) of the object prior to updating.
This can be done by setting the `deletedvclock` parameter to `true` as
part of the [fetch operation](./../../api/protocol-buffers/fetch-object). This can also be done
