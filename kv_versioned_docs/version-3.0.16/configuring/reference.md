...
as <a href="/kv/3.0.16/learn/glossary/#active-anti-entropy-aae">active anti-entropy</a> data, and cluster metadata.
</td>
<td>
<code>./data</code>
</td>
...
<td>
The maximum number of times that a secondary system within Riak can block <a href="../../using/cluster-operations/handoff">handoff</a>
...
associated <a href="/kv/3.0.16/learn/glossary/#vnode">vnode</a> before assuming that the vnode
...
href="/kv/3.0.16/learn/glossary/#vnode">vnodes</a> attempt to trigger <a
href="/kv/3.0.16/learn/glossary/#hinted-handoff">handoff</a> between
...
%% to release 3.0.16 it was set to a default of 10.
</td>
<td>
