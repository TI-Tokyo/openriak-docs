...
(in LevelDB LOG files) Compaction error | Turn off the node and run repair on the LevelDB partition. See <a href="/kv/2.9.4/using/repair-recovery/errors/#more">Step 2</a>.
