...
[dev api pbc]: ./../../developing/api/protocol-buffers
[FQDNs]: http://en.wikipedia.org/wiki/Fully_qualified_domain_name
[use admin riak-admin cluster replace]: ./../admin/riak-admin/#cluster-replace
[use admin riak-admin force replace]: ./../admin/riak-admin/#cluster-force-replace
...
href="/kv/2.1.4/configuring/">Configuration
