...
pagination_label: "Multi-Datacenter Replication Reference: Statistics"
...
`socket` | See <a href="/kv/2.1.4/using/reference/multi-datacenter/statistics/#socket-statistics">Socket Statistics</a>
...
`strategy` | A replication strategy defines an implementation of the Riak Replication protocol. Valid values: `keylist`, `syncv1`.
`fullsync_worker` | The Erlang process ID of the fullsync worker
`bounded_queue` | See <a href="/kv/2.1.4/using/reference/multi-datacenter/statistics/#bounded-queue">Bounded Queue</a>
