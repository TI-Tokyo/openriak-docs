...
security setup described [below](#java-client-basics). [Certificate](./../../../../using/security/managing-sources/#certificate-based-authentication)-based authentication is not
