...
sidebar_label: Store Object
pagination_label: "PBC Store Object"
...
intended [key](./../../../../learn/concepts/keys-and-objects), [bucket](./../../../../learn/concepts/buckets), and [bucket type](./../../../usage/bucket-types). A bucket must always be specified (via
...
[bucket type](./../../../usage/bucket-types) is assigned, Riak will assign
`default`, which means that the [default bucket configuration](./../../../../configuring/reference/#default-bucket-properties) will be used.
...
`content` | The new or updated contented of the object. Uses the same `RpbContent` message returned as part of an `RpbGetResp` message, documented in [PBC Fetch Object](./../fetch-object)
...
as well as the object's [causal context](./../../../../learn/concepts/causal-context), in the `vclock`
