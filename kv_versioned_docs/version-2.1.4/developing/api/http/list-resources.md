...
pagination_label: "HTTP List Resources"
...
* `riak_kv_wm_buckets` - [Bucket Operations](./../#bucket-operations)
* `riak_kv_wm_index` - [HTTP Secondary Indexes](./../secondary-indexes)
* `riak_kv_wm_link_walker` - [HTTP Link Walking](./../link-walking)
* `riak_kv_wm_mapred` - [HTTP MapReduce](./../mapreduce)
* `riak_kv_wm_object`- [Object/Key Operations](./../#object-key-operations)
* `riak_kv_wm_ping` - [HTTP Ping](./../ping)
* `riak_kv_wm_props` - [HTTP Set Bucket Properties](./../set-bucket-props)
* `riak_kv_wm_stats` - [HTTP Status](./../status)
