...
sidebar_label: Vnodes
pagination_label: "Vnodes"
...
[concept causal context]: ./../causal-context
[concept clusters ring]: ./../clusters/#the-ring
[concept replication]: ./../replication
[concept strong consistency]: ./../strong-consistency
[glossary node]: ./../../glossary/#node
[glossary ring]: ./../../glossary/#ring
[perf strong consistency]: ./../../../using/reference/strong-consistency
...
![The Riak
Ring](/riakdocs-resources/images/shared/riak-ring.png)
...
subdirectories. If you're using, say, [Bitcask](./../../../setup/planning/backend/bitcask) as a backend, navigate
