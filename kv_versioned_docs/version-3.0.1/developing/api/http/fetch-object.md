...
pagination_label: "HTTP Fetch Object"
...
object ([default is defined by the bucket](./../set-bucket-props))
* `pr` - how many primary replicas need to be online when doing the read
([default is defined by the bucket](./../set-bucket-props))
...
purposes of R ([default is defined by the bucket](./../set-bucket-props))
...
datetime format
* `Link` - user- and system-defined links to other resources. [Read more about Links.](./../../../../learn/glossary/#links)

The body of the response will be the contents of the object except when siblings
are present.

<RiakDocsNote title="Siblings">
