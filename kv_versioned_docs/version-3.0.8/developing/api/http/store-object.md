...
pagination_label: "HTTP Store Object"
...
* `Link` - user and system-defined links to other resources. [Read more about Links.](./../link-walking)
...
If `returnbody=true`, any of the response headers expected from [HTTP Fetch Object](./../fetch-object) may be present. Like when fetching the object, `300 Multiple Choices`
