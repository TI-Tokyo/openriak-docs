...
[cluster ops v3 mdc]: ./../../../using/cluster-operations/v3-multi-datacenter
[concept aae]: ./../active-anti-entropy
[concept causal context vc]: ./../causal-context/#vector-clocks
[concept clusters]: ./../clusters
[concept vnodes]: ./../vnodes
[glossary node]: ./../../glossary/#node
[glossary ring]: ./../../glossary/#ring
[usage replication]: ./../../../developing/usage/replication
...
bucket's [bucket type](./../../../developing/usage/bucket-types).
...
[Multi-Datacenter Replications](./../../../configuring/planning/v3-multi-datacenter) capabilities.
...
type](./../../../developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index](./../../../developing/usage/secondary-indexes) and
[MapReduce](./../../../developing/usage/mapreduce) queries. Lowering an object or bucket's
