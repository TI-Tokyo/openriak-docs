...
(in LevelDB LOG files) Compaction error | Turn off the node and run repair on the LevelDB partition. See <a href="/kv/3.0.7/using/repair-recovery/errors/#more">Step 2</a>.
