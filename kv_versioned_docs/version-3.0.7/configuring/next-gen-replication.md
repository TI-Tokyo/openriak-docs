...
<RiakDocsNote>
Next Gen Replication relies on the TicTac AAE system, which needs to be enabled and configured. See the [TicTac AAE configuration](./../active-anti-entropy/tictac-aae) documentaion.
</RiakDocsNote>
