...
sidebar_label: Redis Add-on Features
pagination_label: "Riak Redis Add-on Features"
...
[GET-sequence]: /riakdocs-resources/images/redis/GET_seq.msc.png
[SET-sequence]: /riakdocs-resources/images/redis/SET_seq.msc.png
[DEL-sequence]: /riakdocs-resources/images/redis/DEL_seq.msc.png
[Object-lifetime]: /riakdocs-resources/images/redis/Object_lifetime.msc.png
...
![GET command sequence diagram](/riakdocs-resources/images/redis/GET_seq.msc.png)
...
![SET command sequence diagram](/riakdocs-resources/images/redis/SET_seq.msc.png)

The write-around cache strategy of the DEL command is represented by the
following sequence diagram:

![DEL command sequence diagram](/riakdocs-resources/images/redis/DEL_seq.msc.png)
...
![Object lifetime sequence diagram](/riakdocs-resources/images/redis/Object_lifetime.msc.png)
