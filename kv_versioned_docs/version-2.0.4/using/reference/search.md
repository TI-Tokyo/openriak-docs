...
pagination_label: "Search Reference"
...
Search, you should check out the [Using Search](./../../../developing/usage/search) document.

![Yokozuna](/riakdocs-resources/images/yokozuna.png)
...
See the [main Search documentation](./../../../developing/usage/search/#simple-setup) for details on creating an index.
...
You can also find more information on to how customize your own [search schema](./../../../developing/usage/search-schemas).
...
[Active Anti-Entropy](./../../../learn/concepts/active-anti-entropy) \(AAE) is the process of discovering and
...
information on analysis, see [Search Schema](./../../../developing/usage/search-schemas).
