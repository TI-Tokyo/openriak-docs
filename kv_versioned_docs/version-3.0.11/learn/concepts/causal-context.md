...
sidebar_label: Causal Context
pagination_label: "Causal Context"
...
[concept aae]: ./../active-anti-entropy
[concept clusters]: ./../clusters
[concept eventual consistency]: ./../eventual-consistency
[CRM]: http://en.wikipedia.org/wiki/Customer_relationship_management
[dev api http]: ./../../../developing/api/http
[dev key value]: ./../../../developing/key-value-modeling
[glossary read rep]: ./../../glossary/#read-repair
[perf latency reduc]: ./../../../using/performance/latency-reduction
[usage bucket types]: ./../../../developing/usage/bucket-types
[usage conflict resolution]: ./../../../developing/usage/conflict-resolution
[usage protocol buffers]: ./../../../developing/api/protocol-buffers
[usage updating objects]: ./../../../developing/usage/updating-objects
...
In the case of outcome 2, the choice between **a**, **b** and **c** is determined by settings. If you set the `allow_mult` parameter to `true` for a [bucket type](./../../../developing/usage/bucket-types), all non-CRDT writes to that bucket type will create siblings in the case of concurrent writes (and occasionally under other
