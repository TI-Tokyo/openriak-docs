...
sidebar_label: riak admin CLI
pagination_label: "riak admin Command Line Interface"
...
[use admin commands#join]: ./../commands/#join
[use admin commands#leave]: ./../commands/#leave
[use admin commands#status] /kv/3.0.11/using/admin/commands/#status
[cluster ops backup]: ./../../cluster-operations/backing-up
[config reference#node-metadata]: ./../../../configuring/reference/#node-metadata
[cluster ops change info]: ./../../cluster-operations/changing-cluster-info
[usage mapreduce]: ./../../../developing/usage/mapreduce
[usage commit hooks]: ./../../../developing/usage/commit-hooks
[config reference#ring]: ./../../../configuring/reference/#ring
[cluster ops inspect node]: ./../../cluster-operations/inspecting-node
[use ref monitoring]: ./../../reference/statistics-monitoring
[downgrade]: ./../../../setup/downgrade
[security index]: ./../../security
[security managing]: ./../../security/managing-sources
[cluster ops bucket types]: ./../../cluster-operations/bucket-types
[cluster ops 2i]: ./../../reference/secondary-indexes
[repair recover index]: ./../../repair-recovery
[cluster ops strong consistency]: ./../../cluster-operations/strong-consistency
[cluster ops handoff]: ./../../cluster-operations/handoff
[use admin riak admin#stats]: ./#stats
...
<RiakDocsNote title="Note about reip in Riak KV 3.0.11">
...
<RiakDocsNote title="Note about reip prior to Riak 2.0">
...
<RiakDocsNote title="Note in AAE status information">
