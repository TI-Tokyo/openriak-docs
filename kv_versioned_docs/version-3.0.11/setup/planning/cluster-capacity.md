...
pagination_label: "Cluster Capacity Planning"
...
[plan backend leveldb]: ./../backend/leveldb
[plan bitcask capacity]: ./../bitcask-capacity-calc
[plan index]: ./..
[concept replication]: ./../../../learn/concepts/replication
[use admin riak admin#cluster]: ./../../../using/admin/riak-admin/#cluster
