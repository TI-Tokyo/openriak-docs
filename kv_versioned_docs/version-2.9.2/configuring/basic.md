...
pagination_label: "Basic Riak KV Configuration"
...
[use admin riak-admin#member-status]: ./../../using/admin/riak-admin/#member-status
[perf erlang]: ./../../using/performance/erlang
[plan start]: ./../../setup/planning/start
[plan best practices]: ./../../setup/planning/best-practices
[cluster ops backup]: ./../../using/cluster-operations/backing-up
...
[perf benchmark]: ./../../using/performance/benchmarking
[perf open files]: ./../../using/performance/open-files-limit
[perf index]: ./../../using/performance
[perf aws]: ./../../using/performance/amazon-web-services
[Cluster Capacity Planning]: ./../../setup/planning/cluster-capacity/#ring-size-number-of-partitions
...
directly impacted, although the mechanism described in [HTTP Reset Bucket Properties](./../../developing/api/http/reset-bucket-props) can be used to force them to pick up the new
defaults.
