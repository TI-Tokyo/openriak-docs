...
sidebar_label: Write Once
pagination_label: "Write Once"
...
<br />
![Write Once](/riakdocs-resources/images/write_once.png)
<br />
...
<RiakDocsNote title="Note on the `multi` backend">
The [Multi](./../../../setup/planning/backend/multi) backend does not
