...
sidebar_label: Data Type Fetch
pagination_label: "PBC Data Type Fetch"
...
The equivalent of [`RpbGetReq`](./../fetch-object) for [Riak Data Types](./../../../data-types). This request results in a `DtFetchResp`
...
`type` | The [Using Bucket Types](./../../../../using/cluster-operations/bucket-types) of the bucket in which the Data Type is stored, _not_ the type of Data Type (i.e. counter, set, or map)
...
would send a [vclock](./../../../../learn/glossary/#vector-clock) for standard KV updates.
