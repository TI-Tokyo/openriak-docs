...
sidebar_label: Ruby
pagination_label: "Getting Started with Ruby"
...
If you haven't set up a Riak Node and started it, please visit [Running A Cluster](./../../../using/running-a-cluster) first. To try this flavor
