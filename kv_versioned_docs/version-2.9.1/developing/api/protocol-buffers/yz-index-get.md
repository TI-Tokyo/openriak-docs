...
sidebar_label: Yokozuna Index Get
pagination_label: "PBC Yokozuna Index Get"
...
binary (as `name`). Optionally, you can specify a [`schema`](./../../../usage/search-schemas) name and/or an `n_val`, i.e. the number of nodes on which the
