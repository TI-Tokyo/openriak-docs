...
as <a href="/kv/2.9.1/learn/glossary/#active-anti-entropy-aae">active anti-entropy</a> data, and cluster metadata.
</td>
<td>
<code>./data</code>
</td>
...
Owing to lack of usage, SNMP support has been removed from Riak KV 2.9.1 and higher.

## JMX

Owing to lack of usage, JMX support has also been removed from Riak KV 2.9.1 and higher.
...
associated <a href="/kv/2.9.1/learn/glossary/#vnode">vnode</a> before assuming that the vnode
...
href="/kv/2.9.1/learn/glossary/#vnode">vnodes</a> attempt to trigger <a
href="/kv/2.9.1/learn/glossary/#hinted-handoff">handoff</a> between
