...
pagination_label: "Data Modeling"
...
[apps replication properties]: ./../app-guide/replication-properties
...
operations, use of Riak features including [Data Types](./../data-types),
...
* [Serving Advertisements](./#serving-advertisements)
* [Log Data](./#log-data)
...
* [User Events and Timelines](./#user-events-and-timelines)
* [Articles, Blog Posts, and Other Content](./#articles-blog-posts-and-other-content)
...
for analysis [using MapReduce](./../usage/mapreduce) or as a storage system used in
