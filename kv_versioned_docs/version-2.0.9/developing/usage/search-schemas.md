...
sidebar_label: Creating Search Schemas
pagination_label: "Creating Search Schemas"
...
under the hood to convert your values---plain text, JSON, XML, [Riak Data Types](./../../data-types), and [more](./../custom-extractors)---into something that can be indexed and searched later.
...
`_yz_ed`  | Entropy Data | Data related to [active anti-entropy](./../../../learn/concepts/active-anti-entropy)
