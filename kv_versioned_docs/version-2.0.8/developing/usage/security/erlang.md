...
If you are using [trust](./../../../../using/security/managing-sources), [PAM-](./../../../../using/security/managing-sources/#pam-based-authentication), you can use the security setup described [below](#erlang-client-basics). [Password](./../../../../using/security/managing-sources/#password-based-authentication)-based authentication is covered
...
on specifying trusted CIDRs can be found in [Trust-based Authentication](./../../../../using/security/managing-sources/#trust-based-authentication).
