...
pagination_label: "Improving Performance"
...
<RiakDocsNote title="Note on other operating systems">
...
<RiakDocsNote title="Note on Kernel Tuning Tools">
...
<RiakDocsNote title="Note on system default">
