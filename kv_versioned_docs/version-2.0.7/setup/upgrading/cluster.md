...
sidebar_label: Upgrading a Cluster
pagination_label: "Upgrading a Cluster"
...
<RiakDocsNote title="Note on upgrading Riak KV from older versions">
...
If you run [Riak Control](./../../../using/admin/riak-control), you should disable it during the rolling upgrade process.
</RiakDocsNote>
...
<RiakDocsNote title="Note for secondary index (2i) users">
If you use Riak KV's [secondary indexes](./../../../developing/usage/secondary-indexes) and are
upgrading from a version prior to Riak KV version 1.3.1, you need to
reformat the indexes using the [`riak-admin reformat-indexes`](./../../../using/admin/riak-admin) command. More details about reformatting indexes are available in the [release notes](./../../../release-notes).
</RiakDocsNote>
