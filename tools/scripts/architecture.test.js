...
assert.match(staticBuilderSource, /development\|beta-test\)[\s\S]*core-static[\s\S]*release\)[\s\S]*static/, 'static builds must omit archives outside the release profile');
