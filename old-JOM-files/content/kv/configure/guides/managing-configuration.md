...
[retrieve conf val]: #Retrieving-a-configuration-value
[check config]: #checking-your-config-file

## Overview

    This section covers: [Retrieving a configuration value][#retrieve conf val] and [Checking your config file][#check config]
