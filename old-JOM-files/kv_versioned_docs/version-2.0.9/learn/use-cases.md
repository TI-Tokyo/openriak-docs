...
pagination_label: "Use Cases For Riak KV"
...
[dev data model articles etc]: ./../../developing/data-modeling/#articles-blog-posts-and-other-content
[dev data model log data]: ./../../developing/data-modeling/#log-data
[dev data model sensor data]: ./../../developing/data-modeling/#sensor-data
[dev data model serve advertisements]: ./../../developing/data-modeling/#serving-advertisements
[dev data model sess storage]: ./../../developing/data-modeling/#session-storage
[dev data model user acct]: ./../../developing/data-modeling/#user-accounts
[dev data model user events]: ./../../developing/data-modeling/#user-events-and-timelines
[dev data model user settings]: ./../../developing/data-modeling/#user-settings-and-preferences
...
[usage secondary-indexes]: ./../../developing/usage/secondary-indexes
...
tuning a database. Riak's tunable [apps replication properties](./../../developing/app-guide/replication-properties) can be set
...
<table class="links">
  <tr>
    <td>
<a href="http://www.simonbuckle.com/2011/08/27/analyzing-apache-logs-with-riak/" target="_blank" title="Riak at OpenX"><img src="/riakdocs-resources/images/simon-analyzing-logs.png" /></a>
...
data in Riak is opaque, with the exception of [Riak Data Types](./../../developing/data-types),
...
<table class="links">
  <tr>
    <td>
<a href="http://media.basho.com/pdf/Linkfluence-Case-Study-v2-1.pdf" class="vid_img" link target="_blank"><img src="/riakdocs-resources/images/linkfluence-case-study.png" title="Milking Performance" /></a>
  ...
  <tr>
    <td>
<a href="http://basho.com/assets/Basho-Case-Study-ideeli.pdf" class="vid_img" link target="_blank"><img src="/riakdocs-resources/images/ideeli-case-study.png" title="Milking Performance" /></a>
