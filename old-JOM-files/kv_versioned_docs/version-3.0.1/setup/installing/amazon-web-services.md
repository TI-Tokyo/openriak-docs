...
```bash
wget https://files.tiot.jp/riak/kv/3.0/3.0.1/amazon/2/riak-3.0.1-1.amzn2x86_64.rpm
sudo yum localinstall -y riak_3.0.1-1.amzn2x86_64.rpm
```
...
```bash
wget https://files.tiot.jp/riak/kv/3.0/3.0.1/amazon/2/riak-3.0.1-1.amzn2x86_64.rpm
sudo rpm -i riak_3.0.1-1.amzn2x86_64.rpm
```
...
```bash
wget https://files.tiot.jp/riak/kv/3.0/3.0.1/amazon/2016.09/riak-3.0.1-1.amzn1x86_64.rpm
sudo yum localinstall -y riak_3.0.1-1.amzn1x86_64.rpm
```
...
```bash
wget https://files.tiot.jp/riak/kv/3.0/3.0.1/amazon/2016.09/riak-3.0.1-1.amzn1x86_64.rpm
sudo rpm -i riak_3.0.1-1.amzn1x86_64.rpm
```
## Next Steps
