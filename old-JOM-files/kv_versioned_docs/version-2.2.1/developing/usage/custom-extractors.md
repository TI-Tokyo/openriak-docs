...
sidebar_label: Custom Extractors
pagination_label: "Custom Extractors"
...
There are also built-in extractors for [Riak Data Types](./../searching-data-types).
...
can be found in our documentation on [advanced](./../../../configuring/reference/#advanced-configuration)). Here's an
example:
...
create a schema that extends the [default schema](./../search-schemas/#creating-a-custom-schema). The following fields should be added
...
Now, we can create and activate a [bucket type](./../bucket-types)
