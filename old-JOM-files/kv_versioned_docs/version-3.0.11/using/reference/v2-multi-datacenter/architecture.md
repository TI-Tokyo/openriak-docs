...
pagination_label: "V2 Multi-Datacenter Replication Reference: Architecture"
...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3](./../../v3-multi-datacenter/architecture) instead.
</RiakDocsNote>
...
2. The site node in the secondary cluster initiates fullsync replication
   ...
   the primary cluster
3. The site and listener nodes iterate through each [vnode](./../../../../learn/glossary/#vnode) in their respective clusters and compute a hash for
...
<br />
![MDC Fullsync](/riakdocs-resources/images/MDC_Full-sync-small.png)
<br />
...
<br />
![MDC Realtime](/riakdocs-resources/images/MDC-real-time-sync-small.png)
<br />
...
same [ring size](./../../../../learn/concepts/clusters/#the-ring); if you are using fullsync
replication, every bucket's [`n_val`](./../../../../developing/app-guide/replication-properties#n-value-and-replication) must be the same in both the
