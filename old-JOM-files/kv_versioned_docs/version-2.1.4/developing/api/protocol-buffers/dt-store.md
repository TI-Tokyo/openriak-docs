...
sidebar_label: Data Type Store
pagination_label: "PBC Data Type Store"
...
A request to update the value of a [Riak Data Type](./../../../data-types).
...
performed. More on that in the [PBC Data Type Union](./../dt-union) document.
...
`type` | The bucket type of the bucket in which the Data Type is stored, _not_ the type of Data Type (i.e. counter, set, or map). Learn more about [using bucket types](./../../../../using/cluster-operations/bucket-types).
...
[counter](./../dt-counter-store), [set](./../dt-set-store), or [map](./../dt-map-store).
...
<RiakDocsNote title="Note on defaults and special values">
All of the optional parameters below have default values determined on a
per-bucket basis. Please refer to the documentation on <a
href="/kv/2.1.4/developing/api/protocol-buffers/set-bucket-props/">setting
...
`context` | The opaque binary "context" that informs Riak which version of a data type the client has seen, analogous to [vector clocks](./../../../../learn/glossary/#vector-clock)
...
[`RpbPutResp`](./../store-object) for KV operations. If the
