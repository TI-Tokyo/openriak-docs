...
pagination_label: "Enabling and Disabling Handoff"
...
[`riak-admin`](./../../admin/riak-admin) interface enables you to
...
`Hinted` | Total number of <a href="/kv/2.1.4/using/reference/handoff/#types-of-handoff">hinted handoffs</a>
...
This command displays the values for handoff-specific [configurable parameters](./../../../configuring/reference/#intra-cluster-handoff) on each node in
