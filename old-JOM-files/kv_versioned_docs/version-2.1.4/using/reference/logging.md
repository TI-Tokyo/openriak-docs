...
[config reference lager]: ./../../../configuring/reference/#logging
[Erlang]: http://www.erlang.org
[facility level]: http://en.wikipedia.org/wiki/Syslog#Facility_levels
[install source index]: ./../../../setup/installing/source
[lager]: https://github.com/basho/lager
[SASL]: http://www.erlang.org/doc/man/sasl_app.html
[use admin riak cli attach direct]: ./../../admin/riak-cli/#attach-direct
...
`erlang.log` | Logs emitted by the <a href="/kv/2.1.4/using/performance/erlang/">Erlang VM</a> on which Riak runs.
`error.log` | <a href="/kv/2.1.4/using/repair-recovery/errors/">Common errors</a> emitted by Riak.
