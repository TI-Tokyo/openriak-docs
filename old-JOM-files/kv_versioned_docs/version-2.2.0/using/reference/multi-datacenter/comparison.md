...
pagination_label: "Multi-Datacenter Replication Reference: Comparsion"
...
This document is a systematic comparison of [Version 2](./../../v2-multi-datacenter) and [Version 3](./../../v3-multi-datacenter) of Riak Enterprise's Multi-Datacenter
Replication capabilities.

<RiakDocsNote title="Important note on mixing versions">
...
* Version 3 is able to take advantage of [Active Anti-Entropy](./../../../../learn/concepts/active-anti-entropy) \(AAE)
