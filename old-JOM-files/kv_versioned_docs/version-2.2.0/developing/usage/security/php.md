...
If you are using [trust-](./../../../../using/security/managing-sources/#trust-based-authentication) or [PAM](./../../../../using/security/managing-sources/#pam-based-authentication)-based authentication, you can use the
security setup described [below](#php-client-basics). [Certificate](./../../../../using/security/managing-sources/#certificate-based-authentication)-based authentication is not
...
regardless of which [security source](./../../../../using/security/managing-sources) you choose. All clients should also provide a username, regardless of
