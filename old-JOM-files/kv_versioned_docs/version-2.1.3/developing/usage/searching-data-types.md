...
sidebar_label: Searching with Data Types
pagination_label: "Searching with Data Types"
...
that you don't need to worry about as a user). Riak's [counters](./../../data-types/counters), [sets](./../../data-types/sets), and [maps](./../../data-types/maps)
...
knowledge. We'll create and activate a [bucket type](./../bucket-types) for [storing counters](./../../data-types/counters) simply called
`counters`, like so:
...
people in sets. We'll create and activate a [bucket type](./../bucket-types) for [storing sets](./../../data-types/sets) simply called `sets`,
like so:
...
This example will build on the example in the [Using Data Types](./../../data-types)
tutorial. That tutorial walks you through storing CMS-style user data in
Riak [maps](./../../data-types/maps), and we'd suggest that you
