...
sidebar_label: Load Balancing & Proxy
pagination_label: "Load Balancing and Proxy Configuration"
...
<RiakDocsNote title="Nginx version notes">
...
<RiakDocsNote title="Note on access controls">
