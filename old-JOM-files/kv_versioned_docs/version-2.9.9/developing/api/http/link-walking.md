...
sidebar_label: Link Walking
pagination_label: "HTTP Link Walking"
...
is a special case of [MapReduce](./../../../usage/mapreduce), and can be expressed more verbosely as such.
[Read more about Links](./../../../../learn/glossary/#links).
...
<RiakDocsNote title="Link filters">
...
response from [fetching the object](./../fetch-object), without the status
code.
