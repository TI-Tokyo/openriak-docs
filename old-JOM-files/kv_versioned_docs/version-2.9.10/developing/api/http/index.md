...
`POST` | `/types/<type>/buckets/<bucket>/keys` | [HTTP Store Object](./store-object)
...
see the `curl` examples in [Using Data Types](./../../data-types/#usage-examples)
and subpages e.g. [sets](./../../data-types/sets).
