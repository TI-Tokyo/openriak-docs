...
sidebar_label: Monitoring Strong Consistency
pagination_label: "Monitoring Strong Consistency"
...
status of a node. This data is available by running the [`riak-admin status`](./../../admin/riak-admin/#status) command. That data now
includes statistics specific to strongly consistent operations.

A full listing of these stats is available in [Inspecting a Node](./../../../3.0.2s/using/cluster-operations/inspecting-node).
