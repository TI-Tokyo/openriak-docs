...
sidebar_label: Riak KV Glossary
pagination_label: "Riak KV Glossary"
...
[concept buckets]: ./../concepts/buckets
[concept causal context vc]: ./../concepts/causal-context/#vector-clocks
[concept clusters]: ./../concepts/clusters
[concept crdts]: ./../concepts/crdts
[concept eventual consistency]: ./../concepts/eventual-consistency
[concept keys objects]: ./../concepts/keys-and-objects
[concept replication]: ./../concepts/replication
[concept strong consistency]: ./../concepts/strong-consistency
[dev kv model]: ./../../developing/key-value-modeling
[concept replication aae]: ./../concepts/replication/#active-anti-entropy
[dev api http]: ./../../developing/api/http
[dev data model]: ./../../developing/data-modeling
[dev data types]: ./../../developing/data-types
[glossary read rep]: ./#read-repair
[glossary vnode]: ./#vnode
[Lager]: https://github.com/basho/lager
[learn dynamo]: ./../dynamo
[plan cluster capacity]: ./../../setup/planning/cluster-capacity
[repair recover failure recovery]: ./../../using/repair-recovery/failure-recovery
[repair recover repairs]: ./../../using/repair-recovery/repairs
...
* [Bucket Types](./../../developing/usage/bucket-types)
