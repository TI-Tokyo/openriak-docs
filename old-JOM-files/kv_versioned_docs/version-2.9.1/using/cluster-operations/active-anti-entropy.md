...
sidebar_label: Managing Active Anti-Entropy
pagination_label: "Managing Active Anti-Entropy"
...
[config search#throttledelay]: ./../../../configuring/search/#search-anti-entropy-throttle-tier-delay
[config search#throttle]: ./../../../configuring/search/#search-anti-entropy-throttle
...
In Riak versions 2.9.1 and later, [TicTac AAE](./../tictac-active-anti-entropy) is included with releases as an option to be used in addition to or instead of traditional AAE in Riak.
