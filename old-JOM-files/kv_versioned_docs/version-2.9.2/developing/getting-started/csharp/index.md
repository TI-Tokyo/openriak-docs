...
pagination_label: "Getting Started with C Sharp"
...
If you haven't set up a Riak Node and started it, please visit [Running A Cluster](./../../../using/running-a-cluster) first.
...
<RiakDocsNote title="Configuring for a remote cluster">
