...
sidebar_label: Adding/Removing Nodes
pagination_label: "Adding / Removing Nodes"
...
[use running cluster]: ./../../running-a-cluster
...
simply the script [`riak`](./../../admin/riak-cli):
...
<RiakDocsNote title="Note on ring changes">
