...
export default function ChosenOS() {
  ...
  return <span className='chosenOS' style={{display: 'inline-block'}}><img src={useBaseUrl(selected.smallLogo)} alt={selected.displayName} style={{height: "0.8em"}} /> {selected.displayName}</span>;
}
