...
import type { Options as ThemeOptions } from '../themes/theme-openriak';
...
export type Options = {
    ...
    community?: false | PagesPluginOptions;
...
export type ThemeConfig = BaseThemeConfig & OpenRiakThemeConfig & AlgoliaThemeConfig;
