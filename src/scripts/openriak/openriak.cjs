...
const { updateSchemas, updateSchemaFiles, updateTemplateFiles } = require('./commands/updateSchemas.cjs');
...
const commands = {
  ...
  updateSchemaFiles: {
    ...
    example: '"updateSchemaFiles kv 1.0.0" will update cuttlefishschema files for OpenRiak KV version 1.0.0.'
  },
  updateTemplateFiles: {
